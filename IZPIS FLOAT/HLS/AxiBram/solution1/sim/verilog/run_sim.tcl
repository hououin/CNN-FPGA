...
if {[file isfile crazyFunction.autotvin.dat]} {
	file delete -force crazyFunction.autotvin.dat
}

if {[file isfile crazyFunction.autotvout.dat]} {
	file delete -force crazyFunction.autotvout.dat
}
