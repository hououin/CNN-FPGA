...
parameter crazyFunction_continue_addr = 0;
parameter crazyFunction_auto_start_addr = 0;
...
reg  BREADY_reg = 0;
reg [DATA_WIDTH - 1 : 0] mem_CRTL_BUS [CRTL_BUS_DEPTH - 1 : 0] = '{default : 'h0};
reg [DATA_WIDTH-1 : 0] image_mem_CRTL_BUS [ (CRTL_BUS_c_bitwidth+DATA_WIDTH-1)/DATA_WIDTH * CRTL_BUS_DEPTH -1 : 0] = '{default : 'hz};
