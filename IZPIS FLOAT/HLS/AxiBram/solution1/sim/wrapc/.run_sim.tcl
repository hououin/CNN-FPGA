...
# ==============================================================
set ::env(PATH) "$::env(PATH);C:/Xilinx2021/Vitis_HLS/2021.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx2021/Vitis_HLS/2021.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);C:/Xilinx2021/Vitis_HLS/2021.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx2021/Vitis_HLS/2021.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "crazyFunction.autotvin.dat"
	set constFileTvOut       "crazyFunction.autotvout.dat"
	set constFileHdlTvIn     "crazyFunction.autohdltvin.dat"
	set constFileHdlTvOut    "crazyFunction.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
