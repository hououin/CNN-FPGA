...
#
# Generated by Vivado on Thu Jul 27 21:35:04 +0200 2023
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../hello_word.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../hello_word.gen/sources_1/bd/design_1/ipshared/f42d/hdl" +incdir+"C:/Xilinx2021/Vivado/2021.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../hello_word.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../hello_word.gen/sources_1/bd/design_1/ipshared/f42d/hdl" +incdir+"C:/Xilinx2021/Vivado/2021.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../hello_word.gen/sources_1/bd/design_1/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work axi_vip_v1_1_10 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../hello_word.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../hello_word.gen/sources_1/bd/design_1/ipshared/f42d/hdl" +incdir+"C:/Xilinx2021/Vivado/2021.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../hello_word.gen/sources_1/bd/design_1/ipshared/0980/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work processing_system7_vip_v1_0_12 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../hello_word.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../hello_word.gen/sources_1/bd/design_1/ipshared/f42d/hdl" +incdir+"C:/Xilinx2021/Vivado/2021.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../hello_word.gen/sources_1/bd/design_1/ipshared/f42d/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../hello_word.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../hello_word.gen/sources_1/bd/design_1/ipshared/f42d/hdl" +incdir+"C:/Xilinx2021/Vivado/2021.1/data/xilinx_vip/include" \
