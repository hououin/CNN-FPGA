...
// ==============================================================
#ifndef __conv_mul_mul_14s_5jm__HH__
#define __conv_mul_mul_14s_5jm__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_14s_5jm) {
    ...
    SC_CTOR(conv_mul_mul_14s_5jm):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
