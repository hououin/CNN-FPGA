...
// ==============================================================
#ifndef __conv_dcmp_64ns_643i2__HH__
#define __conv_dcmp_64ns_643i2__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_dcmp_64ns_643i2) {
    ...
    SC_CTOR(conv_dcmp_64ns_643i2):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
