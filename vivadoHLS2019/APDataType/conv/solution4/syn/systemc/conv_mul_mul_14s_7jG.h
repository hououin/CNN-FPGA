...
// ==============================================================
#ifndef __conv_mul_mul_14s_7jG__HH__
#define __conv_mul_mul_14s_7jG__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_14s_7jG) {
    ...
    SC_CTOR(conv_mul_mul_14s_7jG):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
