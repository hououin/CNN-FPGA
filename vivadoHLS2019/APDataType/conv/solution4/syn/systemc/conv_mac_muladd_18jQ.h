...
// ==============================================================
#ifndef __conv_mac_muladd_18jQ__HH__
#define __conv_mac_muladd_18jQ__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mac_muladd_18jQ) {
    ...
    SC_CTOR(conv_mac_muladd_18jQ):  simcore_mac_1_U ("simcore_mac_1_U") {
