...
// ==============================================================
#ifndef __conv_mul_mul_10s_8jQ__HH__
#define __conv_mul_mul_10s_8jQ__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_10s_8jQ) {
    ...
    SC_CTOR(conv_mul_mul_10s_8jQ):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
