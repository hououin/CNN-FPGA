...
// ==============================================================
#ifndef __conv_mul_mul_9s_16jw__HH__
#define __conv_mul_mul_9s_16jw__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_9s_16jw) {
    ...
    SC_CTOR(conv_mul_mul_9s_16jw):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
