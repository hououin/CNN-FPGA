...
// ==============================================================
#ifndef __conv_mac_muladd_77jG__HH__
#define __conv_mac_muladd_77jG__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mac_muladd_77jG) {
    ...
    SC_CTOR(conv_mac_muladd_77jG):  simcore_mac_1_U ("simcore_mac_1_U") {
