...
// ==============================================================
#ifndef __conv_mul_mul_8s_15jm__HH__
#define __conv_mul_mul_8s_15jm__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_8s_15jm) {
    ...
    SC_CTOR(conv_mul_mul_8s_15jm):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
