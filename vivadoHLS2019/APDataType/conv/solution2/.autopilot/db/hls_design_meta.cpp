...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("input_V_address1", 10, hls_out, 0, "ap_memory", "MemPortADDR2", 1),
	Port_Property("input_V_ce1", 1, hls_out, 0, "ap_memory", "MemPortCE2", 1),
	Port_Property("input_V_q1", 14, hls_in, 0, "ap_memory", "MemPortDOUT2", 1),
