...
// ==============================================================
#ifndef __conv_mac_muladd_1jbC__HH__
#define __conv_mac_muladd_1jbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mac_muladd_1jbC) {
    ...
    SC_CTOR(conv_mac_muladd_1jbC):  simcore_mac_3_U ("simcore_mac_3_U") {
