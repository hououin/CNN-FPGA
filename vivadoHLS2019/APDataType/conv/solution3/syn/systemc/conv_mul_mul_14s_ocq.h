...
// ==============================================================
#ifndef __conv_mul_mul_14s_ocq__HH__
#define __conv_mul_mul_14s_ocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_14s_ocq) {
    ...
    SC_CTOR(conv_mul_mul_14s_ocq):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
