...
// ==============================================================
#ifndef __conv_mul_mul_14s_fYi__HH__
#define __conv_mul_mul_14s_fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_14s_fYi) {
    ...
    SC_CTOR(conv_mul_mul_14s_fYi):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
