...
// ==============================================================
#ifndef __conv_mul_mul_14s_dEe__HH__
#define __conv_mul_mul_14s_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_14s_dEe) {
    ...
    SC_CTOR(conv_mul_mul_14s_dEe):  ACMP_smul_su_U ("ACMP_smul_su_U") {
