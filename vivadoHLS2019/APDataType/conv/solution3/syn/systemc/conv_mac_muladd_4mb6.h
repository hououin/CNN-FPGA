...
// ==============================================================
#ifndef __conv_mac_muladd_4mb6__HH__
#define __conv_mac_muladd_4mb6__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mac_muladd_4mb6) {
    ...
    SC_CTOR(conv_mac_muladd_4mb6):  simcore_mac_4_U ("simcore_mac_4_U") {
