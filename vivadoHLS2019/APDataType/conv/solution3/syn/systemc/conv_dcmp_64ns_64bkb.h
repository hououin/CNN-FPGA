...
// ==============================================================
#ifndef __conv_dcmp_64ns_64bkb__HH__
#define __conv_dcmp_64ns_64bkb__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_dcmp_64ns_64bkb) {
    ...
    SC_CTOR(conv_dcmp_64ns_64bkb):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
