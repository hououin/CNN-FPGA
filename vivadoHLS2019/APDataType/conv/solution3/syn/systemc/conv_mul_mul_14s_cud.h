...
// ==============================================================
#ifndef __conv_mul_mul_14s_cud__HH__
#define __conv_mul_mul_14s_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_14s_cud) {
    ...
    SC_CTOR(conv_mul_mul_14s_cud):  ACMP_smul_su_U ("ACMP_smul_su_U") {
