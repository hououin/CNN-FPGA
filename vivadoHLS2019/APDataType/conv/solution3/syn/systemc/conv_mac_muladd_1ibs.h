...
// ==============================================================
#ifndef __conv_mac_muladd_1ibs__HH__
#define __conv_mac_muladd_1ibs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mac_muladd_1ibs) {
    ...
    SC_CTOR(conv_mac_muladd_1ibs):  simcore_mac_2_U ("simcore_mac_2_U") {
