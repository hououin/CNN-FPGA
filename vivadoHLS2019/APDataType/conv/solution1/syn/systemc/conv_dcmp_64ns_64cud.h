...
// ==============================================================
#ifndef __conv_dcmp_64ns_64cud__HH__
#define __conv_dcmp_64ns_64cud__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_dcmp_64ns_64cud) {
    ...
    SC_CTOR(conv_dcmp_64ns_64cud):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
