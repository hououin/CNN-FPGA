...
// ==============================================================
#ifndef __cnn_mac_muladd_14bbk__HH__
#define __cnn_mac_muladd_14bbk__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_14bbk) {
    ...
    SC_CTOR(cnn_mac_muladd_14bbk):  simcore_mac_1_U ("simcore_mac_1_U") {
