...
entity dense_out_dense_obhl_rom is 
    generic(
             DWIDTH     : integer := 9; 
             AWIDTH     : integer := 9; 
...
architecture rtl of dense_out_dense_obhl_rom is 
...
entity dense_out_dense_obhl is
    generic (
        DataWidth : INTEGER := 9;
...
architecture arch of dense_out_dense_obhl is
    component dense_out_dense_obhl_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    dense_out_dense_obhl_rom_U :  component dense_out_dense_obhl_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
