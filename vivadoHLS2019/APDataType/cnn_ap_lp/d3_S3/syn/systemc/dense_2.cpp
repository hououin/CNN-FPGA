...
dense_2::dense_2(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_tmp_30_fu_197_p3);
    sensitive << ( j_0_reg_137 );
    ...
    sc_trace(mVcdFile, tmp_30_fu_197_p3, "tmp_30_fu_197_p3");
...
void dense_2::thread_tmp_30_fu_197_p3() {
    tmp_30_fu_197_p3 = esl_concat<6,1>(j_0_reg_137.read(), ap_const_lv1_0);
}
...
void dense_2::thread_zext_ln1117_1_fu_205_p1() {
    zext_ln1117_1_fu_205_p1 = esl_zext<12,7>(tmp_30_fu_197_p3.read());
}
