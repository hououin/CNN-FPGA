...
dense_2::dense_2(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    dense_2_bias_V_U = new dense_2_dense_2_bncg("dense_2_bias_V_U");
    ...
    cnn_mac_muladd_9socq_U30 = new cnn_mac_muladd_9socq<1,1,9,13,22,22>("cnn_mac_muladd_9socq_U30");
    cnn_mac_muladd_9socq_U30->din0(dense_2_weights_V_q0);
    cnn_mac_muladd_9socq_U30->din1(grp_fu_291_p1);
    cnn_mac_muladd_9socq_U30->din2(grp_fu_291_p2);
    cnn_mac_muladd_9socq_U30->dout(grp_fu_291_p3);
...
dense_2::~dense_2() {
    ...
    delete cnn_mac_muladd_9socq_U30;
}
