...
// ==============================================================
#ifndef __cnn_mul_mul_6ns_1ncg__HH__
#define __cnn_mul_mul_6ns_1ncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_6ns_1ncg) {
    ...
    SC_CTOR(cnn_mul_mul_6ns_1ncg):  ACMP_smul_us_U ("ACMP_smul_us_U") {
