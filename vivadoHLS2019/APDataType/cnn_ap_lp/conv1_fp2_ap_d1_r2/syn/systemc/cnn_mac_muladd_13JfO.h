...
// ==============================================================
#ifndef __cnn_mac_muladd_13JfO__HH__
#define __cnn_mac_muladd_13JfO__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_13JfO) {
    ...
    SC_CTOR(cnn_mac_muladd_13JfO):  simcore_mac_9_U ("simcore_mac_9_U") {
