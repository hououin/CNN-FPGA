...
// ==============================================================
#ifndef __cnn_mul_mul_10s_1vdy__HH__
#define __cnn_mul_mul_10s_1vdy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_10s_1vdy) {
    ...
    SC_CTOR(cnn_mul_mul_10s_1vdy):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
