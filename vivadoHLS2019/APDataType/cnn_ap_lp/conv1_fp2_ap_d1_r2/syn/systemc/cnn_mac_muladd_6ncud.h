...
// ==============================================================
#ifndef __cnn_mac_muladd_6ncud__HH__
#define __cnn_mac_muladd_6ncud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_6ncud) {
    ...
    SC_CTOR(cnn_mac_muladd_6ncud):  simcore_mac_0_U ("simcore_mac_0_U") {
