...
// ==============================================================
#ifndef __cnn_mul_mul_7ns_1eOg__HH__
#define __cnn_mul_mul_7ns_1eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_7ns_1eOg) {
    ...
    SC_CTOR(cnn_mul_mul_7ns_1eOg):  ACMP_smul_us_U ("ACMP_smul_us_U") {
