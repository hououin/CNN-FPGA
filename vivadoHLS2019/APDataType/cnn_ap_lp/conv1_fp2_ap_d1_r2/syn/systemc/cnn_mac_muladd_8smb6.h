...
// ==============================================================
#ifndef __cnn_mac_muladd_8smb6__HH__
#define __cnn_mac_muladd_8smb6__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_8smb6) {
    ...
    SC_CTOR(cnn_mac_muladd_8smb6):  simcore_mac_4_U ("simcore_mac_4_U") {
