...
// ==============================================================
#ifndef __cnn_mul_mul_7s_14dEe__HH__
#define __cnn_mul_mul_7s_14dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_7s_14dEe) {
    ...
    SC_CTOR(cnn_mul_mul_7s_14dEe):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
