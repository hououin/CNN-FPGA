...
architecture behav of dense_2 is 
    ...
    component dense_2_dense_2_bAem IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    dense_2_weights_V_U : component dense_2_dense_2_wzec
    generic map (
        DataWidth => 9,
        AddressRange => 1500,
        AddressWidth => 11)
    ...
    dense_2_bias_V_U : component dense_2_dense_2_bAem
    generic map (
        DataWidth => 9,
        AddressRange => 30,
        AddressWidth => 5)
    ...
    cnn_mac_muladd_9sBew_U77 : component cnn_mac_muladd_9sBew
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 9,
