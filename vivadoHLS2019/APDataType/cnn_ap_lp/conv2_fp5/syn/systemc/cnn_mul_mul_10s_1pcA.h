...
// ==============================================================
#ifndef __cnn_mul_mul_10s_1pcA__HH__
#define __cnn_mul_mul_10s_1pcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_10s_1pcA) {
    ...
    SC_CTOR(cnn_mul_mul_10s_1pcA):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
