...
struct dense_out : public sc_module {
    ...
    sc_signal< sc_logic > grp_soft_max_fu_180_dense_array_V_we0;
    sc_signal< sc_lv<14> > grp_soft_max_fu_180_dense_array_V_d0;
    ...
    void thread_add_ln703_fu_336_p2();
