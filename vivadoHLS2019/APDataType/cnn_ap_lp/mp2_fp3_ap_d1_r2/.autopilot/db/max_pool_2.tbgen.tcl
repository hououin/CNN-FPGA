...
set C_modelArgList {
	{ conv_out_0_V int 14 regular {array 1056 { 1 1 } 1 1 }  }
	{ conv_out_1_V int 14 regular {array 880 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ conv_out_1_V_address0 sc_out sc_lv 10 signal 1 } 
	{ conv_out_1_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ conv_out_1_V_q0 sc_in sc_lv 14 signal 1 } 
	{ conv_out_1_V_address1 sc_out sc_lv 10 signal 1 } 
	{ conv_out_1_V_ce1 sc_out sc_logic 1 signal 1 } 
	{ conv_out_1_V_q1 sc_in sc_lv 14 signal 1 } 
	{ max_pool_out_V_address0 sc_out sc_lv 9 signal 2 } 
	{ max_pool_out_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ max_pool_out_V_we0 sc_out sc_logic 1 signal 2 } 
	{ max_pool_out_V_d0 sc_out sc_lv 14 signal 2 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	conv_out_1_V { ap_memory {  { conv_out_1_V_address0 mem_address 1 10 }  { conv_out_1_V_ce0 mem_ce 1 1 }  { conv_out_1_V_q0 mem_dout 0 14 }  { conv_out_1_V_address1 MemPortADDR2 1 10 }  { conv_out_1_V_ce1 MemPortCE2 1 1 }  { conv_out_1_V_q1 MemPortDOUT2 0 14 } } }
