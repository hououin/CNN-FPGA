...
wire   [10:0] zext_ln203_7_fu_415_p1;
reg   [10:0] zext_ln203_7_reg_1063;
...
wire   [63:0] zext_ln203_9_fu_428_p1;
...
wire   [11:0] zext_ln203_8_fu_419_p1;
wire   [11:0] add_ln203_4_fu_423_p2;
...
wire   [10:0] tmp_67_cast_fu_608_p3;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln14_fu_399_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        conv_out_V_addr_reg_1068 <= zext_ln203_9_fu_428_p1;
        zext_ln203_7_reg_1063[4 : 0] <= zext_ln203_7_fu_415_p1[4 : 0];
...
assign add_ln1116_2_fu_616_p2 = (zext_ln203_7_reg_1063 + tmp_67_cast_fu_608_p3);
...
assign add_ln203_4_fu_423_p2 = (zext_ln14_reg_1045 + zext_ln203_8_fu_419_p1);
...
assign tmp_67_cast_fu_608_p3 = {{add_ln1116_1_fu_603_p2}, {4'd0}};
...
assign zext_ln203_7_fu_415_p1 = f_0_reg_251;

assign zext_ln203_8_fu_419_p1 = f_0_reg_251;

assign zext_ln203_9_fu_428_p1 = add_ln203_4_fu_423_p2;
...
always @ (posedge ap_clk) begin
    ...
    zext_ln203_7_reg_1063[10:5] <= 6'b000000;
