...
architecture behav of cnn is 
    ...
    "cnn,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=16.990188,HLS_SYN_LAT=453997,HLS_SYN_TPT=none,HLS_SYN_MEM=31,HLS_SYN_DSP=8,HLS_SYN_FF=3240,HLS_SYN_LUT=11654,HLS_VERSION=2019_1}";
    ...
    signal add_ln203_6_fu_842_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal add_ln203_6_reg_1901 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal grp_max_pool_2_fu_724_ap_start : STD_LOGIC;
    signal grp_max_pool_2_fu_724_ap_done : STD_LOGIC;
    signal grp_max_pool_2_fu_724_ap_idle : STD_LOGIC;
    signal grp_max_pool_2_fu_724_ap_ready : STD_LOGIC;
    signal grp_max_pool_2_fu_724_conv_out_V_address0 : STD_LOGIC_VECTOR (10 downto 0);
    signal grp_max_pool_2_fu_724_conv_out_V_ce0 : STD_LOGIC;
    signal grp_max_pool_2_fu_724_conv_out_V_address1 : STD_LOGIC_VECTOR (10 downto 0);
    signal grp_max_pool_2_fu_724_conv_out_V_ce1 : STD_LOGIC;
    signal grp_max_pool_2_fu_724_max_pool_out_V_address0 : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_max_pool_2_fu_724_max_pool_out_V_ce0 : STD_LOGIC;
    signal grp_max_pool_2_fu_724_max_pool_out_V_we0 : STD_LOGIC;
    signal grp_max_pool_2_fu_724_max_pool_out_V_d0 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal grp_max_pool_2_fu_724_ap_start_reg : STD_LOGIC := '0';
    ...
    signal tmp_53_fu_808_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal zext_ln203_fu_804_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal zext_ln203_14_fu_816_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal zext_ln203_15_fu_838_p1 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_54_fu_1301_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_55_fu_1313_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_56_fu_1444_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_57_fu_1456_p3 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    grp_max_pool_2_fu_724 : component max_pool_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_max_pool_2_fu_724_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((grp_max_pool_2_fu_724_ap_ready = ap_const_logic_1)) then 
                    grp_max_pool_2_fu_724_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state14 => 
                if (((grp_max_pool_2_fu_724_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state14))) then
    ...
    add_ln203_6_fu_842_p2 <= std_logic_vector(unsigned(sub_ln203_reg_1888) + unsigned(zext_ln203_15_fu_838_p1));
    ...
    conv_1_out_V_address0_assign_proc : process(ap_CS_fsm_state2, grp_conv_1_fu_740_conv_out_V_address0, grp_max_pool_1_fu_762_conv_out_V_address0, ap_CS_fsm_state8, ap_CS_fsm_state10)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    conv_1_out_V_ce0_assign_proc : process(ap_CS_fsm_state2, grp_conv_1_fu_740_conv_out_V_ce0, grp_max_pool_1_fu_762_conv_out_V_ce0, ap_CS_fsm_state8, ap_CS_fsm_state10)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    conv_2_out_V_address0_assign_proc : process(ap_CS_fsm_state2, grp_max_pool_2_fu_724_conv_out_V_address0, grp_conv_2_fu_730_conv_out_V_address0, ap_CS_fsm_state14, ap_CS_fsm_state12)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    conv_2_out_V_ce0_assign_proc : process(ap_CS_fsm_state2, grp_max_pool_2_fu_724_conv_out_V_ce0, grp_conv_2_fu_730_conv_out_V_ce0, ap_CS_fsm_state14, ap_CS_fsm_state12)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    conv_2_out_V_ce1_assign_proc : process(grp_max_pool_2_fu_724_conv_out_V_ce1, ap_CS_fsm_state14)
    begin
    ...
    flat_array_V_ce0_assign_proc : process(ap_CS_fsm_state18, grp_max_pool_2_fu_724_ap_done, grp_flat_fu_768_flat_array_V_ce0, ap_CS_fsm_state16, ap_CS_fsm_state14)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state18) or ((grp_max_pool_2_fu_724_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state14)))) then 
    ...
    flat_array_V_we0_assign_proc : process(grp_max_pool_2_fu_724_ap_done, grp_flat_fu_768_flat_array_V_we0, ap_CS_fsm_state16, ap_CS_fsm_state14)
    begin
        if (((grp_max_pool_2_fu_724_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state14))) then 
    ...
    grp_max_pool_2_fu_724_ap_start <= grp_max_pool_2_fu_724_ap_start_reg;
    ...
    max_pool_1_out_V_address0_assign_proc : process(ap_CS_fsm_state2, grp_conv_2_fu_730_input_V_address0, grp_max_pool_1_fu_762_max_pool_out_V_address0, ap_CS_fsm_state12, ap_CS_fsm_state10)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    max_pool_1_out_V_ce0_assign_proc : process(ap_CS_fsm_state2, grp_conv_2_fu_730_input_V_ce0, grp_max_pool_1_fu_762_max_pool_out_V_ce0, ap_CS_fsm_state12, ap_CS_fsm_state10)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    max_pool_2_out_V_address0_assign_proc : process(ap_CS_fsm_state2, grp_max_pool_2_fu_724_max_pool_out_V_address0, grp_flat_fu_768_max_pool_out_V_address0, ap_CS_fsm_state16, ap_CS_fsm_state14)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    max_pool_2_out_V_ce0_assign_proc : process(ap_CS_fsm_state2, grp_max_pool_2_fu_724_max_pool_out_V_ce0, grp_flat_fu_768_max_pool_out_V_ce0, ap_CS_fsm_state16, ap_CS_fsm_state14)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    max_pool_2_out_V_d0_assign_proc : process(ap_CS_fsm_state2, grp_max_pool_2_fu_724_max_pool_out_V_d0, ap_CS_fsm_state14)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    max_pool_2_out_V_we0_assign_proc : process(ap_CS_fsm_state2, icmp_ln23_fu_778_p2, grp_max_pool_2_fu_724_max_pool_out_V_we0, ap_CS_fsm_state14)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln23_fu_778_p2 = ap_const_lv1_1))) then 
    ...
    sext_ln1265_fu_1223_p0 <= dense_1_bias_V_q0;
        ...
        sext_ln203_fu_1141_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(add_ln203_6_reg_1901),64));
    ...
    sub_ln203_fu_820_p2 <= std_logic_vector(unsigned(zext_ln203_fu_804_p1) - unsigned(zext_ln203_14_fu_816_p1));
    ...
    tmp_53_fu_808_p3 <= (i_0_reg_568 & ap_const_lv2_0);
    tmp_54_fu_1301_p3 <= (j_0_i10_reg_668 & ap_const_lv5_0);
    tmp_55_fu_1313_p3 <= (j_0_i10_reg_668 & ap_const_lv1_0);
    tmp_56_fu_1444_p3 <= (f_0_i_reg_702 & ap_const_lv3_0);
    tmp_57_fu_1456_p3 <= (f_0_i_reg_702 & ap_const_lv1_0);
    ...
    zext_ln1116_8_fu_1464_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_57_fu_1456_p3),9));
    zext_ln1116_9_fu_1479_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln1116_4_fu_1474_p2),64));
    zext_ln1116_fu_1452_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_56_fu_1444_p3),9));
    zext_ln1117_6_fu_1309_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_54_fu_1301_p3),12));
    zext_ln1117_7_fu_1321_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_55_fu_1313_p3),12));
    ...
    zext_ln203_14_fu_816_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_53_fu_808_p3),11));
    zext_ln203_15_fu_838_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_0_reg_589),11));
