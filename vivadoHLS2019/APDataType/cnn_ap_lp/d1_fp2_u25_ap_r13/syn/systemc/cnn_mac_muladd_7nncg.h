...
// ==============================================================
#ifndef __cnn_mac_muladd_7nncg__HH__
#define __cnn_mac_muladd_7nncg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_7nncg) {
    ...
    SC_CTOR(cnn_mac_muladd_7nncg):  simcore_mac_0_U ("simcore_mac_0_U") {
