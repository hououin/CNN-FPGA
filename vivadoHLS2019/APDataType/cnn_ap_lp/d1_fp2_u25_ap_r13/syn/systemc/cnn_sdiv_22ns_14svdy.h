...
// ==============================================================
#ifndef __cnn_sdiv_22ns_14svdy__HH__
#define __cnn_sdiv_22ns_14svdy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_sdiv_22ns_14svdy) {
    ...
    SC_CTOR(cnn_sdiv_22ns_14svdy):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
