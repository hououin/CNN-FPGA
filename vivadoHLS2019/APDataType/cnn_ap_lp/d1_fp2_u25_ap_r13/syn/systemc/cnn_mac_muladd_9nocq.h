...
// ==============================================================
#ifndef __cnn_mac_muladd_9nocq__HH__
#define __cnn_mac_muladd_9nocq__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_9nocq) {
    ...
    SC_CTOR(cnn_mac_muladd_9nocq):  simcore_mac_1_U ("simcore_mac_1_U") {
