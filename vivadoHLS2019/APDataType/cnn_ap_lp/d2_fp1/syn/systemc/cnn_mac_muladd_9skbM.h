...
// ==============================================================
#ifndef __cnn_mac_muladd_9skbM__HH__
#define __cnn_mac_muladd_9skbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_9skbM) {
    ...
    SC_CTOR(cnn_mac_muladd_9skbM):  simcore_mac_0_U ("simcore_mac_0_U") {
