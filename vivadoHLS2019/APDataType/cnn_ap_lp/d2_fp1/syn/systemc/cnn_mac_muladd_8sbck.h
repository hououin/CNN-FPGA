...
// ==============================================================
#ifndef __cnn_mac_muladd_8sbck__HH__
#define __cnn_mac_muladd_8sbck__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_8sbck) {
    ...
    SC_CTOR(cnn_mac_muladd_8sbck):  simcore_mac_2_U ("simcore_mac_2_U") {
