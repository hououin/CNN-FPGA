...
// ==============================================================
#ifndef __cnn_mul_mul_8s_13bak__HH__
#define __cnn_mul_mul_8s_13bak__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_8s_13bak) {
    ...
    SC_CTOR(cnn_mul_mul_8s_13bak):  ACMP_smul_su_U ("ACMP_smul_su_U") {
