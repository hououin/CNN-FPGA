...
architecture behav of exp_15_7_s is 
    ...
    component exp_15_7_s_f_x_lsbek IS
    generic (
        DataWidth : INTEGER;
...
begin
    f_x_lsb_table_V_U : component exp_15_7_s_f_x_lsbek
    generic map (
        DataWidth => 11,
        AddressRange => 32,
        AddressWidth => 5)
    ...
    exp_x_msb_2_m_1_tabl_U : component exp_15_7_s_exp_x_bfk
    generic map (
        DataWidth => 25,
        AddressRange => 32,
        AddressWidth => 5)
    ...
    exp_x_msb_1_table_V_U : component exp_15_7_s_exp_x_bgk
    generic map (
        DataWidth => 25,
        AddressRange => 32,
        AddressWidth => 5)
