...
architecture behav of dense_out is 
    ...
    component cnn_mac_muladd_13bll IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component dense_out_dense_obil IS
    generic (
        DataWidth : INTEGER;
    ...
    component dense_out_dense_objl IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    dense_out_weights_V_U : component dense_out_dense_obil
    generic map (
        DataWidth => 9,
        AddressRange => 300,
        AddressWidth => 9)
    ...
    dense_out_bias_V_U : component dense_out_dense_objl
    generic map (
        DataWidth => 8,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    dense_array_V_U : component dense_out_dense_abkl
    generic map (
        DataWidth => 14,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    cnn_mac_muladd_13bll_U143 : component cnn_mac_muladd_13bll
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 13,
