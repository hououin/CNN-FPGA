...
// ==============================================================
#ifndef __cnn_mac_muladd_9nkbM__HH__
#define __cnn_mac_muladd_9nkbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_9nkbM) {
    ...
    SC_CTOR(cnn_mac_muladd_9nkbM):  simcore_mac_0_U ("simcore_mac_0_U") {
