...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_sdiv_22ns_14spcA_U34 = new cnn_sdiv_22ns_14spcA<1,26,22,14,14>("cnn_sdiv_22ns_14spcA_U34");
    cnn_sdiv_22ns_14spcA_U34->clk(ap_clk);
    cnn_sdiv_22ns_14spcA_U34->reset(ap_rst);
    cnn_sdiv_22ns_14spcA_U34->start(grp_fu_249_ap_start);
    cnn_sdiv_22ns_14spcA_U34->done(grp_fu_249_ap_done);
    cnn_sdiv_22ns_14spcA_U34->din0(grp_fu_249_p0);
    cnn_sdiv_22ns_14spcA_U34->din1(grp_fu_249_p1);
    cnn_sdiv_22ns_14spcA_U34->ce(ap_var_for_const0);
    cnn_sdiv_22ns_14spcA_U34->dout(grp_fu_249_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_sdiv_22ns_14spcA_U34;
}
