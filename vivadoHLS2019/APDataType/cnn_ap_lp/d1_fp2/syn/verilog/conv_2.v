...
wire   [63:0] zext_ln1117_4_fu_631_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        p_Val2_21_reg_308 <= {{ret_V_fu_663_p2[21:8]}};
    end else if (((icmp_ln21_fu_495_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
...
assign add_ln1117_fu_552_p2 = (zext_ln1117_2_fu_548_p1 + mul_ln1117_reg_1086);
...
assign input_V_address0 = zext_ln1117_4_fu_631_p1;
...
assign lhs_V_fu_647_p3 = {{p_Val2_21_reg_308}, {8'd0}};
...
assign sub_ln1117_fu_577_p2 = (p_shl1_cast_fu_557_p3 - zext_ln1117_3_fu_573_p1);
...
assign zext_ln1117_2_fu_548_p1 = add_ln26_1_fu_542_p2;

assign zext_ln1117_3_fu_573_p1 = tmp_13_fu_565_p3;

assign zext_ln1117_4_fu_631_p1 = add_ln1117_1_fu_626_p2;
