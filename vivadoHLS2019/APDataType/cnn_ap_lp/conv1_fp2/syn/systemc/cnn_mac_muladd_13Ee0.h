...
// ==============================================================
#ifndef __cnn_mac_muladd_13Ee0__HH__
#define __cnn_mac_muladd_13Ee0__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_13Ee0) {
    ...
    SC_CTOR(cnn_mac_muladd_13Ee0):  simcore_mac_7_U ("simcore_mac_7_U") {
