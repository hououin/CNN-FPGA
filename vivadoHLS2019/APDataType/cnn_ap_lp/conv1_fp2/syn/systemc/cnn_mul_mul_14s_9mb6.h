...
// ==============================================================
#ifndef __cnn_mul_mul_14s_9mb6__HH__
#define __cnn_mul_mul_14s_9mb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_14s_9mb6) {
    ...
    SC_CTOR(cnn_mul_mul_14s_9mb6):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
