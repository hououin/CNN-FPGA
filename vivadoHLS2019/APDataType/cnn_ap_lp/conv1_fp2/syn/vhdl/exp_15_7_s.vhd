...
architecture behav of exp_15_7_s is 
    ...
    component exp_15_7_s_f_x_lsxdS IS
    generic (
        DataWidth : INTEGER;
...
begin
    f_x_lsb_table_V_U : component exp_15_7_s_f_x_lsxdS
    generic map (
        DataWidth => 11,
        AddressRange => 32,
        AddressWidth => 5)
    ...
    exp_x_msb_2_m_1_tabl_U : component exp_15_7_s_exp_x_yd2
    generic map (
        DataWidth => 25,
        AddressRange => 32,
        AddressWidth => 5)
    ...
    exp_x_msb_1_table_V_U : component exp_15_7_s_exp_x_zec
    generic map (
        DataWidth => 25,
        AddressRange => 32,
        AddressWidth => 5)
