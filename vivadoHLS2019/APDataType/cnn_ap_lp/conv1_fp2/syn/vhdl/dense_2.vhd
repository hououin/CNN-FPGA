...
architecture behav of dense_2 is 
    ...
    component dense_2_dense_2_bvdy IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    dense_2_weights_V_U : component dense_2_dense_2_wudo
    generic map (
        DataWidth => 9,
        AddressRange => 1500,
        AddressWidth => 11)
    ...
    dense_2_bias_V_U : component dense_2_dense_2_bvdy
    generic map (
        DataWidth => 9,
        AddressRange => 30,
        AddressWidth => 5)
    ...
    cnn_mac_muladd_9swdI_U71 : component cnn_mac_muladd_9swdI
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 9,
