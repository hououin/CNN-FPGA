...
wire   [8:0] tmp_14_cast_fu_316_p3;
reg   [8:0] tmp_14_cast_reg_420;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln9_fu_261_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        ...
        tmp_14_cast_reg_420[8 : 4] <= tmp_14_cast_fu_316_p3[8 : 4];
    end
end
...
assign add_ln203_4_fu_348_p2 = (tmp_14_cast_reg_420 + zext_ln203_8_fu_344_p1);
...
assign tmp_14_cast_fu_316_p3 = {{add_ln203_3_fu_311_p2}, {4'd0}};

assign tmp_1_fu_243_p3 = {{r_0_reg_132}, {4'd0}};

assign tmp_6_fu_299_p3 = phi_mul_reg_165[32'd5];
...
assign zext_ln203_6_fu_307_p1 = tmp_6_fu_299_p3;
...
assign zext_ln9_fu_251_p1 = tmp_1_fu_243_p3;
...
always @ (posedge ap_clk) begin
    ...
    tmp_14_cast_reg_420[3:0] <= 4'b0000;
