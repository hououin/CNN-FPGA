...
// ==============================================================
#ifndef __cnn_urem_9ns_7ns_ibs__HH__
#define __cnn_urem_9ns_7ns_ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_urem_9ns_7ns_ibs) {
    ...
    SC_CTOR(cnn_urem_9ns_7ns_ibs):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
