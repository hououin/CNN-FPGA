...
// ==============================================================
#ifndef __cnn_fpext_32ns_64xdS__HH__
#define __cnn_fpext_32ns_64xdS__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_fpext_32ns_64xdS) {
    ...
    SC_CTOR(cnn_fpext_32ns_64xdS):  ACMP_fpext_U ("ACMP_fpext_U") {
