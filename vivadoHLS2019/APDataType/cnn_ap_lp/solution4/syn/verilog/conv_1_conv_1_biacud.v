...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module conv_1_conv_1_biacud_rom (
...
initial begin
    $readmemh("./conv_1_conv_1_biacud_rom.dat", ram0);
    $readmemh("./conv_1_conv_1_biacud_rom.dat", ram1);
end
...
conv_1_conv_1_biacud_rom conv_1_conv_1_biacud_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
