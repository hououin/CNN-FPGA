...
// ==============================================================
#ifndef __cnn_mac_muladd_9sfeY__HH__
#define __cnn_mac_muladd_9sfeY__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_9sfeY) {
    ...
    SC_CTOR(cnn_mac_muladd_9sfeY):  simcore_mac_7_U ("simcore_mac_7_U") {
