...
// ==============================================================
#ifndef __cnn_mac_muladd_4nfdY__HH__
#define __cnn_mac_muladd_4nfdY__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_4nfdY) {
    ...
    SC_CTOR(cnn_mac_muladd_4nfdY):  simcore_mac_6_U ("simcore_mac_6_U") {
