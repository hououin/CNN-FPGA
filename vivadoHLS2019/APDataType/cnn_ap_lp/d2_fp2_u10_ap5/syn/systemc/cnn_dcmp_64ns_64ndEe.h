...
// ==============================================================
#ifndef __cnn_dcmp_64ns_64ndEe__HH__
#define __cnn_dcmp_64ns_64ndEe__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_dcmp_64ns_64ndEe) {
    ...
    SC_CTOR(cnn_dcmp_64ns_64ndEe):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
