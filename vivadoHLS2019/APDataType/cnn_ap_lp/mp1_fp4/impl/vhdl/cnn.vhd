...
architecture behav of cnn is 
    ...
    "cnn,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=17.119250,HLS_SYN_LAT=446654,HLS_SYN_TPT=none,HLS_SYN_MEM=31,HLS_SYN_DSP=8,HLS_SYN_FF=2319,HLS_SYN_LUT=8481,HLS_VERSION=2019_1}";
...
begin
    ...
    zext_ln203_18_fu_816_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_11_fu_808_p3),11));
