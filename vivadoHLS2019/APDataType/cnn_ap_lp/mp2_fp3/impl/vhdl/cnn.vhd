...
architecture behav of cnn is 
    ...
    "cnn,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=16.990188,HLS_SYN_LAT=453997,HLS_SYN_TPT=none,HLS_SYN_MEM=31,HLS_SYN_DSP=8,HLS_SYN_FF=2319,HLS_SYN_LUT=8490,HLS_VERSION=2019_1}";
    ...
    signal tmp_11_fu_1301_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_12_fu_1313_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_13_fu_1444_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_14_fu_1456_p3 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal tmp_8_fu_1797_p3 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    p_Result_43_fu_1804_p5 <= (tmp_8_fu_1797_p3 & m_16_fu_1766_p1(22 downto 0));
    ...
    tmp_11_fu_1301_p3 <= (j_0_i10_reg_668 & ap_const_lv5_0);
    tmp_12_fu_1313_p3 <= (j_0_i10_reg_668 & ap_const_lv1_0);
    tmp_13_fu_1444_p3 <= (f_0_i_reg_702 & ap_const_lv3_0);
    tmp_14_fu_1456_p3 <= (f_0_i_reg_702 & ap_const_lv1_0);
    ...
    tmp_8_fu_1797_p3 <= (p_Result_41_reg_2096 & add_ln964_fu_1791_p2);
    tmp_V_13_fu_1557_p3 <= 
    ...
    zext_ln1116_8_fu_1464_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_14_fu_1456_p3),9));
    zext_ln1116_9_fu_1479_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln1116_4_fu_1474_p2),64));
    zext_ln1116_fu_1452_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_13_fu_1444_p3),9));
    zext_ln1117_6_fu_1309_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_11_fu_1301_p3),12));
    zext_ln1117_7_fu_1321_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_12_fu_1313_p3),12));
