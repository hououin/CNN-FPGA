...
begin
    dense_out_weights_V_U : component dense_out_dense_oudo
    generic map (
        DataWidth => 9,
        AddressRange => 300,
        AddressWidth => 9)
    ...
    dense_out_bias_V_U : component dense_out_dense_ovdy
    generic map (
        DataWidth => 8,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    dense_array_V_U : component dense_out_dense_awdI
    generic map (
        DataWidth => 14,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    cnn_mac_muladd_13xdS_U396 : component cnn_mac_muladd_13xdS
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 13,
