...
architecture behav of dense_2 is 
    ...
    signal tmp_5_fu_274_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component cnn_mac_muladd_9spcA IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component dense_2_dense_2_bocq IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    dense_2_weights_V_U : component dense_2_dense_2_wncg
    generic map (
        DataWidth => 9,
        AddressRange => 1500,
        AddressWidth => 11)
    ...
    dense_2_bias_V_U : component dense_2_dense_2_bocq
    generic map (
        DataWidth => 9,
        AddressRange => 30,
        AddressWidth => 5)
    ...
    cnn_mac_muladd_9spcA_U382 : component cnn_mac_muladd_9spcA
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 9,
    ...
    dense_2_out_V_d0 <= 
        ap_const_lv13_0 when (tmp_5_fu_274_p3(0) = '1') else 
        add_ln203_fu_268_p2;
    ...
    tmp_5_fu_274_p3 <= add_ln703_fu_262_p2(13 downto 13);
