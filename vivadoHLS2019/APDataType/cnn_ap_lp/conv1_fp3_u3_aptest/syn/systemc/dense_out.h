...
struct dense_out : public sc_module {
    ...
    dense_out_dense_oudo* dense_out_weights_V_U;
    dense_out_dense_ovdy* dense_out_bias_V_U;
    dense_out_dense_awdI* dense_array_V_U;
    soft_max* grp_soft_max_fu_157;
    cnn_mac_muladd_13xdS<1,1,13,9,22,22>* cnn_mac_muladd_13xdS_U396;
