...
dense_2::dense_2(sc_module_name name) : sc_module(name), mVcdFile(0) {
    dense_2_weights_V_U = new dense_2_dense_2_wncg("dense_2_weights_V_U");
    ...
    dense_2_bias_V_U = new dense_2_dense_2_bocq("dense_2_bias_V_U");
    ...
    cnn_mac_muladd_9spcA_U382 = new cnn_mac_muladd_9spcA<1,1,9,13,22,22>("cnn_mac_muladd_9spcA_U382");
    cnn_mac_muladd_9spcA_U382->din0(dense_2_weights_V_q0);
    cnn_mac_muladd_9spcA_U382->din1(grp_fu_291_p1);
    cnn_mac_muladd_9spcA_U382->din2(grp_fu_291_p2);
    cnn_mac_muladd_9spcA_U382->dout(grp_fu_291_p3);
    ...
    sensitive << ( zext_ln1117_1_fu_205_p1 );

    SC_METHOD(thread_tmp_2_fu_197_p3);
    sensitive << ( j_0_reg_137 );
    ...
    SC_METHOD(thread_zext_ln1117_1_fu_205_p1);
    sensitive << ( tmp_2_fu_197_p3 );
    ...
    sc_trace(mVcdFile, tmp_2_fu_197_p3, "tmp_2_fu_197_p3");
    sc_trace(mVcdFile, zext_ln1117_fu_193_p1, "zext_ln1117_fu_193_p1");
    sc_trace(mVcdFile, zext_ln1117_1_fu_205_p1, "zext_ln1117_1_fu_205_p1");
...
dense_2::~dense_2() {
    ...
    delete cnn_mac_muladd_9spcA_U382;
}
...
void dense_2::thread_dense_2_out_V_d0() {
    dense_2_out_V_d0 = (!tmp_5_fu_274_p3.read()[0].is_01())? sc_lv<13>(): ((tmp_5_fu_274_p3.read()[0].to_bool())? ap_const_lv13_0: add_ln203_fu_268_p2.read());
}
...
void dense_2::thread_sub_ln1117_fu_209_p2() {
    sub_ln1117_fu_209_p2 = (!zext_ln1117_fu_193_p1.read().is_01() || !zext_ln1117_1_fu_205_p1.read().is_01())? sc_lv<12>(): (sc_biguint<12>(zext_ln1117_fu_193_p1.read()) - sc_biguint<12>(zext_ln1117_1_fu_205_p1.read()));
}

void dense_2::thread_tmp_2_fu_197_p3() {
    tmp_2_fu_197_p3 = esl_concat<6,1>(j_0_reg_137.read(), ap_const_lv1_0);
}

void dense_2::thread_tmp_5_fu_274_p3() {
    tmp_5_fu_274_p3 = add_ln703_fu_262_p2.read().range(13, 13);
}
...
void dense_2::thread_zext_ln1117_1_fu_205_p1() {
    zext_ln1117_1_fu_205_p1 = esl_zext<12,7>(tmp_2_fu_197_p3.read());
}
