...
// ==============================================================
#ifndef __cnn_sdiv_22ns_14smb6__HH__
#define __cnn_sdiv_22ns_14smb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_sdiv_22ns_14smb6) {
    ...
    SC_CTOR(cnn_sdiv_22ns_14smb6):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
