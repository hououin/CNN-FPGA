...
dense_2::dense_2(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_mac_muladd_9sxdS_U83 = new cnn_mac_muladd_9sxdS<1,1,9,13,22,22>("cnn_mac_muladd_9sxdS_U83");
    cnn_mac_muladd_9sxdS_U83->din0(dense_2_weights_V_q0);
    cnn_mac_muladd_9sxdS_U83->din1(grp_fu_291_p1);
    cnn_mac_muladd_9sxdS_U83->din2(grp_fu_291_p2);
    cnn_mac_muladd_9sxdS_U83->dout(grp_fu_291_p3);
...
dense_2::~dense_2() {
    ...
    delete cnn_mac_muladd_9sxdS_U83;
}
