...
architecture behav of dense_out is 
    ...
    signal grp_soft_max_fu_180_dense_array_V_address1 : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_soft_max_fu_180_dense_array_V_ce1 : STD_LOGIC;
    signal grp_soft_max_fu_180_dense_array_V_we1 : STD_LOGIC;
    signal grp_soft_max_fu_180_dense_array_V_d1 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal tmp_1_fu_259_p3 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    port map (
        ...
        d0 => dense_array_V_d0,
        q0 => dense_array_V_q0,
        address1 => grp_soft_max_fu_180_dense_array_V_address1,
        ce1 => dense_array_V_ce1,
        we1 => dense_array_V_we1,
        d1 => grp_soft_max_fu_180_dense_array_V_d1,
        q1 => dense_array_V_q1);
    ...
    port map (
        ...
        dense_array_V_address1 => grp_soft_max_fu_180_dense_array_V_address1,
        dense_array_V_ce1 => grp_soft_max_fu_180_dense_array_V_ce1,
        dense_array_V_we1 => grp_soft_max_fu_180_dense_array_V_we1,
        dense_array_V_d1 => grp_soft_max_fu_180_dense_array_V_d1,
    ...
    dense_array_V_ce1_assign_proc : process(grp_soft_max_fu_180_dense_array_V_ce1, ap_CS_fsm_state5)
    begin
    ...
    dense_array_V_d0 <= std_logic_vector(signed(sext_ln1265_fu_332_p1) + signed(w_sum_V_fu_323_p4));

    dense_array_V_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, icmp_ln46_1_reg_391, ap_enable_reg_pp0_iter1)
    begin
    ...
    dense_array_V_we1_assign_proc : process(grp_soft_max_fu_180_dense_array_V_we1, ap_CS_fsm_state5)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            dense_array_V_we1 <= grp_soft_max_fu_180_dense_array_V_we1;
        else 
    ...
    tmp_1_fu_259_p3 <= (select_ln48_fu_217_p3 & ap_const_lv1_0);
    tmp_fu_247_p3 <= (select_ln48_fu_217_p3 & ap_const_lv3_0);
    w_sum_V_fu_323_p4 <= grp_fu_343_p3(21 downto 8);
    zext_ln1116_1_fu_267_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_1_fu_259_p3),9));
