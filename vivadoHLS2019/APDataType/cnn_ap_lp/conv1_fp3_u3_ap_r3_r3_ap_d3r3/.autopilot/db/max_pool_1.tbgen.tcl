...
set C_modelArgList {
	{ conv_out_0_V int 14 regular {array 1352 { 1 3 } 1 1 }  }
	{ conv_out_1_V int 14 regular {array 1352 { 1 3 } 1 1 }  }
	{ conv_out_2_V int 14 regular {array 1352 { 1 3 } 1 1 }  }
	{ max_pool_out_V int 14 regular {array 1014 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ max_pool_out_V_address0 sc_out sc_lv 10 signal 3 } 
	{ max_pool_out_V_ce0 sc_out sc_logic 1 signal 3 } 
	{ max_pool_out_V_we0 sc_out sc_logic 1 signal 3 } 
	{ max_pool_out_V_d0 sc_out sc_lv 14 signal 3 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	conv_out_0_V { ap_memory {  { conv_out_0_V_address0 mem_address 1 11 }  { conv_out_0_V_ce0 mem_ce 1 1 }  { conv_out_0_V_q0 mem_dout 0 14 } } }
	conv_out_1_V { ap_memory {  { conv_out_1_V_address0 mem_address 1 11 }  { conv_out_1_V_ce0 mem_ce 1 1 }  { conv_out_1_V_q0 mem_dout 0 14 } } }
	conv_out_2_V { ap_memory {  { conv_out_2_V_address0 mem_address 1 11 }  { conv_out_2_V_ce0 mem_ce 1 1 }  { conv_out_2_V_q0 mem_dout 0 14 } } }
	max_pool_out_V { ap_memory {  { max_pool_out_V_address0 mem_address 1 10 }  { max_pool_out_V_ce0 mem_ce 1 1 }  { max_pool_out_V_we0 mem_we 1 1 }  { max_pool_out_V_d0 mem_din 1 14 } } }
}
