...
wire   [10:0] tmp_29_cast_fu_608_p3;
...
cnn_mul_mul_10s_1kbM #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 10 ),
    .din1_WIDTH( 14 ),
    .dout_WIDTH( 25 ))
cnn_mul_mul_10s_1kbM_U62(
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        p_Val2_25_reg_308 <= {{ret_V_fu_663_p2[21:8]}};
    end else if (((icmp_ln21_fu_495_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
...
assign add_ln1116_3_fu_616_p2 = (zext_ln203_10_reg_1063 + tmp_29_cast_fu_608_p3);
...
assign lhs_V_fu_647_p3 = {{p_Val2_25_reg_308}, {8'd0}};
...
assign tmp_29_cast_fu_608_p3 = {{add_ln1116_2_fu_603_p2}, {4'd0}};

assign tmp_5_fu_961_p3 = {{p_Result_24_reg_1149}, {add_ln915_fu_955_p2}};

assign tmp_6_fu_453_p3 = {{wr_0_reg_274}, {2'd0}};
...
assign zext_ln1116_3_fu_461_p1 = tmp_6_fu_453_p3;
...
assign zext_ln1117_3_fu_573_p1 = tmp_15_fu_565_p3;
