...
initial begin
    ...
    $readmemh("./conv_1_conv_1_weibkb_rom.dat", ram9);
    $readmemh("./conv_1_conv_1_weibkb_rom.dat", ram10);
    $readmemh("./conv_1_conv_1_weibkb_rom.dat", ram11);
    $readmemh("./conv_1_conv_1_weibkb_rom.dat", ram12);
    $readmemh("./conv_1_conv_1_weibkb_rom.dat", ram13);
end
