...
dense_2::dense_2(sc_module_name name) : sc_module(name), mVcdFile(0) {
    dense_2_weights_V_U = new dense_2_dense_2_wocq("dense_2_weights_V_U");
    ...
    dense_2_bias_V_U = new dense_2_dense_2_bpcA("dense_2_bias_V_U");
    ...
    cnn_mac_muladd_9sqcK_U78 = new cnn_mac_muladd_9sqcK<1,1,9,13,22,22>("cnn_mac_muladd_9sqcK_U78");
    cnn_mac_muladd_9sqcK_U78->din0(dense_2_weights_V_q0);
    cnn_mac_muladd_9sqcK_U78->din1(grp_fu_291_p1);
    cnn_mac_muladd_9sqcK_U78->din2(grp_fu_291_p2);
    cnn_mac_muladd_9sqcK_U78->dout(grp_fu_291_p3);
...
dense_2::~dense_2() {
    ...
    delete cnn_mac_muladd_9sqcK_U78;
}
...
void dense_2::thread_dense_2_out_V_d0() {
    dense_2_out_V_d0 = (!tmp_7_fu_274_p3.read()[0].is_01())? sc_lv<13>(): ((tmp_7_fu_274_p3.read()[0].to_bool())? ap_const_lv13_0: add_ln203_fu_268_p2.read());
}
...
void dense_2::thread_tmp_7_fu_274_p3() {
    tmp_7_fu_274_p3 = add_ln703_fu_262_p2.read().range(13, 13);
}
