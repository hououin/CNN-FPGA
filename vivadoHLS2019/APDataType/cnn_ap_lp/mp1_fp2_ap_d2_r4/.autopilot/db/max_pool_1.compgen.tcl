...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { conv_out_2_V_address0 { O 10 vector } conv_out_2_V_ce0 { O 1 bit } conv_out_2_V_q0 { I 14 vector } conv_out_2_V_address1 { O 10 vector } conv_out_2_V_ce1 { O 1 bit } conv_out_2_V_q1 { I 14 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { conv_out_3_V_address0 { O 10 vector } conv_out_3_V_ce0 { O 1 bit } conv_out_3_V_q0 { I 14 vector } conv_out_3_V_address1 { O 10 vector } conv_out_3_V_ce1 { O 1 bit } conv_out_3_V_q1 { I 14 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { max_pool_out_V_address0 { O 10 vector } max_pool_out_V_ce0 { O 1 bit } max_pool_out_V_we0 { O 1 bit } max_pool_out_V_d0 { O 14 vector } max_pool_out_V_address1 { O 10 vector } max_pool_out_V_ce1 { O 1 bit } max_pool_out_V_we1 { O 1 bit } max_pool_out_V_d1 { O 14 vector } } \
} "
} else {
