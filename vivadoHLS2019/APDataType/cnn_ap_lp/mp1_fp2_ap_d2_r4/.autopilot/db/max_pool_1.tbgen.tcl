...
set C_modelArgList {
	{ conv_out_0_V int 14 regular {array 1092 { 1 1 } 1 1 }  }
	{ conv_out_1_V int 14 regular {array 1092 { 1 1 } 1 1 }  }
	{ conv_out_2_V int 14 regular {array 936 { 1 1 } 1 1 }  }
	{ conv_out_3_V int 14 regular {array 936 { 1 1 } 1 1 }  }
	{ max_pool_out_V int 14 regular {array 1014 { 0 0 } 0 1 }  }
}
...
set portList { 
	...
	{ conv_out_2_V_address0 sc_out sc_lv 10 signal 2 } 
	{ conv_out_2_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ conv_out_2_V_q0 sc_in sc_lv 14 signal 2 } 
	{ conv_out_2_V_address1 sc_out sc_lv 10 signal 2 } 
	{ conv_out_2_V_ce1 sc_out sc_logic 1 signal 2 } 
	{ conv_out_2_V_q1 sc_in sc_lv 14 signal 2 } 
	{ conv_out_3_V_address0 sc_out sc_lv 10 signal 3 } 
	{ conv_out_3_V_ce0 sc_out sc_logic 1 signal 3 } 
	{ conv_out_3_V_q0 sc_in sc_lv 14 signal 3 } 
	{ conv_out_3_V_address1 sc_out sc_lv 10 signal 3 } 
	{ conv_out_3_V_ce1 sc_out sc_logic 1 signal 3 } 
	{ conv_out_3_V_q1 sc_in sc_lv 14 signal 3 } 
	{ max_pool_out_V_address0 sc_out sc_lv 10 signal 4 } 
	{ max_pool_out_V_ce0 sc_out sc_logic 1 signal 4 } 
	{ max_pool_out_V_we0 sc_out sc_logic 1 signal 4 } 
	{ max_pool_out_V_d0 sc_out sc_lv 14 signal 4 } 
	{ max_pool_out_V_address1 sc_out sc_lv 10 signal 4 } 
	{ max_pool_out_V_ce1 sc_out sc_logic 1 signal 4 } 
	{ max_pool_out_V_we1 sc_out sc_logic 1 signal 4 } 
	{ max_pool_out_V_d1 sc_out sc_lv 14 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv_out_2_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "conv_out_2_V", "role": "address0" }} , 
 	...
 	{ "name": "conv_out_2_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "conv_out_2_V", "role": "address1" }} , 
 	...
 	{ "name": "conv_out_3_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "conv_out_3_V", "role": "address0" }} , 
 	...
 	{ "name": "conv_out_3_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "conv_out_3_V", "role": "address1" }} , 
 	...
 	{ "name": "max_pool_out_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "max_pool_out_V", "role": "address1" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "551", "Max" : "551"}
	, {"Name" : "Interval", "Min" : "551", "Max" : "551"}
]}
...
set Spec2ImplPortList { 
	...
	conv_out_2_V { ap_memory {  { conv_out_2_V_address0 mem_address 1 10 }  { conv_out_2_V_ce0 mem_ce 1 1 }  { conv_out_2_V_q0 mem_dout 0 14 }  { conv_out_2_V_address1 MemPortADDR2 1 10 }  { conv_out_2_V_ce1 MemPortCE2 1 1 }  { conv_out_2_V_q1 MemPortDOUT2 0 14 } } }
	conv_out_3_V { ap_memory {  { conv_out_3_V_address0 mem_address 1 10 }  { conv_out_3_V_ce0 mem_ce 1 1 }  { conv_out_3_V_q0 mem_dout 0 14 }  { conv_out_3_V_address1 MemPortADDR2 1 10 }  { conv_out_3_V_ce1 MemPortCE2 1 1 }  { conv_out_3_V_q1 MemPortDOUT2 0 14 } } }
	max_pool_out_V { ap_memory {  { max_pool_out_V_address0 mem_address 1 10 }  { max_pool_out_V_ce0 mem_ce 1 1 }  { max_pool_out_V_we0 mem_we 1 1 }  { max_pool_out_V_d0 mem_din 1 14 }  { max_pool_out_V_address1 MemPortADDR2 1 10 }  { max_pool_out_V_ce1 MemPortCE2 1 1 }  { max_pool_out_V_we1 MemPortWE2 1 1 }  { max_pool_out_V_d1 MemPortDIN2 1 14 } } }
}
