...
// ==============================================================
#ifndef __cnn_urem_4ns_4ns_hbi__HH__
#define __cnn_urem_4ns_4ns_hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_urem_4ns_4ns_hbi) {
    ...
    SC_CTOR(cnn_urem_4ns_4ns_hbi):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
