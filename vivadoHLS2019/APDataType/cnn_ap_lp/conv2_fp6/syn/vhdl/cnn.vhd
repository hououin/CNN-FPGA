...
architecture behav of cnn is 
    ...
    "cnn,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=16.990188,HLS_SYN_LAT=311588,HLS_SYN_TPT=none,HLS_SYN_MEM=31,HLS_SYN_DSP=10,HLS_SYN_FF=2286,HLS_SYN_LUT=8343,HLS_VERSION=2019_1}";
    ...
    signal zext_ln13_3_fu_1280_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal zext_ln13_3_reg_1993 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal grp_max_pool_1_fu_756_max_pool_out_V_d0 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal p_Val2_28_reg_611 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal zext_ln1116_8_fu_1479_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_6_fu_796_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_7_fu_808_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_17_fu_999_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_18_fu_1247_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln203_fu_1241_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_8_fu_1301_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_9_fu_1313_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_19_fu_1390_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln203_1_fu_1384_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_10_fu_1444_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_11_fu_1456_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal zext_ln1116_7_fu_1464_p1 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal tmp_21_fu_1607_p4 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal tmp_22_fu_1661_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_23_fu_1770_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_s_fu_1797_p3 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    cnn_fpext_32ns_64tde_U33 : component cnn_fpext_32ns_64tde
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    cnn_mac_muladd_9svdy_U35 : component cnn_mac_muladd_9svdy
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 9,
    ...
    cnn_mac_muladd_13wdI_U36 : component cnn_mac_muladd_13wdI
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 13,
    ...
    p_Val2_28_reg_611_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state19)) then 
                p_Val2_28_reg_611 <= grp_fu_1828_p3(21 downto 8);
            elsif (((ap_const_logic_1 = ap_CS_fsm_state17) and (icmp_ln9_fu_1145_p2 = ap_const_lv1_0))) then 
    ...
    p_Val2_31_reg_656_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state23)) then 
                p_Val2_31_reg_656 <= grp_fu_1837_p3(21 downto 8);
            elsif (((ap_const_logic_1 = ap_CS_fsm_state21) and (icmp_ln9_1_fu_1264_p2 = ap_const_lv1_0))) then 
    ...
    p_Val2_37_reg_690_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state27)) then 
                p_Val2_37_reg_690 <= grp_fu_1846_p3(21 downto 8);
            elsif (((ap_const_logic_1 = ap_CS_fsm_state25) and (icmp_ln41_fu_1407_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state21) and (icmp_ln9_1_fu_1264_p2 = ap_const_lv1_0))) then
                    zext_ln13_3_reg_1993(4 downto 0) <= zext_ln13_3_fu_1280_p1(4 downto 0);
    ...
    zext_ln13_3_reg_1993(11 downto 5) <= "0000000";
    ...
    add_ln1116_fu_1468_p2 <= std_logic_vector(unsigned(zext_ln1116_7_fu_1464_p1) + unsigned(zext_ln1116_fu_1452_p1));
    add_ln1117_2_fu_1331_p2 <= std_logic_vector(unsigned(sub_ln1117_fu_1325_p2) + unsigned(zext_ln13_3_reg_1993));
    ...
    add_ln703_1_fu_1378_p2 <= std_logic_vector(unsigned(p_Val2_31_reg_656) + unsigned(sext_ln1265_1_fu_1366_p1));
    add_ln703_2_fu_1513_p2 <= std_logic_vector(signed(sext_ln1265_2_fu_1509_p1) + signed(p_Val2_37_reg_690));
    add_ln703_fu_1235_p2 <= std_logic_vector(unsigned(p_Val2_28_reg_611) + unsigned(sext_ln1265_fu_1223_p1));
    ...
    dense_out_weights_V_address0 <= zext_ln1116_8_fu_1479_p1(9 - 1 downto 0);
    ...
    grp_fu_1828_p2 <= (p_Val2_28_reg_611 & ap_const_lv8_0);
    ...
    grp_fu_1837_p2 <= (p_Val2_31_reg_656 & ap_const_lv8_0);
    ...
    grp_fu_1846_p2 <= (p_Val2_37_reg_690 & ap_const_lv8_0);
    ...
    icmp_ln947_fu_1617_p2 <= "1" when (signed(tmp_21_fu_1607_p4) > signed(ap_const_lv31_0)) else "0";
    ...
    p_Result_43_fu_1804_p5 <= (tmp_s_fu_1797_p3 & m_16_fu_1766_p1(22 downto 0));
    ...
    select_ln19_1_fu_1398_p3 <= 
        ap_const_lv13_0 when (tmp_19_fu_1390_p3(0) = '1') else 
        add_ln203_1_fu_1384_p2;
    select_ln19_fu_1255_p3 <= 
        ap_const_lv13_0 when (tmp_18_fu_1247_p3(0) = '1') else 
        add_ln203_fu_1241_p2;
    select_ln588_fu_1007_p3 <= 
        ap_const_lv14_3FFF when (tmp_17_fu_999_p3(0) = '1') else 
        ap_const_lv14_0;
    ...
    select_ln964_fu_1778_p3 <= 
        ap_const_lv8_7F when (tmp_23_fu_1770_p3(0) = '1') else 
        ap_const_lv8_7E;
    ...
    tmp_10_fu_1444_p3 <= (f_0_i_reg_702 & ap_const_lv3_0);
    tmp_11_fu_1456_p3 <= (f_0_i_reg_702 & ap_const_lv1_0);
    tmp_17_fu_999_p3 <= bitcast_ln696_fu_996_p1(31 downto 31);
    tmp_18_fu_1247_p3 <= add_ln703_fu_1235_p2(13 downto 13);
    tmp_19_fu_1390_p3 <= add_ln703_1_fu_1378_p2(13 downto 13);
    tmp_21_fu_1607_p4 <= lsb_index_fu_1601_p2(31 downto 1);
    tmp_22_fu_1661_p3 <= lsb_index_fu_1601_p2(31 downto 31);
    tmp_23_fu_1770_p3 <= m_13_fu_1751_p2(25 downto 25);
    tmp_6_fu_796_p3 <= (i_0_reg_568 & ap_const_lv5_0);
    tmp_7_fu_808_p3 <= (i_0_reg_568 & ap_const_lv2_0);
    tmp_8_fu_1301_p3 <= (j_0_i10_reg_668 & ap_const_lv5_0);
    tmp_9_fu_1313_p3 <= (j_0_i10_reg_668 & ap_const_lv1_0);
    tmp_V_13_fu_1557_p3 <= 
    ...
    tmp_s_fu_1797_p3 <= (p_Result_41_reg_2096 & add_ln964_fu_1791_p2);
    ...
    trunc_ln703_1_fu_1370_p1 <= p_Val2_31_reg_656(13 - 1 downto 0);
    trunc_ln703_fu_1227_p1 <= p_Val2_28_reg_611(13 - 1 downto 0);
    ...
    xor_ln949_fu_1669_p2 <= (tmp_22_fu_1661_p3 xor ap_const_lv1_1);
    zext_ln1116_7_fu_1464_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_11_fu_1456_p3),9));
    zext_ln1116_8_fu_1479_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln1116_4_fu_1474_p2),64));
    zext_ln1116_fu_1452_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_10_fu_1444_p3),9));
    zext_ln1117_6_fu_1309_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_8_fu_1301_p3),12));
    zext_ln1117_7_fu_1321_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_9_fu_1313_p3),12));
    zext_ln1117_fu_1193_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln1117_fu_1188_p2),64));
    zext_ln13_3_fu_1280_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_0_i5_reg_645),12));
    ...
    zext_ln203_17_fu_816_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_7_fu_808_p3),11));
    zext_ln203_18_fu_838_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_0_reg_589),11));
    zext_ln203_fu_804_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_6_fu_796_p3),11));
