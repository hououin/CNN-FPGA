...
entity cnn_dense_out_weibjl_rom is 
    generic(
             DWIDTH     : integer := 9; 
             AWIDTH     : integer := 9; 
...
architecture rtl of cnn_dense_out_weibjl_rom is 
...
entity cnn_dense_out_weibjl is
    generic (
        DataWidth : INTEGER := 9;
...
architecture arch of cnn_dense_out_weibjl is
    component cnn_dense_out_weibjl_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    cnn_dense_out_weibjl_rom_U :  component cnn_dense_out_weibjl_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
