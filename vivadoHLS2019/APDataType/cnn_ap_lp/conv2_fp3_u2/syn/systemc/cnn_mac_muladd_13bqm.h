...
// ==============================================================
#ifndef __cnn_mac_muladd_13bqm__HH__
#define __cnn_mac_muladd_13bqm__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_13bqm) {
    ...
    SC_CTOR(cnn_mac_muladd_13bqm):  simcore_mac_4_U ("simcore_mac_4_U") {
