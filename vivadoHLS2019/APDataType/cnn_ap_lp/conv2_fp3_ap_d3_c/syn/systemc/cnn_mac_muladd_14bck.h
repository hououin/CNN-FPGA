...
// ==============================================================
#ifndef __cnn_mac_muladd_14bck__HH__
#define __cnn_mac_muladd_14bck__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_14bck) {
    ...
    SC_CTOR(cnn_mac_muladd_14bck):  simcore_mac_1_U ("simcore_mac_1_U") {
