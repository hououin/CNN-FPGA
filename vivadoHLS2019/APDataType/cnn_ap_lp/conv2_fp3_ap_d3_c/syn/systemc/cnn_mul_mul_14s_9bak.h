...
// ==============================================================
#ifndef __cnn_mul_mul_14s_9bak__HH__
#define __cnn_mul_mul_14s_9bak__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_14s_9bak) {
    ...
    SC_CTOR(cnn_mul_mul_14s_9bak):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
