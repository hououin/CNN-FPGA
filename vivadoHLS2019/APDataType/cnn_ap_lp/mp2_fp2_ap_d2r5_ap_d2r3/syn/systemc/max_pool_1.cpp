...
max_pool_1::max_pool_1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_add_ln203_2_fu_320_p2);
    ...
    sensitive << ( add_ln203_2_fu_320_p2 );
    ...
    sc_trace(mVcdFile, add_ln203_2_fu_320_p2, "add_ln203_2_fu_320_p2");
...
void max_pool_1::thread_add_ln203_2_fu_320_p2() {
    add_ln203_2_fu_320_p2 = (!zext_ln13_1_reg_423.read().is_01() || !sub_ln203_fu_314_p2.read().is_01())? sc_lv<11>(): (sc_biguint<11>(zext_ln13_1_reg_423.read()) + sc_biguint<11>(sub_ln203_fu_314_p2.read()));
}
...
void max_pool_1::thread_zext_ln203_4_fu_310_p1() {
    zext_ln203_4_fu_310_p1 = esl_zext<11,9>(tmp_7_fu_302_p3.read());
}

void max_pool_1::thread_zext_ln203_5_fu_325_p1() {
    zext_ln203_5_fu_325_p1 = esl_zext<64,11>(add_ln203_2_fu_320_p2.read());
}
