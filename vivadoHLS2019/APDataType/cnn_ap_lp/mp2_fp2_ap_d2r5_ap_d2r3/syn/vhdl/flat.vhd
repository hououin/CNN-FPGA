...
architecture behav of flat is 
    ...
    signal tmp_25_cast_fu_316_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_25_cast_reg_420 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln9_fu_261_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                ...
                select_ln203_reg_416 <= select_ln203_fu_291_p3;
                    tmp_25_cast_reg_420(8 downto 4) <= tmp_25_cast_fu_316_p3(8 downto 4);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    tmp_25_cast_reg_420(3 downto 0) <= "0000";
    ...
    add_ln203_4_fu_348_p2 <= std_logic_vector(unsigned(tmp_25_cast_reg_420) + unsigned(zext_ln203_8_fu_344_p1));
    ...
    select_ln203_fu_291_p3 <= 
        ...
        add_ln203_fu_285_p2;
    tmp_12_fu_243_p3 <= (r_0_reg_132 & ap_const_lv4_0);
    tmp_25_cast_fu_316_p3 <= (add_ln203_3_fu_311_p2 & ap_const_lv4_0);
    tmp_9_fu_299_p3 <= phi_mul_reg_165(5 downto 5);
    ...
    zext_ln203_6_fu_307_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_9_fu_299_p3),5));
    ...
    zext_ln9_fu_251_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_12_fu_243_p3),8));
end behav;
