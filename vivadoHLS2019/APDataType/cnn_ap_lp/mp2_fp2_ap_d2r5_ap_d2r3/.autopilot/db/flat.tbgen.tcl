...
set C_modelArgList {
	{ max_pool_out_0_V int 14 regular {array 160 { 1 3 } 1 1 }  }
	{ max_pool_out_1_V int 14 regular {array 160 { 1 3 } 1 1 }  }
	{ max_pool_out_2_0_V int 14 regular {array 80 { 1 3 } 1 1 }  }
	{ flat_array_V int 14 regular {array 400 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "max_pool_out_0_V", "interface" : "memory", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "max_pool_out_1_V", "interface" : "memory", "bitwidth" : 14, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ max_pool_out_0_V_address0 sc_out sc_lv 8 signal 0 } 
	{ max_pool_out_0_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ max_pool_out_0_V_q0 sc_in sc_lv 14 signal 0 } 
	{ max_pool_out_1_V_address0 sc_out sc_lv 8 signal 1 } 
	{ max_pool_out_1_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ max_pool_out_1_V_q0 sc_in sc_lv 14 signal 1 } 
	{ max_pool_out_2_0_V_address0 sc_out sc_lv 7 signal 2 } 
	{ max_pool_out_2_0_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ max_pool_out_2_0_V_q0 sc_in sc_lv 14 signal 2 } 
	{ flat_array_V_address0 sc_out sc_lv 9 signal 3 } 
	{ flat_array_V_ce0 sc_out sc_logic 1 signal 3 } 
	{ flat_array_V_we0 sc_out sc_logic 1 signal 3 } 
	{ flat_array_V_d0 sc_out sc_lv 14 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "max_pool_out_0_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "max_pool_out_0_V", "role": "q0" }} , 
 	...
 	{ "name": "max_pool_out_1_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "max_pool_out_1_V", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	max_pool_out_0_V { ap_memory {  { max_pool_out_0_V_address0 mem_address 1 8 }  { max_pool_out_0_V_ce0 mem_ce 1 1 }  { max_pool_out_0_V_q0 mem_dout 0 14 } } }
	max_pool_out_1_V { ap_memory {  { max_pool_out_1_V_address0 mem_address 1 8 }  { max_pool_out_1_V_ce0 mem_ce 1 1 }  { max_pool_out_1_V_q0 mem_dout 0 14 } } }
	max_pool_out_2_0_V { ap_memory {  { max_pool_out_2_0_V_address0 mem_address 1 7 }  { max_pool_out_2_0_V_ce0 mem_ce 1 1 }  { max_pool_out_2_0_V_q0 mem_dout 0 14 } } }
