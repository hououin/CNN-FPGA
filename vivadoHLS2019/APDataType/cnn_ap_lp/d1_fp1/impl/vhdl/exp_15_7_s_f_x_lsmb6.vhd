...
entity exp_15_7_s_f_x_lsmb6_rom is 
    generic(
             DWIDTH     : integer := 11; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of exp_15_7_s_f_x_lsmb6_rom is 
...
entity exp_15_7_s_f_x_lsmb6 is
    generic (
...
architecture arch of exp_15_7_s_f_x_lsmb6 is
    component exp_15_7_s_f_x_lsmb6_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    exp_15_7_s_f_x_lsmb6_rom_U :  component exp_15_7_s_f_x_lsmb6_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
