...
(* CORE_GENERATION_INFO="cnn,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=17.487500,HLS_SYN_LAT=428841,HLS_SYN_TPT=none,HLS_SYN_MEM=31,HLS_SYN_DSP=407,HLS_SYN_FF=5299,HLS_SYN_LUT=18983,HLS_VERSION=2019_1}" *)
...
wire    grp_dense_1_fu_625_ap_start;
wire    grp_dense_1_fu_625_ap_done;
wire    grp_dense_1_fu_625_ap_idle;
wire    grp_dense_1_fu_625_ap_ready;
wire   [8:0] grp_dense_1_fu_625_flat_array_V_address0;
wire    grp_dense_1_fu_625_flat_array_V_ce0;
wire   [8:0] grp_dense_1_fu_625_flat_array_V_address1;
wire    grp_dense_1_fu_625_flat_array_V_ce1;
wire   [5:0] grp_dense_1_fu_625_dense_1_out_V_address0;
wire    grp_dense_1_fu_625_dense_1_out_V_ce0;
wire    grp_dense_1_fu_625_dense_1_out_V_we0;
wire   [12:0] grp_dense_1_fu_625_dense_1_out_V_d0;
wire    grp_conv_2_fu_635_ap_start;
wire    grp_conv_2_fu_635_ap_done;
wire    grp_conv_2_fu_635_ap_idle;
wire    grp_conv_2_fu_635_ap_ready;
wire   [9:0] grp_conv_2_fu_635_input_V_address0;
wire    grp_conv_2_fu_635_input_V_ce0;
wire   [10:0] grp_conv_2_fu_635_conv_out_V_address0;
wire    grp_conv_2_fu_635_conv_out_V_ce0;
wire    grp_conv_2_fu_635_conv_out_V_we0;
wire   [13:0] grp_conv_2_fu_635_conv_out_V_d0;
wire    grp_conv_1_fu_645_ap_start;
wire    grp_conv_1_fu_645_ap_done;
wire    grp_conv_1_fu_645_ap_idle;
wire    grp_conv_1_fu_645_ap_ready;
wire   [9:0] grp_conv_1_fu_645_input_V_address0;
wire    grp_conv_1_fu_645_input_V_ce0;
wire   [11:0] grp_conv_1_fu_645_conv_out_V_address0;
wire    grp_conv_1_fu_645_conv_out_V_ce0;
wire    grp_conv_1_fu_645_conv_out_V_we0;
wire   [13:0] grp_conv_1_fu_645_conv_out_V_d0;
wire    grp_soft_max_fu_655_ap_start;
wire    grp_soft_max_fu_655_ap_done;
wire    grp_soft_max_fu_655_ap_idle;
wire    grp_soft_max_fu_655_ap_ready;
wire   [3:0] grp_soft_max_fu_655_dense_array_V_address0;
wire    grp_soft_max_fu_655_dense_array_V_ce0;
wire    grp_soft_max_fu_655_dense_array_V_we0;
wire   [13:0] grp_soft_max_fu_655_dense_array_V_d0;
wire   [3:0] grp_soft_max_fu_655_prediction_V_address0;
wire    grp_soft_max_fu_655_prediction_V_ce0;
wire    grp_soft_max_fu_655_prediction_V_we0;
wire   [13:0] grp_soft_max_fu_655_prediction_V_d0;
...
wire   [11:0] grp_max_pool_1_fu_667_conv_out_V_address0;
wire    grp_max_pool_1_fu_667_conv_out_V_ce0;
...
wire    grp_max_pool_2_fu_673_ap_start;
wire    grp_max_pool_2_fu_673_ap_done;
wire    grp_max_pool_2_fu_673_ap_idle;
wire    grp_max_pool_2_fu_673_ap_ready;
wire   [10:0] grp_max_pool_2_fu_673_conv_out_V_address0;
wire    grp_max_pool_2_fu_673_conv_out_V_ce0;
wire   [8:0] grp_max_pool_2_fu_673_max_pool_out_V_address0;
wire    grp_max_pool_2_fu_673_max_pool_out_V_ce0;
wire    grp_max_pool_2_fu_673_max_pool_out_V_we0;
wire   [13:0] grp_max_pool_2_fu_673_max_pool_out_V_d0;
...
reg   [13:0] p_Val2_29_reg_557;
reg   [5:0] j_0_i_reg_569;
reg   [3:0] d_0_i_reg_580;
wire    ap_CS_fsm_state26;
reg   [13:0] p_Val2_34_reg_591;
reg   [4:0] f_0_i_reg_603;
reg   [3:0] i24_0_reg_614;
wire    ap_CS_fsm_state27;
wire    ap_CS_fsm_state30;
reg    grp_dense_1_fu_625_ap_start_reg;
wire    ap_CS_fsm_state17;
reg    grp_conv_2_fu_635_ap_start_reg;
wire    ap_CS_fsm_state11;
wire    ap_CS_fsm_state12;
reg    grp_conv_1_fu_645_ap_start_reg;
wire    ap_CS_fsm_state7;
wire    ap_CS_fsm_state8;
reg    grp_soft_max_fu_655_ap_start_reg;
reg    grp_max_pool_1_fu_667_ap_start_reg;
wire    ap_CS_fsm_state9;
wire    ap_CS_fsm_state10;
reg    grp_max_pool_2_fu_673_ap_start_reg;
...
wire   [63:0] zext_ln14_1_fu_1088_p1;
...
wire   [9:0] tmp_s_fu_707_p3;
wire   [6:0] tmp_415_fu_719_p3;
...
wire   [10:0] tmp_416_fu_1093_p3;
wire   [6:0] tmp_417_fu_1105_p3;
wire   [11:0] zext_ln1117_fu_1101_p1;
wire   [11:0] zext_ln1117_401_fu_1113_p1;
...
wire   [0:0] tmp_426_fu_1182_p3;
wire   [12:0] add_ln203_fu_1176_p2;
wire   [7:0] tmp_418_fu_1236_p3;
wire   [5:0] tmp_419_fu_1248_p3;
...
initial begin
#0 ap_CS_fsm = 30'd1;
#0 grp_dense_1_fu_625_ap_start_reg = 1'b0;
#0 grp_conv_2_fu_635_ap_start_reg = 1'b0;
#0 grp_conv_1_fu_645_ap_start_reg = 1'b0;
#0 grp_soft_max_fu_655_ap_start_reg = 1'b0;
#0 grp_max_pool_1_fu_667_ap_start_reg = 1'b0;
#0 grp_max_pool_2_fu_673_ap_start_reg = 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_conv_1_fu_645_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state7)) begin
            grp_conv_1_fu_645_ap_start_reg <= 1'b1;
        end else if ((grp_conv_1_fu_645_ap_ready == 1'b1)) begin
            grp_conv_1_fu_645_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_conv_2_fu_635_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state11)) begin
            grp_conv_2_fu_635_ap_start_reg <= 1'b1;
        end else if ((grp_conv_2_fu_635_ap_ready == 1'b1)) begin
            grp_conv_2_fu_635_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_dense_1_fu_625_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state17)) begin
            grp_dense_1_fu_625_ap_start_reg <= 1'b1;
        end else if ((grp_dense_1_fu_625_ap_ready == 1'b1)) begin
            grp_dense_1_fu_625_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_max_pool_2_fu_673_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state13)) begin
            grp_max_pool_2_fu_673_ap_start_reg <= 1'b1;
        end else if ((grp_max_pool_2_fu_673_ap_ready == 1'b1)) begin
            grp_max_pool_2_fu_673_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_soft_max_fu_655_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state23) & (icmp_ln41_fu_1199_p2 == 1'd1))) begin
            grp_soft_max_fu_655_ap_start_reg <= 1'b1;
        end else if ((grp_soft_max_fu_655_ap_ready == 1'b1)) begin
            grp_soft_max_fu_655_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    ...
    end else if (((grp_soft_max_fu_655_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state27))) begin
        i24_0_reg_614 <= 4'd0;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    end else if (((grp_dense_1_fu_625_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state18))) begin
        i_0_i_reg_546 <= 5'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state21)) begin
        p_Val2_29_reg_557 <= {{grp_fu_1620_p3[21:8]}};
    end else if (((1'b1 == ap_CS_fsm_state19) & (icmp_ln9_fu_1056_p2 == 1'd0))) begin
        p_Val2_29_reg_557 <= 14'd0;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state25)) begin
        p_Val2_34_reg_591 <= {{grp_fu_1629_p3[21:8]}};
    end else if (((1'b1 == ap_CS_fsm_state23) & (icmp_ln41_fu_1199_p2 == 1'd0))) begin
        p_Val2_34_reg_591 <= 14'd0;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state20)) begin
        dense_1_out_V_address0 = zext_ln14_1_fu_1088_p1;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state22) | (1'b1 == ap_CS_fsm_state24) | ((grp_dense_1_fu_625_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state18)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state22) | ((grp_dense_1_fu_625_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state18)))) begin
...
always @ (*) begin
    if (((grp_max_pool_2_fu_673_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state14))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state8 : begin
            if (((grp_conv_1_fu_645_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state8))) begin
        ...
        ap_ST_fsm_state12 : begin
            if (((grp_conv_2_fu_635_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state12))) begin
        ...
        ap_ST_fsm_state18 : begin
            if (((grp_dense_1_fu_625_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state18))) begin
        ...
        ap_ST_fsm_state27 : begin
            if (((grp_soft_max_fu_655_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state27))) begin
...
assign add_ln703_1_fu_1305_p2 = ($signed(sext_ln1265_1_fu_1301_p1) + $signed(p_Val2_34_reg_591));

assign add_ln703_fu_1170_p2 = ($signed(p_Val2_29_reg_557) + $signed(sext_ln1265_fu_1158_p1));
...
assign grp_conv_1_fu_645_ap_start = grp_conv_1_fu_645_ap_start_reg;

assign grp_conv_2_fu_635_ap_start = grp_conv_2_fu_635_ap_start_reg;

assign grp_dense_1_fu_625_ap_start = grp_dense_1_fu_625_ap_start_reg;
...
assign grp_fu_1620_p2 = {{p_Val2_29_reg_557}, {8'd0}};

assign grp_fu_1629_p0 = grp_fu_1629_p00;

assign grp_fu_1629_p00 = dense_2_out_V_q0;

assign grp_fu_1629_p2 = {{p_Val2_34_reg_591}, {8'd0}};

assign grp_max_pool_1_fu_667_ap_start = grp_max_pool_1_fu_667_ap_start_reg;

assign grp_max_pool_2_fu_673_ap_start = grp_max_pool_2_fu_673_ap_start_reg;

assign grp_soft_max_fu_655_ap_start = grp_soft_max_fu_655_ap_start_reg;
...
assign icmp_ln947_fu_1409_p2 = (($signed(tmp_428_fu_1399_p4) > $signed(31'd0)) ? 1'b1 : 1'b0);
...
assign p_Result_43_fu_1596_p5 = {{tmp_9_fu_1589_p3}, {m_16_fu_1558_p1[22:0]}};
...
assign select_ln19_fu_1190_p3 = ((tmp_426_fu_1182_p3[0:0] === 1'b1) ? 13'd0 : add_ln203_fu_1176_p2);

assign select_ln588_fu_918_p3 = ((tmp_425_fu_910_p3[0:0] === 1'b1) ? 14'd16383 : 14'd0);
...
assign select_ln964_fu_1570_p3 = ((tmp_430_fu_1562_p3[0:0] === 1'b1) ? 8'd127 : 8'd126);
...
assign sub_ln1117_fu_1117_p2 = (zext_ln1117_fu_1101_p1 - zext_ln1117_401_fu_1113_p1);
...
assign tmp_415_fu_719_p3 = {{i_0_reg_514}, {2'd0}};

assign tmp_416_fu_1093_p3 = {{j_0_i_reg_569}, {5'd0}};

assign tmp_417_fu_1105_p3 = {{j_0_i_reg_569}, {1'd0}};

assign tmp_418_fu_1236_p3 = {{f_0_i_reg_603}, {3'd0}};

assign tmp_419_fu_1248_p3 = {{f_0_i_reg_603}, {1'd0}};

assign tmp_425_fu_910_p3 = bitcast_ln696_fu_907_p1[32'd31];

assign tmp_426_fu_1182_p3 = add_ln703_fu_1170_p2[32'd13];

assign tmp_428_fu_1399_p4 = {{lsb_index_fu_1393_p2[31:1]}};

assign tmp_429_fu_1453_p3 = lsb_index_fu_1393_p2[32'd31];

assign tmp_430_fu_1562_p3 = m_13_fu_1543_p2[32'd25];

assign tmp_9_fu_1589_p3 = {{p_Result_41_reg_1827}, {add_ln964_fu_1583_p2}};
...
assign tmp_s_fu_707_p3 = {{i_0_reg_514}, {5'd0}};
...
assign trunc_ln703_fu_1162_p1 = p_Val2_29_reg_557[12:0];
...
assign xor_ln949_fu_1461_p2 = (tmp_429_fu_1453_p3 ^ 1'd1);

assign zext_ln1116_8_fu_1256_p1 = tmp_419_fu_1248_p3;

assign zext_ln1116_9_fu_1271_p1 = add_ln1116_4_fu_1266_p2;

assign zext_ln1116_fu_1244_p1 = tmp_418_fu_1236_p3;

assign zext_ln1117_401_fu_1113_p1 = tmp_417_fu_1105_p3;

assign zext_ln1117_fu_1101_p1 = tmp_416_fu_1093_p3;

assign zext_ln13_fu_1072_p1 = i_0_i_reg_546;

assign zext_ln14_1_fu_1088_p1 = j_0_i_reg_569;

assign zext_ln14_fu_1068_p1 = i_0_i_reg_546;

assign zext_ln203_17_fu_727_p1 = tmp_415_fu_719_p3;

assign zext_ln203_18_fu_749_p1 = j_0_reg_535;

assign zext_ln203_fu_715_p1 = tmp_s_fu_707_p3;
