...
// ==============================================================
#ifndef __cnn_mac_muladd_14lbW__HH__
#define __cnn_mac_muladd_14lbW__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_14lbW) {
    ...
    SC_CTOR(cnn_mac_muladd_14lbW):  simcore_mac_0_U ("simcore_mac_0_U") {
