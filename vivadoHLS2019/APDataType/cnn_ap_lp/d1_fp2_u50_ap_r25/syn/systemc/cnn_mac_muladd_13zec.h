...
// ==============================================================
#ifndef __cnn_mac_muladd_13zec__HH__
#define __cnn_mac_muladd_13zec__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_13zec) {
    ...
    SC_CTOR(cnn_mac_muladd_13zec):  simcore_mac_3_U ("simcore_mac_3_U") {
