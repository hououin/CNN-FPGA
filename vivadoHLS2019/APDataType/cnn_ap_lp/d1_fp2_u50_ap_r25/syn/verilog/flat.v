...
wire   [2:0] r_fu_594_p2;
reg   [2:0] r_reg_760;
wire    ap_CS_fsm_state2;
wire   [8:0] i_fu_600_p2;
reg   [8:0] i_reg_765;
wire   [0:0] icmp_ln6_fu_588_p2;
wire   [5:0] add_ln203_fu_622_p2;
reg   [5:0] add_ln203_reg_770;
wire   [2:0] c_fu_634_p2;
reg   [2:0] c_reg_778;
wire    ap_CS_fsm_state3;
wire   [8:0] add_ln15_fu_640_p2;
reg   [8:0] add_ln15_reg_783;
wire   [0:0] icmp_ln9_fu_628_p2;
wire   [9:0] tmp_15_cast_fu_655_p3;
reg   [9:0] tmp_15_cast_reg_788;
wire   [4:0] f_fu_669_p2;
reg   [4:0] f_reg_796;
wire    ap_CS_fsm_state4;
wire   [9:0] add_ln203_5_fu_679_p2;
reg   [9:0] add_ln203_5_reg_801;
wire   [0:0] icmp_ln12_fu_663_p2;
wire    ap_CS_fsm_state15;
wire   [8:0] add_ln15_1_fu_744_p2;
...
reg   [8:0] i_2_reg_566;
reg   [4:0] f_0_reg_577;
wire   [63:0] zext_ln203_10_fu_690_p1;
wire   [63:0] zext_ln203_fu_715_p1;
wire   [5:0] trunc_ln203_fu_694_p1;
wire   [4:0] tmp_s_fu_610_p3;
wire   [5:0] zext_ln203_6_fu_606_p1;
wire   [5:0] zext_ln203_7_fu_618_p1;
wire   [5:0] zext_ln203_8_fu_646_p1;
wire   [5:0] add_ln203_4_fu_650_p2;
wire   [9:0] zext_ln203_9_fu_675_p1;
wire   [5:0] grp_fu_684_p1;
wire   [5:0] grp_fu_684_p2;
wire   [19:0] mul_ln203_fu_750_p2;
wire   [5:0] tmp_3_fu_702_p4;
wire  signed [8:0] sext_ln203_fu_711_p1;
wire   [10:0] mul_ln203_fu_750_p0;
wire   [8:0] mul_ln203_fu_750_p1;
reg    grp_fu_684_ap_start;
wire    grp_fu_684_ap_done;
reg   [15:0] ap_NS_fsm;
wire   [19:0] mul_ln203_fu_750_p10;
...
cnn_urem_9ns_6ns_ibs #(
    .ID( 1 ),
    .NUM_STAGE( 13 ),
    .din0_WIDTH( 9 ),
    .din1_WIDTH( 6 ),
    .dout_WIDTH( 6 ))
cnn_urem_9ns_6ns_ibs_U20(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (((icmp_ln12_fu_663_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        c_0_reg_555 <= c_reg_778;
    end else if (((icmp_ln6_fu_588_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        c_0_reg_555 <= 3'd0;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    end else if (((icmp_ln9_fu_628_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        f_0_reg_577 <= 5'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln9_fu_628_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln9_fu_628_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        add_ln15_reg_783 <= add_ln15_fu_640_p2;
        tmp_15_cast_reg_788[9 : 4] <= tmp_15_cast_fu_655_p3[9 : 4];
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln12_fu_663_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        add_ln203_5_reg_801 <= add_ln203_5_fu_679_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln6_fu_588_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | ((icmp_ln6_fu_588_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln6_fu_588_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd0) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd10) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd11) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd12) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd13) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd14) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd15) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd16) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd17) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd18) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd19) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd1) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd20) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd21) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd22) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd23) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if ((~(trunc_ln203_fu_694_p1 == 6'd0) & ~(trunc_ln203_fu_694_p1 == 6'd1) & ~(trunc_ln203_fu_694_p1 == 6'd2) & ~(trunc_ln203_fu_694_p1 == 6'd3) & ~(trunc_ln203_fu_694_p1 == 6'd4) & ~(trunc_ln203_fu_694_p1 == 6'd5) & ~(trunc_ln203_fu_694_p1 == 6'd6) & ~(trunc_ln203_fu_694_p1 == 6'd7) & ~(trunc_ln203_fu_694_p1 == 6'd8) & ~(trunc_ln203_fu_694_p1 == 6'd9) & ~(trunc_ln203_fu_694_p1 == 6'd10) & ~(trunc_ln203_fu_694_p1 == 6'd11) & ~(trunc_ln203_fu_694_p1 == 6'd12) & ~(trunc_ln203_fu_694_p1 == 6'd13) & ~(trunc_ln203_fu_694_p1 == 6'd14) & ~(trunc_ln203_fu_694_p1 == 6'd15) & ~(trunc_ln203_fu_694_p1 == 6'd16) & ~(trunc_ln203_fu_694_p1 == 6'd17) & ~(trunc_ln203_fu_694_p1 == 6'd18) & ~(trunc_ln203_fu_694_p1 == 6'd19) & ~(trunc_ln203_fu_694_p1 == 6'd20) & ~(trunc_ln203_fu_694_p1 == 6'd21) & ~(trunc_ln203_fu_694_p1 == 6'd22) & ~(trunc_ln203_fu_694_p1 == 6'd23) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd2) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd3) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd4) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd5) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd6) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd7) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd8) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (*) begin
    if (((trunc_ln203_fu_694_p1 == 6'd9) & (1'b1 == ap_CS_fsm_state16))) begin
...
assign add_ln15_1_fu_744_p2 = (i_2_reg_566 + 9'd1);

assign add_ln15_fu_640_p2 = (i_1_reg_544 + 9'd16);

assign add_ln203_4_fu_650_p2 = (zext_ln203_8_fu_646_p1 + add_ln203_reg_770);

assign add_ln203_5_fu_679_p2 = (tmp_15_cast_reg_788 + zext_ln203_9_fu_675_p1);

assign add_ln203_fu_622_p2 = (zext_ln203_6_fu_606_p1 + zext_ln203_7_fu_618_p1);
...
assign c_fu_634_p2 = (c_0_reg_555 + 3'd1);

assign f_fu_669_p2 = (f_0_reg_577 + 5'd1);

assign flat_array_0_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_0_V_d0 = max_pool_out_V_q0;

assign flat_array_10_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_10_V_d0 = max_pool_out_V_q0;

assign flat_array_11_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_11_V_d0 = max_pool_out_V_q0;

assign flat_array_12_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_12_V_d0 = max_pool_out_V_q0;

assign flat_array_13_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_13_V_d0 = max_pool_out_V_q0;

assign flat_array_14_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_14_V_d0 = max_pool_out_V_q0;

assign flat_array_15_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_15_V_d0 = max_pool_out_V_q0;

assign flat_array_16_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_16_V_d0 = max_pool_out_V_q0;

assign flat_array_17_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_17_V_d0 = max_pool_out_V_q0;

assign flat_array_18_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_18_V_d0 = max_pool_out_V_q0;

assign flat_array_19_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_19_V_d0 = max_pool_out_V_q0;

assign flat_array_1_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_1_V_d0 = max_pool_out_V_q0;

assign flat_array_20_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_20_V_d0 = max_pool_out_V_q0;

assign flat_array_21_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_21_V_d0 = max_pool_out_V_q0;

assign flat_array_22_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_22_V_d0 = max_pool_out_V_q0;

assign flat_array_23_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_23_V_d0 = max_pool_out_V_q0;

assign flat_array_24_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_24_V_d0 = max_pool_out_V_q0;

assign flat_array_2_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_2_V_d0 = max_pool_out_V_q0;

assign flat_array_3_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_3_V_d0 = max_pool_out_V_q0;

assign flat_array_4_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_4_V_d0 = max_pool_out_V_q0;

assign flat_array_5_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_5_V_d0 = max_pool_out_V_q0;

assign flat_array_6_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_6_V_d0 = max_pool_out_V_q0;

assign flat_array_7_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_7_V_d0 = max_pool_out_V_q0;

assign flat_array_8_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_8_V_d0 = max_pool_out_V_q0;

assign flat_array_9_V_address0 = zext_ln203_fu_715_p1;

assign flat_array_9_V_d0 = max_pool_out_V_q0;

assign grp_fu_684_p1 = 9'd25;

assign i_fu_600_p2 = (i_0_reg_521 + 9'd80);

assign icmp_ln12_fu_663_p2 = ((f_0_reg_577 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln6_fu_588_p2 = ((r_0_reg_533 == 3'd5) ? 1'b1 : 1'b0);

assign icmp_ln9_fu_628_p2 = ((c_0_reg_555 == 3'd5) ? 1'b1 : 1'b0);

assign max_pool_out_V_address0 = zext_ln203_10_fu_690_p1;

assign mul_ln203_fu_750_p0 = 20'd656;

assign mul_ln203_fu_750_p1 = mul_ln203_fu_750_p10;

assign mul_ln203_fu_750_p10 = i_2_reg_566;

assign r_fu_594_p2 = (r_0_reg_533 + 3'd1);

assign sext_ln203_fu_711_p1 = $signed(tmp_3_fu_702_p4);

assign tmp_15_cast_fu_655_p3 = {{add_ln203_4_fu_650_p2}, {4'd0}};

assign tmp_3_fu_702_p4 = {{mul_ln203_fu_750_p2[19:14]}};

assign tmp_s_fu_610_p3 = {{r_0_reg_533}, {2'd0}};

assign trunc_ln203_fu_694_p1 = grp_fu_684_p2[5:0];

assign zext_ln203_10_fu_690_p1 = add_ln203_5_reg_801;

assign zext_ln203_6_fu_606_p1 = r_0_reg_533;

assign zext_ln203_7_fu_618_p1 = tmp_s_fu_610_p3;

assign zext_ln203_8_fu_646_p1 = c_0_reg_555;

assign zext_ln203_9_fu_675_p1 = f_0_reg_577;

assign zext_ln203_fu_715_p1 = $unsigned(sext_ln203_fu_711_p1);

always @ (posedge ap_clk) begin
    tmp_15_cast_reg_788[3:0] <= 4'b0000;
end
