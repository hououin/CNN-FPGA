...
entity exp_15_7_s_exp_x_xdS_rom is 
    generic(
             DWIDTH     : integer := 25; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of exp_15_7_s_exp_x_xdS_rom is 
...
entity exp_15_7_s_exp_x_xdS is
    generic (
...
architecture arch of exp_15_7_s_exp_x_xdS is
    component exp_15_7_s_exp_x_xdS_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    exp_15_7_s_exp_x_xdS_rom_U :  component exp_15_7_s_exp_x_xdS_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
