...
begin
    dense_out_weights_V_U : component dense_out_dense_oAem
    generic map (
        DataWidth => 9,
        AddressRange => 300,
        AddressWidth => 9)
    ...
    dense_out_bias_V_U : component dense_out_dense_oBew
    generic map (
        DataWidth => 8,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    dense_array_V_U : component dense_out_dense_aCeG
    generic map (
        DataWidth => 14,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    cnn_mac_muladd_13DeQ_U116 : component cnn_mac_muladd_13DeQ
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 13,
