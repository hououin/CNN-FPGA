...
// ==============================================================
#ifndef __cnn_mac_muladd_9ssc4__HH__
#define __cnn_mac_muladd_9ssc4__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_9ssc4) {
    ...
    SC_CTOR(cnn_mac_muladd_9ssc4):  simcore_mac_4_U ("simcore_mac_4_U") {
