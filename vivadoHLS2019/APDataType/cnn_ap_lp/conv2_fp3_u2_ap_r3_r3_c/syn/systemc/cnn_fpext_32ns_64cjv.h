...
// ==============================================================
#ifndef __cnn_fpext_32ns_64cjv__HH__
#define __cnn_fpext_32ns_64cjv__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_fpext_32ns_64cjv) {
    ...
    SC_CTOR(cnn_fpext_32ns_64cjv):  ACMP_fpext_U ("ACMP_fpext_U") {
