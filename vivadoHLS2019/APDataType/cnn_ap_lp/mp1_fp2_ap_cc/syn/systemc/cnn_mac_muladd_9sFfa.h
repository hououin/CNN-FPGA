...
// ==============================================================
#ifndef __cnn_mac_muladd_9sFfa__HH__
#define __cnn_mac_muladd_9sFfa__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_9sFfa) {
    ...
    SC_CTOR(cnn_mac_muladd_9sFfa):  simcore_mac_0_U ("simcore_mac_0_U") {
