...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_sdiv_22ns_14smb6_U28 = new cnn_sdiv_22ns_14smb6<1,26,22,14,14>("cnn_sdiv_22ns_14smb6_U28");
    cnn_sdiv_22ns_14smb6_U28->clk(ap_clk);
    cnn_sdiv_22ns_14smb6_U28->reset(ap_rst);
    cnn_sdiv_22ns_14smb6_U28->start(grp_fu_249_ap_start);
    cnn_sdiv_22ns_14smb6_U28->done(grp_fu_249_ap_done);
    cnn_sdiv_22ns_14smb6_U28->din0(grp_fu_249_p0);
    cnn_sdiv_22ns_14smb6_U28->din1(grp_fu_249_p1);
    cnn_sdiv_22ns_14smb6_U28->ce(ap_var_for_const0);
    cnn_sdiv_22ns_14smb6_U28->dout(grp_fu_249_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_sdiv_22ns_14smb6_U28;
}
