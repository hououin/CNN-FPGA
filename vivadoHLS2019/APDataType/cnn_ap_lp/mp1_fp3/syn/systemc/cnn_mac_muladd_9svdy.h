...
// ==============================================================
#ifndef __cnn_mac_muladd_9svdy__HH__
#define __cnn_mac_muladd_9svdy__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_9svdy) {
    ...
    SC_CTOR(cnn_mac_muladd_9svdy):  simcore_mac_2_U ("simcore_mac_2_U") {
