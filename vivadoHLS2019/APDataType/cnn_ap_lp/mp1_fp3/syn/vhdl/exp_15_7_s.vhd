...
architecture behav of exp_15_7_s is 
    ...
    signal tmp_5_fu_551_p4 : STD_LOGIC_VECTOR (1 downto 0);
    signal icmp_ln255_fu_561_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_6_fu_567_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component exp_15_7_s_f_x_lsjbC IS
    generic (
        DataWidth : INTEGER;
    ...
    component exp_15_7_s_exp_x_lbW IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    f_x_lsb_table_V_U : component exp_15_7_s_f_x_lsjbC
    generic map (
        DataWidth => 11,
        AddressRange => 32,
        AddressWidth => 5)
    ...
    exp_x_msb_2_m_1_tabl_U : component exp_15_7_s_exp_x_kbM
    generic map (
        DataWidth => 25,
        AddressRange => 32,
        AddressWidth => 5)
    ...
    exp_x_msb_1_table_V_U : component exp_15_7_s_exp_x_lbW
    generic map (
        DataWidth => 25,
        AddressRange => 32,
        AddressWidth => 5)
    ...
    icmp_ln255_1_fu_591_p2 <= "0" when (tmp_7_fu_581_p4 = ap_const_lv2_0) else "1";
    icmp_ln255_fu_561_p2 <= "0" when (tmp_5_fu_551_p4 = ap_const_lv2_0) else "1";
    ...
    or_ln255_fu_575_p2 <= (tmp_6_fu_567_p3 or icmp_ln255_fu_561_p2);
    ...
    select_ln195_fu_497_p3 <= 
        ...
        ap_const_lv22_0;
    tmp_5_fu_551_p4 <= p_Val2_14_fu_544_p3(21 downto 20);
    tmp_6_fu_567_p3 <= p_Val2_14_fu_544_p3(19 downto 19);
    tmp_7_fu_581_p4 <= p_Val2_14_fu_544_p3(18 downto 17);
