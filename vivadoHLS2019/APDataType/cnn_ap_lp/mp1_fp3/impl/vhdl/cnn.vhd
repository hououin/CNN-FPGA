...
architecture behav of cnn is 
    ...
    "cnn,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=16.990188,HLS_SYN_LAT=446654,HLS_SYN_TPT=none,HLS_SYN_MEM=31,HLS_SYN_DSP=9,HLS_SYN_FF=2365,HLS_SYN_LUT=8485,HLS_VERSION=2019_1}";
    ...
    signal grp_max_pool_1_fu_756_conv_out_V_address1 : STD_LOGIC_VECTOR (11 downto 0);
    signal grp_max_pool_1_fu_756_conv_out_V_ce1 : STD_LOGIC;
    ...
    signal zext_ln203_18_fu_816_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal zext_ln203_19_fu_838_p1 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_23_fu_999_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_25_fu_1390_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_27_fu_1607_p4 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal tmp_28_fu_1661_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_29_fu_1770_p3 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    cnn_fpext_32ns_64tde_U32 : component cnn_fpext_32ns_64tde
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    cnn_mac_muladd_9sudo_U33 : component cnn_mac_muladd_9sudo
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 9,
    ...
    cnn_mac_muladd_9svdy_U34 : component cnn_mac_muladd_9svdy
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 9,
    ...
    cnn_mac_muladd_13wdI_U35 : component cnn_mac_muladd_13wdI
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 13,
    ...
    add_ln203_8_fu_842_p2 <= std_logic_vector(unsigned(sub_ln203_reg_1888) + unsigned(zext_ln203_19_fu_838_p1));
    ...
    conv_1_out_V_ce1_assign_proc : process(grp_max_pool_1_fu_756_conv_out_V_ce1, ap_CS_fsm_state10)
    begin
    ...
    icmp_ln947_fu_1617_p2 <= "1" when (signed(tmp_27_fu_1607_p4) > signed(ap_const_lv31_0)) else "0";
    ...
    select_ln19_1_fu_1398_p3 <= 
        ap_const_lv13_0 when (tmp_25_fu_1390_p3(0) = '1') else 
        add_ln203_1_fu_1384_p2;
    select_ln19_fu_1255_p3 <= 
        ap_const_lv13_0 when (tmp_24_fu_1247_p3(0) = '1') else 
        add_ln203_fu_1241_p2;
    select_ln588_fu_1007_p3 <= 
        ap_const_lv14_3FFF when (tmp_23_fu_999_p3(0) = '1') else 
        ap_const_lv14_0;
    ...
    select_ln964_fu_1778_p3 <= 
        ap_const_lv8_7F when (tmp_29_fu_1770_p3(0) = '1') else 
        ap_const_lv8_7E;
    ...
    sub_ln203_fu_820_p2 <= std_logic_vector(unsigned(zext_ln203_fu_804_p1) - unsigned(zext_ln203_18_fu_816_p1));
    ...
    tmp_23_fu_999_p3 <= bitcast_ln696_fu_996_p1(31 downto 31);
    tmp_24_fu_1247_p3 <= add_ln703_fu_1235_p2(13 downto 13);
    tmp_25_fu_1390_p3 <= add_ln703_1_fu_1378_p2(13 downto 13);
    tmp_27_fu_1607_p4 <= lsb_index_fu_1601_p2(31 downto 1);
    tmp_28_fu_1661_p3 <= lsb_index_fu_1601_p2(31 downto 31);
    tmp_29_fu_1770_p3 <= m_13_fu_1751_p2(25 downto 25);
    ...
    xor_ln949_fu_1669_p2 <= (tmp_28_fu_1661_p3 xor ap_const_lv1_1);
    ...
    zext_ln203_18_fu_816_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_10_fu_808_p3),11));
    zext_ln203_19_fu_838_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_0_reg_589),11));
