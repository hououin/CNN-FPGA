...
architecture behav of dense_out is 
    ...
    component cnn_mac_muladd_13yd2 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    dense_out_weights_V_U : component dense_out_dense_ovdy
    generic map (
        DataWidth => 9,
        AddressRange => 300,
        AddressWidth => 9)
    ...
    dense_out_bias_V_U : component dense_out_dense_owdI
    generic map (
        DataWidth => 8,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    dense_array_V_U : component dense_out_dense_axdS
    generic map (
        DataWidth => 14,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    cnn_mac_muladd_13yd2_U48 : component cnn_mac_muladd_13yd2
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 13,
