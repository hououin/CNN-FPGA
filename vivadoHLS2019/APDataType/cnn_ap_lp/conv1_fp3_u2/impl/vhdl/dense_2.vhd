...
architecture behav of dense_2 is 
    ...
    component cnn_mac_muladd_9socq IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component dense_2_dense_2_bncg IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    ...
    dense_2_bias_V_U : component dense_2_dense_2_bncg
    generic map (
        DataWidth => 9,
        AddressRange => 30,
        AddressWidth => 5)
    ...
    cnn_mac_muladd_9socq_U47 : component cnn_mac_muladd_9socq
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 9,
