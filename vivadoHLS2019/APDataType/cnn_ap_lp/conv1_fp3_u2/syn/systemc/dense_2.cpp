...
dense_2::dense_2(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_mac_muladd_9socq_U47 = new cnn_mac_muladd_9socq<1,1,9,13,22,22>("cnn_mac_muladd_9socq_U47");
    cnn_mac_muladd_9socq_U47->din0(dense_2_weights_V_q0);
    cnn_mac_muladd_9socq_U47->din1(grp_fu_291_p1);
    cnn_mac_muladd_9socq_U47->din2(grp_fu_291_p2);
    cnn_mac_muladd_9socq_U47->dout(grp_fu_291_p3);
...
dense_2::~dense_2() {
    ...
    delete cnn_mac_muladd_9socq_U47;
}
