...
// ==============================================================
#ifndef __cnn_mul_mul_9s_14eOg__HH__
#define __cnn_mul_mul_9s_14eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_9s_14eOg) {
    ...
    SC_CTOR(cnn_mul_mul_9s_14eOg):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
