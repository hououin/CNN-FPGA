...
// ==============================================================
#ifndef __cnn_mac_muladd_13wdI__HH__
#define __cnn_mac_muladd_13wdI__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_13wdI) {
    ...
    SC_CTOR(cnn_mac_muladd_13wdI):  simcore_mac_3_U ("simcore_mac_3_U") {
