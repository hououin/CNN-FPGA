...
// ==============================================================
#ifndef __cnn_mac_muladd_13cQA__HH__
#define __cnn_mac_muladd_13cQA__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_13cQA) {
    ...
    SC_CTOR(cnn_mac_muladd_13cQA):  simcore_mac_2_U ("simcore_mac_2_U") {
