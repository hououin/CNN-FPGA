...
architecture behav of cnn is 
    ...
    "cnn,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=17.356750,HLS_SYN_LAT=453997,HLS_SYN_TPT=none,HLS_SYN_MEM=31,HLS_SYN_DSP=8,HLS_SYN_FF=2291,HLS_SYN_LUT=8472,HLS_VERSION=2019_1}";
    ...
    signal add_ln203_8_reg_1901 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal grp_conv_2_fu_724_conv_out_V_d0 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal grp_conv_1_fu_734_conv_out_V_d0 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal grp_soft_max_fu_744_dense_array_V_d0 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal grp_soft_max_fu_744_prediction_V_d0 : STD_LOGIC_VECTOR (13 downto 0);
    signal grp_max_pool_2_fu_756_ap_start : STD_LOGIC;
    signal grp_max_pool_2_fu_756_ap_done : STD_LOGIC;
    signal grp_max_pool_2_fu_756_ap_idle : STD_LOGIC;
    signal grp_max_pool_2_fu_756_ap_ready : STD_LOGIC;
    signal grp_max_pool_2_fu_756_conv_out_V_address0 : STD_LOGIC_VECTOR (10 downto 0);
    signal grp_max_pool_2_fu_756_conv_out_V_ce0 : STD_LOGIC;
    signal grp_max_pool_2_fu_756_conv_out_V_address1 : STD_LOGIC_VECTOR (10 downto 0);
    signal grp_max_pool_2_fu_756_conv_out_V_ce1 : STD_LOGIC;
    signal grp_max_pool_2_fu_756_max_pool_out_V_address0 : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_max_pool_2_fu_756_max_pool_out_V_ce0 : STD_LOGIC;
    signal grp_max_pool_2_fu_756_max_pool_out_V_we0 : STD_LOGIC;
    signal grp_max_pool_2_fu_756_max_pool_out_V_d0 : STD_LOGIC_VECTOR (13 downto 0);
    signal grp_max_pool_1_fu_762_ap_start : STD_LOGIC;
    signal grp_max_pool_1_fu_762_ap_done : STD_LOGIC;
    signal grp_max_pool_1_fu_762_ap_idle : STD_LOGIC;
    signal grp_max_pool_1_fu_762_ap_ready : STD_LOGIC;
    signal grp_max_pool_1_fu_762_conv_out_V_address0 : STD_LOGIC_VECTOR (11 downto 0);
    signal grp_max_pool_1_fu_762_conv_out_V_ce0 : STD_LOGIC;
    signal grp_max_pool_1_fu_762_max_pool_out_V_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal grp_max_pool_1_fu_762_max_pool_out_V_ce0 : STD_LOGIC;
    signal grp_max_pool_1_fu_762_max_pool_out_V_we0 : STD_LOGIC;
    signal grp_max_pool_1_fu_762_max_pool_out_V_d0 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal grp_max_pool_2_fu_756_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state13 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state13 : signal is "none";
    signal ap_CS_fsm_state14 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state14 : signal is "none";
    signal grp_max_pool_1_fu_762_ap_start_reg : STD_LOGIC := '0';
    ...
    signal tmp_11_fu_808_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_20_fu_999_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_21_fu_1247_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln203_fu_1241_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_12_fu_1301_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_13_fu_1313_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_22_fu_1390_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln203_1_fu_1384_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_14_fu_1444_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_15_fu_1456_p3 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal tmp_24_fu_1607_p4 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal tmp_26_fu_1770_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_9_fu_1797_p3 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    grp_max_pool_2_fu_756 : component max_pool_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_max_pool_1_fu_762 : component max_pool_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_max_pool_1_fu_762_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((grp_max_pool_1_fu_762_ap_ready = ap_const_logic_1)) then 
                    grp_max_pool_1_fu_762_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    grp_max_pool_2_fu_756_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((grp_max_pool_2_fu_756_ap_ready = ap_const_logic_1)) then 
                    grp_max_pool_2_fu_756_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state10 => 
                if (((grp_max_pool_1_fu_762_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state10))) then
            ...
            when ap_ST_fsm_state14 => 
                if (((grp_max_pool_2_fu_756_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state14))) then
    ...
    add_ln203_8_fu_842_p2 <= std_logic_vector(unsigned(sub_ln203_reg_1888) + unsigned(zext_ln203_18_fu_838_p1));
    ...
    conv_1_input_V_address0_assign_proc : process(grp_conv_1_fu_734_input_V_address0, ap_CS_fsm_state6, ap_CS_fsm_state8, sext_ln203_fu_1141_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
    ...
    conv_1_out_V_address0_assign_proc : process(ap_CS_fsm_state2, grp_conv_1_fu_734_conv_out_V_address0, grp_max_pool_1_fu_762_conv_out_V_address0, ap_CS_fsm_state8, ap_CS_fsm_state10)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    conv_1_out_V_ce0_assign_proc : process(ap_CS_fsm_state2, grp_conv_1_fu_734_conv_out_V_ce0, grp_max_pool_1_fu_762_conv_out_V_ce0, ap_CS_fsm_state8, ap_CS_fsm_state10)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    conv_2_out_V_address0_assign_proc : process(ap_CS_fsm_state2, grp_conv_2_fu_724_conv_out_V_address0, grp_max_pool_2_fu_756_conv_out_V_address0, ap_CS_fsm_state12, ap_CS_fsm_state14)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    conv_2_out_V_ce0_assign_proc : process(ap_CS_fsm_state2, grp_conv_2_fu_724_conv_out_V_ce0, grp_max_pool_2_fu_756_conv_out_V_ce0, ap_CS_fsm_state12, ap_CS_fsm_state14)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    conv_2_out_V_ce1_assign_proc : process(grp_max_pool_2_fu_756_conv_out_V_ce1, ap_CS_fsm_state14)
    begin
    ...
    dense_array_V_address0_assign_proc : process(zext_ln48_reg_2034, grp_soft_max_fu_744_dense_array_V_address0, ap_CS_fsm_state28, ap_CS_fsm_state29)
    begin
    ...
    dense_array_V_d0_assign_proc : process(grp_soft_max_fu_744_dense_array_V_d0, ap_CS_fsm_state28, ap_CS_fsm_state29, add_ln703_2_fu_1513_p2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state28)) then 
    ...
    flat_array_V_ce0_assign_proc : process(ap_CS_fsm_state18, grp_max_pool_2_fu_756_ap_done, grp_flat_fu_768_flat_array_V_ce0, ap_CS_fsm_state16, ap_CS_fsm_state14)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state18) or ((grp_max_pool_2_fu_756_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state14)))) then 
    ...
    flat_array_V_we0_assign_proc : process(grp_max_pool_2_fu_756_ap_done, grp_flat_fu_768_flat_array_V_we0, ap_CS_fsm_state16, ap_CS_fsm_state14)
    begin
        if (((grp_max_pool_2_fu_756_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state14))) then 
    ...
    grp_max_pool_1_fu_762_ap_start <= grp_max_pool_1_fu_762_ap_start_reg;
    grp_max_pool_2_fu_756_ap_start <= grp_max_pool_2_fu_756_ap_start_reg;
    ...
    icmp_ln947_fu_1617_p2 <= "1" when (signed(tmp_24_fu_1607_p4) > signed(ap_const_lv31_0)) else "0";
    ...
    max_pool_1_out_V_address0_assign_proc : process(ap_CS_fsm_state2, grp_conv_2_fu_724_input_V_address0, grp_max_pool_1_fu_762_max_pool_out_V_address0, ap_CS_fsm_state12, ap_CS_fsm_state10)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    max_pool_1_out_V_ce0_assign_proc : process(ap_CS_fsm_state2, grp_conv_2_fu_724_input_V_ce0, grp_max_pool_1_fu_762_max_pool_out_V_ce0, ap_CS_fsm_state12, ap_CS_fsm_state10)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    max_pool_1_out_V_d0_assign_proc : process(ap_CS_fsm_state2, grp_max_pool_1_fu_762_max_pool_out_V_d0, ap_CS_fsm_state10)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    max_pool_1_out_V_we0_assign_proc : process(ap_CS_fsm_state2, icmp_ln23_fu_778_p2, grp_max_pool_1_fu_762_max_pool_out_V_we0, ap_CS_fsm_state10)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln23_fu_778_p2 = ap_const_lv1_1))) then 
    ...
    max_pool_2_out_V_address0_assign_proc : process(ap_CS_fsm_state2, grp_max_pool_2_fu_756_max_pool_out_V_address0, grp_flat_fu_768_max_pool_out_V_address0, ap_CS_fsm_state16, ap_CS_fsm_state14)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    max_pool_2_out_V_ce0_assign_proc : process(ap_CS_fsm_state2, grp_max_pool_2_fu_756_max_pool_out_V_ce0, grp_flat_fu_768_max_pool_out_V_ce0, ap_CS_fsm_state16, ap_CS_fsm_state14)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    max_pool_2_out_V_d0_assign_proc : process(ap_CS_fsm_state2, grp_max_pool_2_fu_756_max_pool_out_V_d0, ap_CS_fsm_state14)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    max_pool_2_out_V_we0_assign_proc : process(ap_CS_fsm_state2, icmp_ln23_fu_778_p2, grp_max_pool_2_fu_756_max_pool_out_V_we0, ap_CS_fsm_state14)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln23_fu_778_p2 = ap_const_lv1_1))) then 
    ...
    p_Result_43_fu_1804_p5 <= (tmp_9_fu_1797_p3 & m_16_fu_1766_p1(22 downto 0));
    ...
    prediction_V_address0_assign_proc : process(ap_CS_fsm_state21, ap_CS_fsm_state30, zext_ln70_fu_1532_p1, grp_soft_max_fu_744_prediction_V_address0, ap_CS_fsm_state29)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state30)) then 
    ...
    prediction_V_we0_assign_proc : process(ap_CS_fsm_state21, icmp_ln9_1_fu_1264_p2, grp_soft_max_fu_744_prediction_V_we0, ap_CS_fsm_state29)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state21) and (icmp_ln9_1_fu_1264_p2 = ap_const_lv1_1))) then 
    ...
    select_ln19_1_fu_1398_p3 <= 
        ap_const_lv13_0 when (tmp_22_fu_1390_p3(0) = '1') else 
        add_ln203_1_fu_1384_p2;
    select_ln19_fu_1255_p3 <= 
        ap_const_lv13_0 when (tmp_21_fu_1247_p3(0) = '1') else 
        add_ln203_fu_1241_p2;
    select_ln588_fu_1007_p3 <= 
        ap_const_lv14_3FFF when (tmp_20_fu_999_p3(0) = '1') else 
        ap_const_lv14_0;
    ...
    select_ln964_fu_1778_p3 <= 
        ap_const_lv8_7F when (tmp_26_fu_1770_p3(0) = '1') else 
        ap_const_lv8_7E;
    ...
    sext_ln1265_fu_1223_p0 <= dense_1_bias_V_q0;
        ...
        sext_ln203_fu_1141_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(add_ln203_8_reg_1901),64));
    ...
    tmp_11_fu_808_p3 <= (i_0_reg_568 & ap_const_lv2_0);
    tmp_12_fu_1301_p3 <= (j_0_i10_reg_668 & ap_const_lv5_0);
    tmp_13_fu_1313_p3 <= (j_0_i10_reg_668 & ap_const_lv1_0);
    tmp_14_fu_1444_p3 <= (f_0_i_reg_702 & ap_const_lv3_0);
    tmp_15_fu_1456_p3 <= (f_0_i_reg_702 & ap_const_lv1_0);
    tmp_20_fu_999_p3 <= bitcast_ln696_fu_996_p1(31 downto 31);
    tmp_21_fu_1247_p3 <= add_ln703_fu_1235_p2(13 downto 13);
    tmp_22_fu_1390_p3 <= add_ln703_1_fu_1378_p2(13 downto 13);
    tmp_24_fu_1607_p4 <= lsb_index_fu_1601_p2(31 downto 1);
    tmp_25_fu_1661_p3 <= lsb_index_fu_1601_p2(31 downto 31);
    tmp_26_fu_1770_p3 <= m_13_fu_1751_p2(25 downto 25);
    tmp_9_fu_1797_p3 <= (p_Result_41_reg_2096 & add_ln964_fu_1791_p2);
    tmp_V_13_fu_1557_p3 <= 
    ...
    xor_ln949_fu_1669_p2 <= (tmp_25_fu_1661_p3 xor ap_const_lv1_1);
    zext_ln1116_8_fu_1464_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_15_fu_1456_p3),9));
    zext_ln1116_9_fu_1479_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln1116_4_fu_1474_p2),64));
    zext_ln1116_fu_1452_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_14_fu_1444_p3),9));
    zext_ln1117_6_fu_1309_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_12_fu_1301_p3),12));
    zext_ln1117_7_fu_1321_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_13_fu_1313_p3),12));
    ...
    zext_ln203_17_fu_816_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_11_fu_808_p3),11));
