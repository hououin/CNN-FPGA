...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_sdiv_22ns_14sbsm_U462 = new cnn_sdiv_22ns_14sbsm<1,26,22,14,14>("cnn_sdiv_22ns_14sbsm_U462");
    cnn_sdiv_22ns_14sbsm_U462->clk(ap_clk);
    cnn_sdiv_22ns_14sbsm_U462->reset(ap_rst);
    cnn_sdiv_22ns_14sbsm_U462->din0(grp_fu_267_p0);
    cnn_sdiv_22ns_14sbsm_U462->din1(grp_fu_267_p1);
    cnn_sdiv_22ns_14sbsm_U462->ce(ap_var_for_const0);
    cnn_sdiv_22ns_14sbsm_U462->dout(grp_fu_267_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_sdiv_22ns_14sbsm_U462;
}
