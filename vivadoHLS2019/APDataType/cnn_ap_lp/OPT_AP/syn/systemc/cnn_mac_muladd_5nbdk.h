...
// ==============================================================
#ifndef __cnn_mac_muladd_5nbdk__HH__
#define __cnn_mac_muladd_5nbdk__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_5nbdk) {
    ...
    SC_CTOR(cnn_mac_muladd_5nbdk):  simcore_mac_1_U ("simcore_mac_1_U") {
