...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_sdiv_22ns_14srcU_U42 = new cnn_sdiv_22ns_14srcU<1,26,22,14,14>("cnn_sdiv_22ns_14srcU_U42");
    cnn_sdiv_22ns_14srcU_U42->clk(ap_clk);
    cnn_sdiv_22ns_14srcU_U42->reset(ap_rst);
    cnn_sdiv_22ns_14srcU_U42->din0(grp_fu_267_p0);
    cnn_sdiv_22ns_14srcU_U42->din1(grp_fu_267_p1);
    cnn_sdiv_22ns_14srcU_U42->ce(ap_var_for_const0);
    cnn_sdiv_22ns_14srcU_U42->dout(grp_fu_267_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_sdiv_22ns_14srcU_U42;
}
