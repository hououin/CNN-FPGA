...
// ==============================================================
#ifndef __cnn_sdiv_22ns_14srcU__HH__
#define __cnn_sdiv_22ns_14srcU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_sdiv_22ns_14srcU) {
    ...
    SC_CTOR(cnn_sdiv_22ns_14srcU):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
