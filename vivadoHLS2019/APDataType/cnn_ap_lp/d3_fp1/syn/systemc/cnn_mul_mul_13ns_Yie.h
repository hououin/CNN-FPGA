...
// ==============================================================
#ifndef __cnn_mul_mul_13ns_Yie__HH__
#define __cnn_mul_mul_13ns_Yie__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_13ns_Yie) {
    ...
    SC_CTOR(cnn_mul_mul_13ns_Yie):  ACMP_smul_us_U ("ACMP_smul_us_U") {
