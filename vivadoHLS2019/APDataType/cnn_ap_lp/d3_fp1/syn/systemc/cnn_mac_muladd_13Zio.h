...
// ==============================================================
#ifndef __cnn_mac_muladd_13Zio__HH__
#define __cnn_mac_muladd_13Zio__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_13Zio) {
    ...
    SC_CTOR(cnn_mac_muladd_13Zio):  simcore_mac_2_U ("simcore_mac_2_U") {
