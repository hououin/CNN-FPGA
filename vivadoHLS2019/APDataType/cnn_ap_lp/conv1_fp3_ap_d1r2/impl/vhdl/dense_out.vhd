...
architecture behav of dense_out is 
    ...
    component cnn_mac_muladd_13Ffa IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    dense_out_weights_V_U : component dense_out_dense_oCeG
    generic map (
        DataWidth => 9,
        AddressRange => 300,
        AddressWidth => 9)
    ...
    dense_out_bias_V_U : component dense_out_dense_oDeQ
    generic map (
        DataWidth => 8,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    dense_array_V_U : component dense_out_dense_aEe0
    generic map (
        DataWidth => 14,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    cnn_mac_muladd_13Ffa_U62 : component cnn_mac_muladd_13Ffa
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 13,
