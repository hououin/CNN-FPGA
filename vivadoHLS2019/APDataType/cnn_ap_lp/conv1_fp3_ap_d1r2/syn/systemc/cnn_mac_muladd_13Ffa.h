...
// ==============================================================
#ifndef __cnn_mac_muladd_13Ffa__HH__
#define __cnn_mac_muladd_13Ffa__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_13Ffa) {
    ...
    SC_CTOR(cnn_mac_muladd_13Ffa):  simcore_mac_3_U ("simcore_mac_3_U") {
