...
dense_2::dense_2(sc_module_name name) : sc_module(name), mVcdFile(0) {
    dense_2_weights_V_U = new dense_2_dense_2_wvdy("dense_2_weights_V_U");
    ...
    dense_2_bias_V_U = new dense_2_dense_2_bwdI("dense_2_bias_V_U");
    ...
    cnn_mac_muladd_9sxdS_U47 = new cnn_mac_muladd_9sxdS<1,1,9,13,22,22>("cnn_mac_muladd_9sxdS_U47");
    cnn_mac_muladd_9sxdS_U47->din0(dense_2_weights_V_q0);
    cnn_mac_muladd_9sxdS_U47->din1(grp_fu_291_p1);
    cnn_mac_muladd_9sxdS_U47->din2(grp_fu_291_p2);
    cnn_mac_muladd_9sxdS_U47->dout(grp_fu_291_p3);
...
dense_2::~dense_2() {
    ...
    delete cnn_mac_muladd_9sxdS_U47;
}
