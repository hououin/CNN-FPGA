...
// ==============================================================
#ifndef __cnn_mac_muladd_5nmb6__HH__
#define __cnn_mac_muladd_5nmb6__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_5nmb6) {
    ...
    SC_CTOR(cnn_mac_muladd_5nmb6):  simcore_mac_0_U ("simcore_mac_0_U") {
