...
wire   [10:0] zext_ln203_11_fu_415_p1;
reg   [10:0] zext_ln203_11_reg_1063;
...
wire   [63:0] zext_ln203_13_fu_428_p1;
...
wire   [11:0] zext_ln203_12_fu_419_p1;
...
wire   [10:0] tmp_26_cast_fu_608_p3;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln14_fu_399_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        conv_out_V_addr_reg_1068 <= zext_ln203_13_fu_428_p1;
        zext_ln203_11_reg_1063[4 : 0] <= zext_ln203_11_fu_415_p1[4 : 0];
...
assign add_ln1116_2_fu_616_p2 = (zext_ln203_11_reg_1063 + tmp_26_cast_fu_608_p3);
...
assign add_ln203_6_fu_423_p2 = (zext_ln14_reg_1045 + zext_ln203_12_fu_419_p1);
...
assign p_Result_26_fu_968_p5 = {{tmp_3_fu_961_p3}, {m_6_fu_930_p1[51:0]}};
...
assign tmp_26_cast_fu_608_p3 = {{add_ln1116_1_fu_603_p2}, {4'd0}};

assign tmp_3_fu_961_p3 = {{p_Result_24_reg_1149}, {add_ln915_fu_955_p2}};
...
assign zext_ln203_11_fu_415_p1 = f_0_reg_251;

assign zext_ln203_12_fu_419_p1 = f_0_reg_251;

assign zext_ln203_13_fu_428_p1 = add_ln203_6_fu_423_p2;
...
always @ (posedge ap_clk) begin
    ...
    zext_ln203_11_reg_1063[10:5] <= 6'b000000;
