...
architecture behav of cnn is 
    ...
    "cnn,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=16.990188,HLS_SYN_LAT=446653,HLS_SYN_TPT=none,HLS_SYN_MEM=31,HLS_SYN_DSP=8,HLS_SYN_FF=2706,HLS_SYN_LUT=11010,HLS_VERSION=2019_1}";
    ...
    signal add_ln203_31_fu_842_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal add_ln203_31_reg_1901 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_35_fu_999_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_37_fu_1390_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_39_fu_1607_p4 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal tmp_40_fu_1661_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_41_fu_1770_p3 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    add_ln203_31_fu_842_p2 <= std_logic_vector(unsigned(sub_ln203_reg_1888) + unsigned(zext_ln203_16_fu_838_p1));
    ...
    icmp_ln947_fu_1617_p2 <= "1" when (signed(tmp_39_fu_1607_p4) > signed(ap_const_lv31_0)) else "0";
    ...
    select_ln19_1_fu_1398_p3 <= 
        ap_const_lv13_0 when (tmp_37_fu_1390_p3(0) = '1') else 
        add_ln203_1_fu_1384_p2;
    select_ln19_fu_1255_p3 <= 
        ap_const_lv13_0 when (tmp_36_fu_1247_p3(0) = '1') else 
        add_ln203_fu_1241_p2;
    select_ln588_fu_1007_p3 <= 
        ap_const_lv14_3FFF when (tmp_35_fu_999_p3(0) = '1') else 
        ap_const_lv14_0;
    ...
    select_ln964_fu_1778_p3 <= 
        ap_const_lv8_7F when (tmp_41_fu_1770_p3(0) = '1') else 
        ap_const_lv8_7E;
    ...
    sext_ln1265_fu_1223_p0 <= dense_1_bias_V_q0;
        ...
        sext_ln203_fu_1141_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(add_ln203_31_reg_1901),64));
    ...
    tmp_35_fu_999_p3 <= bitcast_ln696_fu_996_p1(31 downto 31);
    tmp_36_fu_1247_p3 <= add_ln703_fu_1235_p2(13 downto 13);
    tmp_37_fu_1390_p3 <= add_ln703_1_fu_1378_p2(13 downto 13);
    tmp_39_fu_1607_p4 <= lsb_index_fu_1601_p2(31 downto 1);
    tmp_40_fu_1661_p3 <= lsb_index_fu_1601_p2(31 downto 31);
    tmp_41_fu_1770_p3 <= m_13_fu_1751_p2(25 downto 25);
    ...
    xor_ln949_fu_1669_p2 <= (tmp_40_fu_1661_p3 xor ap_const_lv1_1);
    ...
    zext_ln203_15_fu_816_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_9_fu_808_p3),11));
