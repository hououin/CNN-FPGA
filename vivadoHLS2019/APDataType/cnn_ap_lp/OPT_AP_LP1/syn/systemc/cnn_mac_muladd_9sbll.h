...
// ==============================================================
#ifndef __cnn_mac_muladd_9sbll__HH__
#define __cnn_mac_muladd_9sbll__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_9sbll) {
    ...
    SC_CTOR(cnn_mac_muladd_9sbll):  simcore_mac_4_U ("simcore_mac_4_U") {
