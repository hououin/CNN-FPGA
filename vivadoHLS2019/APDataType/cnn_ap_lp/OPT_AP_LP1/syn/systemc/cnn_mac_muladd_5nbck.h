...
// ==============================================================
#ifndef __cnn_mac_muladd_5nbck__HH__
#define __cnn_mac_muladd_5nbck__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_5nbck) {
    ...
    SC_CTOR(cnn_mac_muladd_5nbck):  simcore_mac_1_U ("simcore_mac_1_U") {
