...
// ==============================================================
#ifndef __cnn_mac_muladd_4nfmZ__HH__
#define __cnn_mac_muladd_4nfmZ__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_4nfmZ) {
    ...
    SC_CTOR(cnn_mac_muladd_4nfmZ):  simcore_mac_8_U ("simcore_mac_8_U") {
