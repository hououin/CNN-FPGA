...
// ==============================================================
#ifndef __cnn_mac_muladd_13bwn__HH__
#define __cnn_mac_muladd_13bwn__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_13bwn) {
    ...
    SC_CTOR(cnn_mac_muladd_13bwn):  simcore_mac_6_U ("simcore_mac_6_U") {
