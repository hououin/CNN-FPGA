...
// ==============================================================
#ifndef __cnn_mul_mul_9s_14bek__HH__
#define __cnn_mul_mul_9s_14bek__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_9s_14bek) {
    ...
    SC_CTOR(cnn_mul_mul_9s_14bek):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
