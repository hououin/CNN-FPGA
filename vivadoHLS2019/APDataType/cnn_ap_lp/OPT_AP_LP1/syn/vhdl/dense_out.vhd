...
architecture behav of dense_out is 
    ...
    signal tmp_21_reg_1317 : STD_LOGIC_VECTOR (13 downto 0);
    signal ap_CS_fsm_pp0_stage2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage2 : signal is "none";
    signal ap_block_state5_pp0_stage2_iter0 : BOOLEAN;
    signal ap_block_pp0_stage2_11001 : BOOLEAN;
    signal tmp_27_reg_1342 : STD_LOGIC_VECTOR (13 downto 0);
    signal ap_CS_fsm_pp0_stage3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage3 : signal is "none";
    signal ap_block_state6_pp0_stage3_iter0 : BOOLEAN;
    signal ap_block_pp0_stage3_11001 : BOOLEAN;
    signal tmp_33_reg_1367 : STD_LOGIC_VECTOR (13 downto 0);
    signal ap_CS_fsm_pp0_stage4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage4 : signal is "none";
    signal ap_block_state7_pp0_stage4_iter0 : BOOLEAN;
    signal ap_block_pp0_stage4_11001 : BOOLEAN;
    signal tmp_39_reg_1392 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal tmp_15_fu_402_p3 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal tmp_16_fu_441_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_17_fu_453_p3 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal tmp_18_fu_509_p4 : STD_LOGIC_VECTOR (13 downto 0);
    signal add_ln46_fu_526_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_19_fu_537_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_20_fu_549_p3 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal tmp_22_fu_597_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_23_fu_609_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_24_fu_660_p4 : STD_LOGIC_VECTOR (13 downto 0);
    signal add_ln46_2_fu_677_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_25_fu_687_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_26_fu_699_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_28_fu_746_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_29_fu_758_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_30_fu_809_p4 : STD_LOGIC_VECTOR (13 downto 0);
    signal add_ln46_4_fu_826_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_31_fu_836_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_32_fu_848_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_34_fu_895_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_35_fu_907_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_36_fu_958_p4 : STD_LOGIC_VECTOR (13 downto 0);
    signal add_ln46_6_fu_975_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_37_fu_985_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_38_fu_997_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_40_fu_1044_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_41_fu_1056_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_42_fu_1113_p4 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    component cnn_mac_muladd_13bwn IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    cnn_mac_muladd_13bwn_U530 : component cnn_mac_muladd_13bwn
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 13,
    ...
    cnn_mac_muladd_13bwn_U531 : component cnn_mac_muladd_13bwn
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 13,
    ...
    cnn_mac_muladd_13bwn_U532 : component cnn_mac_muladd_13bwn
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 13,
    ...
    cnn_mac_muladd_13bwn_U533 : component cnn_mac_muladd_13bwn
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 13,
    ...
    cnn_mac_muladd_13bwn_U534 : component cnn_mac_muladd_13bwn
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 13,
    ...
    cnn_mac_muladd_13bwn_U535 : component cnn_mac_muladd_13bwn
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 13,
    ...
    cnn_mac_muladd_13bwn_U536 : component cnn_mac_muladd_13bwn
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 13,
    ...
    cnn_mac_muladd_13bwn_U537 : component cnn_mac_muladd_13bwn
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 13,
    ...
    cnn_mac_muladd_13bwn_U538 : component cnn_mac_muladd_13bwn
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 13,
    ...
    cnn_mac_muladd_13bwn_U539 : component cnn_mac_muladd_13bwn
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 13,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln46_reg_1273 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001))) then
                ...
                tmp_21_reg_1317 <= grp_fu_1159_p3(21 downto 8);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln46_reg_1273 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (ap_const_boolean_0 = ap_block_pp0_stage2_11001))) then
                tmp_27_reg_1342 <= grp_fu_1177_p3(21 downto 8);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln46_reg_1273 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3) and (ap_const_boolean_0 = ap_block_pp0_stage3_11001))) then
                tmp_33_reg_1367 <= grp_fu_1195_p3(21 downto 8);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln46_reg_1273 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage4) and (ap_const_boolean_0 = ap_block_pp0_stage4_11001))) then
                tmp_39_reg_1392 <= grp_fu_1213_p3(21 downto 8);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    grp_fu_1159_p2 <= (tmp_18_fu_509_p4 & ap_const_lv8_0);
    ...
    grp_fu_1168_p2 <= (tmp_21_reg_1317 & ap_const_lv8_0);
    ...
    grp_fu_1177_p2 <= (tmp_24_fu_660_p4 & ap_const_lv8_0);
    ...
    grp_fu_1186_p2 <= (tmp_27_reg_1342 & ap_const_lv8_0);
    ...
    grp_fu_1195_p2 <= (tmp_30_fu_809_p4 & ap_const_lv8_0);
    ...
    grp_fu_1204_p2 <= (tmp_33_reg_1367 & ap_const_lv8_0);
    ...
    grp_fu_1213_p2 <= (tmp_36_fu_958_p4 & ap_const_lv8_0);
    ...
    grp_fu_1222_p2 <= (tmp_39_reg_1392 & ap_const_lv8_0);
    ...
    grp_fu_1231_p2 <= (tmp_42_fu_1113_p4 & ap_const_lv8_0);
    ...
    tmp_15_fu_402_p3 <= (ap_phi_mux_f_0_0_phi_fu_334_p4 & ap_const_lv1_0);
    tmp_16_fu_441_p3 <= (or_ln46_fu_430_p2 & ap_const_lv3_0);
    tmp_17_fu_453_p3 <= (or_ln46_fu_430_p2 & ap_const_lv1_0);
    tmp_18_fu_509_p4 <= grp_fu_1150_p3(21 downto 8);
    tmp_19_fu_537_p3 <= (add_ln46_fu_526_p2 & ap_const_lv3_0);
    tmp_20_fu_549_p3 <= (add_ln46_fu_526_p2 & ap_const_lv1_0);
    tmp_22_fu_597_p3 <= (add_ln46_1_fu_586_p2 & ap_const_lv3_0);
    tmp_23_fu_609_p3 <= (add_ln46_1_fu_586_p2 & ap_const_lv1_0);
    tmp_24_fu_660_p4 <= grp_fu_1168_p3(21 downto 8);
    tmp_25_fu_687_p3 <= (add_ln46_2_fu_677_p2 & ap_const_lv3_0);
    tmp_26_fu_699_p3 <= (add_ln46_2_fu_677_p2 & ap_const_lv1_0);
    tmp_28_fu_746_p3 <= (add_ln46_3_fu_736_p2 & ap_const_lv3_0);
    tmp_29_fu_758_p3 <= (add_ln46_3_fu_736_p2 & ap_const_lv1_0);
    tmp_30_fu_809_p4 <= grp_fu_1186_p3(21 downto 8);
    tmp_31_fu_836_p3 <= (add_ln46_4_fu_826_p2 & ap_const_lv3_0);
    tmp_32_fu_848_p3 <= (add_ln46_4_fu_826_p2 & ap_const_lv1_0);
    tmp_34_fu_895_p3 <= (add_ln46_5_fu_885_p2 & ap_const_lv3_0);
    tmp_35_fu_907_p3 <= (add_ln46_5_fu_885_p2 & ap_const_lv1_0);
    tmp_36_fu_958_p4 <= grp_fu_1204_p3(21 downto 8);
    tmp_37_fu_985_p3 <= (add_ln46_6_fu_975_p2 & ap_const_lv3_0);
    tmp_38_fu_997_p3 <= (add_ln46_6_fu_975_p2 & ap_const_lv1_0);
    tmp_40_fu_1044_p3 <= (add_ln46_7_fu_1034_p2 & ap_const_lv3_0);
    tmp_41_fu_1056_p3 <= (add_ln46_7_fu_1034_p2 & ap_const_lv1_0);
    tmp_42_fu_1113_p4 <= grp_fu_1222_p3(21 downto 8);
    tmp_s_fu_390_p3 <= (ap_phi_mux_f_0_0_phi_fu_334_p4 & ap_const_lv3_0);
    zext_ln1116_10_fu_617_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_23_fu_609_p3),10));
    zext_ln1116_11_fu_632_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln1116_7_fu_627_p2),64));
    zext_ln1116_12_fu_695_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_25_fu_687_p3),10));
    zext_ln1116_13_fu_707_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_26_fu_699_p3),10));
    zext_ln1116_14_fu_722_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln1116_9_fu_717_p2),64));
    zext_ln1116_15_fu_754_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_28_fu_746_p3),10));
    zext_ln1116_16_fu_766_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_29_fu_758_p3),10));
    zext_ln1116_17_fu_781_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln1116_11_fu_776_p2),64));
    zext_ln1116_18_fu_844_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_31_fu_836_p3),10));
    zext_ln1116_19_fu_856_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_32_fu_848_p3),10));
    zext_ln1116_1_fu_410_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_15_fu_402_p3),9));
    zext_ln1116_20_fu_871_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln1116_13_fu_866_p2),64));
    zext_ln1116_21_fu_903_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_34_fu_895_p3),10));
    zext_ln1116_22_fu_915_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_35_fu_907_p3),10));
    zext_ln1116_23_fu_930_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln1116_15_fu_925_p2),64));
    zext_ln1116_24_fu_993_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_37_fu_985_p3),10));
    zext_ln1116_25_fu_1005_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_38_fu_997_p3),10));
    zext_ln1116_26_fu_1020_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln1116_17_fu_1015_p2),64));
    zext_ln1116_27_fu_1052_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_40_fu_1044_p3),10));
    zext_ln1116_28_fu_1064_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_41_fu_1056_p3),10));
    ...
    zext_ln1116_3_fu_449_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_16_fu_441_p3),9));
    zext_ln1116_4_fu_461_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_17_fu_453_p3),9));
    zext_ln1116_5_fu_476_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln1116_3_fu_471_p2),64));
    zext_ln1116_6_fu_545_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_19_fu_537_p3),9));
    zext_ln1116_7_fu_557_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_20_fu_549_p3),9));
    zext_ln1116_8_fu_572_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln1116_5_fu_567_p2),64));
    zext_ln1116_9_fu_605_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_22_fu_597_p3),10));
    zext_ln1116_fu_398_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_390_p3),9));
