...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module dense_1_dense_1_wbil_rom (
...
initial begin
    $readmemh("./dense_1_dense_1_wbil_rom.dat", ram0);
    $readmemh("./dense_1_dense_1_wbil_rom.dat", ram1);
    $readmemh("./dense_1_dense_1_wbil_rom.dat", ram2);
end
...
dense_1_dense_1_wbil_rom dense_1_dense_1_wbil_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
