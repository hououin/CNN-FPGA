...
// ==============================================================
#ifndef __cnn_mac_muladd_9szec__HH__
#define __cnn_mac_muladd_9szec__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_9szec) {
    ...
    SC_CTOR(cnn_mac_muladd_9szec):  simcore_mac_2_U ("simcore_mac_2_U") {
