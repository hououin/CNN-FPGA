...
architecture behav of dense_2 is 
    ...
    component cnn_mac_muladd_9szec IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component dense_2_dense_2_byd2 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    dense_2_weights_V_U : component dense_2_dense_2_wxdS
    generic map (
        DataWidth => 9,
        AddressRange => 1500,
        AddressWidth => 11)
    ...
    dense_2_bias_V_U : component dense_2_dense_2_byd2
    generic map (
        DataWidth => 9,
        AddressRange => 30,
        AddressWidth => 5)
    ...
    cnn_mac_muladd_9szec_U60 : component cnn_mac_muladd_9szec
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 9,
