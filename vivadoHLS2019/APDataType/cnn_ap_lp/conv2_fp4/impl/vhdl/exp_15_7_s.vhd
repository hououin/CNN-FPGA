...
architecture behav of exp_15_7_s is 
    ...
    component exp_15_7_s_f_x_lsBew IS
    generic (
        DataWidth : INTEGER;
...
begin
    f_x_lsb_table_V_U : component exp_15_7_s_f_x_lsBew
    generic map (
        DataWidth => 11,
        AddressRange => 32,
        AddressWidth => 5)
    ...
    exp_x_msb_2_m_1_tabl_U : component exp_15_7_s_exp_x_CeG
    generic map (
        DataWidth => 25,
        AddressRange => 32,
        AddressWidth => 5)
    ...
    exp_x_msb_1_table_V_U : component exp_15_7_s_exp_x_DeQ
    generic map (
        DataWidth => 25,
        AddressRange => 32,
        AddressWidth => 5)
