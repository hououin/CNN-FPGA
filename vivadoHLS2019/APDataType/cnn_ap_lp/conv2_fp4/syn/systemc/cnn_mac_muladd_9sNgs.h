...
// ==============================================================
#ifndef __cnn_mac_muladd_9sNgs__HH__
#define __cnn_mac_muladd_9sNgs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_9sNgs) {
    ...
    SC_CTOR(cnn_mac_muladd_9sNgs):  simcore_mac_2_U ("simcore_mac_2_U") {
