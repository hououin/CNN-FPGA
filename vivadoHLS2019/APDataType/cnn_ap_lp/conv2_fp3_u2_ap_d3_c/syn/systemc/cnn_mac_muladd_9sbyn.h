...
// ==============================================================
#ifndef __cnn_mac_muladd_9sbyn__HH__
#define __cnn_mac_muladd_9sbyn__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_9sbyn) {
    ...
    SC_CTOR(cnn_mac_muladd_9sbyn):  simcore_mac_4_U ("simcore_mac_4_U") {
