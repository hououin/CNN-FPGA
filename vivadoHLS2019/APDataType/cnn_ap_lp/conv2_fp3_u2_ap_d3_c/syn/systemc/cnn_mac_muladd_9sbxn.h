...
// ==============================================================
#ifndef __cnn_mac_muladd_9sbxn__HH__
#define __cnn_mac_muladd_9sbxn__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_9sbxn) {
    ...
    SC_CTOR(cnn_mac_muladd_9sbxn):  simcore_mac_3_U ("simcore_mac_3_U") {
