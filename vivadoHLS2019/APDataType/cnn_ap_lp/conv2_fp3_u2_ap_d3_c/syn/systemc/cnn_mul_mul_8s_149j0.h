...
// ==============================================================
#ifndef __cnn_mul_mul_8s_149j0__HH__
#define __cnn_mul_mul_8s_149j0__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_8s_149j0) {
    ...
    SC_CTOR(cnn_mul_mul_8s_149j0):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
