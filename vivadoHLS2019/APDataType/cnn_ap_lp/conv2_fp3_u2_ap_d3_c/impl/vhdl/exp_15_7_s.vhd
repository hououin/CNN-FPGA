...
architecture behav of exp_15_7_s is 
    ...
    signal p_Result_s_56_fu_323_p1 : STD_LOGIC_VECTOR (14 downto 0);
    ...
    component exp_15_7_s_f_x_lsbhl IS
    generic (
        DataWidth : INTEGER;
    ...
    component exp_15_7_s_exp_x_bil IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    f_x_lsb_table_V_U : component exp_15_7_s_f_x_lsbhl
    generic map (
        DataWidth => 11,
        AddressRange => 32,
        AddressWidth => 5)
    ...
    exp_x_msb_2_m_1_tabl_U : component exp_15_7_s_exp_x_bil
    generic map (
        DataWidth => 25,
        AddressRange => 32,
        AddressWidth => 5)
    ...
    exp_x_msb_1_table_V_U : component exp_15_7_s_exp_x_bjl
    generic map (
        DataWidth => 25,
        AddressRange => 32,
        AddressWidth => 5)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                p_Result_s_56_reg_627 <= p_Result_s_56_fu_323_p1(10 downto 7);
