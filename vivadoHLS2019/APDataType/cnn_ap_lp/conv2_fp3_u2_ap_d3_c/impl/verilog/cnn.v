...
(* CORE_GENERATION_INFO="cnn,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=20.118563,HLS_SYN_LAT=196407,HLS_SYN_TPT=none,HLS_SYN_MEM=35,HLS_SYN_DSP=116,HLS_SYN_FF=7781,HLS_SYN_LUT=14203,HLS_VERSION=2019_1}" *)
...
wire   [0:0] p_Result_31_fu_1785_p3;
reg   [0:0] p_Result_31_reg_2338;
wire   [13:0] tmp_V_9_fu_1799_p3;
reg   [13:0] tmp_V_9_reg_2343;
...
wire   [13:0] add_ln703_3_fu_1755_p2;
wire   [9:0] tmp_s_fu_1038_p3;
wire   [6:0] tmp_118_fu_1050_p3;
wire   [10:0] zext_ln203_fu_1046_p1;
wire   [10:0] zext_ln203_16_fu_1058_p1;
wire   [10:0] zext_ln203_17_fu_1080_p1;
...
wire   [53:0] p_Result_30_fu_1142_p1;
wire   [0:0] p_Result_29_fu_1108_p3;
...
wire   [0:0] tmp_126_fu_1489_p3;
wire   [12:0] add_ln203_fu_1483_p2;
wire   [10:0] tmp_119_fu_1543_p3;
wire   [6:0] tmp_120_fu_1555_p3;
...
wire  signed [8:0] sext_ln1265_2_fu_1608_p0;
wire  signed [8:0] sext_ln703_2_fu_1616_p0;
wire  signed [13:0] sext_ln1265_2_fu_1608_p1;
wire  signed [12:0] sext_ln703_2_fu_1616_p1;
wire   [12:0] trunc_ln703_1_fu_1612_p1;
wire   [13:0] add_ln703_2_fu_1620_p2;
wire   [0:0] tmp_127_fu_1632_p3;
wire   [12:0] add_ln203_1_fu_1626_p2;
wire   [7:0] tmp_121_fu_1686_p3;
wire   [5:0] tmp_122_fu_1698_p3;
...
wire  signed [13:0] sext_ln1265_3_fu_1751_p1;
wire   [13:0] tmp_V_fu_1793_p2;
reg   [13:0] p_Result_13_fu_1807_p4;
wire   [31:0] p_Result_32_fu_1817_p3;
reg   [31:0] l_fu_1825_p3;
wire   [31:0] lsb_index_fu_1843_p2;
wire   [30:0] tmp_129_fu_1849_p4;
...
wire   [31:0] m_7_fu_1986_p3;
wire   [31:0] m_8_fu_1993_p2;
wire   [30:0] m_s_fu_1998_p4;
wire   [0:0] tmp_131_fu_2012_p3;
wire   [7:0] select_ln964_fu_2020_p3;
wire   [7:0] sub_ln964_fu_2028_p2;
wire   [7:0] add_ln964_fu_2033_p2;
wire   [31:0] m_11_fu_2008_p1;
wire   [8:0] tmp_9_fu_2039_p3;
wire   [31:0] p_Result_33_fu_2046_p5;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state19)) begin
        p_Val2_22_reg_737 <= {{grp_fu_2070_p3[21:8]}};
    end else if (((1'b1 == ap_CS_fsm_state17) & (icmp_ln9_fu_1387_p2 == 1'd0))) begin
        p_Val2_22_reg_737 <= 14'd0;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state23)) begin
        p_Val2_25_reg_782 <= {{grp_fu_2079_p3[21:8]}};
    end else if (((1'b1 == ap_CS_fsm_state21) & (icmp_ln9_1_fu_1506_p2 == 1'd0))) begin
        p_Val2_25_reg_782 <= 14'd0;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state27)) begin
        p_Val2_31_reg_816 <= {{grp_fu_2088_p3[21:8]}};
    end else if (((1'b1 == ap_CS_fsm_state25) & (icmp_ln41_fu_1649_p2 == 1'd0))) begin
        p_Val2_31_reg_816 <= 14'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state31)) begin
        ...
        p_Result_31_reg_2338 <= prediction_V_q0[32'd13];
...
assign add_ln203_7_fu_1084_p2 = (sub_ln203_reg_2130 + zext_ln203_17_fu_1080_p1);
...
assign add_ln703_2_fu_1620_p2 = ($signed(p_Val2_25_reg_782) + $signed(sext_ln1265_2_fu_1608_p1));

assign add_ln703_3_fu_1755_p2 = ($signed(sext_ln1265_3_fu_1751_p1) + $signed(p_Val2_31_reg_816));

assign add_ln703_fu_1477_p2 = ($signed(p_Val2_22_reg_737) + $signed(sext_ln1265_fu_1465_p1));
...
assign and_ln949_fu_1931_p2 = (xor_ln949_fu_1911_p2 & p_Result_27_fu_1923_p3);
...
assign bitcast_ln739_fu_2058_p1 = p_Result_33_fu_2046_p5;
...
assign icmp_ln947_1_fu_1891_p2 = ((p_Result_s_fu_1885_p2 != 14'd0) ? 1'b1 : 1'b0);

assign icmp_ln947_fu_1859_p2 = (($signed(tmp_129_fu_1849_p4) > $signed(31'd0)) ? 1'b1 : 1'b0);
...
always @ (p_Result_32_fu_1817_p3) begin
    if (p_Result_32_fu_1817_p3[0] == 1'b1) begin
        l_fu_1825_p3 = 32'd0;
    end else if (p_Result_32_fu_1817_p3[1] == 1'b1) begin
        l_fu_1825_p3 = 32'd1;
    end else if (p_Result_32_fu_1817_p3[2] == 1'b1) begin
        l_fu_1825_p3 = 32'd2;
    end else if (p_Result_32_fu_1817_p3[3] == 1'b1) begin
        l_fu_1825_p3 = 32'd3;
    end else if (p_Result_32_fu_1817_p3[4] == 1'b1) begin
        l_fu_1825_p3 = 32'd4;
    end else if (p_Result_32_fu_1817_p3[5] == 1'b1) begin
        l_fu_1825_p3 = 32'd5;
    end else if (p_Result_32_fu_1817_p3[6] == 1'b1) begin
        l_fu_1825_p3 = 32'd6;
    end else if (p_Result_32_fu_1817_p3[7] == 1'b1) begin
        l_fu_1825_p3 = 32'd7;
    end else if (p_Result_32_fu_1817_p3[8] == 1'b1) begin
        l_fu_1825_p3 = 32'd8;
    end else if (p_Result_32_fu_1817_p3[9] == 1'b1) begin
        l_fu_1825_p3 = 32'd9;
    end else if (p_Result_32_fu_1817_p3[10] == 1'b1) begin
        l_fu_1825_p3 = 32'd10;
    end else if (p_Result_32_fu_1817_p3[11] == 1'b1) begin
        l_fu_1825_p3 = 32'd11;
    end else if (p_Result_32_fu_1817_p3[12] == 1'b1) begin
        l_fu_1825_p3 = 32'd12;
    end else if (p_Result_32_fu_1817_p3[13] == 1'b1) begin
        l_fu_1825_p3 = 32'd13;
    end else if (p_Result_32_fu_1817_p3[14] == 1'b1) begin
        l_fu_1825_p3 = 32'd14;
    end else if (p_Result_32_fu_1817_p3[15] == 1'b1) begin
        l_fu_1825_p3 = 32'd15;
    end else if (p_Result_32_fu_1817_p3[16] == 1'b1) begin
        l_fu_1825_p3 = 32'd16;
    end else if (p_Result_32_fu_1817_p3[17] == 1'b1) begin
        l_fu_1825_p3 = 32'd17;
    end else if (p_Result_32_fu_1817_p3[18] == 1'b1) begin
        l_fu_1825_p3 = 32'd18;
    end else if (p_Result_32_fu_1817_p3[19] == 1'b1) begin
        l_fu_1825_p3 = 32'd19;
    end else if (p_Result_32_fu_1817_p3[20] == 1'b1) begin
        l_fu_1825_p3 = 32'd20;
    end else if (p_Result_32_fu_1817_p3[21] == 1'b1) begin
        l_fu_1825_p3 = 32'd21;
    end else if (p_Result_32_fu_1817_p3[22] == 1'b1) begin
        l_fu_1825_p3 = 32'd22;
    end else if (p_Result_32_fu_1817_p3[23] == 1'b1) begin
        l_fu_1825_p3 = 32'd23;
    end else if (p_Result_32_fu_1817_p3[24] == 1'b1) begin
        l_fu_1825_p3 = 32'd24;
    end else if (p_Result_32_fu_1817_p3[25] == 1'b1) begin
        l_fu_1825_p3 = 32'd25;
    end else if (p_Result_32_fu_1817_p3[26] == 1'b1) begin
        l_fu_1825_p3 = 32'd26;
    end else if (p_Result_32_fu_1817_p3[27] == 1'b1) begin
        l_fu_1825_p3 = 32'd27;
    end else if (p_Result_32_fu_1817_p3[28] == 1'b1) begin
        l_fu_1825_p3 = 32'd28;
    end else if (p_Result_32_fu_1817_p3[29] == 1'b1) begin
        l_fu_1825_p3 = 32'd29;
    end else if (p_Result_32_fu_1817_p3[30] == 1'b1) begin
        l_fu_1825_p3 = 32'd30;
    end else if (p_Result_32_fu_1817_p3[31] == 1'b1) begin
        l_fu_1825_p3 = 32'd31;
    end else begin
        l_fu_1825_p3 = 32'd32;
    end
...
assign m_11_fu_2008_p1 = m_s_fu_1998_p4;

assign m_7_fu_1986_p3 = ((icmp_ln958_reg_2359[0:0] === 1'b1) ? lshr_ln958_fu_1969_p2 : shl_ln958_fu_1980_p2);

assign m_8_fu_1993_p2 = (m_7_fu_1986_p3 + or_ln_reg_2354);

assign m_fu_1961_p1 = tmp_V_9_reg_2343;

assign m_s_fu_1998_p4 = {{m_8_fu_1993_p2[31:1]}};

assign man_V_1_fu_1146_p2 = (54'd0 - p_Result_30_fu_1142_p1);

assign man_V_2_fu_1152_p3 = ((p_Result_29_fu_1108_p3[0:0] === 1'b1) ? man_V_1_fu_1146_p2 : p_Result_30_fu_1142_p1);
...
always @ (tmp_V_9_fu_1799_p3) begin
    for (ap_tvar_int_0 = 14 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 13 - 0) begin
            p_Result_13_fu_1807_p4[ap_tvar_int_0] = 1'b0;
        end else begin
            p_Result_13_fu_1807_p4[ap_tvar_int_0] = tmp_V_9_fu_1799_p3[13 - ap_tvar_int_0];
        end
    end
end

assign p_Result_27_fu_1923_p3 = tmp_V_9_fu_1799_p3[add_ln949_fu_1917_p2];

assign p_Result_29_fu_1108_p3 = ireg_V_fu_1100_p1[32'd63];

assign p_Result_30_fu_1142_p1 = tmp_fu_1134_p3;

assign p_Result_31_fu_1785_p3 = prediction_V_q0[32'd13];

assign p_Result_32_fu_1817_p3 = {{18'd262143}, {p_Result_13_fu_1807_p4}};

assign p_Result_33_fu_2046_p5 = {{tmp_9_fu_2039_p3}, {m_11_fu_2008_p1[22:0]}};

assign p_Result_s_fu_1885_p2 = (tmp_V_9_fu_1799_p3 & lshr_ln947_fu_1879_p2);
...
assign select_ln19_1_fu_1640_p3 = ((tmp_127_fu_1632_p3[0:0] === 1'b1) ? 13'd0 : add_ln203_1_fu_1626_p2);

assign select_ln19_fu_1497_p3 = ((tmp_126_fu_1489_p3[0:0] === 1'b1) ? 13'd0 : add_ln203_fu_1483_p2);

assign select_ln588_fu_1249_p3 = ((tmp_125_fu_1241_p3[0:0] === 1'b1) ? 14'd16383 : 14'd0);
...
assign select_ln964_fu_2020_p3 = ((tmp_131_fu_2012_p3[0:0] === 1'b1) ? 8'd127 : 8'd126);

assign sext_ln1117_fu_1578_p1 = $signed(add_ln1117_9_fu_1573_p2);

assign sext_ln1265_2_fu_1608_p0 = dense_2_bias_V_q0;

assign sext_ln1265_2_fu_1608_p1 = sext_ln1265_2_fu_1608_p0;

assign sext_ln1265_3_fu_1751_p1 = $signed(dense_out_bias_V_q0);
...
assign sub_ln203_fu_1062_p2 = (zext_ln203_fu_1046_p1 - zext_ln203_16_fu_1058_p1);
...
assign tmp_118_fu_1050_p3 = {{i_0_reg_694}, {2'd0}};

assign tmp_119_fu_1543_p3 = {{j_0_i18_reg_794}, {5'd0}};

assign tmp_120_fu_1555_p3 = {{j_0_i18_reg_794}, {1'd0}};

assign tmp_121_fu_1686_p3 = {{f_0_i_reg_828}, {3'd0}};

assign tmp_122_fu_1698_p3 = {{f_0_i_reg_828}, {1'd0}};

assign tmp_125_fu_1241_p3 = bitcast_ln696_fu_1238_p1[32'd31];

assign tmp_126_fu_1489_p3 = add_ln703_fu_1477_p2[32'd13];

assign tmp_127_fu_1632_p3 = add_ln703_2_fu_1620_p2[32'd13];

assign tmp_129_fu_1849_p4 = {{lsb_index_fu_1843_p2[31:1]}};

assign tmp_130_fu_1903_p3 = lsb_index_fu_1843_p2[32'd31];

assign tmp_131_fu_2012_p3 = m_8_fu_1993_p2[32'd25];

assign tmp_9_fu_2039_p3 = {{p_Result_31_reg_2338}, {add_ln964_fu_2033_p2}};

assign tmp_V_9_fu_1799_p3 = ((p_Result_31_fu_1785_p3[0:0] === 1'b1) ? tmp_V_fu_1793_p2 : prediction_V_q0);
...
assign trunc_ln703_1_fu_1612_p1 = p_Val2_25_reg_782[12:0];

assign trunc_ln703_fu_1469_p1 = p_Val2_22_reg_737[12:0];
...
assign xor_ln949_fu_1911_p2 = (tmp_130_fu_1903_p3 ^ 1'd1);

assign zext_ln1116_3_fu_1706_p1 = tmp_122_fu_1698_p3;

assign zext_ln1116_4_fu_1721_p1 = add_ln1116_2_fu_1716_p2;

assign zext_ln1116_fu_1694_p1 = tmp_121_fu_1686_p3;

assign zext_ln1117_14_fu_1551_p1 = tmp_119_fu_1543_p3;

assign zext_ln1117_15_fu_1563_p1 = tmp_120_fu_1555_p3;
...
assign zext_ln203_16_fu_1058_p1 = tmp_118_fu_1050_p3;

assign zext_ln203_17_fu_1080_p1 = j_0_reg_715;
