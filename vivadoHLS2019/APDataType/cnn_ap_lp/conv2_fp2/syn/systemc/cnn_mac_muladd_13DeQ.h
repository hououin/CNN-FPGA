...
// ==============================================================
#ifndef __cnn_mac_muladd_13DeQ__HH__
#define __cnn_mac_muladd_13DeQ__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_13DeQ) {
    ...
    SC_CTOR(cnn_mac_muladd_13DeQ):  simcore_mac_5_U ("simcore_mac_5_U") {
