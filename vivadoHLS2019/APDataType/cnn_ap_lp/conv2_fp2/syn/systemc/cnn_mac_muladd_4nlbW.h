...
// ==============================================================
#ifndef __cnn_mac_muladd_4nlbW__HH__
#define __cnn_mac_muladd_4nlbW__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_4nlbW) {
    ...
    SC_CTOR(cnn_mac_muladd_4nlbW):  simcore_mac_0_U ("simcore_mac_0_U") {
