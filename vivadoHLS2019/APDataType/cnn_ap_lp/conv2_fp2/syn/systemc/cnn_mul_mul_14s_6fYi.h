...
// ==============================================================
#ifndef __cnn_mul_mul_14s_6fYi__HH__
#define __cnn_mul_mul_14s_6fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_14s_6fYi) {
    ...
    SC_CTOR(cnn_mul_mul_14s_6fYi):  ACMP_smul_su_U ("ACMP_smul_su_U") {
