...
// ==============================================================
#ifndef __cnn_mac_muladd_14ncg__HH__
#define __cnn_mac_muladd_14ncg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_14ncg) {
    ...
    SC_CTOR(cnn_mac_muladd_14ncg):  simcore_mac_2_U ("simcore_mac_2_U") {
