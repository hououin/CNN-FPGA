...
wire   [6:0] zext_ln203_27_fu_396_p1;
reg   [6:0] zext_ln203_27_reg_996;
...
wire   [13:0] tmp_V_4_fu_616_p2;
reg   [13:0] tmp_V_4_reg_1052;
wire    ap_CS_fsm_state8;
wire   [0:0] icmp_ln885_fu_622_p2;
reg   [0:0] icmp_ln885_reg_1060;
wire   [0:0] p_Result_24_fu_628_p3;
reg   [0:0] p_Result_24_reg_1064;
wire    ap_CS_fsm_state9;
wire   [13:0] tmp_V_5_fu_640_p3;
reg   [13:0] tmp_V_5_reg_1069;
...
wire   [0:0] icmp_ln924_32_fu_934_p2;
reg   [0:0] icmp_ln924_32_reg_1106;
reg   [4:0] r_0_reg_205;
...
wire   [63:0] m_1_fu_837_p3;
wire   [63:0] m_2_fu_847_p2;
wire   [62:0] m_5_fu_853_p4;
wire   [0:0] tmp_959_fu_867_p3;
wire   [10:0] sub_ln915_fu_883_p2;
wire   [10:0] select_ln915_fu_875_p3;
wire   [10:0] add_ln915_fu_888_p2;
wire   [63:0] m_6_fu_863_p1;
wire   [11:0] tmp_34_fu_894_p3;
wire   [63:0] p_Result_26_fu_901_p5;
wire   [51:0] trunc_ln8_fu_918_p4;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        p_Val2_19_reg_275 <= {{ret_V_fu_596_p2[21:8]}};
...
always @ (posedge ap_clk) begin
    if (((icmp_ln14_fu_380_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        conv_out_V_addr_reg_1001 <= zext_ln203_29_fu_409_p1;
        zext_ln203_27_reg_996[2 : 0] <= zext_ln203_27_fu_396_p1[2 : 0];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        p_Result_24_reg_1064 <= tmp_V_4_reg_1052[32'd13];
...
assign add_ln1116_1_fu_539_p2 = (sub_ln1116_1_fu_533_p2 + zext_ln203_27_reg_996);

assign add_ln1116_fu_508_p2 = ($signed(sext_ln1116_reg_1014) + $signed(zext_ln1116_1_fu_504_p1));

assign add_ln1117_fu_559_p2 = (sub_ln1117_reg_1019 + zext_ln1117_70_fu_555_p1);

assign add_ln203_6_fu_404_p2 = (sub_ln203_reg_978 + zext_ln203_28_fu_400_p1);
...
assign and_ln899_fu_771_p2 = (xor_ln899_fu_751_p2 & p_Result_22_fu_763_p3);
...
assign grp_fu_309_p0 = p_Result_26_fu_901_p5;
...
assign icmp_ln885_fu_622_p2 = ((tmp_V_4_fu_616_p2 == 14'd0) ? 1'b1 : 1'b0);

assign icmp_ln897_2_fu_731_p2 = ((p_Result_21_fu_725_p2 != 14'd0) ? 1'b1 : 1'b0);

assign icmp_ln897_fu_699_p2 = (($signed(tmp_957_fu_689_p4) > $signed(31'd0)) ? 1'b1 : 1'b0);
...
assign icmp_ln924_32_fu_934_p2 = ((trunc_ln8_fu_918_p4 == 52'd0) ? 1'b1 : 1'b0);
...
always @ (p_Result_25_fu_657_p3) begin
    if (p_Result_25_fu_657_p3[0] == 1'b1) begin
        l_fu_665_p3 = 32'd0;
    end else if (p_Result_25_fu_657_p3[1] == 1'b1) begin
        l_fu_665_p3 = 32'd1;
    end else if (p_Result_25_fu_657_p3[2] == 1'b1) begin
        l_fu_665_p3 = 32'd2;
    end else if (p_Result_25_fu_657_p3[3] == 1'b1) begin
        l_fu_665_p3 = 32'd3;
    end else if (p_Result_25_fu_657_p3[4] == 1'b1) begin
        l_fu_665_p3 = 32'd4;
    end else if (p_Result_25_fu_657_p3[5] == 1'b1) begin
        l_fu_665_p3 = 32'd5;
    end else if (p_Result_25_fu_657_p3[6] == 1'b1) begin
        l_fu_665_p3 = 32'd6;
    end else if (p_Result_25_fu_657_p3[7] == 1'b1) begin
        l_fu_665_p3 = 32'd7;
    end else if (p_Result_25_fu_657_p3[8] == 1'b1) begin
        l_fu_665_p3 = 32'd8;
    end else if (p_Result_25_fu_657_p3[9] == 1'b1) begin
        l_fu_665_p3 = 32'd9;
    end else if (p_Result_25_fu_657_p3[10] == 1'b1) begin
        l_fu_665_p3 = 32'd10;
    end else if (p_Result_25_fu_657_p3[11] == 1'b1) begin
        l_fu_665_p3 = 32'd11;
    end else if (p_Result_25_fu_657_p3[12] == 1'b1) begin
        l_fu_665_p3 = 32'd12;
    end else if (p_Result_25_fu_657_p3[13] == 1'b1) begin
        l_fu_665_p3 = 32'd13;
    end else if (p_Result_25_fu_657_p3[14] == 1'b1) begin
        l_fu_665_p3 = 32'd14;
    end else if (p_Result_25_fu_657_p3[15] == 1'b1) begin
        l_fu_665_p3 = 32'd15;
    end else if (p_Result_25_fu_657_p3[16] == 1'b1) begin
        l_fu_665_p3 = 32'd16;
    end else if (p_Result_25_fu_657_p3[17] == 1'b1) begin
        l_fu_665_p3 = 32'd17;
    end else if (p_Result_25_fu_657_p3[18] == 1'b1) begin
        l_fu_665_p3 = 32'd18;
    end else if (p_Result_25_fu_657_p3[19] == 1'b1) begin
        l_fu_665_p3 = 32'd19;
    end else if (p_Result_25_fu_657_p3[20] == 1'b1) begin
        l_fu_665_p3 = 32'd20;
    end else if (p_Result_25_fu_657_p3[21] == 1'b1) begin
        l_fu_665_p3 = 32'd21;
    end else if (p_Result_25_fu_657_p3[22] == 1'b1) begin
        l_fu_665_p3 = 32'd22;
    end else if (p_Result_25_fu_657_p3[23] == 1'b1) begin
        l_fu_665_p3 = 32'd23;
    end else if (p_Result_25_fu_657_p3[24] == 1'b1) begin
        l_fu_665_p3 = 32'd24;
    end else if (p_Result_25_fu_657_p3[25] == 1'b1) begin
        l_fu_665_p3 = 32'd25;
    end else if (p_Result_25_fu_657_p3[26] == 1'b1) begin
        l_fu_665_p3 = 32'd26;
    end else if (p_Result_25_fu_657_p3[27] == 1'b1) begin
        l_fu_665_p3 = 32'd27;
    end else if (p_Result_25_fu_657_p3[28] == 1'b1) begin
        l_fu_665_p3 = 32'd28;
    end else if (p_Result_25_fu_657_p3[29] == 1'b1) begin
        l_fu_665_p3 = 32'd29;
    end else if (p_Result_25_fu_657_p3[30] == 1'b1) begin
        l_fu_665_p3 = 32'd30;
    end else if (p_Result_25_fu_657_p3[31] == 1'b1) begin
        l_fu_665_p3 = 32'd31;
    end else begin
        l_fu_665_p3 = 32'd32;
    end
...
assign lhs_V_fu_580_p3 = {{p_Val2_19_reg_275}, {8'd0}};
...
assign lshr_ln908_fu_812_p2 = zext_ln907_16_fu_804_p1 >> add_ln908_fu_807_p2;

assign m_1_fu_837_p3 = ((icmp_ln908_reg_1086[0:0] === 1'b1) ? zext_ln908_fu_818_p1 : shl_ln908_fu_831_p2);

assign m_2_fu_847_p2 = (zext_ln911_fu_844_p1 + m_1_fu_837_p3);

assign m_5_fu_853_p4 = {{m_2_fu_847_p2[63:1]}};

assign m_6_fu_863_p1 = m_5_fu_853_p4;

assign m_fu_801_p1 = tmp_V_5_reg_1069;

assign or_ln899_fu_777_p2 = (and_ln899_fu_771_p2 | a_fu_737_p2);

assign or_ln924_fu_940_p2 = (icmp_ln924_reg_1101 | icmp_ln924_32_reg_1106);

assign or_ln_fu_783_p3 = {{31'd0}, {or_ln899_fu_777_p2}};

assign p_Result_21_fu_725_p2 = (tmp_V_5_fu_640_p3 & lshr_ln897_fu_719_p2);

assign p_Result_22_fu_763_p3 = tmp_V_5_fu_640_p3[add_ln899_fu_757_p2];

assign p_Result_24_fu_628_p3 = tmp_V_4_reg_1052[32'd13];

assign p_Result_25_fu_657_p3 = {{18'd262143}, {p_Result_s_fu_647_p4}};

assign p_Result_26_fu_901_p5 = {{tmp_34_fu_894_p3}, {m_6_fu_863_p1[51:0]}};

integer ap_tvar_int_0;

always @ (tmp_V_5_fu_640_p3) begin
    for (ap_tvar_int_0 = 14 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 13 - 0) begin
            ...
            p_Result_s_fu_647_p4[ap_tvar_int_0] = tmp_V_5_fu_640_p3[13 - ap_tvar_int_0];
        end
    end
end
...
assign select_ln915_fu_875_p3 = ((tmp_959_fu_867_p3[0:0] === 1'b1) ? 11'd1023 : 11'd1022);

assign sext_ln1116_fu_448_p1 = $signed(sub_ln1116_fu_442_p2);

assign sext_ln1117_fu_564_p1 = $signed(add_ln1117_fu_559_p2);

assign sext_ln1118_1268_fu_577_p1 = r_V_fu_950_p2;
...
assign sub_ln1117_fu_482_p2 = (zext_ln1117_fu_466_p1 - zext_ln1117_69_fu_478_p1);

assign sub_ln203_fu_374_p2 = (p_shl_cast_fu_354_p3 - zext_ln203_26_fu_370_p1);
...
assign tmp_34_fu_894_p3 = {{p_Result_24_reg_1064}, {add_ln915_fu_888_p2}};

assign tmp_909_fu_430_p3 = {{wr_0_reg_264}, {2'd0}};

assign tmp_910_fu_458_p3 = {{add_ln23_fu_452_p2}, {5'd0}};

assign tmp_911_fu_470_p3 = {{add_ln23_fu_452_p2}, {2'd0}};

assign tmp_955_fu_362_p3 = {{add_ln203_fu_348_p2}, {1'd0}};

assign tmp_957_fu_689_p4 = {{lsb_index_fu_683_p2[31:1]}};

assign tmp_958_fu_743_p3 = lsb_index_fu_683_p2[32'd31];

assign tmp_959_fu_867_p3 = m_2_fu_847_p2[32'd54];

assign tmp_V_4_fu_616_p2 = ($signed(sext_ln1265_fu_612_p1) + $signed(p_Val2_s_reg_252));

assign tmp_V_5_fu_640_p3 = ((p_Result_24_fu_628_p3[0:0] === 1'b1) ? tmp_V_fu_635_p2 : tmp_V_4_reg_1052);

assign tmp_V_fu_635_p2 = (14'd0 - tmp_V_4_reg_1052);
...
assign trunc_ln8_fu_918_p4 = {{m_2_fu_847_p2[52:1]}};

assign wc_fu_498_p2 = (wc_0_reg_287 + 2'd1);

assign wr_fu_424_p2 = (wr_0_reg_264 + 2'd1);

assign xor_ln899_fu_751_p2 = (tmp_958_fu_743_p3 ^ 1'd1);

assign zext_ln1116_1_fu_504_p1 = wc_0_reg_287;

assign zext_ln1116_2_fu_544_p1 = add_ln1116_1_fu_539_p2;

assign zext_ln1116_fu_438_p1 = tmp_909_fu_430_p3;

assign zext_ln1117_69_fu_478_p1 = tmp_911_fu_470_p3;

assign zext_ln1117_70_fu_555_p1 = add_ln23_1_fu_549_p2;

assign zext_ln1117_fu_466_p1 = tmp_910_fu_458_p3;

assign zext_ln18_fu_414_p1 = wr_0_reg_264;

assign zext_ln203_26_fu_370_p1 = tmp_955_fu_362_p3;

assign zext_ln203_27_fu_396_p1 = f_0_reg_241;

assign zext_ln203_28_fu_400_p1 = f_0_reg_241;

assign zext_ln203_29_fu_409_p1 = add_ln203_6_fu_404_p2;
...
assign zext_ln703_fu_592_p1 = $unsigned(sext_ln1118_1268_fu_577_p1);

assign zext_ln728_fu_588_p1 = lhs_V_fu_580_p3;

assign zext_ln897_fu_715_p1 = sub_ln897_fu_709_p2;

assign zext_ln907_16_fu_804_p1 = tmp_V_5_reg_1069;
...
always @ (posedge ap_clk) begin
    ...
    zext_ln203_27_reg_996[6:3] <= 4'b0000;
