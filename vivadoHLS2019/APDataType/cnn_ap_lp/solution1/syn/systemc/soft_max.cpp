...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_sdiv_22ns_14slbW_U26->start(grp_fu_249_ap_start);
    cnn_sdiv_22ns_14slbW_U26->done(grp_fu_249_ap_done);
    cnn_sdiv_22ns_14slbW_U26->din0(grp_fu_249_p0);
    cnn_sdiv_22ns_14slbW_U26->din1(grp_fu_249_p1);
    cnn_sdiv_22ns_14slbW_U26->ce(ap_var_for_const0);
    cnn_sdiv_22ns_14slbW_U26->dout(grp_fu_249_p2);
