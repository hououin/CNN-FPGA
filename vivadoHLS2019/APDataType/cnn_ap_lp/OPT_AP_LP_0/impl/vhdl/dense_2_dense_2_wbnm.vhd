...
entity dense_2_dense_2_wbnm_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 30
...
architecture rtl of dense_2_dense_2_wbnm_rom is 
...
entity dense_2_dense_2_wbnm is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of dense_2_dense_2_wbnm is
    component dense_2_dense_2_wbnm_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    dense_2_dense_2_wbnm_rom_U :  component dense_2_dense_2_wbnm_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
