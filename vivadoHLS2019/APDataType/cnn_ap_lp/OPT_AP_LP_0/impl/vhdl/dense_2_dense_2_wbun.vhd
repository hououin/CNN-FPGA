...
entity dense_2_dense_2_wbun_rom is 
    generic(
             DWIDTH     : integer := 9; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 30
...
architecture rtl of dense_2_dense_2_wbun_rom is 
...
entity dense_2_dense_2_wbun is
    generic (
        DataWidth : INTEGER := 9;
...
architecture arch of dense_2_dense_2_wbun is
    component dense_2_dense_2_wbun_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    dense_2_dense_2_wbun_rom_U :  component dense_2_dense_2_wbun_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
