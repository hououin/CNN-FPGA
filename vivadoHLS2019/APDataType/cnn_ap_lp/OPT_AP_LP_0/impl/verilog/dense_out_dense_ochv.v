...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module dense_out_dense_ochv_rom (
...
initial begin
    $readmemh("./dense_out_dense_ochv_rom.dat", ram0);
    $readmemh("./dense_out_dense_ochv_rom.dat", ram1);
    $readmemh("./dense_out_dense_ochv_rom.dat", ram2);
end
...
dense_out_dense_ochv_rom dense_out_dense_ochv_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
