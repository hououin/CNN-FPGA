...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_sdiv_22ns_14scgu_U2342 = new cnn_sdiv_22ns_14scgu<1,26,22,14,14>("cnn_sdiv_22ns_14scgu_U2342");
    cnn_sdiv_22ns_14scgu_U2342->clk(ap_clk);
    cnn_sdiv_22ns_14scgu_U2342->reset(ap_rst);
    cnn_sdiv_22ns_14scgu_U2342->din0(grp_fu_267_p0);
    cnn_sdiv_22ns_14scgu_U2342->din1(grp_fu_267_p1);
    cnn_sdiv_22ns_14scgu_U2342->ce(ap_var_for_const0);
    cnn_sdiv_22ns_14scgu_U2342->dout(grp_fu_267_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_sdiv_22ns_14scgu_U2342;
}
