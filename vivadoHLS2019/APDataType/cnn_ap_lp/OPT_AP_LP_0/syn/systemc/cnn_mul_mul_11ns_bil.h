...
// ==============================================================
#ifndef __cnn_mul_mul_11ns_bil__HH__
#define __cnn_mul_mul_11ns_bil__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_11ns_bil) {
    ...
    SC_CTOR(cnn_mul_mul_11ns_bil):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
