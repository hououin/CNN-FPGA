...
// ==============================================================
#ifndef __cnn_mac_muladd_9syd2__HH__
#define __cnn_mac_muladd_9syd2__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_9syd2) {
    ...
    SC_CTOR(cnn_mac_muladd_9syd2):  simcore_mac_5_U ("simcore_mac_5_U") {
