...
// ==============================================================
#ifndef __cnn_mac_muladd_4njbC__HH__
#define __cnn_mac_muladd_4njbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_4njbC) {
    ...
    SC_CTOR(cnn_mac_muladd_4njbC):  simcore_mac_2_U ("simcore_mac_2_U") {
