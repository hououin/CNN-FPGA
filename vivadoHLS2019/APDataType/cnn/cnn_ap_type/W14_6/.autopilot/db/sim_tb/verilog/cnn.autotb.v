...
`define AESL_BRAM_prediction_output AESL_autobram_prediction_output
`define AESL_BRAM_INST_prediction_output bram_inst_prediction_output
`define AUTOTB_TVIN_cnn_input  "./c.cnn.autotvin_cnn_input.dat"
`define AUTOTB_TVIN_prediction_output  "./c.cnn.autotvin_prediction_output.dat"
`define AUTOTB_TVIN_cnn_input_out_wrapc  "./rtl.cnn.autotvin_cnn_input.dat"
`define AUTOTB_TVIN_prediction_output_out_wrapc  "./rtl.cnn.autotvin_prediction_output.dat"
`define AUTOTB_TVOUT_prediction_output  "./c.cnn.autotvout_prediction_output.dat"
`define AUTOTB_TVOUT_prediction_output_out_wrapc  "./impl_rtl.cnn.autotvout_prediction_output.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 600;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 458988;
parameter LENGTH_cnn_input = 784;
parameter LENGTH_prediction_output = 10;
...
wire [31 : 0] prediction_output_ADDR_A;
wire  prediction_output_EN_A;
wire [3 : 0] prediction_output_WEN_A;
wire [31 : 0] prediction_output_DIN_A;
wire [31 : 0] prediction_output_DOUT_A;
wire  prediction_output_CLK_A;
wire  prediction_output_RST_A;
integer done_cnt = 0;
...
//------------------------bramprediction_output Instantiation--------------

// The input and output of bramprediction_output
wire  bramprediction_output_Clk_A, bramprediction_output_Clk_B;
wire  bramprediction_output_EN_A, bramprediction_output_EN_B;
wire  [4 - 1 : 0] bramprediction_output_WEN_A, bramprediction_output_WEN_B;
wire    [31 : 0]    bramprediction_output_Addr_A, bramprediction_output_Addr_B;
wire    [31 : 0]    bramprediction_output_Din_A, bramprediction_output_Din_B;
wire    [31 : 0]    bramprediction_output_Dout_A, bramprediction_output_Dout_B;
wire    bramprediction_output_ready;
wire    bramprediction_output_done;

`AESL_BRAM_prediction_output `AESL_BRAM_INST_prediction_output(
...
assign bramprediction_output_Clk_A = prediction_output_CLK_A;
assign bramprediction_output_Rst_A = prediction_output_RST_A;
assign bramprediction_output_Addr_A = prediction_output_ADDR_A;
assign bramprediction_output_EN_A = prediction_output_EN_A;
assign bramprediction_output_WEN_A = prediction_output_WEN_A;
assign bramprediction_output_Din_A = prediction_output_DIN_A;
assign bramprediction_output_WEN_B = 0;
assign bramprediction_output_Din_B = 0;
assign bramprediction_output_ready= ready_initial | bramprediction_output_done;
assign bramprediction_output_done =    AESL_done_delay;
...
reg end_cnn_input;
reg [31:0] size_cnn_input;
reg [31:0] size_cnn_input_backup;
reg end_prediction_output;
reg [31:0] size_prediction_output;
reg [31:0] size_prediction_output_backup;
...
reg dump_tvout_finish_prediction_output;

initial begin : dump_tvout_runtime_sign_prediction_output
    integer fp;
    dump_tvout_finish_prediction_output = 0;
    fp = $fopen(`AUTOTB_TVOUT_prediction_output_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_prediction_output_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    $fdisplay(fp,"[[[runtime]]]");
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_prediction_output_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_prediction_output_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    ...
    $fdisplay(fp,"[[[/runtime]]]");
    $fclose(fp);
    dump_tvout_finish_prediction_output = 1;
end
