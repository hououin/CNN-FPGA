...
// ==============================================================
#ifndef __cnn_sdiv_20ns_13slbW__HH__
#define __cnn_sdiv_20ns_13slbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_sdiv_20ns_13slbW) {
    ...
    ACMP_sdiv_seq<ID, 24, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_sdiv_seq_U;

    SC_CTOR(cnn_sdiv_20ns_13slbW):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
