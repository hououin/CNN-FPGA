...
// ==============================================================
#ifndef __cnn_mul_mul_9s_13hbi__HH__
#define __cnn_mul_mul_9s_13hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_9s_13hbi) {
    ...
    SC_CTOR(cnn_mul_mul_9s_13hbi):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
