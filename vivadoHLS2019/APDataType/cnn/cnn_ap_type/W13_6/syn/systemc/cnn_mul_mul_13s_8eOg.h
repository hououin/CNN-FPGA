...
// ==============================================================
#ifndef __cnn_mul_mul_13s_8eOg__HH__
#define __cnn_mul_mul_13s_8eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_13s_8eOg) {
    ...
    SC_CTOR(cnn_mul_mul_13s_8eOg):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
