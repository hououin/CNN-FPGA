...
set C_modelArgList {
	{ conv_out_V int 13 regular {array 4056 { 1 3 } 1 1 }  }
	{ max_pool_out_V int 13 regular {array 1014 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "conv_out_V", "interface" : "memory", "bitwidth" : 13, "direction" : "READONLY"} , 
 	{ "Name" : "max_pool_out_V", "interface" : "memory", "bitwidth" : 13, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ conv_out_V_q0 sc_in sc_lv 13 signal 0 } 
	...
	{ max_pool_out_V_d0 sc_out sc_lv 13 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv_out_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "conv_out_V", "role": "q0" }} , 
 	...
 	{ "name": "max_pool_out_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "max_pool_out_V", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	conv_out_V { ap_memory {  { conv_out_V_address0 mem_address 1 12 }  { conv_out_V_ce0 mem_ce 1 1 }  { conv_out_V_q0 mem_dout 0 13 } } }
	max_pool_out_V { ap_memory {  { max_pool_out_V_address0 mem_address 1 10 }  { max_pool_out_V_ce0 mem_ce 1 1 }  { max_pool_out_V_we0 mem_we 1 1 }  { max_pool_out_V_d0 mem_din 1 13 } } }
}
