...
set C_modelArgList {
	{ conv_out_V int 13 regular {array 1936 { 1 3 } 1 1 }  }
	{ max_pool_out_V int 13 regular {array 400 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	conv_out_V { ap_memory {  { conv_out_V_address0 mem_address 1 11 }  { conv_out_V_ce0 mem_ce 1 1 }  { conv_out_V_q0 mem_dout 0 13 } } }
	max_pool_out_V { ap_memory {  { max_pool_out_V_address0 mem_address 1 9 }  { max_pool_out_V_ce0 mem_ce 1 1 }  { max_pool_out_V_we0 mem_we 1 1 }  { max_pool_out_V_d0 mem_din 1 13 } } }
}
