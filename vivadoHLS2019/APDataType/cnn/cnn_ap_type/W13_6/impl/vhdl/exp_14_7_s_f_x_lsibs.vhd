...
entity exp_14_7_s_f_x_lsibs_rom is 
    generic(
             DWIDTH     : integer := 11; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of exp_14_7_s_f_x_lsibs_rom is 
...
entity exp_14_7_s_f_x_lsibs is
    generic (
...
architecture arch of exp_14_7_s_f_x_lsibs is
    component exp_14_7_s_f_x_lsibs_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    exp_14_7_s_f_x_lsibs_rom_U :  component exp_14_7_s_f_x_lsibs_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
