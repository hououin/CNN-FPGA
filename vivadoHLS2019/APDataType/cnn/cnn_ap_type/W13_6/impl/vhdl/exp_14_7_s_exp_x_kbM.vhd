...
entity exp_14_7_s_exp_x_kbM_rom is 
    generic(
             DWIDTH     : integer := 25; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of exp_14_7_s_exp_x_kbM_rom is 
...
entity exp_14_7_s_exp_x_kbM is
    generic (
...
architecture arch of exp_14_7_s_exp_x_kbM is
    component exp_14_7_s_exp_x_kbM_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    exp_14_7_s_exp_x_kbM_rom_U :  component exp_14_7_s_exp_x_kbM_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
