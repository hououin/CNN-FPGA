...
wire  signed [7:0] conv_1_weights_V_q0;
wire   [2:0] conv_1_bias_V_address0;
reg    conv_1_bias_V_ce0;
wire   [5:0] conv_1_bias_V_q0;
...
wire   [12:0] tmp_V_8_fu_616_p2;
reg   [12:0] tmp_V_8_reg_1052;
...
wire   [12:0] tmp_V_9_fu_640_p3;
reg   [12:0] tmp_V_9_reg_1069;
...
reg   [12:0] p_Val2_s_reg_252;
reg   [1:0] wr_0_reg_264;
reg   [12:0] p_Val2_26_reg_275;
reg   [1:0] wc_0_reg_287;
reg   [12:0] ap_phi_mux_storemerge_phi_fu_301_p4;
...
wire  signed [21:0] r_V_fu_950_p2;
wire   [19:0] lhs_V_fu_580_p3;
wire  signed [25:0] sext_ln1118_2_fu_577_p1;
wire   [26:0] zext_ln703_fu_592_p1;
wire   [26:0] zext_ln728_fu_588_p1;
wire   [26:0] ret_V_fu_596_p2;
wire  signed [12:0] sext_ln1265_fu_612_p1;
wire   [12:0] tmp_V_fu_635_p2;
reg   [12:0] p_Result_s_fu_647_p4;
...
wire   [12:0] zext_ln897_fu_715_p1;
wire   [12:0] lshr_ln897_fu_719_p2;
wire   [12:0] p_Result_29_fu_725_p2;
wire   [0:0] icmp_ln897_fu_699_p2;
wire   [0:0] icmp_ln897_2_fu_731_p2;
wire   [0:0] tmp_17_fu_743_p3;
wire   [12:0] trunc_ln894_fu_679_p1;
wire   [12:0] add_ln899_fu_757_p2;
...
cnn_mul_mul_13s_8eOg #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 13 ),
    .din1_WIDTH( 8 ),
    .dout_WIDTH( 22 ))
cnn_mul_mul_13s_8eOg_U2(
    .din0(input_V_q0),
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        p_Val2_26_reg_275 <= {{ret_V_fu_596_p2[19:7]}};
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        p_Result_32_reg_1064 <= tmp_V_8_reg_1052[32'd12];
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        if (((icmp_ln885_reg_1060 == 1'd0) & (1'd1 == and_ln924_fu_944_p2))) begin
            ...
            ap_phi_mux_storemerge_phi_fu_301_p4 = 13'd0;
        end else begin
...
assign add_ln899_fu_757_p2 = ($signed(13'd8139) + $signed(trunc_ln894_fu_679_p1));
...
assign icmp_ln885_fu_622_p2 = ((tmp_V_8_fu_616_p2 == 13'd0) ? 1'b1 : 1'b0);

assign icmp_ln897_2_fu_731_p2 = ((p_Result_29_fu_725_p2 != 13'd0) ? 1'b1 : 1'b0);
...
assign lhs_V_fu_580_p3 = {{p_Val2_26_reg_275}, {7'd0}};

assign lsb_index_fu_683_p2 = ($signed(32'd4294967243) + $signed(sub_ln894_fu_673_p2));

assign lshr_ln897_fu_719_p2 = 13'd8191 >> zext_ln897_fu_715_p1;
...
assign p_Result_32_fu_628_p3 = tmp_V_8_reg_1052[32'd12];

assign p_Result_33_fu_657_p3 = {{19'd524287}, {p_Result_s_fu_647_p4}};
...
always @ (tmp_V_9_fu_640_p3) begin
    for (ap_tvar_int_0 = 13 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 12 - 0) begin
            ...
            p_Result_s_fu_647_p4[ap_tvar_int_0] = tmp_V_9_fu_640_p3[12 - ap_tvar_int_0];
        end
    end
end
...
assign sub_ln894_fu_673_p2 = (32'd13 - l_fu_665_p3);

assign sub_ln897_fu_709_p2 = (4'd3 - trunc_ln897_fu_705_p1);
...
assign tmp_V_fu_635_p2 = (13'd0 - tmp_V_8_reg_1052);
...
assign trunc_ln894_fu_679_p1 = sub_ln894_fu_673_p2[12:0];
