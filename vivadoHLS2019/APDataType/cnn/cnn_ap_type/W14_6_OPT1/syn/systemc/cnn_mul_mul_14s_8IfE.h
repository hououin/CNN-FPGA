...
// ==============================================================
#ifndef __cnn_mul_mul_14s_8IfE__HH__
#define __cnn_mul_mul_14s_8IfE__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_14s_8IfE) {
    ...
    SC_CTOR(cnn_mul_mul_14s_8IfE):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
