...
// ==============================================================
#ifndef __cnn_mac_muladd_14ibs__HH__
#define __cnn_mac_muladd_14ibs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_14ibs) {
    ...
    SC_CTOR(cnn_mac_muladd_14ibs):  simcore_mac_4_U ("simcore_mac_4_U") {
