...
#include "cnn_mac_muladd_4nHfu.h"
#include "cnn_mul_mul_14s_8IfE.h"
#include "cnn_mul_mul_14s_9JfO.h"
#include "cnn_mul_mul_14s_1KfY.h"
...
#include "conv_2_conv_2_biaGfk.h"
...
struct conv_2 : public sc_module {
    ...
    conv_2_conv_2_weircU* conv_2_weights_V_0_3_U;
    conv_2_conv_2_weisc4* conv_2_weights_V_0_4_U;
    conv_2_conv_2_weitde* conv_2_weights_V_0_5_U;
    conv_2_conv_2_weiudo* conv_2_weights_V_1_0_U;
    conv_2_conv_2_weivdy* conv_2_weights_V_1_1_U;
    conv_2_conv_2_weiwdI* conv_2_weights_V_1_2_U;
    conv_2_conv_2_weixdS* conv_2_weights_V_1_3_U;
    conv_2_conv_2_weiyd2* conv_2_weights_V_1_4_U;
    conv_2_conv_2_weizec* conv_2_weights_V_1_5_U;
    conv_2_conv_2_weiAem* conv_2_weights_V_2_0_U;
    conv_2_conv_2_weiBew* conv_2_weights_V_2_1_U;
    conv_2_conv_2_weiCeG* conv_2_weights_V_2_2_U;
    conv_2_conv_2_weiDeQ* conv_2_weights_V_2_3_U;
    conv_2_conv_2_weiEe0* conv_2_weights_V_2_4_U;
    conv_2_conv_2_weiFfa* conv_2_weights_V_2_5_U;
    conv_2_conv_2_biaGfk* conv_2_bias_V_U;
    cnn_dcmp_64ns_64nbkb<1,2,64,64,1>* cnn_dcmp_64ns_64nbkb_U54;
    cnn_mac_muladd_4nHfu<1,1,4,5,4,8>* cnn_mac_muladd_4nHfu_U55;
    cnn_mul_mul_14s_8IfE<1,1,14,8,23>* cnn_mul_mul_14s_8IfE_U56;
    cnn_mul_mul_14s_9JfO<1,1,14,9,24>* cnn_mul_mul_14s_9JfO_U57;
    cnn_mul_mul_14s_8IfE<1,1,14,8,23>* cnn_mul_mul_14s_8IfE_U58;
    cnn_mul_mul_14s_9JfO<1,1,14,9,24>* cnn_mul_mul_14s_9JfO_U59;
    cnn_mul_mul_14s_9JfO<1,1,14,9,24>* cnn_mul_mul_14s_9JfO_U60;
    cnn_mul_mul_14s_9JfO<1,1,14,9,24>* cnn_mul_mul_14s_9JfO_U61;
    cnn_mul_mul_14s_8IfE<1,1,14,8,23>* cnn_mul_mul_14s_8IfE_U62;
    cnn_mul_mul_14s_9JfO<1,1,14,9,24>* cnn_mul_mul_14s_9JfO_U63;
    cnn_mul_mul_14s_8IfE<1,1,14,8,23>* cnn_mul_mul_14s_8IfE_U64;
    cnn_mul_mul_14s_8IfE<1,1,14,8,23>* cnn_mul_mul_14s_8IfE_U65;
    cnn_mul_mul_14s_1KfY<1,1,14,10,25>* cnn_mul_mul_14s_1KfY_U66;
    cnn_mul_mul_14s_8IfE<1,1,14,8,23>* cnn_mul_mul_14s_8IfE_U67;
    cnn_mul_mul_14s_8IfE<1,1,14,8,23>* cnn_mul_mul_14s_8IfE_U68;
    cnn_mul_mul_14s_9JfO<1,1,14,9,24>* cnn_mul_mul_14s_9JfO_U69;
    cnn_mul_mul_14s_8IfE<1,1,14,8,23>* cnn_mul_mul_14s_8IfE_U70;
    cnn_mul_mul_14s_9JfO<1,1,14,9,24>* cnn_mul_mul_14s_9JfO_U71;
    cnn_mul_mul_14s_9JfO<1,1,14,9,24>* cnn_mul_mul_14s_9JfO_U72;
    cnn_mul_mul_14s_9JfO<1,1,14,9,24>* cnn_mul_mul_14s_9JfO_U73;
    ...
    sc_signal< sc_lv<6> > tmp_s_fu_920_p3;
    ...
    sc_signal< sc_lv<12> > tmp_4_fu_2265_p3;
