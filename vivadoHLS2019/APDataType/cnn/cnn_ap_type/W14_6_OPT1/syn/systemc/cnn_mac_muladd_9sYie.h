...
// ==============================================================
#ifndef __cnn_mac_muladd_9sYie__HH__
#define __cnn_mac_muladd_9sYie__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_9sYie) {
    ...
    SC_CTOR(cnn_mac_muladd_9sYie):  simcore_mac_8_U ("simcore_mac_8_U") {
