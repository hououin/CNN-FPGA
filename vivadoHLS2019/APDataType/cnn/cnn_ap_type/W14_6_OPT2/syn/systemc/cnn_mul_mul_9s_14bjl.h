...
// ==============================================================
#ifndef __cnn_mul_mul_9s_14bjl__HH__
#define __cnn_mul_mul_9s_14bjl__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_9s_14bjl) {
    ...
    SC_CTOR(cnn_mul_mul_9s_14bjl):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
