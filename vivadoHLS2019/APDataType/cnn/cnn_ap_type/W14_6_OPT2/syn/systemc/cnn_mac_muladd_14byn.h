...
// ==============================================================
#ifndef __cnn_mac_muladd_14byn__HH__
#define __cnn_mac_muladd_14byn__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_14byn) {
    ...
    SC_CTOR(cnn_mac_muladd_14byn):  simcore_mac_8_U ("simcore_mac_8_U") {
