...
// ==============================================================
#ifndef __cnn_mac_muladd_13bAo__HH__
#define __cnn_mac_muladd_13bAo__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_13bAo) {
    ...
    SC_CTOR(cnn_mac_muladd_13bAo):  simcore_mac_10_U ("simcore_mac_10_U") {
