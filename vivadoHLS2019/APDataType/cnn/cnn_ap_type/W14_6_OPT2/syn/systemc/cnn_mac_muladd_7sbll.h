...
// ==============================================================
#ifndef __cnn_mac_muladd_7sbll__HH__
#define __cnn_mac_muladd_7sbll__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_7sbll) {
    ...
    SC_CTOR(cnn_mac_muladd_7sbll):  simcore_mac_6_U ("simcore_mac_6_U") {
