...
set C_modelArgList {
	...
	{ conv_out_V int 16 regular {array 4056 { 0 3 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cnn_mul_mul_16s_1eOg_U2", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	conv_out_V { ap_memory {  { conv_out_V_address0 mem_address 1 12 }  { conv_out_V_ce0 mem_ce 1 1 }  { conv_out_V_we0 mem_we 1 1 }  { conv_out_V_d0 mem_din 1 16 } } }
}
