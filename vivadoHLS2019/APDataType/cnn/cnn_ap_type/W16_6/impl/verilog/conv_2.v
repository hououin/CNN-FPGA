...
wire  signed [11:0] conv_2_weights_V_q0;
wire   [3:0] conv_2_bias_V_address0;
reg    conv_2_bias_V_ce0;
wire   [9:0] conv_2_bias_V_q0;
...
wire   [15:0] tmp_V_4_fu_681_p2;
reg   [15:0] tmp_V_4_reg_1135;
...
wire   [15:0] tmp_V_5_fu_705_p3;
reg   [15:0] tmp_V_5_reg_1152;
...
reg   [15:0] p_Val2_s_reg_260;
reg   [1:0] wr_0_reg_272;
reg   [15:0] w_sum_1_reg_283;
reg   [1:0] wc_0_reg_295;
reg   [15:0] p_Val2_19_reg_306;
reg   [2:0] ch_0_reg_318;
reg   [15:0] ap_phi_mux_storemerge_phi_fu_332_p4;
...
wire  signed [28:0] r_V_fu_1015_p2;
wire   [25:0] lhs_V_fu_645_p3;
wire  signed [31:0] sext_ln1118_1_fu_642_p1;
wire   [32:0] zext_ln728_fu_653_p1;
wire   [32:0] zext_ln703_fu_657_p1;
wire   [32:0] ret_V_fu_661_p2;
wire  signed [15:0] sext_ln1265_fu_677_p1;
wire   [15:0] tmp_V_fu_700_p2;
reg   [15:0] p_Result_s_fu_712_p4;
wire   [31:0] p_Result_25_fu_722_p3;
reg   [31:0] l_fu_730_p3;
wire   [31:0] lsb_index_fu_748_p2;
wire   [30:0] tmp_8_fu_754_p4;
wire   [4:0] trunc_ln897_fu_770_p1;
wire   [4:0] sub_ln897_fu_774_p2;
wire   [15:0] zext_ln897_fu_780_p1;
wire   [15:0] lshr_ln897_fu_784_p2;
wire   [15:0] p_Result_21_fu_790_p2;
wire   [0:0] icmp_ln897_fu_764_p2;
wire   [0:0] icmp_ln897_1_fu_796_p2;
wire   [0:0] tmp_10_fu_808_p3;
wire   [15:0] trunc_ln894_fu_744_p1;
wire   [15:0] add_ln899_fu_822_p2;
...
cnn_mul_mul_12s_1hbi #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 12 ),
    .din1_WIDTH( 16 ),
    .dout_WIDTH( 29 ))
cnn_mul_mul_12s_1hbi_U12(
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        p_Val2_19_reg_306 <= {{ret_V_fu_661_p2[25:10]}};
    end else if (((icmp_ln21_fu_493_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        ...
        p_Result_24_reg_1147 <= tmp_V_4_reg_1135[32'd15];
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        if (((icmp_ln885_reg_1143 == 1'd0) & (1'd1 == and_ln924_fu_1009_p2))) begin
            ...
            ap_phi_mux_storemerge_phi_fu_332_p4 = 16'd0;
        end else begin
...
assign add_ln899_fu_822_p2 = ($signed(16'd65483) + $signed(trunc_ln894_fu_744_p1));
...
assign icmp_ln885_fu_687_p2 = ((tmp_V_4_fu_681_p2 == 16'd0) ? 1'b1 : 1'b0);

assign icmp_ln897_1_fu_796_p2 = ((p_Result_21_fu_790_p2 != 16'd0) ? 1'b1 : 1'b0);
...
assign lhs_V_fu_645_p3 = {{p_Val2_19_reg_306}, {10'd0}};

assign lsb_index_fu_748_p2 = ($signed(32'd4294967243) + $signed(sub_ln894_fu_738_p2));

assign lshr_ln897_fu_784_p2 = 16'd65535 >> zext_ln897_fu_780_p1;
...
assign p_Result_24_fu_693_p3 = tmp_V_4_reg_1135[32'd15];

assign p_Result_25_fu_722_p3 = {{16'd65535}, {p_Result_s_fu_712_p4}};
...
always @ (tmp_V_5_fu_705_p3) begin
    for (ap_tvar_int_0 = 16 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 15 - 0) begin
            ...
            p_Result_s_fu_712_p4[ap_tvar_int_0] = tmp_V_5_fu_705_p3[15 - ap_tvar_int_0];
        end
    end
end
...
assign sub_ln894_fu_738_p2 = (32'd16 - l_fu_730_p3);

assign sub_ln897_fu_774_p2 = (5'd6 - trunc_ln897_fu_770_p1);
...
assign tmp_V_fu_700_p2 = (16'd0 - tmp_V_4_reg_1135);
...
assign trunc_ln894_fu_744_p1 = sub_ln894_fu_738_p2[15:0];

assign trunc_ln897_fu_770_p1 = sub_ln894_fu_738_p2[4:0];
