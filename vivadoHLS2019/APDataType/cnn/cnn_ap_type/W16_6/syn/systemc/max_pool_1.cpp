...
const sc_lv<16> max_pool_1::ap_const_lv16_0 = "0000000000000000";
...
void max_pool_1::thread_icmp_ln1494_fu_396_p2() {
    icmp_ln1494_fu_396_p2 = (!conv_out_V_q0.read().is_01() || !max_1_reg_164.read().is_01())? sc_lv<1>(): (sc_bigint<16>(conv_out_V_q0.read()) > sc_bigint<16>(max_1_reg_164.read()));
}
...
void max_pool_1::thread_select_ln29_fu_402_p3() {
    select_ln29_fu_402_p3 = (!icmp_ln1494_fu_396_p2.read()[0].is_01())? sc_lv<16>(): ((icmp_ln1494_fu_396_p2.read()[0].to_bool())? conv_out_V_q0.read(): max_1_reg_164.read());
}
