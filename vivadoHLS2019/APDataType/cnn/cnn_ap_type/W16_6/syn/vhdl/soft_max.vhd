...
architecture behav of soft_max is 
    ...
    signal rhs_V_fu_163_p1 : STD_LOGIC_VECTOR (16 downto 0);
    signal rhs_V_reg_270 : STD_LOGIC_VECTOR (16 downto 0);
    signal select_ln13_fu_173_p3 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal sext_ln27_fu_198_p1 : STD_LOGIC_VECTOR (25 downto 0);
    signal sext_ln27_reg_293 : STD_LOGIC_VECTOR (25 downto 0);
    signal p_Val2_4_fu_212_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal p_Val2_4_reg_298 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_CS_fsm_state7 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state7 : signal is "none";
    signal sum_V_fu_216_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal sum_V_reg_303 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal grp_exp_17_7_s_fu_135_ap_start : STD_LOGIC;
    signal grp_exp_17_7_s_fu_135_ap_done : STD_LOGIC;
    signal grp_exp_17_7_s_fu_135_ap_idle : STD_LOGIC;
    signal grp_exp_17_7_s_fu_135_ap_ready : STD_LOGIC;
    signal grp_exp_17_7_s_fu_135_x_V : STD_LOGIC_VECTOR (16 downto 0);
    signal grp_exp_17_7_s_fu_135_ap_return : STD_LOGIC_VECTOR (16 downto 0);
    signal p_Val2_1_reg_78 : STD_LOGIC_VECTOR (15 downto 0);
    signal m_0_reg_90 : STD_LOGIC_VECTOR (3 downto 0);
    signal p_Val2_3_reg_101 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal grp_exp_17_7_s_fu_135_ap_start_reg : STD_LOGIC := '0';
    ...
    signal lhs_V_fu_202_p0 : STD_LOGIC_VECTOR (15 downto 0);
    signal lhs_V_fu_202_p1 : STD_LOGIC_VECTOR (16 downto 0);
    ...
    component cnn_sdiv_26ns_16slbW IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    grp_exp_17_7_s_fu_135 : component exp_17_7_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_exp_17_7_s_fu_135_ap_start,
        ap_done => grp_exp_17_7_s_fu_135_ap_done,
        ap_idle => grp_exp_17_7_s_fu_135_ap_idle,
        ap_ready => grp_exp_17_7_s_fu_135_ap_ready,
        x_V => grp_exp_17_7_s_fu_135_x_V,
        ap_return => grp_exp_17_7_s_fu_135_ap_return);

    cnn_sdiv_26ns_16slbW_U26 : component cnn_sdiv_26ns_16slbW
    generic map (
        ID => 1,
        NUM_STAGE => 30,
        din0_WIDTH => 26,
    ...
    grp_exp_17_7_s_fu_135_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((grp_exp_17_7_s_fu_135_ap_ready = ap_const_logic_1)) then 
                    grp_exp_17_7_s_fu_135_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    grp_exp_17_7_s_fu_135_ap_start <= grp_exp_17_7_s_fu_135_ap_start_reg;
    grp_exp_17_7_s_fu_135_x_V <= std_logic_vector(signed(lhs_V_fu_202_p1) - signed(rhs_V_reg_270));
    ...
    grp_fu_247_p0 <= (dense_array_V_q0 & ap_const_lv10_0);
    grp_fu_247_p1 <= sext_ln27_reg_293(16 - 1 downto 0);
    ...
    lhs_V_fu_202_p0 <= dense_array_V_q0;
        lhs_V_fu_202_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(lhs_V_fu_202_p0),17));

    m_fu_152_p2 <= std_logic_vector(unsigned(m_0_reg_90) + unsigned(ap_const_lv4_1));
    p_Val2_4_fu_212_p1 <= grp_exp_17_7_s_fu_135_ap_return(16 - 1 downto 0);
    prediction_V_address0 <= zext_ln29_reg_316(4 - 1 downto 0);

    prediction_V_ce0_assign_proc : process(ap_CS_fsm_state39)
    begin
    ...
    prediction_V_d0 <= grp_fu_247_p2(16 - 1 downto 0);

    prediction_V_we0_assign_proc : process(ap_CS_fsm_state39)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state39)) then 
        ...
        rhs_V_fu_163_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(p_Val2_1_reg_78),17));

    select_ln13_fu_173_p3 <= 
        dense_array_V_q0 when (icmp_ln1495_fu_167_p2(0) = '1') else 
        p_Val2_1_reg_78;
        sext_ln27_fu_198_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(p_Val2_3_reg_101),26));
