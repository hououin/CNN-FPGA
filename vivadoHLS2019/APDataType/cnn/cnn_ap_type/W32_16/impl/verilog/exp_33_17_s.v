...
reg   [0:0] tmp_reg_917_pp0_iter2_reg;
reg   [6:0] p_Result_18_reg_923;
wire   [7:0] tmp_V_fu_509_p4;
reg   [7:0] tmp_V_reg_928;
wire   [4:0] tmp_V_1_fu_519_p1;
reg   [4:0] tmp_V_1_reg_933;
reg   [4:0] tmp_V_1_reg_933_pp0_iter1_reg;
wire   [0:0] or_ln281_8_fu_599_p2;
reg   [0:0] or_ln281_8_reg_948;
reg   [0:0] or_ln281_8_reg_948_pp0_iter1_reg;
reg   [0:0] or_ln281_8_reg_948_pp0_iter2_reg;
wire   [0:0] or_ln281_17_fu_653_p2;
reg   [0:0] or_ln281_17_reg_953;
reg   [0:0] or_ln281_17_reg_953_pp0_iter1_reg;
reg   [0:0] or_ln281_17_reg_953_pp0_iter2_reg;
reg   [31:0] f_x_msb_3_V_reg_958;
wire   [8:0] ret_V_fu_682_p2;
reg   [8:0] ret_V_reg_963;
wire   [40:0] trunc_ln612_2_fu_688_p1;
reg   [40:0] trunc_ln612_2_reg_969;
reg   [49:0] exp_x_msb_2_3_4_lsb_s_reg_980;
reg   [49:0] exp_x_msb_1_V_reg_985;
...
wire   [4:0] p_Result_30_fu_665_p4;
wire   [8:0] lhs_V_fu_675_p1;
wire   [8:0] rhs_V_fu_679_p1;
wire   [7:0] p_Result_29_fu_659_p3;
wire   [49:0] p_Result_31_fu_707_p3;
wire   [46:0] rhs_V_3_fu_697_p5;
wire   [46:0] r_V_4_fu_721_p0;
wire   [49:0] r_V_4_fu_721_p1;
wire   [96:0] r_V_4_fu_721_p2;
wire   [44:0] tmp_s_fu_727_p4;
wire   [55:0] rhs_V_1_fu_741_p4;
wire   [56:0] lhs_V_1_fu_737_p1;
wire   [56:0] zext_ln728_fu_749_p1;
wire   [56:0] zext_ln703_4_fu_759_p1;
wire   [56:0] ret_V_4_fu_753_p2;
wire   [56:0] ret_V_5_fu_763_p2;
wire   [49:0] r_V_5_fu_785_p0;
wire   [49:0] r_V_5_fu_785_p1;
wire   [99:0] r_V_5_fu_785_p2;
wire   [47:0] y_lo_s_V_fu_791_p4;
wire   [49:0] zext_ln703_fu_801_p1;
wire   [49:0] y_l_V_fu_805_p2;
wire   [0:0] xor_ln282_fu_820_p2;
wire   [0:0] or_ln281_18_fu_833_p2;
wire   [45:0] select_ln282_fu_825_p3;
wire   [45:0] y_V_fu_810_p4;
wire   [45:0] p_Val2_18_fu_837_p3;
wire   [1:0] tmp_4_fu_855_p4;
wire   [1:0] tmp_3_fu_845_p4;
wire   [1:0] or_ln456_fu_865_p2;
wire   [2:0] tmp_5_fu_877_p4;
wire   [0:0] icmp_ln456_1_fu_887_p2;
wire   [0:0] icmp_ln456_fu_871_p2;
wire   [0:0] or_ln456_1_fu_893_p2;
wire   [32:0] tmp_1_fu_899_p4;
reg   [0:0] ap_NS_fsm;
reg    ap_idle_pp0_0to2;
reg    ap_reset_idle_pp0;
wire    ap_enable_pp0;
wire   [96:0] r_V_4_fu_721_p00;
wire   [96:0] r_V_4_fu_721_p10;
wire   [99:0] r_V_5_fu_785_p00;
wire   [99:0] r_V_5_fu_785_p10;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        exp_x_msb_2_3_4_lsb_s_reg_980 <= {{ret_V_5_fu_763_p2[55:6]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        p_Result_18_reg_923 <= {{p_Result_18_fu_499_p1[19:13]}};
        ret_V_reg_963 <= ret_V_fu_682_p2;
        tmp_V_1_reg_933 <= tmp_V_1_fu_519_p1;
        tmp_V_1_reg_933_pp0_iter1_reg <= tmp_V_1_reg_933;
        tmp_V_reg_928 <= {{tmp_V_fu_509_p1[12:5]}};
        tmp_reg_917 <= tmp_fu_225_p1[32'd32];
...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b0 == ap_block_pp0_stage0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
assign ap_return = ((or_ln456_1_fu_893_p2[0:0] === 1'b1) ? 33'd4294967295 : tmp_1_fu_899_p4);

assign exp_x_msb_1_table_V_address0 = zext_ln544_2_fu_692_p1;
...
assign icmp_ln456_1_fu_887_p2 = ((tmp_5_fu_877_p4 != 3'd0) ? 1'b1 : 1'b0);

assign icmp_ln456_fu_871_p2 = ((or_ln456_fu_865_p2 != 2'd0) ? 1'b1 : 1'b0);

assign lhs_V_1_fu_737_p1 = tmp_s_fu_727_p4;

assign lhs_V_fu_675_p1 = p_Result_30_fu_665_p4;
...
assign or_ln281_18_fu_833_p2 = (or_ln281_8_reg_948_pp0_iter2_reg | or_ln281_17_reg_953_pp0_iter2_reg);
...
assign or_ln456_1_fu_893_p2 = (icmp_ln456_fu_871_p2 | icmp_ln456_1_fu_887_p2);

assign or_ln456_fu_865_p2 = (tmp_4_fu_855_p4 | tmp_3_fu_845_p4);
...
assign p_Result_29_fu_659_p3 = {{tmp_reg_917}, {p_Result_18_reg_923}};

assign p_Result_2_fu_261_p3 = x_l_V_fu_199_p1[32'd22];

assign p_Result_30_fu_665_p4 = {{f_x_msb_2_table_V_q0[45:41]}};

assign p_Result_31_fu_707_p3 = {{ret_V_reg_963}, {trunc_ln612_2_reg_969}};
...
assign p_Val2_18_fu_837_p3 = ((or_ln281_18_fu_833_p2[0:0] === 1'b1) ? select_ln282_fu_825_p3 : y_V_fu_810_p4);

assign r_V_4_fu_721_p0 = r_V_4_fu_721_p00;

assign r_V_4_fu_721_p00 = rhs_V_3_fu_697_p5;

assign r_V_4_fu_721_p1 = r_V_4_fu_721_p10;

assign r_V_4_fu_721_p10 = p_Result_31_fu_707_p3;

assign r_V_4_fu_721_p2 = (r_V_4_fu_721_p0 * r_V_4_fu_721_p1);

assign r_V_5_fu_785_p0 = r_V_5_fu_785_p00;

assign r_V_5_fu_785_p00 = exp_x_msb_1_V_reg_985;

assign r_V_5_fu_785_p1 = r_V_5_fu_785_p10;

assign r_V_5_fu_785_p10 = exp_x_msb_2_3_4_lsb_s_reg_980;

assign r_V_5_fu_785_p2 = (r_V_5_fu_785_p0 * r_V_5_fu_785_p1);

assign ret_V_4_fu_753_p2 = (lhs_V_1_fu_737_p1 + zext_ln728_fu_749_p1);

assign ret_V_5_fu_763_p2 = (zext_ln703_4_fu_759_p1 + ret_V_4_fu_753_p2);

assign ret_V_fu_682_p2 = (lhs_V_fu_675_p1 + rhs_V_fu_679_p1);

assign rhs_V_1_fu_741_p4 = {{{ret_V_reg_963}, {trunc_ln612_2_reg_969}}, {6'd0}};

assign rhs_V_3_fu_697_p5 = {{{{tmp_V_1_reg_933_pp0_iter1_reg}, {7'd0}}, {f_x_msb_3_V_reg_958}}, {3'd0}};

assign rhs_V_fu_679_p1 = tmp_V_reg_928;

assign select_ln282_fu_825_p3 = ((xor_ln282_fu_820_p2[0:0] === 1'b1) ? 46'd70368744177663 : 46'd0);

assign tmp_1_fu_899_p4 = {{p_Val2_18_fu_837_p3[39:7]}};

assign tmp_3_fu_845_p4 = {{p_Val2_18_fu_837_p3[45:44]}};

assign tmp_4_fu_855_p4 = {{p_Val2_18_fu_837_p3[43:42]}};

assign tmp_5_fu_877_p4 = {{p_Val2_18_fu_837_p3[41:39]}};
...
assign tmp_s_fu_727_p4 = {{r_V_4_fu_721_p2[96:52]}};

assign trunc_ln612_2_fu_688_p1 = f_x_msb_2_table_V_q0[40:0];
...
assign xor_ln282_fu_820_p2 = (tmp_reg_917_pp0_iter2_reg ^ 1'd1);

assign y_V_fu_810_p4 = {{y_l_V_fu_805_p2[49:4]}};

assign y_l_V_fu_805_p2 = (zext_ln703_fu_801_p1 + exp_x_msb_1_V_reg_985);

assign y_lo_s_V_fu_791_p4 = {{r_V_5_fu_785_p2[99:52]}};

assign zext_ln544_1_fu_528_p1 = tmp_V_fu_509_p4;

assign zext_ln544_2_fu_692_p1 = p_Result_29_fu_659_p3;

assign zext_ln544_fu_523_p1 = tmp_V_1_fu_519_p1;

assign zext_ln703_4_fu_759_p1 = rhs_V_3_fu_697_p5;

assign zext_ln703_fu_801_p1 = y_lo_s_V_fu_791_p4;

assign zext_ln728_fu_749_p1 = rhs_V_1_fu_741_p4;
