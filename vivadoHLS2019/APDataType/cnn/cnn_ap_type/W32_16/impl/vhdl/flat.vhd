...
architecture behav of flat is 
    ...
    signal add_ln203_fu_180_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln203_reg_271 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal tmp_15_cast_fu_213_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_15_cast_reg_289 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal r_0_reg_91 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal zext_ln203_9_fu_242_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln14_fu_247_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_s_fu_168_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal zext_ln203_fu_164_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal zext_ln203_6_fu_176_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal zext_ln203_7_fu_204_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln203_4_fu_208_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal zext_ln203_8_fu_233_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal add_ln203_5_fu_237_p2 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    r_0_reg_91_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln9_fu_186_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln9_fu_186_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                add_ln15_reg_284 <= add_ln15_fu_198_p2;
                    tmp_15_cast_reg_289(9 downto 4) <= tmp_15_cast_fu_213_p3(9 downto 4);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    tmp_15_cast_reg_289(3 downto 0) <= "0000";
    ...
    add_ln203_4_fu_208_p2 <= std_logic_vector(unsigned(zext_ln203_7_fu_204_p1) + unsigned(add_ln203_reg_271));
    add_ln203_5_fu_237_p2 <= std_logic_vector(unsigned(tmp_15_cast_reg_289) + unsigned(zext_ln203_8_fu_233_p1));
    add_ln203_fu_180_p2 <= std_logic_vector(unsigned(zext_ln203_fu_164_p1) + unsigned(zext_ln203_6_fu_176_p1));
    ...
    flat_array_V_address0 <= zext_ln14_fu_247_p1(9 - 1 downto 0);
    ...
    i_fu_158_p2 <= std_logic_vector(unsigned(i_0_reg_79) + unsigned(ap_const_lv9_50));
    icmp_ln12_fu_221_p2 <= "1" when (f_0_reg_135 = ap_const_lv5_10) else "0";
    icmp_ln6_fu_146_p2 <= "1" when (r_0_reg_91 = ap_const_lv3_5) else "0";
    icmp_ln9_fu_186_p2 <= "1" when (c_0_reg_113 = ap_const_lv3_5) else "0";
    max_pool_out_V_address0 <= zext_ln203_9_fu_242_p1(9 - 1 downto 0);
    ...
    r_fu_152_p2 <= std_logic_vector(unsigned(r_0_reg_91) + unsigned(ap_const_lv3_1));
    tmp_15_cast_fu_213_p3 <= (add_ln203_4_fu_208_p2 & ap_const_lv4_0);
    tmp_s_fu_168_p3 <= (r_0_reg_91 & ap_const_lv2_0);
    zext_ln14_fu_247_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_2_reg_124),64));
    zext_ln203_6_fu_176_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_168_p3),6));
    zext_ln203_7_fu_204_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(c_0_reg_113),6));
    zext_ln203_8_fu_233_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(f_0_reg_135),10));
    zext_ln203_9_fu_242_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln203_5_fu_237_p2),64));
    zext_ln203_fu_164_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(r_0_reg_91),6));
end behav;
