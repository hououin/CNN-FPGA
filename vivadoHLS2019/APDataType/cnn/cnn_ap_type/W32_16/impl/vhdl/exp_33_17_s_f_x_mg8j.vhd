...
entity exp_33_17_s_f_x_mg8j_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of exp_33_17_s_f_x_mg8j_rom is 
...
entity exp_33_17_s_f_x_mg8j is
    generic (
...
architecture arch of exp_33_17_s_f_x_mg8j is
    component exp_33_17_s_f_x_mg8j_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    exp_33_17_s_f_x_mg8j_rom_U :  component exp_33_17_s_f_x_mg8j_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
