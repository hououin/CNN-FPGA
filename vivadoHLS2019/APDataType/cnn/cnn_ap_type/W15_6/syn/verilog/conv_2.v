...
wire  signed [10:0] conv_2_weights_V_q0;
wire   [3:0] conv_2_bias_V_address0;
reg    conv_2_bias_V_ce0;
wire   [8:0] conv_2_bias_V_q0;
...
wire   [14:0] tmp_V_4_fu_683_p2;
reg   [14:0] tmp_V_4_reg_1137;
...
wire   [14:0] tmp_V_5_fu_707_p3;
reg   [14:0] tmp_V_5_reg_1154;
...
reg   [14:0] p_Val2_s_reg_262;
reg   [1:0] wr_0_reg_274;
reg   [14:0] w_sum_1_reg_285;
reg   [1:0] wc_0_reg_297;
reg   [14:0] p_Val2_19_reg_308;
reg   [2:0] ch_0_reg_320;
reg   [14:0] ap_phi_mux_storemerge_phi_fu_334_p4;
...
wire  signed [26:0] r_V_fu_1017_p2;
wire   [23:0] lhs_V_fu_647_p3;
wire  signed [29:0] sext_ln1118_1_fu_644_p1;
wire   [30:0] zext_ln728_fu_655_p1;
wire   [30:0] zext_ln703_fu_659_p1;
wire   [30:0] ret_V_fu_663_p2;
wire  signed [14:0] sext_ln1265_fu_679_p1;
wire   [14:0] tmp_V_fu_702_p2;
reg   [14:0] p_Result_s_fu_714_p4;
wire   [31:0] p_Result_25_fu_724_p3;
reg   [31:0] l_fu_732_p3;
wire   [31:0] lsb_index_fu_750_p2;
wire   [30:0] tmp_8_fu_756_p4;
wire   [3:0] trunc_ln897_fu_772_p1;
wire   [3:0] sub_ln897_fu_776_p2;
wire   [14:0] zext_ln897_fu_782_p1;
wire   [14:0] lshr_ln897_fu_786_p2;
wire   [14:0] p_Result_21_fu_792_p2;
wire   [0:0] icmp_ln897_fu_766_p2;
wire   [0:0] icmp_ln897_1_fu_798_p2;
wire   [0:0] tmp_10_fu_810_p3;
wire   [14:0] trunc_ln894_fu_746_p1;
wire   [14:0] add_ln899_fu_824_p2;
...
cnn_mul_mul_11s_1hbi #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 11 ),
    .din1_WIDTH( 15 ),
    .dout_WIDTH( 27 ))
cnn_mul_mul_11s_1hbi_U12(
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        p_Val2_19_reg_308 <= {{ret_V_fu_663_p2[23:9]}};
    end else if (((icmp_ln21_fu_495_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        ...
        p_Result_24_reg_1149 <= tmp_V_4_reg_1137[32'd14];
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        if (((icmp_ln885_reg_1145 == 1'd0) & (1'd1 == and_ln924_fu_1011_p2))) begin
            ...
            ap_phi_mux_storemerge_phi_fu_334_p4 = 15'd0;
        end else begin
...
assign add_ln899_fu_824_p2 = ($signed(15'd32715) + $signed(trunc_ln894_fu_746_p1));
...
assign icmp_ln885_fu_689_p2 = ((tmp_V_4_fu_683_p2 == 15'd0) ? 1'b1 : 1'b0);

assign icmp_ln897_1_fu_798_p2 = ((p_Result_21_fu_792_p2 != 15'd0) ? 1'b1 : 1'b0);

assign icmp_ln897_fu_766_p2 = (($signed(tmp_8_fu_756_p4) > $signed(31'd0)) ? 1'b1 : 1'b0);
...
assign lhs_V_fu_647_p3 = {{p_Val2_19_reg_308}, {9'd0}};

assign lsb_index_fu_750_p2 = ($signed(32'd4294967243) + $signed(sub_ln894_fu_740_p2));

assign lshr_ln897_fu_786_p2 = 15'd32767 >> zext_ln897_fu_782_p1;
...
assign p_Result_24_fu_695_p3 = tmp_V_4_reg_1137[32'd14];

assign p_Result_25_fu_724_p3 = {{17'd131071}, {p_Result_s_fu_714_p4}};
...
always @ (tmp_V_5_fu_707_p3) begin
    for (ap_tvar_int_0 = 15 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 14 - 0) begin
            ...
            p_Result_s_fu_714_p4[ap_tvar_int_0] = tmp_V_5_fu_707_p3[14 - ap_tvar_int_0];
        end
    end
end
...
assign select_ln915_fu_942_p3 = ((tmp_11_fu_934_p3[0:0] === 1'b1) ? 11'd1023 : 11'd1022);
...
assign sub_ln1116_1_fu_536_p2 = (p_shl_fu_520_p3 - tmp_12_fu_528_p3);
...
assign sub_ln894_fu_740_p2 = (32'd15 - l_fu_732_p3);

assign sub_ln897_fu_776_p2 = (4'd5 - trunc_ln897_fu_772_p1);

assign sub_ln908_fu_889_p2 = (32'd54 - sub_ln894_reg_1160);

assign sub_ln915_fu_950_p2 = (11'd6 - trunc_ln893_reg_1176);

assign tmp_10_fu_810_p3 = lsb_index_fu_750_p2[32'd31];

assign tmp_11_fu_934_p3 = m_2_fu_914_p2[32'd54];

assign tmp_12_fu_528_p3 = {{add_ln1116_fu_511_p2}, {1'd0}};

assign tmp_13_fu_565_p3 = {{add_ln1117_fu_552_p2}, {1'd0}};

assign tmp_25_cast_fu_608_p3 = {{add_ln1116_1_fu_603_p2}, {4'd0}};

assign tmp_4_fu_961_p3 = {{p_Result_24_reg_1149}, {add_ln915_fu_955_p2}};

assign tmp_5_fu_453_p3 = {{wr_0_reg_274}, {2'd0}};

assign tmp_6_fu_387_p3 = {{add_ln203_fu_381_p2}, {4'd0}};

assign tmp_8_fu_756_p4 = {{lsb_index_fu_750_p2[31:1]}};
...
assign tmp_V_fu_702_p2 = (15'd0 - tmp_V_4_reg_1137);
...
assign trunc_ln894_fu_746_p1 = sub_ln894_fu_740_p2[14:0];
...
assign xor_ln899_fu_818_p2 = (tmp_10_fu_810_p3 ^ 1'd1);

assign zext_ln1116_1_fu_461_p1 = tmp_5_fu_453_p3;
...
assign zext_ln1117_2_fu_573_p1 = tmp_13_fu_565_p3;
