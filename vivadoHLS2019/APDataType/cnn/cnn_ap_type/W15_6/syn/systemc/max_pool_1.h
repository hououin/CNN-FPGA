...
struct max_pool_1 : public sc_module {
    ...
    sc_signal< sc_lv<15> > select_ln29_fu_402_p3;
    ...
    sc_signal< sc_lv<15> > max_0_reg_140;
    sc_signal< sc_lv<2> > mpr_0_reg_153;
    sc_signal< sc_lv<15> > max_1_reg_164;
