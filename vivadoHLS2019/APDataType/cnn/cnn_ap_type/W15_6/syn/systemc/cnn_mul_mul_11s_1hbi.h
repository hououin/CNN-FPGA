...
// ==============================================================
#ifndef __cnn_mul_mul_11s_1hbi__HH__
#define __cnn_mul_mul_11s_1hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_11s_1hbi) {
    ...
    SC_CTOR(cnn_mul_mul_11s_1hbi):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
