...
wire  signed [9:0] conv_1_weights_V_q0;
wire   [2:0] conv_1_bias_V_address0;
reg    conv_1_bias_V_ce0;
wire   [7:0] conv_1_bias_V_q0;
...
wire   [14:0] tmp_V_8_fu_616_p2;
reg   [14:0] tmp_V_8_reg_1052;
...
wire   [14:0] tmp_V_9_fu_640_p3;
reg   [14:0] tmp_V_9_reg_1069;
...
reg   [14:0] p_Val2_s_reg_252;
reg   [1:0] wr_0_reg_264;
reg   [14:0] p_Val2_26_reg_275;
reg   [1:0] wc_0_reg_287;
reg   [14:0] ap_phi_mux_storemerge_phi_fu_301_p4;
...
wire  signed [25:0] r_V_fu_950_p2;
wire   [23:0] lhs_V_fu_580_p3;
wire  signed [29:0] sext_ln1118_2_fu_577_p1;
wire   [30:0] zext_ln703_fu_592_p1;
wire   [30:0] zext_ln728_fu_588_p1;
wire   [30:0] ret_V_fu_596_p2;
wire  signed [14:0] sext_ln1265_fu_612_p1;
wire   [14:0] tmp_V_fu_635_p2;
reg   [14:0] p_Result_s_fu_647_p4;
wire   [31:0] p_Result_33_fu_657_p3;
reg   [31:0] l_fu_665_p3;
wire   [31:0] lsb_index_fu_683_p2;
wire   [30:0] tmp_16_fu_689_p4;
wire   [3:0] trunc_ln897_fu_705_p1;
wire   [3:0] sub_ln897_fu_709_p2;
wire   [14:0] zext_ln897_fu_715_p1;
wire   [14:0] lshr_ln897_fu_719_p2;
wire   [14:0] p_Result_29_fu_725_p2;
wire   [0:0] icmp_ln897_fu_699_p2;
wire   [0:0] icmp_ln897_2_fu_731_p2;
wire   [0:0] tmp_17_fu_743_p3;
wire   [14:0] trunc_ln894_fu_679_p1;
wire   [14:0] add_ln899_fu_757_p2;
...
cnn_mul_mul_15s_1eOg #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 15 ),
    .din1_WIDTH( 10 ),
    .dout_WIDTH( 26 ))
cnn_mul_mul_15s_1eOg_U2(
    .din0(input_V_q0),
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        p_Val2_26_reg_275 <= {{ret_V_fu_596_p2[23:9]}};
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        p_Result_32_reg_1064 <= tmp_V_8_reg_1052[32'd14];
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        if (((icmp_ln885_reg_1060 == 1'd0) & (1'd1 == and_ln924_fu_944_p2))) begin
            ...
            ap_phi_mux_storemerge_phi_fu_301_p4 = 15'd0;
        end else begin
...
assign add_ln899_fu_757_p2 = ($signed(15'd32715) + $signed(trunc_ln894_fu_679_p1));
...
assign icmp_ln885_fu_622_p2 = ((tmp_V_8_fu_616_p2 == 15'd0) ? 1'b1 : 1'b0);

assign icmp_ln897_2_fu_731_p2 = ((p_Result_29_fu_725_p2 != 15'd0) ? 1'b1 : 1'b0);

assign icmp_ln897_fu_699_p2 = (($signed(tmp_16_fu_689_p4) > $signed(31'd0)) ? 1'b1 : 1'b0);
...
assign lhs_V_fu_580_p3 = {{p_Val2_26_reg_275}, {9'd0}};

assign lsb_index_fu_683_p2 = ($signed(32'd4294967243) + $signed(sub_ln894_fu_673_p2));

assign lshr_ln897_fu_719_p2 = 15'd32767 >> zext_ln897_fu_715_p1;
...
assign m_fu_801_p1 = tmp_V_9_reg_1069;
...
assign p_Result_29_fu_725_p2 = (tmp_V_9_fu_640_p3 & lshr_ln897_fu_719_p2);

assign p_Result_30_fu_763_p3 = tmp_V_9_fu_640_p3[add_ln899_fu_757_p2];

assign p_Result_32_fu_628_p3 = tmp_V_8_reg_1052[32'd14];

assign p_Result_33_fu_657_p3 = {{17'd131071}, {p_Result_s_fu_647_p4}};

assign p_Result_34_fu_901_p5 = {{tmp_8_fu_894_p3}, {m_11_fu_863_p1[51:0]}};

integer ap_tvar_int_0;

always @ (tmp_V_9_fu_640_p3) begin
    for (ap_tvar_int_0 = 15 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 14 - 0) begin
            ...
            p_Result_s_fu_647_p4[ap_tvar_int_0] = tmp_V_9_fu_640_p3[14 - ap_tvar_int_0];
        end
    end
end
...
assign select_ln915_fu_875_p3 = ((tmp_18_fu_867_p3[0:0] === 1'b1) ? 11'd1023 : 11'd1022);
...
assign sub_ln894_fu_673_p2 = (32'd15 - l_fu_665_p3);

assign sub_ln897_fu_709_p2 = (4'd5 - trunc_ln897_fu_705_p1);

assign sub_ln908_fu_822_p2 = (32'd54 - sub_ln894_reg_1075);

assign sub_ln915_fu_883_p2 = (11'd6 - trunc_ln893_reg_1091);

assign tmp_10_fu_470_p3 = {{add_ln23_fu_452_p2}, {2'd0}};

assign tmp_14_fu_362_p3 = {{add_ln203_fu_348_p2}, {1'd0}};

assign tmp_16_fu_689_p4 = {{lsb_index_fu_683_p2[31:1]}};

assign tmp_17_fu_743_p3 = lsb_index_fu_683_p2[32'd31];

assign tmp_18_fu_867_p3 = m_8_fu_847_p2[32'd54];

assign tmp_7_fu_430_p3 = {{wr_0_reg_264}, {2'd0}};

assign tmp_8_fu_894_p3 = {{p_Result_32_reg_1064}, {add_ln915_fu_888_p2}};

assign tmp_9_fu_458_p3 = {{add_ln23_fu_452_p2}, {5'd0}};

assign tmp_V_8_fu_616_p2 = ($signed(sext_ln1265_fu_612_p1) + $signed(p_Val2_s_reg_252));

assign tmp_V_9_fu_640_p3 = ((p_Result_32_fu_628_p3[0:0] === 1'b1) ? tmp_V_fu_635_p2 : tmp_V_8_reg_1052);

assign tmp_V_fu_635_p2 = (15'd0 - tmp_V_8_reg_1052);
...
assign trunc_ln894_fu_679_p1 = sub_ln894_fu_673_p2[14:0];
...
assign xor_ln899_fu_751_p2 = (tmp_17_fu_743_p3 ^ 1'd1);

assign zext_ln1116_6_fu_504_p1 = wc_0_reg_287;

assign zext_ln1116_7_fu_544_p1 = add_ln1116_3_fu_539_p2;

assign zext_ln1116_fu_438_p1 = tmp_7_fu_430_p3;

assign zext_ln1117_4_fu_478_p1 = tmp_10_fu_470_p3;

assign zext_ln1117_5_fu_555_p1 = add_ln23_1_fu_549_p2;

assign zext_ln1117_fu_466_p1 = tmp_9_fu_458_p3;

assign zext_ln18_fu_414_p1 = wr_0_reg_264;

assign zext_ln203_13_fu_370_p1 = tmp_14_fu_362_p3;
...
assign zext_ln907_2_fu_804_p1 = tmp_V_9_reg_1069;
