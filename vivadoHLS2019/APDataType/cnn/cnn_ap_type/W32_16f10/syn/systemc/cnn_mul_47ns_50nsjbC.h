...
// ==============================================================
#ifndef __cnn_mul_47ns_50nsjbC__HH__
#define __cnn_mul_47ns_50nsjbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_47ns_50nsjbC) {
    ...
    SC_CTOR(cnn_mul_47ns_50nsjbC):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
