...
// ==============================================================
#ifndef __cnn_mul_50ns_50nskbM__HH__
#define __cnn_mul_50ns_50nskbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_50ns_50nskbM) {
    ...
    SC_CTOR(cnn_mul_50ns_50nskbM):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
