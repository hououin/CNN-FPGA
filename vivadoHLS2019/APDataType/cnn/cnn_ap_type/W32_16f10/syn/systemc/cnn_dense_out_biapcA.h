...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(cnn_dense_out_biapcA_ram) {
        ram[0] = "0b0001110111000010";
        ram[1] = "0b0100110101010110";
        ram[2] = "0b1011111111111101";
        ram[3] = "0b1111010110101011";
        ram[4] = "0b1111101100011101";
        ram[5] = "0b0000000100001011";
        ram[6] = "0b1110000100011000";
        ram[7] = "0b1100100111010100";
        ram[8] = "0b0001010011011001";
        ram[9] = "0b0010001001000100";
