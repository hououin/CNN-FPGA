...
// ==============================================================
#ifndef __cnn_sdiv_48ns_32slbW__HH__
#define __cnn_sdiv_48ns_32slbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_sdiv_48ns_32slbW) {
    ...
    SC_CTOR(cnn_sdiv_48ns_32slbW):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
