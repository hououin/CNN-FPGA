...
set C_modelArgList {
	{ input_V int 32 regular {array 784 { 1 3 } 1 1 }  }
	{ conv_out_V int 32 regular {array 4056 { 0 3 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "192037", "EstimateLatencyMax" : "212317",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "192037", "Max" : "212317"}
	, {"Name" : "Interval", "Min" : "192037", "Max" : "212317"}
]}
...
set Spec2ImplPortList { 
	...
	conv_out_V { ap_memory {  { conv_out_V_address0 mem_address 1 12 }  { conv_out_V_ce0 mem_ce 1 1 }  { conv_out_V_we0 mem_we 1 1 }  { conv_out_V_d0 mem_din 1 32 } } }
}
