...
set C_modelArgList {
	{ conv_out_V int 14 regular {array 4056 { 1 1 } 1 1 }  }
	{ max_pool_out_0_V int 14 regular {array 169 { 0 3 } 0 1 }  }
	{ max_pool_out_1_V int 14 regular {array 169 { 0 3 } 0 1 }  }
	{ max_pool_out_2_V int 14 regular {array 169 { 0 3 } 0 1 }  }
	{ max_pool_out_3_V int 14 regular {array 169 { 0 3 } 0 1 }  }
	{ max_pool_out_4_V int 14 regular {array 169 { 0 3 } 0 1 }  }
	{ max_pool_out_5_V int 14 regular {array 169 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ conv_out_V_address1 sc_out sc_lv 12 signal 0 } 
	{ conv_out_V_ce1 sc_out sc_logic 1 signal 0 } 
	{ conv_out_V_q1 sc_in sc_lv 14 signal 0 } 
	{ max_pool_out_0_V_address0 sc_out sc_lv 8 signal 1 } 
	{ max_pool_out_0_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ max_pool_out_0_V_we0 sc_out sc_logic 1 signal 1 } 
	{ max_pool_out_0_V_d0 sc_out sc_lv 14 signal 1 } 
	{ max_pool_out_1_V_address0 sc_out sc_lv 8 signal 2 } 
	{ max_pool_out_1_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ max_pool_out_1_V_we0 sc_out sc_logic 1 signal 2 } 
	{ max_pool_out_1_V_d0 sc_out sc_lv 14 signal 2 } 
	{ max_pool_out_2_V_address0 sc_out sc_lv 8 signal 3 } 
	{ max_pool_out_2_V_ce0 sc_out sc_logic 1 signal 3 } 
	{ max_pool_out_2_V_we0 sc_out sc_logic 1 signal 3 } 
	{ max_pool_out_2_V_d0 sc_out sc_lv 14 signal 3 } 
	{ max_pool_out_3_V_address0 sc_out sc_lv 8 signal 4 } 
	{ max_pool_out_3_V_ce0 sc_out sc_logic 1 signal 4 } 
	{ max_pool_out_3_V_we0 sc_out sc_logic 1 signal 4 } 
	{ max_pool_out_3_V_d0 sc_out sc_lv 14 signal 4 } 
	{ max_pool_out_4_V_address0 sc_out sc_lv 8 signal 5 } 
	{ max_pool_out_4_V_ce0 sc_out sc_logic 1 signal 5 } 
	{ max_pool_out_4_V_we0 sc_out sc_logic 1 signal 5 } 
	{ max_pool_out_4_V_d0 sc_out sc_lv 14 signal 5 } 
	{ max_pool_out_5_V_address0 sc_out sc_lv 8 signal 6 } 
	{ max_pool_out_5_V_ce0 sc_out sc_logic 1 signal 6 } 
	{ max_pool_out_5_V_we0 sc_out sc_logic 1 signal 6 } 
	{ max_pool_out_5_V_d0 sc_out sc_lv 14 signal 6 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cnn_mac_muladd_5nocq_U78", "Parent" : "0"}]}
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "2031", "Max" : "2031"}
]}
...
set Spec2ImplPortList { 
	conv_out_V { ap_memory {  { conv_out_V_address0 mem_address 1 12 }  { conv_out_V_ce0 mem_ce 1 1 }  { conv_out_V_q0 mem_dout 0 14 }  { conv_out_V_address1 MemPortADDR2 1 12 }  { conv_out_V_ce1 MemPortCE2 1 1 }  { conv_out_V_q1 MemPortDOUT2 0 14 } } }
	max_pool_out_0_V { ap_memory {  { max_pool_out_0_V_address0 mem_address 1 8 }  { max_pool_out_0_V_ce0 mem_ce 1 1 }  { max_pool_out_0_V_we0 mem_we 1 1 }  { max_pool_out_0_V_d0 mem_din 1 14 } } }
	max_pool_out_1_V { ap_memory {  { max_pool_out_1_V_address0 mem_address 1 8 }  { max_pool_out_1_V_ce0 mem_ce 1 1 }  { max_pool_out_1_V_we0 mem_we 1 1 }  { max_pool_out_1_V_d0 mem_din 1 14 } } }
	max_pool_out_2_V { ap_memory {  { max_pool_out_2_V_address0 mem_address 1 8 }  { max_pool_out_2_V_ce0 mem_ce 1 1 }  { max_pool_out_2_V_we0 mem_we 1 1 }  { max_pool_out_2_V_d0 mem_din 1 14 } } }
	max_pool_out_3_V { ap_memory {  { max_pool_out_3_V_address0 mem_address 1 8 }  { max_pool_out_3_V_ce0 mem_ce 1 1 }  { max_pool_out_3_V_we0 mem_we 1 1 }  { max_pool_out_3_V_d0 mem_din 1 14 } } }
	max_pool_out_4_V { ap_memory {  { max_pool_out_4_V_address0 mem_address 1 8 }  { max_pool_out_4_V_ce0 mem_ce 1 1 }  { max_pool_out_4_V_we0 mem_we 1 1 }  { max_pool_out_4_V_d0 mem_din 1 14 } } }
	max_pool_out_5_V { ap_memory {  { max_pool_out_5_V_address0 mem_address 1 8 }  { max_pool_out_5_V_ce0 mem_ce 1 1 }  { max_pool_out_5_V_we0 mem_we 1 1 }  { max_pool_out_5_V_d0 mem_din 1 14 } } }
}
