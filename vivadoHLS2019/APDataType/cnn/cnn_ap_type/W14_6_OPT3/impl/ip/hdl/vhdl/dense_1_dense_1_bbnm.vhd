...
entity dense_1_dense_1_bbnm_rom is 
    generic(
             DWIDTH     : integer := 6; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 50
...
architecture rtl of dense_1_dense_1_bbnm_rom is 
...
entity dense_1_dense_1_bbnm is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of dense_1_dense_1_bbnm is
    component dense_1_dense_1_bbnm_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    dense_1_dense_1_bbnm_rom_U :  component dense_1_dense_1_bbnm_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
