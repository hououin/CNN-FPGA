...
// ==============================================================
#ifndef __cnn_mul_mul_14s_1bkl__HH__
#define __cnn_mul_mul_14s_1bkl__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_14s_1bkl) {
    ...
    SC_CTOR(cnn_mul_mul_14s_1bkl):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
