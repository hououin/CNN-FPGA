...
// ==============================================================
#ifndef __cnn_mac_muladd_7nbom__HH__
#define __cnn_mac_muladd_7nbom__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_7nbom) {
    ...
    SC_CTOR(cnn_mac_muladd_7nbom):  simcore_mac_8_U ("simcore_mac_8_U") {
