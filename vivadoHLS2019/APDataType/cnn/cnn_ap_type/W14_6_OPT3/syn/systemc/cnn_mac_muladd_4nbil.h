...
// ==============================================================
#ifndef __cnn_mac_muladd_4nbil__HH__
#define __cnn_mac_muladd_4nbil__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_4nbil) {
    ...
    SC_CTOR(cnn_mac_muladd_4nbil):  simcore_mac_6_U ("simcore_mac_6_U") {
