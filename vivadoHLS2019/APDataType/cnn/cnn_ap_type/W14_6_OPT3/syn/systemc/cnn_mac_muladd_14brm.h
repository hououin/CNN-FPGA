...
// ==============================================================
#ifndef __cnn_mac_muladd_14brm__HH__
#define __cnn_mac_muladd_14brm__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_14brm) {
    ...
    SC_CTOR(cnn_mac_muladd_14brm):  simcore_mac_11_U ("simcore_mac_11_U") {
