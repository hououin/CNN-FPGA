...
// ==============================================================
#ifndef __cnn_mac_muladd_9sbqm__HH__
#define __cnn_mac_muladd_9sbqm__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_9sbqm) {
    ...
    SC_CTOR(cnn_mac_muladd_9sbqm):  simcore_mac_10_U ("simcore_mac_10_U") {
