...
entity exp_13_7_s_exp_x_ibs_rom is 
    generic(
             DWIDTH     : integer := 25; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of exp_13_7_s_exp_x_ibs_rom is 
...
entity exp_13_7_s_exp_x_ibs is
    generic (
...
architecture arch of exp_13_7_s_exp_x_ibs is
    component exp_13_7_s_exp_x_ibs_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    exp_13_7_s_exp_x_ibs_rom_U :  component exp_13_7_s_exp_x_ibs_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
