...
// ==============================================================
#ifndef __cnn_sdiv_18ns_12skbM__HH__
#define __cnn_sdiv_18ns_12skbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_sdiv_18ns_12skbM) {
    ...
    SC_CTOR(cnn_sdiv_18ns_12skbM):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
