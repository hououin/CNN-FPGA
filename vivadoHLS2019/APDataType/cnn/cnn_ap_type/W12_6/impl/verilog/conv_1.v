...
wire  signed [6:0] conv_1_weights_V_q0;
wire   [2:0] conv_1_bias_V_address0;
reg    conv_1_bias_V_ce0;
wire   [4:0] conv_1_bias_V_q0;
...
wire   [6:0] zext_ln203_14_fu_396_p1;
reg   [6:0] zext_ln203_14_reg_996;
...
wire   [11:0] tmp_V_7_fu_616_p2;
reg   [11:0] tmp_V_7_reg_1052;
wire    ap_CS_fsm_state8;
wire   [0:0] icmp_ln885_fu_622_p2;
reg   [0:0] icmp_ln885_reg_1060;
wire   [0:0] p_Result_28_fu_628_p3;
reg   [0:0] p_Result_28_reg_1064;
wire    ap_CS_fsm_state9;
wire   [11:0] tmp_V_8_fu_640_p3;
reg   [11:0] tmp_V_8_reg_1069;
...
reg   [11:0] p_Val2_s_reg_252;
reg   [1:0] wr_0_reg_264;
reg   [11:0] p_Val2_21_reg_275;
reg   [1:0] wc_0_reg_287;
reg   [11:0] ap_phi_mux_storemerge_phi_fu_301_p4;
wire   [0:0] and_ln924_fu_944_p2;
wire   [63:0] zext_ln203_16_fu_409_p1;
wire   [63:0] zext_ln1116_7_fu_544_p1;
wire  signed [63:0] sext_ln1117_fu_564_p1;
wire   [63:0] grp_fu_309_p0;
wire   [9:0] zext_ln203_fu_344_p1;
wire   [9:0] add_ln203_fu_348_p2;
wire   [10:0] tmp_15_fu_362_p3;
wire   [12:0] p_shl_cast_fu_354_p3;
wire   [12:0] zext_ln203_13_fu_370_p1;
wire   [12:0] zext_ln203_15_fu_400_p1;
wire   [12:0] add_ln203_7_fu_404_p2;
wire   [3:0] tmp_6_fu_430_p3;
wire   [4:0] zext_ln1116_fu_438_p1;
wire   [4:0] zext_ln18_fu_414_p1;
wire   [4:0] sub_ln1116_fu_442_p2;
wire   [4:0] add_ln23_fu_452_p2;
wire   [9:0] tmp_8_fu_458_p3;
wire   [6:0] tmp_9_fu_470_p3;
wire   [10:0] zext_ln1117_fu_466_p1;
wire   [10:0] zext_ln1117_4_fu_478_p1;
wire   [5:0] zext_ln1116_6_fu_504_p1;
wire   [5:0] add_ln1116_fu_508_p2;
wire   [3:0] trunc_ln1116_fu_513_p1;
wire   [6:0] p_shl5_cast_fu_517_p3;
wire   [6:0] p_shl6_cast_fu_525_p3;
wire   [6:0] sub_ln1116_2_fu_533_p2;
wire   [6:0] add_ln1116_3_fu_539_p2;
wire   [4:0] zext_ln21_fu_488_p1;
wire   [4:0] add_ln23_1_fu_549_p2;
wire   [10:0] zext_ln1117_5_fu_555_p1;
wire   [10:0] add_ln1117_fu_559_p2;
wire  signed [19:0] r_V_fu_950_p2;
wire   [17:0] lhs_V_fu_580_p3;
wire  signed [23:0] sext_ln1118_2_fu_577_p1;
wire   [24:0] zext_ln703_fu_592_p1;
wire   [24:0] zext_ln728_fu_588_p1;
wire   [24:0] ret_V_fu_596_p2;
wire  signed [11:0] sext_ln1265_fu_612_p1;
wire   [11:0] tmp_V_fu_635_p2;
reg   [11:0] p_Result_s_fu_647_p4;
wire   [31:0] p_Result_29_fu_657_p3;
reg   [31:0] l_fu_665_p3;
wire   [31:0] lsb_index_fu_683_p2;
wire   [30:0] tmp_17_fu_689_p4;
wire   [3:0] trunc_ln897_fu_705_p1;
wire   [3:0] sub_ln897_fu_709_p2;
wire   [11:0] zext_ln897_fu_715_p1;
wire   [11:0] lshr_ln897_fu_719_p2;
wire   [11:0] p_Result_25_fu_725_p2;
wire   [0:0] icmp_ln897_fu_699_p2;
wire   [0:0] icmp_ln897_2_fu_731_p2;
wire   [0:0] tmp_18_fu_743_p3;
wire   [11:0] trunc_ln894_fu_679_p1;
wire   [11:0] add_ln899_fu_757_p2;
wire   [0:0] p_Result_26_fu_763_p3;
...
cnn_mul_mul_12s_7eOg #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 12 ),
    .din1_WIDTH( 7 ),
    .dout_WIDTH( 20 ))
cnn_mul_mul_12s_7eOg_U2(
    .din0(input_V_q0),
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        p_Val2_21_reg_275 <= {{ret_V_fu_596_p2[17:6]}};
...
always @ (posedge ap_clk) begin
    if (((icmp_ln14_fu_380_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        conv_out_V_addr_reg_1001 <= zext_ln203_16_fu_409_p1;
        zext_ln203_14_reg_996[2 : 0] <= zext_ln203_14_fu_396_p1[2 : 0];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        p_Result_28_reg_1064 <= tmp_V_7_reg_1052[32'd11];
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        if (((icmp_ln885_reg_1060 == 1'd0) & (1'd1 == and_ln924_fu_944_p2))) begin
            ...
            ap_phi_mux_storemerge_phi_fu_301_p4 = 12'd0;
        end else begin
...
assign add_ln1116_3_fu_539_p2 = (sub_ln1116_2_fu_533_p2 + zext_ln203_14_reg_996);

assign add_ln1116_fu_508_p2 = ($signed(sext_ln1116_reg_1014) + $signed(zext_ln1116_6_fu_504_p1));

assign add_ln1117_fu_559_p2 = (sub_ln1117_reg_1019 + zext_ln1117_5_fu_555_p1);

assign add_ln203_7_fu_404_p2 = (sub_ln203_reg_978 + zext_ln203_15_fu_400_p1);
...
assign add_ln899_fu_757_p2 = ($signed(12'd4043) + $signed(trunc_ln894_fu_679_p1));
...
assign and_ln899_fu_771_p2 = (xor_ln899_fu_751_p2 & p_Result_26_fu_763_p3);
...
assign conv_1_weights_V_address0 = zext_ln1116_7_fu_544_p1;
...
assign grp_fu_309_p0 = p_Result_30_fu_901_p5;
...
assign icmp_ln885_fu_622_p2 = ((tmp_V_7_fu_616_p2 == 12'd0) ? 1'b1 : 1'b0);

assign icmp_ln897_2_fu_731_p2 = ((p_Result_25_fu_725_p2 != 12'd0) ? 1'b1 : 1'b0);

assign icmp_ln897_fu_699_p2 = (($signed(tmp_17_fu_689_p4) > $signed(31'd0)) ? 1'b1 : 1'b0);
...
always @ (p_Result_29_fu_657_p3) begin
    if (p_Result_29_fu_657_p3[0] == 1'b1) begin
        l_fu_665_p3 = 32'd0;
    end else if (p_Result_29_fu_657_p3[1] == 1'b1) begin
        l_fu_665_p3 = 32'd1;
    end else if (p_Result_29_fu_657_p3[2] == 1'b1) begin
        l_fu_665_p3 = 32'd2;
    end else if (p_Result_29_fu_657_p3[3] == 1'b1) begin
        l_fu_665_p3 = 32'd3;
    end else if (p_Result_29_fu_657_p3[4] == 1'b1) begin
        l_fu_665_p3 = 32'd4;
    end else if (p_Result_29_fu_657_p3[5] == 1'b1) begin
        l_fu_665_p3 = 32'd5;
    end else if (p_Result_29_fu_657_p3[6] == 1'b1) begin
        l_fu_665_p3 = 32'd6;
    end else if (p_Result_29_fu_657_p3[7] == 1'b1) begin
        l_fu_665_p3 = 32'd7;
    end else if (p_Result_29_fu_657_p3[8] == 1'b1) begin
        l_fu_665_p3 = 32'd8;
    end else if (p_Result_29_fu_657_p3[9] == 1'b1) begin
        l_fu_665_p3 = 32'd9;
    end else if (p_Result_29_fu_657_p3[10] == 1'b1) begin
        l_fu_665_p3 = 32'd10;
    end else if (p_Result_29_fu_657_p3[11] == 1'b1) begin
        l_fu_665_p3 = 32'd11;
    end else if (p_Result_29_fu_657_p3[12] == 1'b1) begin
        l_fu_665_p3 = 32'd12;
    end else if (p_Result_29_fu_657_p3[13] == 1'b1) begin
        l_fu_665_p3 = 32'd13;
    end else if (p_Result_29_fu_657_p3[14] == 1'b1) begin
        l_fu_665_p3 = 32'd14;
    end else if (p_Result_29_fu_657_p3[15] == 1'b1) begin
        l_fu_665_p3 = 32'd15;
    end else if (p_Result_29_fu_657_p3[16] == 1'b1) begin
        l_fu_665_p3 = 32'd16;
    end else if (p_Result_29_fu_657_p3[17] == 1'b1) begin
        l_fu_665_p3 = 32'd17;
    end else if (p_Result_29_fu_657_p3[18] == 1'b1) begin
        l_fu_665_p3 = 32'd18;
    end else if (p_Result_29_fu_657_p3[19] == 1'b1) begin
        l_fu_665_p3 = 32'd19;
    end else if (p_Result_29_fu_657_p3[20] == 1'b1) begin
        l_fu_665_p3 = 32'd20;
    end else if (p_Result_29_fu_657_p3[21] == 1'b1) begin
        l_fu_665_p3 = 32'd21;
    end else if (p_Result_29_fu_657_p3[22] == 1'b1) begin
        l_fu_665_p3 = 32'd22;
    end else if (p_Result_29_fu_657_p3[23] == 1'b1) begin
        l_fu_665_p3 = 32'd23;
    end else if (p_Result_29_fu_657_p3[24] == 1'b1) begin
        l_fu_665_p3 = 32'd24;
    end else if (p_Result_29_fu_657_p3[25] == 1'b1) begin
        l_fu_665_p3 = 32'd25;
    end else if (p_Result_29_fu_657_p3[26] == 1'b1) begin
        l_fu_665_p3 = 32'd26;
    end else if (p_Result_29_fu_657_p3[27] == 1'b1) begin
        l_fu_665_p3 = 32'd27;
    end else if (p_Result_29_fu_657_p3[28] == 1'b1) begin
        l_fu_665_p3 = 32'd28;
    end else if (p_Result_29_fu_657_p3[29] == 1'b1) begin
        l_fu_665_p3 = 32'd29;
    end else if (p_Result_29_fu_657_p3[30] == 1'b1) begin
        l_fu_665_p3 = 32'd30;
    end else if (p_Result_29_fu_657_p3[31] == 1'b1) begin
        l_fu_665_p3 = 32'd31;
    end else begin
        l_fu_665_p3 = 32'd32;
    end
...
assign lhs_V_fu_580_p3 = {{p_Val2_21_reg_275}, {6'd0}};

assign lsb_index_fu_683_p2 = ($signed(32'd4294967243) + $signed(sub_ln894_fu_673_p2));

assign lshr_ln897_fu_719_p2 = 12'd4095 >> zext_ln897_fu_715_p1;
...
assign p_Result_25_fu_725_p2 = (tmp_V_8_fu_640_p3 & lshr_ln897_fu_719_p2);

assign p_Result_26_fu_763_p3 = tmp_V_8_fu_640_p3[add_ln899_fu_757_p2];

assign p_Result_28_fu_628_p3 = tmp_V_7_reg_1052[32'd11];

assign p_Result_29_fu_657_p3 = {{20'd1048575}, {p_Result_s_fu_647_p4}};

assign p_Result_30_fu_901_p5 = {{tmp_7_fu_894_p3}, {m_11_fu_863_p1[51:0]}};
...
always @ (tmp_V_8_fu_640_p3) begin
    for (ap_tvar_int_0 = 12 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 11 - 0) begin
            ...
            p_Result_s_fu_647_p4[ap_tvar_int_0] = tmp_V_8_fu_640_p3[11 - ap_tvar_int_0];
        end
    end
end
...
assign select_ln915_fu_875_p3 = ((tmp_19_fu_867_p3[0:0] === 1'b1) ? 11'd1023 : 11'd1022);

assign sext_ln1116_fu_448_p1 = $signed(sub_ln1116_fu_442_p2);

assign sext_ln1117_fu_564_p1 = $signed(add_ln1117_fu_559_p2);

assign sext_ln1118_2_fu_577_p1 = r_V_fu_950_p2;

assign sext_ln1265_fu_612_p1 = $signed(conv_1_bias_V_q0);

assign shl_ln908_fu_831_p2 = m_fu_801_p1 << zext_ln908_2_fu_827_p1;

assign sub_ln1116_2_fu_533_p2 = (p_shl5_cast_fu_517_p3 - p_shl6_cast_fu_525_p3);

assign sub_ln1116_fu_442_p2 = (zext_ln1116_fu_438_p1 - zext_ln18_fu_414_p1);

assign sub_ln1117_fu_482_p2 = (zext_ln1117_fu_466_p1 - zext_ln1117_4_fu_478_p1);

assign sub_ln203_fu_374_p2 = (p_shl_cast_fu_354_p3 - zext_ln203_13_fu_370_p1);

assign sub_ln894_fu_673_p2 = (32'd12 - l_fu_665_p3);

assign sub_ln897_fu_709_p2 = (4'd2 - trunc_ln897_fu_705_p1);

assign sub_ln908_fu_822_p2 = (32'd54 - sub_ln894_reg_1075);

assign sub_ln915_fu_883_p2 = (11'd6 - trunc_ln893_reg_1091);

assign tmp_15_fu_362_p3 = {{add_ln203_fu_348_p2}, {1'd0}};

assign tmp_17_fu_689_p4 = {{lsb_index_fu_683_p2[31:1]}};

assign tmp_18_fu_743_p3 = lsb_index_fu_683_p2[32'd31];

assign tmp_19_fu_867_p3 = m_8_fu_847_p2[32'd54];

assign tmp_6_fu_430_p3 = {{wr_0_reg_264}, {2'd0}};

assign tmp_7_fu_894_p3 = {{p_Result_28_reg_1064}, {add_ln915_fu_888_p2}};

assign tmp_8_fu_458_p3 = {{add_ln23_fu_452_p2}, {5'd0}};

assign tmp_9_fu_470_p3 = {{add_ln23_fu_452_p2}, {2'd0}};

assign tmp_V_7_fu_616_p2 = ($signed(sext_ln1265_fu_612_p1) + $signed(p_Val2_s_reg_252));

assign tmp_V_8_fu_640_p3 = ((p_Result_28_fu_628_p3[0:0] === 1'b1) ? tmp_V_fu_635_p2 : tmp_V_7_reg_1052);

assign tmp_V_fu_635_p2 = (12'd0 - tmp_V_7_reg_1052);
...
assign trunc_ln894_fu_679_p1 = sub_ln894_fu_673_p2[11:0];
...
assign xor_ln899_fu_751_p2 = (tmp_18_fu_743_p3 ^ 1'd1);

assign zext_ln1116_6_fu_504_p1 = wc_0_reg_287;

assign zext_ln1116_7_fu_544_p1 = add_ln1116_3_fu_539_p2;

assign zext_ln1116_fu_438_p1 = tmp_6_fu_430_p3;

assign zext_ln1117_4_fu_478_p1 = tmp_9_fu_470_p3;

assign zext_ln1117_5_fu_555_p1 = add_ln23_1_fu_549_p2;

assign zext_ln1117_fu_466_p1 = tmp_8_fu_458_p3;

assign zext_ln18_fu_414_p1 = wr_0_reg_264;

assign zext_ln203_13_fu_370_p1 = tmp_15_fu_362_p3;

assign zext_ln203_14_fu_396_p1 = f_0_reg_241;

assign zext_ln203_15_fu_400_p1 = f_0_reg_241;

assign zext_ln203_16_fu_409_p1 = add_ln203_7_fu_404_p2;
...
assign zext_ln703_fu_592_p1 = $unsigned(sext_ln1118_2_fu_577_p1);
...
always @ (posedge ap_clk) begin
    ...
    zext_ln203_14_reg_996[6:3] <= 4'b0000;
