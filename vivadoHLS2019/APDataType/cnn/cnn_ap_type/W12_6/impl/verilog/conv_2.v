...
wire  signed [7:0] conv_2_weights_V_q0;
wire   [3:0] conv_2_bias_V_address0;
reg    conv_2_bias_V_ce0;
wire   [5:0] conv_2_bias_V_q0;
...
wire   [11:0] tmp_V_3_fu_683_p2;
reg   [11:0] tmp_V_3_reg_1137;
wire    ap_CS_fsm_state9;
wire   [0:0] icmp_ln885_fu_689_p2;
reg   [0:0] icmp_ln885_reg_1145;
wire   [0:0] p_Result_20_fu_695_p3;
reg   [0:0] p_Result_20_reg_1149;
wire    ap_CS_fsm_state10;
wire   [11:0] tmp_V_4_fu_707_p3;
reg   [11:0] tmp_V_4_reg_1154;
...
reg   [11:0] p_Val2_s_reg_262;
reg   [1:0] wr_0_reg_274;
reg   [11:0] w_sum_1_reg_285;
reg   [1:0] wc_0_reg_297;
reg   [11:0] p_Val2_14_reg_308;
reg   [2:0] ch_0_reg_320;
reg   [11:0] ap_phi_mux_storemerge_phi_fu_334_p4;
wire   [0:0] and_ln924_fu_1011_p2;
wire   [63:0] zext_ln203_12_fu_428_p1;
wire   [63:0] zext_ln1116_5_fu_621_p1;
wire   [63:0] zext_ln1117_3_fu_631_p1;
wire   [63:0] grp_fu_342_p0;
wire   [6:0] zext_ln203_fu_377_p1;
wire   [6:0] add_ln203_fu_381_p2;
wire   [10:0] tmp_6_fu_387_p3;
wire   [11:0] zext_ln203_11_fu_419_p1;
wire   [11:0] add_ln203_6_fu_423_p2;
wire   [3:0] tmp_4_fu_453_p3;
wire   [4:0] zext_ln1116_1_fu_461_p1;
...
wire   [5:0] zext_ln1116_2_fu_507_p1;
wire   [5:0] add_ln1116_fu_511_p2;
wire   [3:0] trunc_ln1116_fu_516_p1;
wire   [6:0] p_shl_fu_520_p3;
wire   [6:0] tmp_13_fu_528_p3;
wire   [3:0] zext_ln21_fu_491_p1;
wire   [3:0] add_ln26_1_fu_542_p2;
wire   [7:0] zext_ln1117_1_fu_548_p1;
wire   [7:0] add_ln1117_fu_552_p2;
wire   [8:0] tmp_14_fu_565_p3;
wire   [10:0] p_shl1_cast_fu_557_p3;
wire   [10:0] zext_ln1117_2_fu_573_p1;
wire   [6:0] zext_ln1116_3_fu_595_p1;
wire   [6:0] add_ln1116_1_fu_603_p2;
wire   [10:0] tmp_25_cast_fu_608_p3;
wire   [10:0] add_ln1116_2_fu_616_p2;
wire   [10:0] zext_ln1116_4_fu_599_p1;
wire   [10:0] add_ln1117_1_fu_626_p2;
wire  signed [20:0] r_V_fu_1017_p2;
wire   [17:0] lhs_V_fu_647_p3;
wire  signed [23:0] sext_ln1118_1_fu_644_p1;
wire   [24:0] zext_ln728_fu_655_p1;
wire   [24:0] zext_ln703_fu_659_p1;
wire   [24:0] ret_V_fu_663_p2;
wire  signed [11:0] sext_ln1265_fu_679_p1;
wire   [11:0] tmp_V_fu_702_p2;
reg   [11:0] p_Result_s_fu_714_p4;
wire   [31:0] p_Result_21_fu_724_p3;
reg   [31:0] l_fu_732_p3;
wire   [31:0] lsb_index_fu_750_p2;
wire   [30:0] tmp_10_fu_756_p4;
wire   [3:0] trunc_ln897_fu_772_p1;
wire   [3:0] sub_ln897_fu_776_p2;
wire   [11:0] zext_ln897_fu_782_p1;
wire   [11:0] lshr_ln897_fu_786_p2;
wire   [11:0] p_Result_17_fu_792_p2;
wire   [0:0] icmp_ln897_fu_766_p2;
wire   [0:0] icmp_ln897_1_fu_798_p2;
wire   [0:0] tmp_11_fu_810_p3;
wire   [11:0] trunc_ln894_fu_746_p1;
wire   [11:0] add_ln899_fu_824_p2;
wire   [0:0] p_Result_18_fu_830_p3;
...
cnn_mul_mul_8s_12hbi #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 12 ),
    .dout_WIDTH( 21 ))
cnn_mul_mul_8s_12hbi_U12(
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        p_Val2_14_reg_308 <= {{ret_V_fu_663_p2[17:6]}};
    end else if (((icmp_ln21_fu_495_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        ...
        p_Result_20_reg_1149 <= tmp_V_3_reg_1137[32'd11];
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        if (((icmp_ln885_reg_1145 == 1'd0) & (1'd1 == and_ln924_fu_1011_p2))) begin
            ...
            ap_phi_mux_storemerge_phi_fu_334_p4 = 12'd0;
        end else begin
...
assign add_ln1116_1_fu_603_p2 = (zext_ln1116_3_fu_595_p1 + sub_ln1116_1_reg_1104);

assign add_ln1116_2_fu_616_p2 = (zext_ln203_10_reg_1063 + tmp_25_cast_fu_608_p3);

assign add_ln1116_fu_511_p2 = ($signed(zext_ln1116_2_fu_507_p1) + $signed(sext_ln1116_reg_1081));

assign add_ln1117_1_fu_626_p2 = (zext_ln1116_4_fu_599_p1 + sub_ln1117_reg_1109);

assign add_ln1117_fu_552_p2 = (zext_ln1117_1_fu_548_p1 + mul_ln1117_reg_1086);
...
assign add_ln899_fu_824_p2 = ($signed(12'd4043) + $signed(trunc_ln894_fu_746_p1));
...
assign and_ln899_fu_838_p2 = (xor_ln899_fu_818_p2 & p_Result_18_fu_830_p3);
...
assign conv_2_weights_V_address0 = zext_ln1116_5_fu_621_p1;
...
assign grp_fu_342_p0 = p_Result_22_fu_968_p5;
...
assign icmp_ln885_fu_689_p2 = ((tmp_V_3_fu_683_p2 == 12'd0) ? 1'b1 : 1'b0);

assign icmp_ln897_1_fu_798_p2 = ((p_Result_17_fu_792_p2 != 12'd0) ? 1'b1 : 1'b0);

assign icmp_ln897_fu_766_p2 = (($signed(tmp_10_fu_756_p4) > $signed(31'd0)) ? 1'b1 : 1'b0);
...
assign input_V_address0 = zext_ln1117_3_fu_631_p1;


always @ (p_Result_21_fu_724_p3) begin
    if (p_Result_21_fu_724_p3[0] == 1'b1) begin
        l_fu_732_p3 = 32'd0;
    end else if (p_Result_21_fu_724_p3[1] == 1'b1) begin
        l_fu_732_p3 = 32'd1;
    end else if (p_Result_21_fu_724_p3[2] == 1'b1) begin
        l_fu_732_p3 = 32'd2;
    end else if (p_Result_21_fu_724_p3[3] == 1'b1) begin
        l_fu_732_p3 = 32'd3;
    end else if (p_Result_21_fu_724_p3[4] == 1'b1) begin
        l_fu_732_p3 = 32'd4;
    end else if (p_Result_21_fu_724_p3[5] == 1'b1) begin
        l_fu_732_p3 = 32'd5;
    end else if (p_Result_21_fu_724_p3[6] == 1'b1) begin
        l_fu_732_p3 = 32'd6;
    end else if (p_Result_21_fu_724_p3[7] == 1'b1) begin
        l_fu_732_p3 = 32'd7;
    end else if (p_Result_21_fu_724_p3[8] == 1'b1) begin
        l_fu_732_p3 = 32'd8;
    end else if (p_Result_21_fu_724_p3[9] == 1'b1) begin
        l_fu_732_p3 = 32'd9;
    end else if (p_Result_21_fu_724_p3[10] == 1'b1) begin
        l_fu_732_p3 = 32'd10;
    end else if (p_Result_21_fu_724_p3[11] == 1'b1) begin
        l_fu_732_p3 = 32'd11;
    end else if (p_Result_21_fu_724_p3[12] == 1'b1) begin
        l_fu_732_p3 = 32'd12;
    end else if (p_Result_21_fu_724_p3[13] == 1'b1) begin
        l_fu_732_p3 = 32'd13;
    end else if (p_Result_21_fu_724_p3[14] == 1'b1) begin
        l_fu_732_p3 = 32'd14;
    end else if (p_Result_21_fu_724_p3[15] == 1'b1) begin
        l_fu_732_p3 = 32'd15;
    end else if (p_Result_21_fu_724_p3[16] == 1'b1) begin
        l_fu_732_p3 = 32'd16;
    end else if (p_Result_21_fu_724_p3[17] == 1'b1) begin
        l_fu_732_p3 = 32'd17;
    end else if (p_Result_21_fu_724_p3[18] == 1'b1) begin
        l_fu_732_p3 = 32'd18;
    end else if (p_Result_21_fu_724_p3[19] == 1'b1) begin
        l_fu_732_p3 = 32'd19;
    end else if (p_Result_21_fu_724_p3[20] == 1'b1) begin
        l_fu_732_p3 = 32'd20;
    end else if (p_Result_21_fu_724_p3[21] == 1'b1) begin
        l_fu_732_p3 = 32'd21;
    end else if (p_Result_21_fu_724_p3[22] == 1'b1) begin
        l_fu_732_p3 = 32'd22;
    end else if (p_Result_21_fu_724_p3[23] == 1'b1) begin
        l_fu_732_p3 = 32'd23;
    end else if (p_Result_21_fu_724_p3[24] == 1'b1) begin
        l_fu_732_p3 = 32'd24;
    end else if (p_Result_21_fu_724_p3[25] == 1'b1) begin
        l_fu_732_p3 = 32'd25;
    end else if (p_Result_21_fu_724_p3[26] == 1'b1) begin
        l_fu_732_p3 = 32'd26;
    end else if (p_Result_21_fu_724_p3[27] == 1'b1) begin
        l_fu_732_p3 = 32'd27;
    end else if (p_Result_21_fu_724_p3[28] == 1'b1) begin
        l_fu_732_p3 = 32'd28;
    end else if (p_Result_21_fu_724_p3[29] == 1'b1) begin
        l_fu_732_p3 = 32'd29;
    end else if (p_Result_21_fu_724_p3[30] == 1'b1) begin
        l_fu_732_p3 = 32'd30;
    end else if (p_Result_21_fu_724_p3[31] == 1'b1) begin
        l_fu_732_p3 = 32'd31;
    end else begin
        l_fu_732_p3 = 32'd32;
    end
...
assign lhs_V_fu_647_p3 = {{p_Val2_14_reg_308}, {6'd0}};

assign lsb_index_fu_750_p2 = ($signed(32'd4294967243) + $signed(sub_ln894_fu_740_p2));

assign lshr_ln897_fu_786_p2 = 12'd4095 >> zext_ln897_fu_782_p1;
...
assign m_fu_868_p1 = tmp_V_4_reg_1154;
...
assign p_Result_17_fu_792_p2 = (tmp_V_4_fu_707_p3 & lshr_ln897_fu_786_p2);

assign p_Result_18_fu_830_p3 = tmp_V_4_fu_707_p3[add_ln899_fu_824_p2];

assign p_Result_20_fu_695_p3 = tmp_V_3_reg_1137[32'd11];

assign p_Result_21_fu_724_p3 = {{20'd1048575}, {p_Result_s_fu_714_p4}};

assign p_Result_22_fu_968_p5 = {{tmp_3_fu_961_p3}, {m_6_fu_930_p1[51:0]}};

integer ap_tvar_int_0;

always @ (tmp_V_4_fu_707_p3) begin
    for (ap_tvar_int_0 = 12 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 11 - 0) begin
            ...
            p_Result_s_fu_714_p4[ap_tvar_int_0] = tmp_V_4_fu_707_p3[11 - ap_tvar_int_0];
        end
    end
end
...
assign select_ln915_fu_942_p3 = ((tmp_12_fu_934_p3[0:0] === 1'b1) ? 11'd1023 : 11'd1022);
...
assign sub_ln1116_1_fu_536_p2 = (p_shl_fu_520_p3 - tmp_13_fu_528_p3);

assign sub_ln1116_fu_465_p2 = (zext_ln1116_1_fu_461_p1 - zext_ln1116_fu_449_p1);

assign sub_ln1117_fu_577_p2 = (p_shl1_cast_fu_557_p3 - zext_ln1117_2_fu_573_p1);

assign sub_ln894_fu_740_p2 = (32'd12 - l_fu_732_p3);

assign sub_ln897_fu_776_p2 = (4'd2 - trunc_ln897_fu_772_p1);

assign sub_ln908_fu_889_p2 = (32'd54 - sub_ln894_reg_1160);

assign sub_ln915_fu_950_p2 = (11'd6 - trunc_ln893_reg_1176);

assign tmp_10_fu_756_p4 = {{lsb_index_fu_750_p2[31:1]}};

assign tmp_11_fu_810_p3 = lsb_index_fu_750_p2[32'd31];

assign tmp_12_fu_934_p3 = m_2_fu_914_p2[32'd54];

assign tmp_13_fu_528_p3 = {{add_ln1116_fu_511_p2}, {1'd0}};

assign tmp_14_fu_565_p3 = {{add_ln1117_fu_552_p2}, {1'd0}};

assign tmp_25_cast_fu_608_p3 = {{add_ln1116_1_fu_603_p2}, {4'd0}};

assign tmp_3_fu_961_p3 = {{p_Result_20_reg_1149}, {add_ln915_fu_955_p2}};

assign tmp_4_fu_453_p3 = {{wr_0_reg_274}, {2'd0}};

assign tmp_6_fu_387_p3 = {{add_ln203_fu_381_p2}, {4'd0}};

assign tmp_V_3_fu_683_p2 = ($signed(sext_ln1265_fu_679_p1) + $signed(p_Val2_s_reg_262));

assign tmp_V_4_fu_707_p3 = ((p_Result_20_fu_695_p3[0:0] === 1'b1) ? tmp_V_fu_702_p2 : tmp_V_3_reg_1137);

assign tmp_V_fu_702_p2 = (12'd0 - tmp_V_3_reg_1137);
...
assign trunc_ln894_fu_746_p1 = sub_ln894_fu_740_p2[11:0];
...
assign xor_ln899_fu_818_p2 = (tmp_11_fu_810_p3 ^ 1'd1);

assign zext_ln1116_1_fu_461_p1 = tmp_4_fu_453_p3;

assign zext_ln1116_2_fu_507_p1 = wc_0_reg_297;

assign zext_ln1116_3_fu_595_p1 = ch_0_reg_320;

assign zext_ln1116_4_fu_599_p1 = ch_0_reg_320;

assign zext_ln1116_5_fu_621_p1 = add_ln1116_2_fu_616_p2;

assign zext_ln1116_fu_449_p1 = wr_0_reg_274;

assign zext_ln1117_1_fu_548_p1 = add_ln26_1_fu_542_p2;

assign zext_ln1117_2_fu_573_p1 = tmp_14_fu_565_p3;

assign zext_ln1117_3_fu_631_p1 = add_ln1117_1_fu_626_p2;

assign zext_ln14_fu_395_p1 = tmp_6_fu_387_p3;
...
assign zext_ln907_1_fu_871_p1 = tmp_V_4_reg_1154;
