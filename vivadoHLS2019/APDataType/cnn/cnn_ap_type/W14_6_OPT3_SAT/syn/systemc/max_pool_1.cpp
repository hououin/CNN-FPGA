...
max_pool_1::max_pool_1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    cnn_mac_muladd_5nlbW_U75 = new cnn_mac_muladd_5nlbW<1,1,5,4,4,8>("cnn_mac_muladd_5nlbW_U75");
    cnn_mac_muladd_5nlbW_U75->din0(grp_fu_720_p0);
    cnn_mac_muladd_5nlbW_U75->din1(grp_fu_720_p1);
    cnn_mac_muladd_5nlbW_U75->din2(grp_fu_720_p2);
    cnn_mac_muladd_5nlbW_U75->dout(grp_fu_720_p3);
    ...
    SC_METHOD(thread_tmp_7_fu_504_p3);
    sensitive << ( add_ln1494_3_fu_490_p2 );
    ...
    sc_trace(mVcdFile, tmp_7_fu_504_p3, "tmp_7_fu_504_p3");
...
max_pool_1::~max_pool_1() {
    ...
    delete cnn_mac_muladd_5nlbW_U75;
}
...
void max_pool_1::thread_tmp_7_fu_504_p3() {
    tmp_7_fu_504_p3 = esl_concat<10,1>(add_ln1494_3_fu_490_p2.read(), ap_const_lv1_0);
}

void max_pool_1::thread_tmp_8_fu_551_p3() {
    tmp_8_fu_551_p3 = esl_concat<10,1>(add_ln1494_5_fu_538_p2.read(), ap_const_lv1_0);
}

void max_pool_1::thread_tmp_9_fu_594_p3() {
    tmp_9_fu_594_p3 = esl_concat<10,1>(add_ln1494_7_fu_580_p2.read(), ap_const_lv1_0);
}
...
void max_pool_1::thread_zext_ln1494_10_fu_559_p1() {
    zext_ln1494_10_fu_559_p1 = esl_zext<13,11>(tmp_8_fu_551_p3.read());
}
...
void max_pool_1::thread_zext_ln1494_12_fu_602_p1() {
    zext_ln1494_12_fu_602_p1 = esl_zext<13,11>(tmp_9_fu_594_p3.read());
}
...
void max_pool_1::thread_zext_ln1494_7_fu_512_p1() {
    zext_ln1494_7_fu_512_p1 = esl_zext<13,11>(tmp_7_fu_504_p3.read());
}
