...
// ==============================================================
#ifndef __cnn_mul_mul_8ns_1dEe__HH__
#define __cnn_mul_mul_8ns_1dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_8ns_1dEe) {
    ...
    SC_CTOR(cnn_mul_mul_8ns_1dEe):  ACMP_smul_us_U ("ACMP_smul_us_U") {
