...
// ==============================================================
#ifndef __cnn_mac_muladd_7nbll__HH__
#define __cnn_mac_muladd_7nbll__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_7nbll) {
    ...
    SC_CTOR(cnn_mac_muladd_7nbll):  simcore_mac_10_U ("simcore_mac_10_U") {
