...
// ==============================================================
#ifndef __cnn_mac_muladd_20jbC__HH__
#define __cnn_mac_muladd_20jbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_20jbC) {
    ...
    SC_CTOR(cnn_mac_muladd_20jbC):  simcore_mac_5_U ("simcore_mac_5_U") {
