...
// ==============================================================
#ifndef __cnn_mac_muladd_14bil__HH__
#define __cnn_mac_muladd_14bil__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_14bil) {
    ...
    SC_CTOR(cnn_mac_muladd_14bil):  simcore_mac_9_U ("simcore_mac_9_U") {
