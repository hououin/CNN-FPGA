...
// ==============================================================
#ifndef __cnn_mac_muladd_6sfYi__HH__
#define __cnn_mac_muladd_6sfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_6sfYi) {
    ...
    SC_CTOR(cnn_mac_muladd_6sfYi):  simcore_mac_1_U ("simcore_mac_1_U") {
