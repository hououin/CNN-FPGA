...
// ==============================================================
#ifndef __cnn_mul_mul_9s_13bwn__HH__
#define __cnn_mul_mul_9s_13bwn__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_9s_13bwn) {
    ...
    SC_CTOR(cnn_mul_mul_9s_13bwn):  ACMP_smul_su_U ("ACMP_smul_su_U") {
