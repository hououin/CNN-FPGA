...
// ==============================================================
#ifndef __dense_dense_out_wfYi_H__
#define __dense_dense_out_wfYi_H__
...
struct dense_dense_out_wfYi_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_dense_out_wfYi_ram) {
...
SC_MODULE(dense_dense_out_wfYi) {
...
dense_dense_out_wfYi_ram* meminst;


SC_CTOR(dense_dense_out_wfYi) {
meminst = new dense_dense_out_wfYi_ram("dense_dense_out_wfYi_ram");
