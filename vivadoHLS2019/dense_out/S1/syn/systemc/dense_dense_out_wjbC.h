...
// ==============================================================
#ifndef __dense_dense_out_wjbC_H__
#define __dense_dense_out_wjbC_H__
...
struct dense_dense_out_wjbC_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_dense_out_wjbC_ram) {
...
SC_MODULE(dense_dense_out_wjbC) {
...
dense_dense_out_wjbC_ram* meminst;


SC_CTOR(dense_dense_out_wjbC) {
meminst = new dense_dense_out_wjbC_ram("dense_dense_out_wjbC_ram");
