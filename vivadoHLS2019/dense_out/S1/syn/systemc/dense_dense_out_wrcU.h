...
// ==============================================================
#ifndef __dense_dense_out_wrcU_H__
#define __dense_dense_out_wrcU_H__
...
struct dense_dense_out_wrcU_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_dense_out_wrcU_ram) {
...
SC_MODULE(dense_dense_out_wrcU) {
...
dense_dense_out_wrcU_ram* meminst;


SC_CTOR(dense_dense_out_wrcU) {
meminst = new dense_dense_out_wrcU_ram("dense_dense_out_wrcU_ram");
