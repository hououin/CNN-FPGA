...
// ==============================================================
#ifndef __dense_dense_out_whbi_H__
#define __dense_dense_out_whbi_H__
...
struct dense_dense_out_whbi_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_dense_out_whbi_ram) {
...
SC_MODULE(dense_dense_out_whbi) {
...
dense_dense_out_whbi_ram* meminst;


SC_CTOR(dense_dense_out_whbi) {
meminst = new dense_dense_out_whbi_ram("dense_dense_out_whbi_ram");
