...
// ==============================================================
#ifndef __dense_dense_out_wEe0_H__
#define __dense_dense_out_wEe0_H__
...
struct dense_dense_out_wEe0_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_dense_out_wEe0_ram) {
...
SC_MODULE(dense_dense_out_wEe0) {
...
dense_dense_out_wEe0_ram* meminst;


SC_CTOR(dense_dense_out_wEe0) {
meminst = new dense_dense_out_wEe0_ram("dense_dense_out_wEe0_ram");
