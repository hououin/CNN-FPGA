...
// ==============================================================
#ifndef __dense_dense_out_wDeQ_H__
#define __dense_dense_out_wDeQ_H__
...
struct dense_dense_out_wDeQ_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_dense_out_wDeQ_ram) {
...
SC_MODULE(dense_dense_out_wDeQ) {
...
dense_dense_out_wDeQ_ram* meminst;


SC_CTOR(dense_dense_out_wDeQ) {
meminst = new dense_dense_out_wDeQ_ram("dense_dense_out_wDeQ_ram");
