...
// ==============================================================
#ifndef __dense_dense_out_wtde_H__
#define __dense_dense_out_wtde_H__
...
struct dense_dense_out_wtde_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_dense_out_wtde_ram) {
...
SC_MODULE(dense_dense_out_wtde) {
...
dense_dense_out_wtde_ram* meminst;


SC_CTOR(dense_dense_out_wtde) {
meminst = new dense_dense_out_wtde_ram("dense_dense_out_wtde_ram");
