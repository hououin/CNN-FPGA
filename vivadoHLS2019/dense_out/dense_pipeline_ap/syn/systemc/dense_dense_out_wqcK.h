...
// ==============================================================
#ifndef __dense_dense_out_wqcK_H__
#define __dense_dense_out_wqcK_H__
...
struct dense_dense_out_wqcK_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_dense_out_wqcK_ram) {
...
SC_MODULE(dense_dense_out_wqcK) {
...
dense_dense_out_wqcK_ram* meminst;


SC_CTOR(dense_dense_out_wqcK) {
meminst = new dense_dense_out_wqcK_ram("dense_dense_out_wqcK_ram");
