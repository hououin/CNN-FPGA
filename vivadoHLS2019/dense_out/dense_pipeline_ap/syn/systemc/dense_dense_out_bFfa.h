...
// ==============================================================
#ifndef __dense_dense_out_bFfa_H__
#define __dense_dense_out_bFfa_H__
...
struct dense_dense_out_bFfa_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_dense_out_bFfa_ram) {
...
SC_MODULE(dense_dense_out_bFfa) {
...
dense_dense_out_bFfa_ram* meminst;


SC_CTOR(dense_dense_out_bFfa) {
meminst = new dense_dense_out_bFfa_ram("dense_dense_out_bFfa_ram");
