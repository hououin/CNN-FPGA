...
// ==============================================================
#ifndef __dense_dense_out_wlbW_H__
#define __dense_dense_out_wlbW_H__
...
struct dense_dense_out_wlbW_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_dense_out_wlbW_ram) {
...
SC_MODULE(dense_dense_out_wlbW) {
...
dense_dense_out_wlbW_ram* meminst;


SC_CTOR(dense_dense_out_wlbW) {
meminst = new dense_dense_out_wlbW_ram("dense_dense_out_wlbW_ram");
