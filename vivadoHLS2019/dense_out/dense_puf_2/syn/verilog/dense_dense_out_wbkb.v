...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module dense_dense_out_wbkb_rom (
...
initial begin
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram0);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram1);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram2);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram3);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram4);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram5);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram6);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram7);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram8);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram9);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram10);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram11);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram12);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram13);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram14);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram15);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram16);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram17);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram18);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram19);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram20);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram21);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram22);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram23);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram24);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram25);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram26);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram27);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram28);
    $readmemh("./dense_dense_out_wbkb_rom.dat", ram29);
end
...
dense_dense_out_wbkb_rom dense_dense_out_wbkb_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
