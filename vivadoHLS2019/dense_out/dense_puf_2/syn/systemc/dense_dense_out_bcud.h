...
// ==============================================================
#ifndef __dense_dense_out_bcud_H__
#define __dense_dense_out_bcud_H__
...
struct dense_dense_out_bcud_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_dense_out_bcud_ram) {
...
SC_MODULE(dense_dense_out_bcud) {
...
dense_dense_out_bcud_ram* meminst;


SC_CTOR(dense_dense_out_bcud) {
meminst = new dense_dense_out_bcud_ram("dense_dense_out_bcud_ram");
