...
// ==============================================================
#ifndef __dense_dense_out_wCeG_H__
#define __dense_dense_out_wCeG_H__
...
struct dense_dense_out_wCeG_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_dense_out_wCeG_ram) {
...
SC_MODULE(dense_dense_out_wCeG) {
...
dense_dense_out_wCeG_ram* meminst;


SC_CTOR(dense_dense_out_wCeG) {
meminst = new dense_dense_out_wCeG_ram("dense_dense_out_wCeG_ram");
