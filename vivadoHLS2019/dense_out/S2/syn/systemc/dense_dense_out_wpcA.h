...
// ==============================================================
#ifndef __dense_dense_out_wpcA_H__
#define __dense_dense_out_wpcA_H__
...
struct dense_dense_out_wpcA_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_dense_out_wpcA_ram) {
...
SC_MODULE(dense_dense_out_wpcA) {
...
dense_dense_out_wpcA_ram* meminst;


SC_CTOR(dense_dense_out_wpcA) {
meminst = new dense_dense_out_wpcA_ram("dense_dense_out_wpcA_ram");
