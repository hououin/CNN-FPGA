...
// ==============================================================
#ifndef __dense_dense_out_wudo_H__
#define __dense_dense_out_wudo_H__
...
struct dense_dense_out_wudo_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_dense_out_wudo_ram) {
...
SC_MODULE(dense_dense_out_wudo) {
...
dense_dense_out_wudo_ram* meminst;


SC_CTOR(dense_dense_out_wudo) {
meminst = new dense_dense_out_wudo_ram("dense_dense_out_wudo_ram");
