...
// ==============================================================
#ifndef __dense_dense_out_weOg_H__
#define __dense_dense_out_weOg_H__
...
struct dense_dense_out_weOg_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_dense_out_weOg_ram) {
...
SC_MODULE(dense_dense_out_weOg) {
...
dense_dense_out_weOg_ram* meminst;


SC_CTOR(dense_dense_out_weOg) {
meminst = new dense_dense_out_weOg_ram("dense_dense_out_weOg_ram");
