...
// ==============================================================
#ifndef __dense_dense_out_wibs_H__
#define __dense_dense_out_wibs_H__
...
struct dense_dense_out_wibs_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_dense_out_wibs_ram) {
...
SC_MODULE(dense_dense_out_wibs) {
...
dense_dense_out_wibs_ram* meminst;


SC_CTOR(dense_dense_out_wibs) {
meminst = new dense_dense_out_wibs_ram("dense_dense_out_wibs_ram");
