...
// ==============================================================
#ifndef __dense_dense_out_bbkb_H__
#define __dense_dense_out_bbkb_H__
...
struct dense_dense_out_bbkb_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_dense_out_bbkb_ram) {
...
SC_MODULE(dense_dense_out_bbkb) {
...
dense_dense_out_bbkb_ram* meminst;


SC_CTOR(dense_dense_out_bbkb) {
meminst = new dense_dense_out_bbkb_ram("dense_dense_out_bbkb_ram");
