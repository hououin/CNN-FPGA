...
set C_modelArgList {
	{ max_pool_out float 32 regular {array 400 { 1 1 } 1 1 }  }
	{ flat_array float 32 regular {array 400 { 0 0 } 0 1 }  }
}
...
set portList { 
	...
	{ max_pool_out_q1 sc_in sc_lv 32 signal 0 } 
	...
	{ flat_array_address1 sc_out sc_lv 9 signal 1 } 
	{ flat_array_ce1 sc_out sc_logic 1 signal 1 } 
	{ flat_array_we1 sc_out sc_logic 1 signal 1 } 
	{ flat_array_d1 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "max_pool_out_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "max_pool_out", "role": "q1" }} , 
...
set ArgLastReadFirstWriteLatency {
	flat {
		max_pool_out {Type I LastRead 41 FirstWrite -1}
...
set Spec2ImplPortList { 
	max_pool_out { ap_memory {  { max_pool_out_address0 mem_address 1 9 }  { max_pool_out_ce0 mem_ce 1 1 }  { max_pool_out_q0 mem_dout 0 32 }  { max_pool_out_address1 MemPortADDR2 1 9 }  { max_pool_out_ce1 MemPortCE2 1 1 }  { max_pool_out_q1 MemPortDOUT2 0 32 } } }
	flat_array { ap_memory {  { flat_array_address0 mem_address 1 9 }  { flat_array_ce0 mem_ce 1 1 }  { flat_array_we0 mem_we 1 1 }  { flat_array_d0 mem_din 1 32 }  { flat_array_address1 MemPortADDR2 1 9 }  { flat_array_ce1 MemPortCE2 1 1 }  { flat_array_we1 MemPortWE2 1 1 }  { flat_array_d1 MemPortDIN2 1 32 } } }
}
