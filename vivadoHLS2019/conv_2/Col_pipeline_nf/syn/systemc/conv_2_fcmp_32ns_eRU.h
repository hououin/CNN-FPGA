...
// ==============================================================
#ifndef __conv_2_fcmp_32ns_eRU__HH__
#define __conv_2_fcmp_32ns_eRU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_2_fcmp_32ns_eRU) {
    ...
    SC_CTOR(conv_2_fcmp_32ns_eRU):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
