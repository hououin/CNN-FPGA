...
// ==============================================================
#ifndef __conv_2_mac_muladdfYi__HH__
#define __conv_2_mac_muladdfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_2_mac_muladdfYi) {
    ...
    SC_CTOR(conv_2_mac_muladdfYi):  simcore_mac_0_U ("simcore_mac_0_U") {
