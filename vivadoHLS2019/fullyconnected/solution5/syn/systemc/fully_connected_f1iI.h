...
// ==============================================================
#ifndef __fully_connected_f1iI__HH__
#define __fully_connected_f1iI__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fully_connected_f1iI) {
    ...
    SC_CTOR(fully_connected_f1iI):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
