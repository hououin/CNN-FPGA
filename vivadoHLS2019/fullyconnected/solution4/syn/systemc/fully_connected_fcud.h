...
// ==============================================================
#ifndef __fully_connected_fcud_H__
#define __fully_connected_fcud_H__
...
struct fully_connected_fcud_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(fully_connected_fcud_ram) {
...
SC_MODULE(fully_connected_fcud) {
...
fully_connected_fcud_ram* meminst;


SC_CTOR(fully_connected_fcud) {
meminst = new fully_connected_fcud_ram("fully_connected_fcud_ram");
