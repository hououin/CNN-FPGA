...
// ==============================================================
#ifndef __fully_connected_ffYi__HH__
#define __fully_connected_ffYi__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fully_connected_ffYi) {
    ...
    SC_CTOR(fully_connected_ffYi):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
