...
// ==============================================================
#ifndef __fully_connected_fbkb_H__
#define __fully_connected_fbkb_H__
...
struct fully_connected_fbkb_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(fully_connected_fbkb_ram) {
...
SC_MODULE(fully_connected_fbkb) {
...
fully_connected_fbkb_ram* meminst;


SC_CTOR(fully_connected_fbkb) {
meminst = new fully_connected_fbkb_ram("fully_connected_fbkb_ram");
