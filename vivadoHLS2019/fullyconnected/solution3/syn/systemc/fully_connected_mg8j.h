...
// ==============================================================
#ifndef __fully_connected_mg8j__HH__
#define __fully_connected_mg8j__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(fully_connected_mg8j) {
    ...
    SC_CTOR(fully_connected_mg8j):  simcore_mac_0_U ("simcore_mac_0_U") {
