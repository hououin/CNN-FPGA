...
entity fully_connected_fbkb_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 50
...
architecture rtl of fully_connected_fbkb_rom is 
...
entity fully_connected_fbkb is
    generic (
...
architecture arch of fully_connected_fbkb is
    component fully_connected_fbkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    fully_connected_fbkb_rom_U :  component fully_connected_fbkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
