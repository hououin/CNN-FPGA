...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    cnn_fadd_32ns_32nbkb_U860 = new cnn_fadd_32ns_32nbkb<1,4,32,32,32>("cnn_fadd_32ns_32nbkb_U860");
    cnn_fadd_32ns_32nbkb_U860->clk(ap_clk);
    cnn_fadd_32ns_32nbkb_U860->reset(ap_rst);
    cnn_fadd_32ns_32nbkb_U860->din0(sum_0_reg_68);
    cnn_fadd_32ns_32nbkb_U860->din1(reg_123);
    cnn_fadd_32ns_32nbkb_U860->ce(ap_var_for_const0);
    cnn_fadd_32ns_32nbkb_U860->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32nibs_U861 = new cnn_fdiv_32ns_32nibs<1,8,32,32,32>("cnn_fdiv_32ns_32nibs_U861");
    cnn_fdiv_32ns_32nibs_U861->clk(ap_clk);
    cnn_fdiv_32ns_32nibs_U861->reset(ap_rst);
    cnn_fdiv_32ns_32nibs_U861->din0(reg_123);
    cnn_fdiv_32ns_32nibs_U861->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32nibs_U861->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32nibs_U861->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32njbC_U862 = new cnn_fexp_32ns_32njbC<1,5,32,32,32>("cnn_fexp_32ns_32njbC_U862");
    cnn_fexp_32ns_32njbC_U862->clk(ap_clk);
    cnn_fexp_32ns_32njbC_U862->reset(ap_rst);
    cnn_fexp_32ns_32njbC_U862->din0(ap_var_for_const1);
    cnn_fexp_32ns_32njbC_U862->din1(dense_array_q0);
    cnn_fexp_32ns_32njbC_U862->ce(ap_var_for_const0);
    cnn_fexp_32ns_32njbC_U862->dout(grp_fu_112_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fadd_32ns_32nbkb_U860;
    delete cnn_fdiv_32ns_32nibs_U861;
    delete cnn_fexp_32ns_32njbC_U862;
}
