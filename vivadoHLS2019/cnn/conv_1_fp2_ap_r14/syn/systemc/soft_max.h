...
struct soft_max : public sc_module {
    ...
    cnn_fadd_32ns_32nbkb<1,4,32,32,32>* cnn_fadd_32ns_32nbkb_U860;
    cnn_fdiv_32ns_32nibs<1,8,32,32,32>* cnn_fdiv_32ns_32nibs_U861;
    cnn_fexp_32ns_32njbC<1,5,32,32,32>* cnn_fexp_32ns_32njbC_U862;
