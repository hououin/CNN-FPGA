...
architecture behav of conv_2 is 
    ...
    signal tmp_29_cast_fu_541_p3 : STD_LOGIC_VECTOR (10 downto 0);
...
begin
    conv_2_weights_U : component conv_2_conv_2_weihbi
    generic map (
        DataWidth => 32,
        AddressRange => 864,
        AddressWidth => 10)
    ...
    cnn_fadd_32ns_32nbkb_U848 : component cnn_fadd_32ns_32nbkb
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    cnn_fmul_32ns_32ncud_U849 : component cnn_fmul_32ns_32ncud
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    cnn_fcmp_32ns_32ndEe_U850 : component cnn_fcmp_32ns_32ndEe
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    add_ln26_5_fu_549_p2 <= std_logic_vector(unsigned(zext_ln35_1_reg_657) + unsigned(tmp_29_cast_fu_541_p3));
    ...
    tmp_29_cast_fu_541_p3 <= (add_ln26_4_fu_536_p2 & ap_const_lv4_0);
    ...
    zext_ln26_2_fu_394_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_8_fu_386_p3),5));
    ...
    zext_ln26_7_fu_506_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_10_fu_498_p3),11));
