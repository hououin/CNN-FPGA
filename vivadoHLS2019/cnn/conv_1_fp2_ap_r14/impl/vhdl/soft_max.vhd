...
begin
    cnn_fadd_32ns_32nbkb_U860 : component cnn_fadd_32ns_32nbkb
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    cnn_fdiv_32ns_32nibs_U861 : component cnn_fdiv_32ns_32nibs
    generic map (
        ID => 1,
        NUM_STAGE => 8,
        din0_WIDTH => 32,
    ...
    cnn_fexp_32ns_32njbC_U862 : component cnn_fexp_32ns_32njbC
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
