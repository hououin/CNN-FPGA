...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_fadd_32ns_32nkbM_U71->din0(sum_0_reg_68);
    cnn_fadd_32ns_32nkbM_U71->din1(reg_123);
    cnn_fadd_32ns_32nkbM_U71->ce(ap_var_for_const0);
    cnn_fadd_32ns_32nkbM_U71->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32npcA_U72 = new cnn_fdiv_32ns_32npcA<1,8,32,32,32>("cnn_fdiv_32ns_32npcA_U72");
    cnn_fdiv_32ns_32npcA_U72->clk(ap_clk);
    cnn_fdiv_32ns_32npcA_U72->reset(ap_rst);
    cnn_fdiv_32ns_32npcA_U72->din0(reg_123);
    cnn_fdiv_32ns_32npcA_U72->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32npcA_U72->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32npcA_U72->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32nqcK_U73 = new cnn_fexp_32ns_32nqcK<1,5,32,32,32>("cnn_fexp_32ns_32nqcK_U73");
    cnn_fexp_32ns_32nqcK_U73->clk(ap_clk);
    cnn_fexp_32ns_32nqcK_U73->reset(ap_rst);
    cnn_fexp_32ns_32nqcK_U73->din0(ap_var_for_const1);
    cnn_fexp_32ns_32nqcK_U73->din1(dense_array_q0);
    cnn_fexp_32ns_32nqcK_U73->ce(ap_var_for_const0);
    cnn_fexp_32ns_32nqcK_U73->dout(grp_fu_112_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fdiv_32ns_32npcA_U72;
    delete cnn_fexp_32ns_32nqcK_U73;
}
