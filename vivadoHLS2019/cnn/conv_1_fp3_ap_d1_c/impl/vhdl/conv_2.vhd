...
begin
    conv_2_weights_U : component conv_2_conv_2_weiocq
    generic map (
        DataWidth => 32,
        AddressRange => 864,
        AddressWidth => 10)
    ...
    cnn_fadd_32ns_32nkbM_U59 : component cnn_fadd_32ns_32nkbM
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    cnn_fmul_32ns_32nlbW_U60 : component cnn_fmul_32ns_32nlbW
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    cnn_fcmp_32ns_32nmb6_U61 : component cnn_fcmp_32ns_32nmb6
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
