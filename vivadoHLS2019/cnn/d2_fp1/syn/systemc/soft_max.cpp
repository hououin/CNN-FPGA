...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_fadd_32ns_32ncud_U92->din0(sum_0_reg_68);
    cnn_fadd_32ns_32ncud_U92->din1(reg_123);
    cnn_fadd_32ns_32ncud_U92->ce(ap_var_for_const0);
    cnn_fadd_32ns_32ncud_U92->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32n7jG_U93 = new cnn_fdiv_32ns_32n7jG<1,8,32,32,32>("cnn_fdiv_32ns_32n7jG_U93");
    cnn_fdiv_32ns_32n7jG_U93->clk(ap_clk);
    cnn_fdiv_32ns_32n7jG_U93->reset(ap_rst);
    cnn_fdiv_32ns_32n7jG_U93->din0(reg_123);
    cnn_fdiv_32ns_32n7jG_U93->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32n7jG_U93->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32n7jG_U93->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32n8jQ_U94 = new cnn_fexp_32ns_32n8jQ<1,5,32,32,32>("cnn_fexp_32ns_32n8jQ_U94");
    cnn_fexp_32ns_32n8jQ_U94->clk(ap_clk);
    cnn_fexp_32ns_32n8jQ_U94->reset(ap_rst);
    cnn_fexp_32ns_32n8jQ_U94->din0(ap_var_for_const1);
    cnn_fexp_32ns_32n8jQ_U94->din1(dense_array_q0);
    cnn_fexp_32ns_32n8jQ_U94->ce(ap_var_for_const0);
    cnn_fexp_32ns_32n8jQ_U94->dout(grp_fu_112_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fdiv_32ns_32n7jG_U93;
    delete cnn_fexp_32ns_32n8jQ_U94;
}
