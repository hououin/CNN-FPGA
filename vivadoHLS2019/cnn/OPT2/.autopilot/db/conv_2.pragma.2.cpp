...
# 1 "cnn/conv_2_weights.h" 1



float conv_2_weights [3][3][6][16] = {
  {
   {
...
float conv_2_bias [16] = {-0.216688 ,-0.144009 ,-0.252378 ,0.132175 ,-0.193526 ,-0.095462 ,-0.075797 ,-0.230617 ,0.185964 ,-0.178931 ,-0.050411 ,-0.045991 ,-0.204324 ,0.037598 ,-0.310033 ,-0.09754};
# 4 "cnn/conv_2.cpp" 2

void conv_2(float input[(26 / 2)][(26 / 2)][6], float conv_out[11][11][16]) {_ssdm_SpecArrayDimSize(input, 13);_ssdm_SpecArrayDimSize(conv_out, 11);
