...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_fadd_32ns_32nbkb_U80->din0(sum_0_reg_68);
    cnn_fadd_32ns_32nbkb_U80->din1(reg_123);
    cnn_fadd_32ns_32nbkb_U80->ce(ap_var_for_const0);
    cnn_fadd_32ns_32nbkb_U80->dout(grp_fu_102_p2);
    ...
    cnn_fdiv_32ns_32ng8j_U81->din0(reg_123);
    cnn_fdiv_32ns_32ng8j_U81->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32ng8j_U81->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32ng8j_U81->dout(grp_fu_107_p2);
    ...
    cnn_fexp_32ns_32nhbi_U82->dout(grp_fu_112_p2);
