...
set C_modelArgList {
	...
	{ conv_out_0 float 32 regular {array 1092 { 0 3 } 0 1 }  }
	{ conv_out_1 float 32 regular {array 1092 { 0 3 } 0 1 }  }
	{ conv_out_2 float 32 regular {array 936 { 0 3 } 0 1 }  }
	{ conv_out_3 float 32 regular {array 936 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	...
	conv_out_2 { ap_memory {  { conv_out_2_address0 mem_address 1 10 }  { conv_out_2_ce0 mem_ce 1 1 }  { conv_out_2_we0 mem_we 1 1 }  { conv_out_2_d0 mem_din 1 32 } } }
	conv_out_3 { ap_memory {  { conv_out_3_address0 mem_address 1 10 }  { conv_out_3_ce0 mem_ce 1 1 }  { conv_out_3_we0 mem_we 1 1 }  { conv_out_3_d0 mem_din 1 32 } } }
}
