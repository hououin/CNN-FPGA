...
entity cnn_dense_2_bias_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 30
...
architecture rtl of cnn_dense_2_bias_rom is 
...
architecture arch of cnn_dense_2_bias is
    component cnn_dense_2_bias_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    cnn_dense_2_bias_rom_U :  component cnn_dense_2_bias_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
