...
set C_modelArgList {
	...
	{ dense_1_out float 32 regular {array 50 { 1 3 } 1 1 } {global 0}  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dense_2_bias_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dense_2_weights_U", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4510", "Max" : "4510"}
	, {"Name" : "Interval", "Min" : "4510", "Max" : "4510"}
]}
...
set Spec2ImplPortList { 
	...
	dense_1_out { ap_memory {  { dense_1_out_address0 mem_address 1 6 }  { dense_1_out_ce0 mem_ce 1 1 }  { dense_1_out_q0 mem_dout 0 32 } } }
}
