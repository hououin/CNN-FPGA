...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    cnn_fadd_32ns_32nbkb_U199 = new cnn_fadd_32ns_32nbkb<1,4,32,32,32>("cnn_fadd_32ns_32nbkb_U199");
    cnn_fadd_32ns_32nbkb_U199->clk(ap_clk);
    cnn_fadd_32ns_32nbkb_U199->reset(ap_rst);
    cnn_fadd_32ns_32nbkb_U199->din0(sum_0_reg_68);
    cnn_fadd_32ns_32nbkb_U199->din1(reg_123);
    cnn_fadd_32ns_32nbkb_U199->ce(ap_var_for_const0);
    cnn_fadd_32ns_32nbkb_U199->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32n8jQ_U200 = new cnn_fdiv_32ns_32n8jQ<1,8,32,32,32>("cnn_fdiv_32ns_32n8jQ_U200");
    cnn_fdiv_32ns_32n8jQ_U200->clk(ap_clk);
    cnn_fdiv_32ns_32n8jQ_U200->reset(ap_rst);
    cnn_fdiv_32ns_32n8jQ_U200->din0(reg_123);
    cnn_fdiv_32ns_32n8jQ_U200->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32n8jQ_U200->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32n8jQ_U200->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32n9j0_U201 = new cnn_fexp_32ns_32n9j0<1,5,32,32,32>("cnn_fexp_32ns_32n9j0_U201");
    cnn_fexp_32ns_32n9j0_U201->clk(ap_clk);
    cnn_fexp_32ns_32n9j0_U201->reset(ap_rst);
    cnn_fexp_32ns_32n9j0_U201->din0(ap_var_for_const1);
    cnn_fexp_32ns_32n9j0_U201->din1(dense_array_q0);
    cnn_fexp_32ns_32n9j0_U201->ce(ap_var_for_const0);
    cnn_fexp_32ns_32n9j0_U201->dout(grp_fu_112_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fadd_32ns_32nbkb_U199;
    delete cnn_fdiv_32ns_32n8jQ_U200;
    delete cnn_fexp_32ns_32n9j0_U201;
}
