...
set C_modelArgList {
	...
	{ max_pool_1_out float 32 regular {array 1014 { 1 3 } 1 1 } {global 0}  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cnn_fmul_32ns_32ndEe_U17", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cnn_fcmp_32ns_32neOg_U18", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cnn_mac_muladd_4nhbi_U19", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cnn_mac_muladd_4nhbi_U20", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "439473", "Max" : "439473"}
	, {"Name" : "Interval", "Min" : "439473", "Max" : "439473"}
]}
...
set Spec2ImplPortList { 
	...
	max_pool_1_out { ap_memory {  { max_pool_1_out_address0 mem_address 1 10 }  { max_pool_1_out_ce0 mem_ce 1 1 }  { max_pool_1_out_q0 mem_dout 0 32 } } }
}
