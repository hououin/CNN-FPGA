...
// ==============================================================
#ifndef __dense_out_dense_olbW_H__
#define __dense_out_dense_olbW_H__
...
struct dense_out_dense_olbW_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_out_dense_olbW_ram) {
...
SC_MODULE(dense_out_dense_olbW) {
...
dense_out_dense_olbW_ram* meminst;


SC_CTOR(dense_out_dense_olbW) {
meminst = new dense_out_dense_olbW_ram("dense_out_dense_olbW_ram");
