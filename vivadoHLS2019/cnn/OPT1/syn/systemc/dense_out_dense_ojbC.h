...
// ==============================================================
#ifndef __dense_out_dense_ojbC_H__
#define __dense_out_dense_ojbC_H__
...
struct dense_out_dense_ojbC_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_out_dense_ojbC_ram) {
...
SC_MODULE(dense_out_dense_ojbC) {
...
dense_out_dense_ojbC_ram* meminst;


SC_CTOR(dense_out_dense_ojbC) {
meminst = new dense_out_dense_ojbC_ram("dense_out_dense_ojbC_ram");
