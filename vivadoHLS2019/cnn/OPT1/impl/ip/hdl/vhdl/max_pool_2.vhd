...
architecture behav of max_pool_2 is 
    ...
    signal tmp_6_cast_fu_505_p3 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal tmp_2_fu_630_p4 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    add_ln29_1_fu_513_p2 <= std_logic_vector(unsigned(tmp_6_cast_fu_505_p3) + unsigned(zext_ln26_1_fu_279_p1));
    ...
    icmp_ln29_2_fu_662_p2 <= "0" when (tmp_2_fu_630_p4 = ap_const_lv8_FF) else "1";
    icmp_ln29_3_fu_668_p2 <= "1" when (trunc_ln29_1_fu_640_p1 = ap_const_lv23_0) else "0";
    icmp_ln29_4_fu_761_p2 <= "0" when (tmp_4_fu_730_p4 = ap_const_lv8_FF) else "1";
    ...
    max_pool_out_address0 <= zext_ln36_3_fu_816_p1(9 - 1 downto 0);
    ...
    max_pool_out_we0_assign_proc : process(ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_11001, icmp_ln20_1_reg_927, ap_enable_reg_pp0_iter1)
    begin
    ...
    tmp_2_fu_630_p4 <= bitcast_ln29_1_fu_627_p1(30 downto 23);
    tmp_4_fu_730_p4 <= bitcast_ln29_2_fu_727_p1(30 downto 23);
    tmp_6_cast_fu_505_p3 <= (add_ln29_fu_499_p2 & ap_const_lv4_0);
