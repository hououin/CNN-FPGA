...
# 2 "cnn/dense_out.cpp" 2

# 1 "cnn/dense_weights_out.h" 1
...
# 6 "cnn/dense_out.cpp" 2

void soft_max(float dense_array[10], float prediction[10])
{_ssdm_SpecArrayDimSize(dense_array, 10);_ssdm_SpecArrayDimSize(prediction, 10);
    float sum = 0.0;
    Sum_Loop:
    for (int i = 0; i < 10; ++i)
    {
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
# 12 "cnn/dense_out.cpp"
...
{_ssdm_SpecArrayDimSize(dense_2_out, 30);_ssdm_SpecArrayDimSize(prediction, 10);
