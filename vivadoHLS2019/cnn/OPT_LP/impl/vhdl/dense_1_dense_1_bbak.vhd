...
entity dense_1_dense_1_bbak_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 50
...
architecture rtl of dense_1_dense_1_bbak_rom is 
...
entity dense_1_dense_1_bbak is
    generic (
...
architecture arch of dense_1_dense_1_bbak is
    component dense_1_dense_1_bbak_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    dense_1_dense_1_bbak_rom_U :  component dense_1_dense_1_bbak_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
