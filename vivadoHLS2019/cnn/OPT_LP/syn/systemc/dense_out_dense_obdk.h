...
// ==============================================================
#ifndef __dense_out_dense_obdk_H__
#define __dense_out_dense_obdk_H__
...
struct dense_out_dense_obdk_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_out_dense_obdk_ram) {
...
SC_MODULE(dense_out_dense_obdk) {
...
dense_out_dense_obdk_ram* meminst;


SC_CTOR(dense_out_dense_obdk) {
meminst = new dense_out_dense_obdk_ram("dense_out_dense_obdk_ram");
