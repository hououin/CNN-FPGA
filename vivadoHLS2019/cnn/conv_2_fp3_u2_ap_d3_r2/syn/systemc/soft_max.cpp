...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_fadd_32ns_32ncud_U97->din0(sum_0_reg_68);
    cnn_fadd_32ns_32ncud_U97->din1(reg_123);
    cnn_fadd_32ns_32ncud_U97->ce(ap_var_for_const0);
    cnn_fadd_32ns_32ncud_U97->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32n8jQ_U98 = new cnn_fdiv_32ns_32n8jQ<1,8,32,32,32>("cnn_fdiv_32ns_32n8jQ_U98");
    cnn_fdiv_32ns_32n8jQ_U98->clk(ap_clk);
    cnn_fdiv_32ns_32n8jQ_U98->reset(ap_rst);
    cnn_fdiv_32ns_32n8jQ_U98->din0(reg_123);
    cnn_fdiv_32ns_32n8jQ_U98->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32n8jQ_U98->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32n8jQ_U98->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32n9j0_U99 = new cnn_fexp_32ns_32n9j0<1,5,32,32,32>("cnn_fexp_32ns_32n9j0_U99");
    cnn_fexp_32ns_32n9j0_U99->clk(ap_clk);
    cnn_fexp_32ns_32n9j0_U99->reset(ap_rst);
    cnn_fexp_32ns_32n9j0_U99->din0(ap_var_for_const1);
    cnn_fexp_32ns_32n9j0_U99->din1(dense_array_q0);
    cnn_fexp_32ns_32n9j0_U99->ce(ap_var_for_const0);
    cnn_fexp_32ns_32n9j0_U99->dout(grp_fu_112_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fdiv_32ns_32n8jQ_U98;
    delete cnn_fexp_32ns_32n9j0_U99;
}
