...
void flat::thread_add_ln14_2_fu_237_p2() {
    add_ln14_2_fu_237_p2 = (!tmp_17_cast_reg_289.read().is_01() || !zext_ln14_4_fu_233_p1.read().is_01())? sc_lv<10>(): (sc_biguint<10>(tmp_17_cast_reg_289.read()) + sc_biguint<10>(zext_ln14_4_fu_233_p1.read()));
}
...
void flat::thread_tmp_17_cast_fu_213_p3() {
    tmp_17_cast_fu_213_p3 = esl_concat<6,4>(add_ln14_1_fu_208_p2.read(), ap_const_lv4_0);
}
