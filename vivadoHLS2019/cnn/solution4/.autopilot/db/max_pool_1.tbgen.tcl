...
set C_modelArgList {
	{ conv_out float 32 regular {array 21632 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ conv_out_address1 sc_out sc_lv 15 signal 0 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cnn_fcmp_32ns_32nmb6_U23", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cnn_fcmp_32ns_32nmb6_U24", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cnn_mac_muladd_5nocq_U25", "Parent" : "0"}]}
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "10818", "Max" : "10818"}
]}
...
set Spec2ImplPortList { 
	conv_out { ap_memory {  { conv_out_address0 mem_address 1 15 }  { conv_out_ce0 mem_ce 1 1 }  { conv_out_q0 mem_dout 0 32 }  { conv_out_address1 MemPortADDR2 1 15 }  { conv_out_ce1 MemPortCE2 1 1 }  { conv_out_q1 MemPortDOUT2 0 32 } } }
