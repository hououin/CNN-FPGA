...
set C_modelArgList {
	...
	{ conv_2_out float 32 regular {array 7744 { 1 1 } 1 1 } {global 0}  }
}
...
set portList { 
	...
	{ max_pool_out_address0 sc_out sc_lv 11 signal 0 } 
	...
	{ conv_2_out_address0 sc_out sc_lv 13 signal 1 } 
	{ conv_2_out_ce0 sc_out sc_logic 1 signal 1 } 
	{ conv_2_out_q0 sc_in sc_lv 32 signal 1 } 
	{ conv_2_out_address1 sc_out sc_lv 13 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv_2_out_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "conv_2_out", "role": "address0" }} , 
 	...
 	{ "name": "conv_2_out_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "conv_2_out", "role": "address1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cnn_fcmp_32ns_32nmb6_U133", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cnn_fcmp_32ns_32nmb6_U134", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	conv_2_out { ap_memory {  { conv_2_out_address0 mem_address 1 13 }  { conv_2_out_ce0 mem_ce 1 1 }  { conv_2_out_q0 mem_dout 0 32 }  { conv_2_out_address1 MemPortADDR2 1 13 }  { conv_2_out_ce1 MemPortCE2 1 1 }  { conv_2_out_q1 MemPortDOUT2 0 32 } } }
}
