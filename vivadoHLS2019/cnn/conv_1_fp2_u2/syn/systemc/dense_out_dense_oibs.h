...
// ==============================================================
#ifndef __dense_out_dense_oibs_H__
#define __dense_out_dense_oibs_H__
...
struct dense_out_dense_oibs_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_out_dense_oibs_ram) {
...
SC_MODULE(dense_out_dense_oibs) {
...
dense_out_dense_oibs_ram* meminst;


SC_CTOR(dense_out_dense_oibs) {
meminst = new dense_out_dense_oibs_ram("dense_out_dense_oibs_ram");
