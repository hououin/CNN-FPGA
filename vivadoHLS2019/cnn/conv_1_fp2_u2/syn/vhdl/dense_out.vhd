...
architecture behav of dense_out is 
    ...
    component dense_out_dense_ohbi IS
    generic (
        DataWidth : INTEGER;
    ...
    component dense_out_dense_ajbC IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    dense_out_weights_U : component dense_out_dense_ohbi
    generic map (
        DataWidth => 32,
        AddressRange => 300,
        AddressWidth => 9)
    ...
    dense_out_bias_U : component dense_out_dense_oibs
    generic map (
        DataWidth => 32,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    dense_array_U : component dense_out_dense_ajbC
    generic map (
        DataWidth => 32,
        AddressRange => 10,
        AddressWidth => 4)
