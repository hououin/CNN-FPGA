...
architecture behav of soft_max is 
    ...
    component cnn_fdiv_32ns_32nfYi IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component cnn_fexp_32ns_32ng8j IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    cnn_fdiv_32ns_32nfYi_U62 : component cnn_fdiv_32ns_32nfYi
    generic map (
        ID => 1,
        NUM_STAGE => 8,
        din0_WIDTH => 32,
    ...
    cnn_fexp_32ns_32ng8j_U63 : component cnn_fexp_32ns_32ng8j
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
