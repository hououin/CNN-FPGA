...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    cnn_fadd_32ns_32ncud_U134 = new cnn_fadd_32ns_32ncud<1,4,32,32,32>("cnn_fadd_32ns_32ncud_U134");
    cnn_fadd_32ns_32ncud_U134->clk(ap_clk);
    cnn_fadd_32ns_32ncud_U134->reset(ap_rst);
    cnn_fadd_32ns_32ncud_U134->din0(sum_0_reg_68);
    cnn_fadd_32ns_32ncud_U134->din1(reg_123);
    cnn_fadd_32ns_32ncud_U134->ce(ap_var_for_const0);
    cnn_fadd_32ns_32ncud_U134->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32njbC_U135 = new cnn_fdiv_32ns_32njbC<1,8,32,32,32>("cnn_fdiv_32ns_32njbC_U135");
    cnn_fdiv_32ns_32njbC_U135->clk(ap_clk);
    cnn_fdiv_32ns_32njbC_U135->reset(ap_rst);
    cnn_fdiv_32ns_32njbC_U135->din0(reg_123);
    cnn_fdiv_32ns_32njbC_U135->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32njbC_U135->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32njbC_U135->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32nkbM_U136 = new cnn_fexp_32ns_32nkbM<1,5,32,32,32>("cnn_fexp_32ns_32nkbM_U136");
    cnn_fexp_32ns_32nkbM_U136->clk(ap_clk);
    cnn_fexp_32ns_32nkbM_U136->reset(ap_rst);
    cnn_fexp_32ns_32nkbM_U136->din0(ap_var_for_const1);
    cnn_fexp_32ns_32nkbM_U136->din1(dense_array_q0);
    cnn_fexp_32ns_32nkbM_U136->ce(ap_var_for_const0);
    cnn_fexp_32ns_32nkbM_U136->dout(grp_fu_112_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fdiv_32ns_32njbC_U135;
    delete cnn_fexp_32ns_32nkbM_U136;
}
