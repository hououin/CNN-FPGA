...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    cnn_fadd_32ns_32ncud_U133 = new cnn_fadd_32ns_32ncud<1,4,32,32,32>("cnn_fadd_32ns_32ncud_U133");
    cnn_fadd_32ns_32ncud_U133->clk(ap_clk);
    cnn_fadd_32ns_32ncud_U133->reset(ap_rst);
    cnn_fadd_32ns_32ncud_U133->din0(sum_0_reg_68);
    cnn_fadd_32ns_32ncud_U133->din1(reg_123);
    cnn_fadd_32ns_32ncud_U133->ce(ap_var_for_const0);
    cnn_fadd_32ns_32ncud_U133->dout(grp_fu_102_p2);
