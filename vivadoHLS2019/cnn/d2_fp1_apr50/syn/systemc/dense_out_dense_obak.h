...
// ==============================================================
#ifndef __dense_out_dense_obak_H__
#define __dense_out_dense_obak_H__
...
struct dense_out_dense_obak_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_out_dense_obak_ram) {
...
SC_MODULE(dense_out_dense_obak) {
...
dense_out_dense_obak_ram* meminst;


SC_CTOR(dense_out_dense_obak) {
meminst = new dense_out_dense_obak_ram("dense_out_dense_obak_ram");
