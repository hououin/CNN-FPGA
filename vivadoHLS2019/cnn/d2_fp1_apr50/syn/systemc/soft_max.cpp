...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    cnn_fadd_32ns_32ncud_U286 = new cnn_fadd_32ns_32ncud<1,4,32,32,32>("cnn_fadd_32ns_32ncud_U286");
    cnn_fadd_32ns_32ncud_U286->clk(ap_clk);
    cnn_fadd_32ns_32ncud_U286->reset(ap_rst);
    cnn_fadd_32ns_32ncud_U286->din0(sum_0_reg_68);
    cnn_fadd_32ns_32ncud_U286->din1(reg_123);
    cnn_fadd_32ns_32ncud_U286->ce(ap_var_for_const0);
    cnn_fadd_32ns_32ncud_U286->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32n7jG_U287 = new cnn_fdiv_32ns_32n7jG<1,8,32,32,32>("cnn_fdiv_32ns_32n7jG_U287");
    cnn_fdiv_32ns_32n7jG_U287->clk(ap_clk);
    cnn_fdiv_32ns_32n7jG_U287->reset(ap_rst);
    cnn_fdiv_32ns_32n7jG_U287->din0(reg_123);
    cnn_fdiv_32ns_32n7jG_U287->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32n7jG_U287->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32n7jG_U287->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32n8jQ_U288 = new cnn_fexp_32ns_32n8jQ<1,5,32,32,32>("cnn_fexp_32ns_32n8jQ_U288");
    cnn_fexp_32ns_32n8jQ_U288->clk(ap_clk);
    cnn_fexp_32ns_32n8jQ_U288->reset(ap_rst);
    cnn_fexp_32ns_32n8jQ_U288->din0(ap_var_for_const1);
    cnn_fexp_32ns_32n8jQ_U288->din1(dense_array_q0);
    cnn_fexp_32ns_32n8jQ_U288->ce(ap_var_for_const0);
    cnn_fexp_32ns_32n8jQ_U288->dout(grp_fu_112_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fdiv_32ns_32n7jG_U287;
    delete cnn_fexp_32ns_32n8jQ_U288;
}
