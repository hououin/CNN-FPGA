...
flat::flat(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_332_cast_reg_289 );
    ...
    SC_METHOD(thread_tmp_332_cast_fu_213_p3);
    ...
    sc_trace(mVcdFile, tmp_332_cast_fu_213_p3, "tmp_332_cast_fu_213_p3");
    sc_trace(mVcdFile, tmp_332_cast_reg_289, "tmp_332_cast_reg_289");
...
void flat::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln9_fu_186_p2.read()))) {
        ...
        tmp_332_cast_reg_289 = tmp_332_cast_fu_213_p3.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
...
void flat::thread_add_ln14_2_fu_237_p2() {
    add_ln14_2_fu_237_p2 = (!tmp_332_cast_reg_289.read().is_01() || !zext_ln14_4_fu_233_p1.read().is_01())? sc_lv<10>(): (sc_biguint<10>(tmp_332_cast_reg_289.read()) + sc_biguint<10>(zext_ln14_4_fu_233_p1.read()));
}
...
void flat::thread_tmp_332_cast_fu_213_p3() {
    tmp_332_cast_fu_213_p3 = esl_concat<6,4>(add_ln14_1_fu_208_p2.read(), ap_const_lv4_0);
}
