...
dense_2::dense_2(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_tmp_24_fu_197_p3);
    sensitive << ( j_0_reg_131 );

    SC_METHOD(thread_tmp_25_fu_209_p3);
    sensitive << ( j_0_reg_131 );
    ...
    sensitive << ( tmp_24_fu_197_p3 );

    SC_METHOD(thread_zext_ln14_7_fu_217_p1);
    sensitive << ( tmp_25_fu_209_p3 );
    ...
    sc_trace(mVcdFile, tmp_24_fu_197_p3, "tmp_24_fu_197_p3");
    sc_trace(mVcdFile, tmp_25_fu_209_p3, "tmp_25_fu_209_p3");
...
void dense_2::thread_tmp_24_fu_197_p3() {
    tmp_24_fu_197_p3 = esl_concat<6,5>(j_0_reg_131.read(), ap_const_lv5_0);
}

void dense_2::thread_tmp_25_fu_209_p3() {
    tmp_25_fu_209_p3 = esl_concat<6,1>(j_0_reg_131.read(), ap_const_lv1_0);
}
...
void dense_2::thread_zext_ln14_6_fu_205_p1() {
    zext_ln14_6_fu_205_p1 = esl_zext<12,11>(tmp_24_fu_197_p3.read());
}

void dense_2::thread_zext_ln14_7_fu_217_p1() {
    zext_ln14_7_fu_217_p1 = esl_zext<12,7>(tmp_25_fu_209_p3.read());
}
