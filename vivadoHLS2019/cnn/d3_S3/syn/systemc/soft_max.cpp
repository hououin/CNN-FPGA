...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_fadd_32ns_32ncud_U40->din0(sum_0_reg_80);
    cnn_fadd_32ns_32ncud_U40->din1(reg_135);
    cnn_fadd_32ns_32ncud_U40->ce(ap_var_for_const0);
    cnn_fadd_32ns_32ncud_U40->dout(grp_fu_114_p2);
    ...
    cnn_fdiv_32ns_32nkbM_U41->din0(reg_135);
    cnn_fdiv_32ns_32nkbM_U41->din1(sum_0_reg_80);
    cnn_fdiv_32ns_32nkbM_U41->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32nkbM_U41->dout(grp_fu_119_p2);
    ...
    cnn_fexp_32ns_32nlbW_U42->dout(grp_fu_124_p2);
