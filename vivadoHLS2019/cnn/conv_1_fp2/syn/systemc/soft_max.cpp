...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_fadd_32ns_32nbkb_U48->din0(sum_0_reg_68);
    cnn_fadd_32ns_32nbkb_U48->din1(reg_123);
    cnn_fadd_32ns_32nbkb_U48->ce(ap_var_for_const0);
    cnn_fadd_32ns_32nbkb_U48->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32ng8j_U49 = new cnn_fdiv_32ns_32ng8j<1,8,32,32,32>("cnn_fdiv_32ns_32ng8j_U49");
    cnn_fdiv_32ns_32ng8j_U49->clk(ap_clk);
    cnn_fdiv_32ns_32ng8j_U49->reset(ap_rst);
    cnn_fdiv_32ns_32ng8j_U49->din0(reg_123);
    cnn_fdiv_32ns_32ng8j_U49->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32ng8j_U49->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32ng8j_U49->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32nhbi_U50 = new cnn_fexp_32ns_32nhbi<1,5,32,32,32>("cnn_fexp_32ns_32nhbi_U50");
    cnn_fexp_32ns_32nhbi_U50->clk(ap_clk);
    cnn_fexp_32ns_32nhbi_U50->reset(ap_rst);
    cnn_fexp_32ns_32nhbi_U50->din0(ap_var_for_const1);
    cnn_fexp_32ns_32nhbi_U50->din1(dense_array_q0);
    cnn_fexp_32ns_32nhbi_U50->ce(ap_var_for_const0);
    cnn_fexp_32ns_32nhbi_U50->dout(grp_fu_112_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fdiv_32ns_32ng8j_U49;
    delete cnn_fexp_32ns_32nhbi_U50;
}
