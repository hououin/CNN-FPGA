...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_fadd_32ns_32nbkb_U64->din0(sum_0_reg_68);
    cnn_fadd_32ns_32nbkb_U64->din1(reg_123);
    cnn_fadd_32ns_32nbkb_U64->ce(ap_var_for_const0);
    cnn_fadd_32ns_32nbkb_U64->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32ng8j_U65 = new cnn_fdiv_32ns_32ng8j<1,8,32,32,32>("cnn_fdiv_32ns_32ng8j_U65");
    cnn_fdiv_32ns_32ng8j_U65->clk(ap_clk);
    cnn_fdiv_32ns_32ng8j_U65->reset(ap_rst);
    cnn_fdiv_32ns_32ng8j_U65->din0(reg_123);
    cnn_fdiv_32ns_32ng8j_U65->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32ng8j_U65->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32ng8j_U65->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32nhbi_U66 = new cnn_fexp_32ns_32nhbi<1,5,32,32,32>("cnn_fexp_32ns_32nhbi_U66");
    cnn_fexp_32ns_32nhbi_U66->clk(ap_clk);
    cnn_fexp_32ns_32nhbi_U66->reset(ap_rst);
    cnn_fexp_32ns_32nhbi_U66->din0(ap_var_for_const1);
    cnn_fexp_32ns_32nhbi_U66->din1(dense_array_q0);
    cnn_fexp_32ns_32nhbi_U66->ce(ap_var_for_const0);
    cnn_fexp_32ns_32nhbi_U66->dout(grp_fu_112_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fdiv_32ns_32ng8j_U65;
    delete cnn_fexp_32ns_32nhbi_U66;
}
