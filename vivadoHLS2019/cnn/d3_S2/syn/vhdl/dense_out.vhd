...
architecture behav of dense_out is 
    ...
    signal tmp_2_fu_250_p3 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    dense_out_weights_U : component dense_out_dense_oncg
    generic map (
        DataWidth => 32,
        AddressRange => 300,
        AddressWidth => 9)
    ...
    tmp_2_fu_250_p3 <= (select_ln38_1_fu_213_p3 & ap_const_lv1_0);
    ...
    zext_ln38_3_fu_258_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_2_fu_250_p3),9));
