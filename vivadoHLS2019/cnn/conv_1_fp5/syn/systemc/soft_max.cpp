...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_fadd_32ns_32ncud_U28->din0(sum_0_reg_68);
    cnn_fadd_32ns_32ncud_U28->din1(reg_123);
    cnn_fadd_32ns_32ncud_U28->ce(ap_var_for_const0);
    cnn_fadd_32ns_32ncud_U28->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32nhbi_U29 = new cnn_fdiv_32ns_32nhbi<1,8,32,32,32>("cnn_fdiv_32ns_32nhbi_U29");
    cnn_fdiv_32ns_32nhbi_U29->clk(ap_clk);
    cnn_fdiv_32ns_32nhbi_U29->reset(ap_rst);
    cnn_fdiv_32ns_32nhbi_U29->din0(reg_123);
    cnn_fdiv_32ns_32nhbi_U29->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32nhbi_U29->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32nhbi_U29->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32nibs_U30 = new cnn_fexp_32ns_32nibs<1,5,32,32,32>("cnn_fexp_32ns_32nibs_U30");
    cnn_fexp_32ns_32nibs_U30->clk(ap_clk);
    cnn_fexp_32ns_32nibs_U30->reset(ap_rst);
    cnn_fexp_32ns_32nibs_U30->din0(ap_var_for_const1);
    cnn_fexp_32ns_32nibs_U30->din1(dense_array_q0);
    cnn_fexp_32ns_32nibs_U30->ce(ap_var_for_const0);
    cnn_fexp_32ns_32nibs_U30->dout(grp_fu_112_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fdiv_32ns_32nhbi_U29;
    delete cnn_fexp_32ns_32nibs_U30;
}
