...
// ==============================================================
#ifndef __dense_out_dense_okbM_H__
#define __dense_out_dense_okbM_H__
...
struct dense_out_dense_okbM_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_out_dense_okbM_ram) {
...
SC_MODULE(dense_out_dense_okbM) {
...
dense_out_dense_okbM_ram* meminst;


SC_CTOR(dense_out_dense_okbM) {
meminst = new dense_out_dense_okbM_ram("dense_out_dense_okbM_ram");
