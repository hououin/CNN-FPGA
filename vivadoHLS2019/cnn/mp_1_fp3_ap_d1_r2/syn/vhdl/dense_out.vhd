...
architecture behav of dense_out is 
    ...
    signal tmp_12_fu_218_p3 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    component dense_out_dense_albW IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    dense_out_weights_U : component dense_out_dense_ojbC
    generic map (
        DataWidth => 32,
        AddressRange => 300,
        AddressWidth => 9)
    ...
    dense_out_bias_U : component dense_out_dense_okbM
    generic map (
        DataWidth => 32,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    dense_array_U : component dense_out_dense_albW
    generic map (
        DataWidth => 32,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    prediction_EN_A <= grp_soft_max_fu_149_prediction_EN_A;
    prediction_WEN_A <= grp_soft_max_fu_149_prediction_WEN_A;
    tmp_12_fu_218_p3 <= (f_0_reg_138 & ap_const_lv1_0);
    ...
    zext_ln38_3_fu_226_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_12_fu_218_p3),9));
