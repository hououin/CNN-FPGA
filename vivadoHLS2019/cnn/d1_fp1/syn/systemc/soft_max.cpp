...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_fadd_32ns_32ncud_U36->din0(sum_0_reg_68);
    cnn_fadd_32ns_32ncud_U36->din1(reg_123);
    cnn_fadd_32ns_32ncud_U36->ce(ap_var_for_const0);
    cnn_fadd_32ns_32ncud_U36->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32nibs_U37 = new cnn_fdiv_32ns_32nibs<1,8,32,32,32>("cnn_fdiv_32ns_32nibs_U37");
    cnn_fdiv_32ns_32nibs_U37->clk(ap_clk);
    cnn_fdiv_32ns_32nibs_U37->reset(ap_rst);
    cnn_fdiv_32ns_32nibs_U37->din0(reg_123);
    cnn_fdiv_32ns_32nibs_U37->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32nibs_U37->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32nibs_U37->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32njbC_U38 = new cnn_fexp_32ns_32njbC<1,5,32,32,32>("cnn_fexp_32ns_32njbC_U38");
    cnn_fexp_32ns_32njbC_U38->clk(ap_clk);
    cnn_fexp_32ns_32njbC_U38->reset(ap_rst);
    cnn_fexp_32ns_32njbC_U38->din0(ap_var_for_const1);
    cnn_fexp_32ns_32njbC_U38->din1(dense_array_q0);
    cnn_fexp_32ns_32njbC_U38->ce(ap_var_for_const0);
    cnn_fexp_32ns_32njbC_U38->dout(grp_fu_112_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fdiv_32ns_32nibs_U37;
    delete cnn_fexp_32ns_32njbC_U38;
}
