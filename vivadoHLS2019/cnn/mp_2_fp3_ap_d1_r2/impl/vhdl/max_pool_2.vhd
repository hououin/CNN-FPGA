...
architecture behav of max_pool_2 is 
    ...
    signal tmp_1_fu_345_p3 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_5_fu_524_p4 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_6_fu_541_p4 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    cnn_fcmp_32ns_32neOg_U108 : component cnn_fcmp_32ns_32neOg
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    cnn_fcmp_32ns_32neOg_U109 : component cnn_fcmp_32ns_32neOg
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    cnn_fcmp_32ns_32neOg_U110 : component cnn_fcmp_32ns_32neOg
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    icmp_ln29_2_fu_555_p2 <= "0" when (tmp_5_fu_524_p4 = ap_const_lv8_FF) else "1";
    icmp_ln29_3_fu_561_p2 <= "1" when (trunc_ln29_1_fu_534_p1 = ap_const_lv23_0) else "0";
    icmp_ln29_4_fu_573_p2 <= "0" when (tmp_6_fu_541_p4 = ap_const_lv8_FF) else "1";
    ...
    icmp_ln29_fu_489_p2 <= "0" when (tmp_3_fu_475_p4 = ap_const_lv8_FF) else "1";
    ...
    tmp_1_fu_345_p3 <= (add_ln29_fu_339_p2 & ap_const_lv4_0);
    tmp_3_fu_475_p4 <= bitcast_ln29_fu_472_p1(30 downto 23);
    tmp_5_fu_524_p4 <= bitcast_ln29_1_fu_521_p1(30 downto 23);
    tmp_6_fu_541_p4 <= bitcast_ln29_2_fu_538_p1(30 downto 23);
    ...
    zext_ln29_2_fu_353_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_1_fu_345_p3),12));
