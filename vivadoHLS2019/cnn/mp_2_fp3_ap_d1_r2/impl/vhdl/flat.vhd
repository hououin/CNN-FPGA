...
architecture behav of flat is 
    ...
    signal tmp_23_cast_fu_213_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_23_cast_reg_289 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln9_fu_186_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                add_ln15_reg_284 <= add_ln15_fu_198_p2;
                    tmp_23_cast_reg_289(9 downto 4) <= tmp_23_cast_fu_213_p3(9 downto 4);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    tmp_23_cast_reg_289(3 downto 0) <= "0000";
    ...
    add_ln14_2_fu_237_p2 <= std_logic_vector(unsigned(tmp_23_cast_reg_289) + unsigned(zext_ln14_4_fu_233_p1));
    ...
    tmp_23_cast_fu_213_p3 <= (add_ln14_1_fu_208_p2 & ap_const_lv4_0);
