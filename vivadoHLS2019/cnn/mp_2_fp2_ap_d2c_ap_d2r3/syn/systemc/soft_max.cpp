...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    cnn_fadd_32ns_32ncud_U150 = new cnn_fadd_32ns_32ncud<1,4,32,32,32>("cnn_fadd_32ns_32ncud_U150");
    cnn_fadd_32ns_32ncud_U150->clk(ap_clk);
    cnn_fadd_32ns_32ncud_U150->reset(ap_rst);
    cnn_fadd_32ns_32ncud_U150->din0(sum_0_reg_68);
    cnn_fadd_32ns_32ncud_U150->din1(reg_123);
    cnn_fadd_32ns_32ncud_U150->ce(ap_var_for_const0);
    cnn_fadd_32ns_32ncud_U150->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32n7jG_U151 = new cnn_fdiv_32ns_32n7jG<1,8,32,32,32>("cnn_fdiv_32ns_32n7jG_U151");
    cnn_fdiv_32ns_32n7jG_U151->clk(ap_clk);
    cnn_fdiv_32ns_32n7jG_U151->reset(ap_rst);
    cnn_fdiv_32ns_32n7jG_U151->din0(reg_123);
    cnn_fdiv_32ns_32n7jG_U151->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32n7jG_U151->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32n7jG_U151->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32n8jQ_U152 = new cnn_fexp_32ns_32n8jQ<1,5,32,32,32>("cnn_fexp_32ns_32n8jQ_U152");
    cnn_fexp_32ns_32n8jQ_U152->clk(ap_clk);
    cnn_fexp_32ns_32n8jQ_U152->reset(ap_rst);
    cnn_fexp_32ns_32n8jQ_U152->din0(ap_var_for_const1);
    cnn_fexp_32ns_32n8jQ_U152->din1(dense_array_q0);
    cnn_fexp_32ns_32n8jQ_U152->ce(ap_var_for_const0);
    cnn_fexp_32ns_32n8jQ_U152->dout(grp_fu_112_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fdiv_32ns_32n7jG_U151;
    delete cnn_fexp_32ns_32n8jQ_U152;
}
