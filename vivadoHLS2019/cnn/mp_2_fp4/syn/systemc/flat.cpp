...
void flat::thread_add_ln14_2_fu_237_p2() {
    add_ln14_2_fu_237_p2 = (!tmp_20_cast_reg_289.read().is_01() || !zext_ln14_4_fu_233_p1.read().is_01())? sc_lv<10>(): (sc_biguint<10>(tmp_20_cast_reg_289.read()) + sc_biguint<10>(zext_ln14_4_fu_233_p1.read()));
}
...
void flat::thread_tmp_1_fu_168_p3() {
    tmp_1_fu_168_p3 = esl_concat<3,2>(r_0_reg_79.read(), ap_const_lv2_0);
}

void flat::thread_tmp_20_cast_fu_213_p3() {
    tmp_20_cast_fu_213_p3 = esl_concat<6,4>(add_ln14_1_fu_208_p2.read(), ap_const_lv4_0);
}

void flat::thread_zext_ln14_1_fu_176_p1() {
    zext_ln14_1_fu_176_p1 = esl_zext<6,5>(tmp_1_fu_168_p3.read());
}
