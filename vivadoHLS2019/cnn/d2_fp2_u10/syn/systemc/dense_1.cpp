...
dense_1::dense_1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_add_ln14_12_fu_206_p2);
    ...
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( zext_ln14_34_fu_217_p1 );
    ...
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( zext_ln14_14_fu_201_p1 );
    ...
    SC_METHOD(thread_tmp_4_fu_225_p4);
    ...
    SC_METHOD(thread_zext_ln14_14_fu_201_p1);
    sensitive << ( j_0_reg_129 );

    SC_METHOD(thread_zext_ln14_34_fu_217_p1);
    ...
    sc_trace(mVcdFile, add_ln14_12_fu_206_p2, "add_ln14_12_fu_206_p2");
    sc_trace(mVcdFile, add_ln14_12_reg_298, "add_ln14_12_reg_298");
    ...
    sc_trace(mVcdFile, zext_ln14_34_fu_217_p1, "zext_ln14_34_fu_217_p1");
    sc_trace(mVcdFile, zext_ln14_14_fu_201_p1, "zext_ln14_14_fu_201_p1");
    ...
    sc_trace(mVcdFile, tmp_4_fu_225_p4, "tmp_4_fu_225_p4");
...
void dense_1::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        phi_mul_reg_140 = add_ln14_12_reg_298.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(icmp_ln9_fu_169_p2.read(), ap_const_lv1_0))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln13_fu_189_p2.read()))) {
        add_ln14_12_reg_298 = add_ln14_12_fu_206_p2.read();
    }
...
void dense_1::thread_add_ln14_12_fu_206_p2() {
    add_ln14_12_fu_206_p2 = (!phi_mul_reg_140.read().is_01() || !ap_const_lv15_32.is_01())? sc_lv<15>(): (sc_biguint<15>(phi_mul_reg_140.read()) + sc_biguint<15>(ap_const_lv15_32));
}
...
void dense_1::thread_dense_1_weights_address0() {
    dense_1_weights_address0 =  (sc_lv<15>) (zext_ln14_34_fu_217_p1.read());
}
...
void dense_1::thread_flat_array_address0() {
    flat_array_address0 =  (sc_lv<9>) (zext_ln14_14_fu_201_p1.read());
}
...
void dense_1::thread_icmp_ln19_fu_239_p2() {
    icmp_ln19_fu_239_p2 = (!tmp_4_fu_225_p4.read().is_01() || !ap_const_lv8_FF.is_01())? sc_lv<1>(): sc_lv<1>(tmp_4_fu_225_p4.read() != ap_const_lv8_FF);
}
...
void dense_1::thread_tmp_4_fu_225_p4() {
    tmp_4_fu_225_p4 = bitcast_ln19_fu_222_p1.read().range(30, 23);
}
...
void dense_1::thread_zext_ln14_14_fu_201_p1() {
    zext_ln14_14_fu_201_p1 = esl_zext<64,9>(j_0_reg_129.read());
}

void dense_1::thread_zext_ln14_34_fu_217_p1() {
    zext_ln14_34_fu_217_p1 = esl_zext<64,15>(add_ln14_fu_212_p2.read());
}
