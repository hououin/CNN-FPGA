...
#include "dense_out_dense_obck.h"
#include "dense_out_dense_abdk.h"
...
struct dense_out : public sc_module {
    ...
    dense_out_dense_obbk* dense_out_weights_U;
    dense_out_dense_obck* dense_out_bias_U;
    dense_out_dense_abdk* dense_array_U;
    soft_max* grp_soft_max_fu_149;
    cnn_fadd_32ns_32ncud<1,4,32,32,32>* cnn_fadd_32ns_32ncud_U142;
