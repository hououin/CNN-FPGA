...
wire   [9:0] tmp_180_cast_fu_213_p3;
reg   [9:0] tmp_180_cast_reg_289;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln9_fu_186_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        ...
        tmp_180_cast_reg_289[9 : 4] <= tmp_180_cast_fu_213_p3[9 : 4];
    end
end
...
assign add_ln14_2_fu_237_p2 = (tmp_180_cast_reg_289 + zext_ln14_5_fu_233_p1);
...
assign tmp_180_cast_fu_213_p3 = {{add_ln14_1_fu_208_p2}, {4'd0}};
...
always @ (posedge ap_clk) begin
    tmp_180_cast_reg_289[3:0] <= 4'b0000;
end
