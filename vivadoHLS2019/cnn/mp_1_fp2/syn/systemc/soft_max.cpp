...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_fadd_32ns_32ncud_U27->din0(sum_0_reg_68);
    cnn_fadd_32ns_32ncud_U27->din1(reg_123);
    cnn_fadd_32ns_32ncud_U27->ce(ap_var_for_const0);
    cnn_fadd_32ns_32ncud_U27->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32ng8j_U28 = new cnn_fdiv_32ns_32ng8j<1,8,32,32,32>("cnn_fdiv_32ns_32ng8j_U28");
    cnn_fdiv_32ns_32ng8j_U28->clk(ap_clk);
    cnn_fdiv_32ns_32ng8j_U28->reset(ap_rst);
    cnn_fdiv_32ns_32ng8j_U28->din0(reg_123);
    cnn_fdiv_32ns_32ng8j_U28->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32ng8j_U28->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32ng8j_U28->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32nhbi_U29 = new cnn_fexp_32ns_32nhbi<1,5,32,32,32>("cnn_fexp_32ns_32nhbi_U29");
    ...
    cnn_fexp_32ns_32nhbi_U29->dout(grp_fu_112_p2);
