...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_fadd_32ns_32ncud_U34->din0(sum_0_reg_68);
    cnn_fadd_32ns_32ncud_U34->din1(reg_123);
    cnn_fadd_32ns_32ncud_U34->ce(ap_var_for_const0);
    cnn_fadd_32ns_32ncud_U34->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32nhbi_U35 = new cnn_fdiv_32ns_32nhbi<1,8,32,32,32>("cnn_fdiv_32ns_32nhbi_U35");
    cnn_fdiv_32ns_32nhbi_U35->clk(ap_clk);
    cnn_fdiv_32ns_32nhbi_U35->reset(ap_rst);
    cnn_fdiv_32ns_32nhbi_U35->din0(reg_123);
    cnn_fdiv_32ns_32nhbi_U35->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32nhbi_U35->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32nhbi_U35->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32nibs_U36 = new cnn_fexp_32ns_32nibs<1,5,32,32,32>("cnn_fexp_32ns_32nibs_U36");
    ...
    cnn_fexp_32ns_32nibs_U36->dout(grp_fu_112_p2);
