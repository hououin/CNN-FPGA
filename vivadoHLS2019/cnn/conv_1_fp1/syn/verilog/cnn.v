...
(* CORE_GENERATION_INFO="cnn,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=18.023660,HLS_SYN_LAT=975984,HLS_SYN_TPT=none,HLS_SYN_MEM=91,HLS_SYN_DSP=118,HLS_SYN_FF=26811,HLS_SYN_LUT=48506,HLS_VERSION=2019_1}" *)
...
wire    grp_conv_1_fu_398_ap_start;
wire    grp_conv_1_fu_398_ap_done;
wire    grp_conv_1_fu_398_ap_idle;
wire    grp_conv_1_fu_398_ap_ready;
wire   [9:0] grp_conv_1_fu_398_input_r_address0;
wire    grp_conv_1_fu_398_input_r_ce0;
wire   [9:0] grp_conv_1_fu_398_input_r_address1;
wire    grp_conv_1_fu_398_input_r_ce1;
wire   [11:0] grp_conv_1_fu_398_conv_out_address0;
wire    grp_conv_1_fu_398_conv_out_ce0;
wire    grp_conv_1_fu_398_conv_out_we0;
wire   [31:0] grp_conv_1_fu_398_conv_out_d0;
wire   [11:0] grp_conv_1_fu_398_conv_out_address1;
wire    grp_conv_1_fu_398_conv_out_ce1;
wire    grp_conv_1_fu_398_conv_out_we1;
wire   [31:0] grp_conv_1_fu_398_conv_out_d1;
wire    grp_dense_out_fu_405_ap_start;
wire    grp_dense_out_fu_405_ap_done;
wire    grp_dense_out_fu_405_ap_idle;
wire    grp_dense_out_fu_405_ap_ready;
wire   [31:0] grp_dense_out_fu_405_prediction_Addr_A;
wire    grp_dense_out_fu_405_prediction_EN_A;
wire   [3:0] grp_dense_out_fu_405_prediction_WEN_A;
wire   [31:0] grp_dense_out_fu_405_prediction_Din_A;
wire   [4:0] grp_dense_out_fu_405_dense_2_out_address0;
wire    grp_dense_out_fu_405_dense_2_out_ce0;
wire    grp_conv_2_fu_417_ap_start;
wire    grp_conv_2_fu_417_ap_done;
wire    grp_conv_2_fu_417_ap_idle;
wire    grp_conv_2_fu_417_ap_ready;
wire   [10:0] grp_conv_2_fu_417_conv_out_address0;
wire    grp_conv_2_fu_417_conv_out_ce0;
wire    grp_conv_2_fu_417_conv_out_we0;
wire   [31:0] grp_conv_2_fu_417_conv_out_d0;
wire   [9:0] grp_conv_2_fu_417_max_pool_1_out_address0;
wire    grp_conv_2_fu_417_max_pool_1_out_ce0;
...
reg    grp_conv_1_fu_398_ap_start_reg;
wire    ap_CS_fsm_state5;
reg    grp_dense_out_fu_405_ap_start_reg;
wire    ap_CS_fsm_state40;
reg    grp_conv_2_fu_417_ap_start_reg;
...
wire   [9:0] tmp_326_fu_509_p3;
wire   [6:0] tmp_327_fu_521_p3;
...
wire   [10:0] tmp_328_fu_716_p3;
wire   [6:0] tmp_329_fu_728_p3;
...
initial begin
#0 ap_CS_fsm = 40'd1;
#0 grp_conv_1_fu_398_ap_start_reg = 1'b0;
#0 grp_dense_out_fu_405_ap_start_reg = 1'b0;
#0 grp_conv_2_fu_417_ap_start_reg = 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_conv_1_fu_398_ap_start_reg <= 1'b0;
    end else begin
        if (((icmp_ln23_fu_491_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            grp_conv_1_fu_398_ap_start_reg <= 1'b1;
        end else if ((grp_conv_1_fu_398_ap_ready == 1'b1)) begin
            grp_conv_1_fu_398_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_conv_2_fu_417_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state8)) begin
            grp_conv_2_fu_417_ap_start_reg <= 1'b1;
        end else if ((grp_conv_2_fu_417_ap_ready == 1'b1)) begin
            grp_conv_2_fu_417_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_dense_out_fu_405_ap_start_reg <= 1'b0;
    end else begin
        if (((icmp_ln9_1_fu_679_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state27))) begin
            grp_dense_out_fu_405_ap_start_reg <= 1'b1;
        end else if ((grp_dense_out_fu_405_ap_ready == 1'b1)) begin
            grp_dense_out_fu_405_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if (((grp_dense_out_fu_405_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state40))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state5 : begin
            if (((grp_conv_1_fu_398_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
        ...
        ap_ST_fsm_state9 : begin
            if (((grp_conv_2_fu_417_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state9))) begin
...
assign grp_conv_1_fu_398_ap_start = grp_conv_1_fu_398_ap_start_reg;

assign grp_conv_2_fu_417_ap_start = grp_conv_2_fu_417_ap_start_reg;

assign grp_dense_out_fu_405_ap_start = grp_dense_out_fu_405_ap_start_reg;
...
assign icmp_ln19_2_fu_774_p2 = ((tmp_319_fu_760_p4 != 8'd255) ? 1'b1 : 1'b0);
...
assign prediction_Addr_A = grp_dense_out_fu_405_prediction_Addr_A;

assign prediction_Clk_A = ap_clk;

assign prediction_Din_A = grp_dense_out_fu_405_prediction_Din_A;

assign prediction_EN_A = grp_dense_out_fu_405_prediction_EN_A;

assign prediction_Rst_A = ap_rst_n_inv;

assign prediction_WEN_A = grp_dense_out_fu_405_prediction_WEN_A;
...
assign tmp_319_fu_760_p4 = {{bitcast_ln19_1_fu_756_p1[30:23]}};

assign tmp_326_fu_509_p3 = {{i_0_reg_287}, {5'd0}};

assign tmp_327_fu_521_p3 = {{i_0_reg_287}, {2'd0}};

assign tmp_328_fu_716_p3 = {{j_0_i7_reg_387}, {5'd0}};

assign tmp_329_fu_728_p3 = {{j_0_i7_reg_387}, {1'd0}};
...
assign zext_ln14_8_fu_724_p1 = tmp_328_fu_716_p3;

assign zext_ln14_9_fu_736_p1 = tmp_329_fu_728_p3;

assign zext_ln14_fu_587_p1 = i_0_i_reg_319;

assign zext_ln27_1_fu_551_p1 = ix_in_1_reg_298;

assign zext_ln27_2_fu_529_p1 = tmp_327_fu_521_p3;

assign zext_ln27_3_fu_556_p1 = j_0_reg_308;

assign zext_ln27_fu_517_p1 = tmp_326_fu_509_p3;
