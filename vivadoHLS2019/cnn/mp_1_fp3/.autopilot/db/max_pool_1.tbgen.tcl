...
set C_modelArgList {
	...
	{ conv_1_out float 32 regular {array 4056 { 1 1 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "max_pool_out", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "conv_1_out", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cnn_fcmp_32ns_32neOg_U12", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cnn_mac_muladd_5nfYi_U13", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	conv_1_out { ap_memory {  { conv_1_out_address0 mem_address 1 12 }  { conv_1_out_ce0 mem_ce 1 1 }  { conv_1_out_q0 mem_dout 0 32 }  { conv_1_out_address1 MemPortADDR2 1 12 }  { conv_1_out_ce1 MemPortCE2 1 1 }  { conv_1_out_q1 MemPortDOUT2 0 32 } } }
}
