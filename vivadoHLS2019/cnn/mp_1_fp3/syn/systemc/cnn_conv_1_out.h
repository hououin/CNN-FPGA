...
// ==============================================================
#ifndef __cnn_conv_1_out_H__
#define __cnn_conv_1_out_H__
...
cnn_conv_1_out_ram* meminst;


SC_CTOR(cnn_conv_1_out) {
meminst = new cnn_conv_1_out_ram("cnn_conv_1_out_ram");
