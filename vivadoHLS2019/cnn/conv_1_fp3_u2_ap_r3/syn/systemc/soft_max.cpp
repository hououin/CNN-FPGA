...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    cnn_fadd_32ns_32ncud_U77 = new cnn_fadd_32ns_32ncud<1,4,32,32,32>("cnn_fadd_32ns_32ncud_U77");
    cnn_fadd_32ns_32ncud_U77->clk(ap_clk);
    cnn_fadd_32ns_32ncud_U77->reset(ap_rst);
    cnn_fadd_32ns_32ncud_U77->din0(sum_0_reg_68);
    cnn_fadd_32ns_32ncud_U77->din1(reg_123);
    cnn_fadd_32ns_32ncud_U77->ce(ap_var_for_const0);
    cnn_fadd_32ns_32ncud_U77->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32nibs_U78 = new cnn_fdiv_32ns_32nibs<1,8,32,32,32>("cnn_fdiv_32ns_32nibs_U78");
    cnn_fdiv_32ns_32nibs_U78->clk(ap_clk);
    cnn_fdiv_32ns_32nibs_U78->reset(ap_rst);
    cnn_fdiv_32ns_32nibs_U78->din0(reg_123);
    cnn_fdiv_32ns_32nibs_U78->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32nibs_U78->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32nibs_U78->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32njbC_U79 = new cnn_fexp_32ns_32njbC<1,5,32,32,32>("cnn_fexp_32ns_32njbC_U79");
    cnn_fexp_32ns_32njbC_U79->clk(ap_clk);
    cnn_fexp_32ns_32njbC_U79->reset(ap_rst);
    cnn_fexp_32ns_32njbC_U79->din0(ap_var_for_const1);
    cnn_fexp_32ns_32njbC_U79->din1(dense_array_q0);
    cnn_fexp_32ns_32njbC_U79->ce(ap_var_for_const0);
    cnn_fexp_32ns_32njbC_U79->dout(grp_fu_112_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fdiv_32ns_32nibs_U78;
    delete cnn_fexp_32ns_32njbC_U79;
}
