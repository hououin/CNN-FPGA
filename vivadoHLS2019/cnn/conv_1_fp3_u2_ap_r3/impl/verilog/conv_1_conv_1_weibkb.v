...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module conv_1_conv_1_weibkb_rom (
addr0, ce0, q0, addr1, ce1, q1, addr2, ce2, q2, addr3, ce3, q3, addr4, ce4, q4, addr5, ce5, q5, addr6, ce6, q6, addr7, ce7, q7, addr8, ce8, q8, addr9, ce9, q9, addr10, ce10, q10, addr11, ce11, q11, addr12, ce12, q12, addr13, ce13, q13, addr14, ce14, q14, addr15, ce15, q15, addr16, ce16, q16, addr17, ce17, q17, clk);
...
initial begin
    $readmemh("./conv_1_conv_1_weibkb_rom.dat", ram0);
    $readmemh("./conv_1_conv_1_weibkb_rom.dat", ram1);
    $readmemh("./conv_1_conv_1_weibkb_rom.dat", ram2);
    $readmemh("./conv_1_conv_1_weibkb_rom.dat", ram3);
    $readmemh("./conv_1_conv_1_weibkb_rom.dat", ram4);
    $readmemh("./conv_1_conv_1_weibkb_rom.dat", ram5);
    $readmemh("./conv_1_conv_1_weibkb_rom.dat", ram6);
    $readmemh("./conv_1_conv_1_weibkb_rom.dat", ram7);
    $readmemh("./conv_1_conv_1_weibkb_rom.dat", ram8);
end
...
conv_1_conv_1_weibkb_rom conv_1_conv_1_weibkb_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
