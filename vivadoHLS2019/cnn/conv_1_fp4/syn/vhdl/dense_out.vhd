...
architecture behav of dense_out is 
    ...
    component dense_out_dense_ancg IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    dense_out_weights_U : component dense_out_dense_olbW
    generic map (
        DataWidth => 32,
        AddressRange => 300,
        AddressWidth => 9)
    ...
    dense_out_bias_U : component dense_out_dense_omb6
    generic map (
        DataWidth => 32,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    dense_array_U : component dense_out_dense_ancg
    generic map (
        DataWidth => 32,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    cnn_fadd_32ns_32neOg_U36 : component cnn_fadd_32ns_32neOg
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    cnn_fmul_32ns_32nfYi_U37 : component cnn_fmul_32ns_32nfYi
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
