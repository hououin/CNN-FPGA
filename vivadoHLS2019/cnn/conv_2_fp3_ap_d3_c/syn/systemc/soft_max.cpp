...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_fadd_32ns_32ncud_U111->din0(sum_0_reg_68);
    cnn_fadd_32ns_32ncud_U111->din1(reg_123);
    cnn_fadd_32ns_32ncud_U111->ce(ap_var_for_const0);
    cnn_fadd_32ns_32ncud_U111->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32n8jQ_U112 = new cnn_fdiv_32ns_32n8jQ<1,8,32,32,32>("cnn_fdiv_32ns_32n8jQ_U112");
    cnn_fdiv_32ns_32n8jQ_U112->clk(ap_clk);
    cnn_fdiv_32ns_32n8jQ_U112->reset(ap_rst);
    cnn_fdiv_32ns_32n8jQ_U112->din0(reg_123);
    cnn_fdiv_32ns_32n8jQ_U112->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32n8jQ_U112->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32n8jQ_U112->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32n9j0_U113 = new cnn_fexp_32ns_32n9j0<1,5,32,32,32>("cnn_fexp_32ns_32n9j0_U113");
    cnn_fexp_32ns_32n9j0_U113->clk(ap_clk);
    cnn_fexp_32ns_32n9j0_U113->reset(ap_rst);
    cnn_fexp_32ns_32n9j0_U113->din0(ap_var_for_const1);
    cnn_fexp_32ns_32n9j0_U113->din1(dense_array_q0);
    cnn_fexp_32ns_32n9j0_U113->ce(ap_var_for_const0);
    cnn_fexp_32ns_32n9j0_U113->dout(grp_fu_112_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fdiv_32ns_32n8jQ_U112;
    delete cnn_fexp_32ns_32n9j0_U113;
}
