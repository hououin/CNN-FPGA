...
// ==============================================================
#ifndef __dense_out_dense_obbk_H__
#define __dense_out_dense_obbk_H__
...
struct dense_out_dense_obbk_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_out_dense_obbk_ram) {
...
SC_MODULE(dense_out_dense_obbk) {
...
dense_out_dense_obbk_ram* meminst;


SC_CTOR(dense_out_dense_obbk) {
meminst = new dense_out_dense_obbk_ram("dense_out_dense_obbk_ram");
