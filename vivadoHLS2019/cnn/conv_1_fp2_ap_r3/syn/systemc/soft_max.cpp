...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_fadd_32ns_32nbkb_U74->din0(sum_0_reg_68);
    cnn_fadd_32ns_32nbkb_U74->din1(reg_123);
    cnn_fadd_32ns_32nbkb_U74->ce(ap_var_for_const0);
    cnn_fadd_32ns_32nbkb_U74->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32nhbi_U75 = new cnn_fdiv_32ns_32nhbi<1,8,32,32,32>("cnn_fdiv_32ns_32nhbi_U75");
    cnn_fdiv_32ns_32nhbi_U75->clk(ap_clk);
    cnn_fdiv_32ns_32nhbi_U75->reset(ap_rst);
    cnn_fdiv_32ns_32nhbi_U75->din0(reg_123);
    cnn_fdiv_32ns_32nhbi_U75->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32nhbi_U75->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32nhbi_U75->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32nibs_U76 = new cnn_fexp_32ns_32nibs<1,5,32,32,32>("cnn_fexp_32ns_32nibs_U76");
    cnn_fexp_32ns_32nibs_U76->clk(ap_clk);
    cnn_fexp_32ns_32nibs_U76->reset(ap_rst);
    cnn_fexp_32ns_32nibs_U76->din0(ap_var_for_const1);
    cnn_fexp_32ns_32nibs_U76->din1(dense_array_q0);
    cnn_fexp_32ns_32nibs_U76->ce(ap_var_for_const0);
    cnn_fexp_32ns_32nibs_U76->dout(grp_fu_112_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fdiv_32ns_32nhbi_U75;
    delete cnn_fexp_32ns_32nibs_U76;
}
