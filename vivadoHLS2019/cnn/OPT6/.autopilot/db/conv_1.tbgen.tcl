...
set C_modelArgList {
	...
	{ conv_out_0 float 32 regular {array 2028 { 0 0 } 0 1 }  }
	{ conv_out_1 float 32 regular {array 2028 { 0 0 } 0 1 }  }
}
...
set portList { 
	...
	{ conv_out_0_address1 sc_out sc_lv 11 signal 1 } 
	...
	{ conv_out_1_address1 sc_out sc_lv 11 signal 2 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "26", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cnn_mac_muladd_5neOg_U26", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	conv_out_0 { ap_memory {  { conv_out_0_address0 mem_address 1 11 }  { conv_out_0_ce0 mem_ce 1 1 }  { conv_out_0_we0 mem_we 1 1 }  { conv_out_0_d0 mem_din 1 32 }  { conv_out_0_address1 MemPortADDR2 1 11 }  { conv_out_0_ce1 MemPortCE2 1 1 }  { conv_out_0_we1 MemPortWE2 1 1 }  { conv_out_0_d1 MemPortDIN2 1 32 } } }
	conv_out_1 { ap_memory {  { conv_out_1_address0 mem_address 1 11 }  { conv_out_1_ce0 mem_ce 1 1 }  { conv_out_1_we0 mem_we 1 1 }  { conv_out_1_d0 mem_din 1 32 }  { conv_out_1_address1 MemPortADDR2 1 11 }  { conv_out_1_ce1 MemPortCE2 1 1 }  { conv_out_1_we1 MemPortWE2 1 1 }  { conv_out_1_d1 MemPortDIN2 1 32 } } }
}
