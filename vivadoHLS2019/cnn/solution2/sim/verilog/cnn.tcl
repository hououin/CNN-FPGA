...
set prediction_group [add_wave_group prediction(bram) -into $coutputgroup]
add_wave /apatb_cnn_top/AESL_inst_cnn/prediction_Rst_A -into $prediction_group -radix hex
add_wave /apatb_cnn_top/AESL_inst_cnn/prediction_Clk_A -into $prediction_group -radix hex
add_wave /apatb_cnn_top/AESL_inst_cnn/prediction_Dout_A -into $prediction_group -radix hex
add_wave /apatb_cnn_top/AESL_inst_cnn/prediction_Din_A -into $prediction_group -radix hex
add_wave /apatb_cnn_top/AESL_inst_cnn/prediction_WEN_A -into $prediction_group -color #ffff00 -radix hex
add_wave /apatb_cnn_top/AESL_inst_cnn/prediction_EN_A -into $prediction_group -color #ffff00 -radix hex
add_wave /apatb_cnn_top/AESL_inst_cnn/prediction_Addr_A -into $prediction_group -radix hex
...
set tb_prediction_group [add_wave_group prediction(bram) -into $tbcoutputgroup]
add_wave /apatb_cnn_top/prediction_RST_A -into $tb_prediction_group -radix hex
add_wave /apatb_cnn_top/prediction_CLK_A -into $tb_prediction_group -radix hex
add_wave /apatb_cnn_top/prediction_DOUT_A -into $tb_prediction_group -radix hex
add_wave /apatb_cnn_top/prediction_DIN_A -into $tb_prediction_group -radix hex
add_wave /apatb_cnn_top/prediction_WEN_A -into $tb_prediction_group -color #ffff00 -radix hex
add_wave /apatb_cnn_top/prediction_EN_A -into $tb_prediction_group -color #ffff00 -radix hex
add_wave /apatb_cnn_top/prediction_ADDR_A -into $tb_prediction_group -radix hex
