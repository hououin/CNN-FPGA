...
// ==============================================================
#ifndef __cnn_fcmp_32ns_32neOg__HH__
#define __cnn_fcmp_32ns_32neOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_fcmp_32ns_32neOg) {
    ...
    SC_CTOR(cnn_fcmp_32ns_32neOg):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
