...
`define AUTOTB_TVIN_prediction  "./c.cnn.autotvin_prediction.dat"
`define AUTOTB_TVIN_cnn_input_out_wrapc  "./rtl.cnn.autotvin_cnn_input.dat"
`define AUTOTB_TVIN_prediction_out_wrapc  "./rtl.cnn.autotvin_prediction.dat"
`define AUTOTB_TVOUT_prediction  "./c.cnn.autotvout_prediction.dat"
`define AUTOTB_TVOUT_prediction_out_wrapc  "./impl_rtl.cnn.autotvout_prediction.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1283541;
...
initial begin : dump_tvout_runtime_sign_prediction
    ...
    fp = $fopen(`AUTOTB_TVOUT_prediction_out_wrapc, "w");
    if (fp == 0) begin
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_prediction_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_prediction_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
