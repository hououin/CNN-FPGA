...
// ==============================================================
#ifndef __cnn_mac_muladd_9nbil__HH__
#define __cnn_mac_muladd_9nbil__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_9nbil) {
    ...
    SC_CTOR(cnn_mac_muladd_9nbil):  simcore_mac_0_U ("simcore_mac_0_U") {
