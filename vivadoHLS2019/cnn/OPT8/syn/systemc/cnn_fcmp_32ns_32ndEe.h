...
// ==============================================================
#ifndef __cnn_fcmp_32ns_32ndEe__HH__
#define __cnn_fcmp_32ns_32ndEe__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_fcmp_32ns_32ndEe) {
    ...
    SC_CTOR(cnn_fcmp_32ns_32ndEe):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
