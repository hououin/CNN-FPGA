...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    cnn_fadd_32ns_32nkbM_U42 = new cnn_fadd_32ns_32nkbM<1,4,32,32,32>("cnn_fadd_32ns_32nkbM_U42");
    cnn_fadd_32ns_32nkbM_U42->clk(ap_clk);
    cnn_fadd_32ns_32nkbM_U42->reset(ap_rst);
    cnn_fadd_32ns_32nkbM_U42->din0(sum_0_reg_68);
    cnn_fadd_32ns_32nkbM_U42->din1(reg_123);
    cnn_fadd_32ns_32nkbM_U42->ce(ap_var_for_const0);
    cnn_fadd_32ns_32nkbM_U42->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32npcA_U43 = new cnn_fdiv_32ns_32npcA<1,8,32,32,32>("cnn_fdiv_32ns_32npcA_U43");
    cnn_fdiv_32ns_32npcA_U43->clk(ap_clk);
    cnn_fdiv_32ns_32npcA_U43->reset(ap_rst);
    cnn_fdiv_32ns_32npcA_U43->din0(reg_123);
    cnn_fdiv_32ns_32npcA_U43->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32npcA_U43->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32npcA_U43->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32nqcK_U44 = new cnn_fexp_32ns_32nqcK<1,5,32,32,32>("cnn_fexp_32ns_32nqcK_U44");
    cnn_fexp_32ns_32nqcK_U44->clk(ap_clk);
    cnn_fexp_32ns_32nqcK_U44->reset(ap_rst);
    cnn_fexp_32ns_32nqcK_U44->din0(ap_var_for_const1);
    cnn_fexp_32ns_32nqcK_U44->din1(dense_array_q0);
    cnn_fexp_32ns_32nqcK_U44->ce(ap_var_for_const0);
    cnn_fexp_32ns_32nqcK_U44->dout(grp_fu_112_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fadd_32ns_32nkbM_U42;
    delete cnn_fdiv_32ns_32npcA_U43;
    delete cnn_fexp_32ns_32nqcK_U44;
}
