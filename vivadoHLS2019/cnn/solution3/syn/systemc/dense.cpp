...
dense::dense(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_fadd_32ns_32ncud_U39 = new cnn_fadd_32ns_32ncud<1,2,32,32,32>("cnn_fadd_32ns_32ncud_U39");
    cnn_fadd_32ns_32ncud_U39->clk(ap_clk);
    cnn_fadd_32ns_32ncud_U39->reset(ap_rst);
    cnn_fadd_32ns_32ncud_U39->din0(grp_fu_168_p0);
    cnn_fadd_32ns_32ncud_U39->din1(grp_fu_173_p2);
    cnn_fadd_32ns_32ncud_U39->ce(ap_var_for_const1);
    cnn_fadd_32ns_32ncud_U39->dout(grp_fu_168_p2);
    ...
    cnn_fmul_32ns_32ndEe_U40->din0(dense_weights_q0);
    cnn_fmul_32ns_32ndEe_U40->din1(flat_array_q0);
    cnn_fmul_32ns_32ndEe_U40->ce(ap_var_for_const1);
    cnn_fmul_32ns_32ndEe_U40->dout(grp_fu_173_p2);
...
void dense::thread_tmp_2_fu_241_p3() {
    tmp_2_fu_241_p3 = esl_concat<11,1>(select_ln35_1_fu_204_p3.read(), ap_const_lv1_0);
}

void dense::thread_tmp_s_fu_229_p3() {
    tmp_s_fu_229_p3 = esl_concat<11,3>(select_ln35_1_fu_204_p3.read(), ap_const_lv3_0);
}
...
void dense::thread_zext_ln35_7_fu_237_p1() {
    zext_ln35_7_fu_237_p1 = esl_zext<15,14>(tmp_s_fu_229_p3.read());
}

void dense::thread_zext_ln35_8_fu_249_p1() {
    zext_ln35_8_fu_249_p1 = esl_zext<15,12>(tmp_2_fu_241_p3.read());
}
