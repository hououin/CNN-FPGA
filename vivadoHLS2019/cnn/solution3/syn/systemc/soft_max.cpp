...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    cnn_fadd_32ns_32ncud_U33 = new cnn_fadd_32ns_32ncud<1,2,32,32,32>("cnn_fadd_32ns_32ncud_U33");
    cnn_fadd_32ns_32ncud_U33->clk(ap_clk);
    cnn_fadd_32ns_32ncud_U33->reset(ap_rst);
    cnn_fadd_32ns_32ncud_U33->din0(sum_0_reg_84);
    cnn_fadd_32ns_32ncud_U33->din1(reg_140);
    cnn_fadd_32ns_32ncud_U33->ce(ap_var_for_const0);
    cnn_fadd_32ns_32ncud_U33->dout(grp_fu_118_p2);
    cnn_fdiv_32ns_32njbC_U34 = new cnn_fdiv_32ns_32njbC<1,6,32,32,32>("cnn_fdiv_32ns_32njbC_U34");
    cnn_fdiv_32ns_32njbC_U34->clk(ap_clk);
    cnn_fdiv_32ns_32njbC_U34->reset(ap_rst);
    cnn_fdiv_32ns_32njbC_U34->din0(reg_140);
    cnn_fdiv_32ns_32njbC_U34->din1(sum_0_reg_84);
    cnn_fdiv_32ns_32njbC_U34->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32njbC_U34->dout(grp_fu_123_p2);
    cnn_fexp_32ns_32nkbM_U35 = new cnn_fexp_32ns_32nkbM<1,4,32,32,32>("cnn_fexp_32ns_32nkbM_U35");
    cnn_fexp_32ns_32nkbM_U35->clk(ap_clk);
    cnn_fexp_32ns_32nkbM_U35->reset(ap_rst);
    cnn_fexp_32ns_32nkbM_U35->din0(ap_var_for_const1);
    cnn_fexp_32ns_32nkbM_U35->din1(dense_array_q0);
    cnn_fexp_32ns_32nkbM_U35->ce(ap_var_for_const0);
    cnn_fexp_32ns_32nkbM_U35->dout(grp_fu_129_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fdiv_32ns_32njbC_U34;
    delete cnn_fexp_32ns_32nkbM_U35;
}
