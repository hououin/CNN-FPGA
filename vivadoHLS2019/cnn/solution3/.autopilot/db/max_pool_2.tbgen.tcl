...
set C_modelArgList {
	...
	{ conv_2_out float 32 regular {array 7744 { 1 3 } 1 1 } {global 0}  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cnn_mac_muladd_5nibs_U27", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "11201", "Max" : "11201"}
	, {"Name" : "Interval", "Min" : "11201", "Max" : "11201"}
]}
...
set Spec2ImplPortList { 
	...
	conv_2_out { ap_memory {  { conv_2_out_address0 mem_address 1 13 }  { conv_2_out_ce0 mem_ce 1 1 }  { conv_2_out_q0 mem_dout 0 32 } } }
}
