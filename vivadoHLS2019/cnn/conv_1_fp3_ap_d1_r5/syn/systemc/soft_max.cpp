...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cnn_fadd_32ns_32nkbM_U50->reset(ap_rst);
    cnn_fadd_32ns_32nkbM_U50->din0(sum_0_reg_68);
    cnn_fadd_32ns_32nkbM_U50->din1(reg_123);
    cnn_fadd_32ns_32nkbM_U50->ce(ap_var_for_const0);
    cnn_fadd_32ns_32nkbM_U50->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32nqcK_U51 = new cnn_fdiv_32ns_32nqcK<1,8,32,32,32>("cnn_fdiv_32ns_32nqcK_U51");
    cnn_fdiv_32ns_32nqcK_U51->clk(ap_clk);
    cnn_fdiv_32ns_32nqcK_U51->reset(ap_rst);
    cnn_fdiv_32ns_32nqcK_U51->din0(reg_123);
    cnn_fdiv_32ns_32nqcK_U51->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32nqcK_U51->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32nqcK_U51->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32nrcU_U52 = new cnn_fexp_32ns_32nrcU<1,5,32,32,32>("cnn_fexp_32ns_32nrcU_U52");
    cnn_fexp_32ns_32nrcU_U52->clk(ap_clk);
    cnn_fexp_32ns_32nrcU_U52->reset(ap_rst);
    cnn_fexp_32ns_32nrcU_U52->din0(ap_var_for_const1);
    cnn_fexp_32ns_32nrcU_U52->din1(dense_array_q0);
    cnn_fexp_32ns_32nrcU_U52->ce(ap_var_for_const0);
    cnn_fexp_32ns_32nrcU_U52->dout(grp_fu_112_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fdiv_32ns_32nqcK_U51;
    delete cnn_fexp_32ns_32nrcU_U52;
}
