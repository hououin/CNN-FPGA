...
begin
    dense_out_weights_U : component dense_out_dense_osc4
    generic map (
        DataWidth => 32,
        AddressRange => 300,
        AddressWidth => 9)
    ...
    dense_out_bias_U : component dense_out_dense_otde
    generic map (
        DataWidth => 32,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    dense_array_U : component dense_out_dense_audo
    generic map (
        DataWidth => 32,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    cnn_fadd_32ns_32nkbM_U56 : component cnn_fadd_32ns_32nkbM
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    cnn_fmul_32ns_32nlbW_U57 : component cnn_fmul_32ns_32nlbW
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
