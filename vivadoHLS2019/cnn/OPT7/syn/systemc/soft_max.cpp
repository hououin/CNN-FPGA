...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    cnn_fadd_32ns_32nbkb_U164 = new cnn_fadd_32ns_32nbkb<1,4,32,32,32>("cnn_fadd_32ns_32nbkb_U164");
    cnn_fadd_32ns_32nbkb_U164->clk(ap_clk);
    cnn_fadd_32ns_32nbkb_U164->reset(ap_rst);
    cnn_fadd_32ns_32nbkb_U164->din0(sum_0_reg_68);
    cnn_fadd_32ns_32nbkb_U164->din1(reg_123);
    cnn_fadd_32ns_32nbkb_U164->ce(ap_var_for_const0);
    cnn_fadd_32ns_32nbkb_U164->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32n8jQ_U165 = new cnn_fdiv_32ns_32n8jQ<1,8,32,32,32>("cnn_fdiv_32ns_32n8jQ_U165");
    cnn_fdiv_32ns_32n8jQ_U165->clk(ap_clk);
    cnn_fdiv_32ns_32n8jQ_U165->reset(ap_rst);
    cnn_fdiv_32ns_32n8jQ_U165->din0(reg_123);
    cnn_fdiv_32ns_32n8jQ_U165->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32n8jQ_U165->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32n8jQ_U165->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32n9j0_U166 = new cnn_fexp_32ns_32n9j0<1,5,32,32,32>("cnn_fexp_32ns_32n9j0_U166");
    cnn_fexp_32ns_32n9j0_U166->clk(ap_clk);
    cnn_fexp_32ns_32n9j0_U166->reset(ap_rst);
    cnn_fexp_32ns_32n9j0_U166->din0(ap_var_for_const1);
    cnn_fexp_32ns_32n9j0_U166->din1(dense_array_q0);
    cnn_fexp_32ns_32n9j0_U166->ce(ap_var_for_const0);
    cnn_fexp_32ns_32n9j0_U166->dout(grp_fu_112_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fadd_32ns_32nbkb_U164;
    delete cnn_fdiv_32ns_32n8jQ_U165;
    delete cnn_fexp_32ns_32n9j0_U166;
}
