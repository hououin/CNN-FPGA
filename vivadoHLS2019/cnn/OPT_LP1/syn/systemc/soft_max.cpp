...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    cnn_fadd_32ns_32ncud_U141 = new cnn_fadd_32ns_32ncud<1,4,32,32,32>("cnn_fadd_32ns_32ncud_U141");
    cnn_fadd_32ns_32ncud_U141->clk(ap_clk);
    cnn_fadd_32ns_32ncud_U141->reset(ap_rst);
    cnn_fadd_32ns_32ncud_U141->din0(sum_0_reg_80);
    cnn_fadd_32ns_32ncud_U141->din1(reg_135);
    cnn_fadd_32ns_32ncud_U141->ce(ap_var_for_const0);
    cnn_fadd_32ns_32ncud_U141->dout(grp_fu_114_p2);
    cnn_fdiv_32ns_32nbck_U142 = new cnn_fdiv_32ns_32nbck<1,8,32,32,32>("cnn_fdiv_32ns_32nbck_U142");
    cnn_fdiv_32ns_32nbck_U142->clk(ap_clk);
    cnn_fdiv_32ns_32nbck_U142->reset(ap_rst);
    cnn_fdiv_32ns_32nbck_U142->din0(reg_135);
    cnn_fdiv_32ns_32nbck_U142->din1(sum_0_reg_80);
    cnn_fdiv_32ns_32nbck_U142->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32nbck_U142->dout(grp_fu_119_p2);
    cnn_fexp_32ns_32nbdk_U143 = new cnn_fexp_32ns_32nbdk<1,5,32,32,32>("cnn_fexp_32ns_32nbdk_U143");
    cnn_fexp_32ns_32nbdk_U143->clk(ap_clk);
    cnn_fexp_32ns_32nbdk_U143->reset(ap_rst);
    cnn_fexp_32ns_32nbdk_U143->din0(ap_var_for_const1);
    cnn_fexp_32ns_32nbdk_U143->din1(dense_array_q0);
    cnn_fexp_32ns_32nbdk_U143->ce(ap_var_for_const0);
    cnn_fexp_32ns_32nbdk_U143->dout(grp_fu_124_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fdiv_32ns_32nbck_U142;
    delete cnn_fexp_32ns_32nbdk_U143;
}
