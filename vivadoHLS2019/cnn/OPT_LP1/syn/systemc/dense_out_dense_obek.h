...
// ==============================================================
#ifndef __dense_out_dense_obek_H__
#define __dense_out_dense_obek_H__
...
struct dense_out_dense_obek_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_out_dense_obek_ram) {
...
SC_MODULE(dense_out_dense_obek) {
...
dense_out_dense_obek_ram* meminst;


SC_CTOR(dense_out_dense_obek) {
meminst = new dense_out_dense_obek_ram("dense_out_dense_obek_ram");
