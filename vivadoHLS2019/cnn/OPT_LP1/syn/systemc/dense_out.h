...
struct dense_out : public sc_module {
    ...
    dense_out_dense_obek* dense_out_bias_U;
    dense_out_dense_obfk* dense_out_weights_U;
    dense_out_dense_abgk* dense_array_U;
    soft_max* grp_soft_max_fu_170;
    cnn_fadd_32ns_32ncud<1,4,32,32,32>* cnn_fadd_32ns_32ncud_U147;
    ...
    sc_signal< sc_lv<6> > tmp_23_fu_250_p3;
