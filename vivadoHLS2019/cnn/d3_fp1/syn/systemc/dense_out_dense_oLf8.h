...
// ==============================================================
#ifndef __dense_out_dense_oLf8_H__
#define __dense_out_dense_oLf8_H__
...
struct dense_out_dense_oLf8_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_out_dense_oLf8_ram) {
...
SC_MODULE(dense_out_dense_oLf8) {
...
dense_out_dense_oLf8_ram* meminst;


SC_CTOR(dense_out_dense_oLf8) {
meminst = new dense_out_dense_oLf8_ram("dense_out_dense_oLf8_ram");
