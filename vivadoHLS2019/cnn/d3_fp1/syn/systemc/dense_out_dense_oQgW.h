...
// ==============================================================
#ifndef __dense_out_dense_oQgW_H__
#define __dense_out_dense_oQgW_H__
...
struct dense_out_dense_oQgW_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_out_dense_oQgW_ram) {
...
SC_MODULE(dense_out_dense_oQgW) {
...
dense_out_dense_oQgW_ram* meminst;


SC_CTOR(dense_out_dense_oQgW) {
meminst = new dense_out_dense_oQgW_ram("dense_out_dense_oQgW_ram");
