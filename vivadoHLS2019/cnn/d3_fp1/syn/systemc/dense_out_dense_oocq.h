...
// ==============================================================
#ifndef __dense_out_dense_oocq_H__
#define __dense_out_dense_oocq_H__
...
struct dense_out_dense_oocq_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_out_dense_oocq_ram) {
...
SC_MODULE(dense_out_dense_oocq) {
...
dense_out_dense_oocq_ram* meminst;


SC_CTOR(dense_out_dense_oocq) {
meminst = new dense_out_dense_oocq_ram("dense_out_dense_oocq_ram");
