...
// ==============================================================
#ifndef __dense_out_dense_orcU_H__
#define __dense_out_dense_orcU_H__
...
struct dense_out_dense_orcU_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_out_dense_orcU_ram) {
...
SC_MODULE(dense_out_dense_orcU) {
...
dense_out_dense_orcU_ram* meminst;


SC_CTOR(dense_out_dense_orcU) {
meminst = new dense_out_dense_orcU_ram("dense_out_dense_orcU_ram");
