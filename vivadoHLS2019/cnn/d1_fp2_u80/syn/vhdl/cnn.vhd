...
architecture behav of cnn is 
    ...
    "cnn,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=17.393000,HLS_SYN_LAT=1224288,HLS_SYN_TPT=none,HLS_SYN_MEM=92,HLS_SYN_DSP=114,HLS_SYN_FF=5172,HLS_SYN_LUT=14315,HLS_VERSION=2019_1}";
    ...
    signal zext_ln14_84_fu_501_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal zext_ln14_244_fu_514_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal zext_ln14_245_fu_526_p1 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    dense_1_out_address0_assign_proc : process(ap_CS_fsm_state17, grp_dense_1_fu_296_dense_1_out_address0, ap_CS_fsm_state15, zext_ln14_84_fu_501_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state17)) then 
            dense_1_out_address0 <= zext_ln14_84_fu_501_p1(6 - 1 downto 0);
    ...
    sub_ln14_fu_530_p2 <= std_logic_vector(unsigned(zext_ln14_244_fu_514_p1) - unsigned(zext_ln14_245_fu_526_p1));
    ...
    zext_ln14_244_fu_514_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_17_fu_506_p3),12));
    zext_ln14_245_fu_526_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_18_fu_518_p3),12));
    zext_ln14_84_fu_501_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_0_i_reg_285),64));
