...
// ==============================================================
#ifndef __dense_out_dense_obck_H__
#define __dense_out_dense_obck_H__
...
struct dense_out_dense_obck_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_out_dense_obck_ram) {
...
SC_MODULE(dense_out_dense_obck) {
...
dense_out_dense_obck_ram* meminst;


SC_CTOR(dense_out_dense_obck) {
meminst = new dense_out_dense_obck_ram("dense_out_dense_obck_ram");
