...
struct dense_out : public sc_module {
    ...
    dense_out_dense_osc4* dense_out_weights_U;
    dense_out_dense_otde* dense_out_bias_U;
    dense_out_dense_audo* dense_array_U;
    soft_max* grp_soft_max_fu_149;
    cnn_fadd_32ns_32nkbM<1,4,32,32,32>* cnn_fadd_32ns_32nkbM_U71;
    cnn_fmul_32ns_32nlbW<1,2,32,32,32>* cnn_fmul_32ns_32nlbW_U72;
