...
architecture behav of soft_max is 
    ...
    component cnn_fdiv_32ns_32nqcK IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component cnn_fexp_32ns_32nrcU IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    cnn_fadd_32ns_32nkbM_U65 : component cnn_fadd_32ns_32nkbM
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    cnn_fdiv_32ns_32nqcK_U66 : component cnn_fdiv_32ns_32nqcK
    generic map (
        ID => 1,
        NUM_STAGE => 8,
        din0_WIDTH => 32,
    ...
    cnn_fexp_32ns_32nrcU_U67 : component cnn_fexp_32ns_32nrcU
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
