<project xmlns="com.autoesl.autopilot.project" top="cnn" name="cnn">
    ...
    <files xmlns="">
        ...
        <file name="cnn/dense_weights.h" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
        <file name="cnn/dense.h" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
        <file name="cnn/dense.cpp" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
