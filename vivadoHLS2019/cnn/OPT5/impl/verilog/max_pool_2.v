...
output   max_pool_2_out_we0;
output  [31:0] max_pool_2_out_d0;
...
wire   [11:0] tmp_3_cast_fu_505_p3;
...
assign add_ln29_1_fu_513_p2 = (tmp_3_cast_fu_505_p3 + zext_ln26_1_fu_279_p1);
...
assign icmp_ln29_2_fu_662_p2 = ((tmp_5_fu_630_p4 != 8'd255) ? 1'b1 : 1'b0);

assign icmp_ln29_3_fu_668_p2 = ((trunc_ln29_1_fu_640_p1 == 23'd0) ? 1'b1 : 1'b0);

assign icmp_ln29_4_fu_761_p2 = ((tmp_7_fu_730_p4 != 8'd255) ? 1'b1 : 1'b0);
...
assign max_pool_2_out_address0 = zext_ln36_3_fu_816_p1;

assign max_pool_2_out_d0 = ((and_ln29_3_fu_803_p2[0:0] === 1'b1) ? conv_2_out_load_1_reg_897 : select_ln29_reg_920);
...
assign tmp_3_cast_fu_505_p3 = {{add_ln29_fu_499_p2}, {4'd0}};

assign tmp_5_fu_630_p4 = {{bitcast_ln29_1_fu_627_p1[30:23]}};

assign tmp_7_fu_730_p4 = {{bitcast_ln29_2_fu_727_p1[30:23]}};
