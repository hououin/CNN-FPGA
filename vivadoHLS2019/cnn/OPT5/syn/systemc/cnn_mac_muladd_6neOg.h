...
// ==============================================================
#ifndef __cnn_mac_muladd_6neOg__HH__
#define __cnn_mac_muladd_6neOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_6neOg) {
    ...
    SC_CTOR(cnn_mac_muladd_6neOg):  simcore_mac_0_U ("simcore_mac_0_U") {
