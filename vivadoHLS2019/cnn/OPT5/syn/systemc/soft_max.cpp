...
soft_max::soft_max(sc_module_name name) : sc_module(name), mVcdFile(0) {
    cnn_fadd_32ns_32nbkb_U339 = new cnn_fadd_32ns_32nbkb<1,4,32,32,32>("cnn_fadd_32ns_32nbkb_U339");
    cnn_fadd_32ns_32nbkb_U339->clk(ap_clk);
    cnn_fadd_32ns_32nbkb_U339->reset(ap_rst);
    cnn_fadd_32ns_32nbkb_U339->din0(sum_0_reg_68);
    cnn_fadd_32ns_32nbkb_U339->din1(reg_123);
    cnn_fadd_32ns_32nbkb_U339->ce(ap_var_for_const0);
    cnn_fadd_32ns_32nbkb_U339->dout(grp_fu_102_p2);
    cnn_fdiv_32ns_32nbck_U340 = new cnn_fdiv_32ns_32nbck<1,8,32,32,32>("cnn_fdiv_32ns_32nbck_U340");
    cnn_fdiv_32ns_32nbck_U340->clk(ap_clk);
    cnn_fdiv_32ns_32nbck_U340->reset(ap_rst);
    cnn_fdiv_32ns_32nbck_U340->din0(reg_123);
    cnn_fdiv_32ns_32nbck_U340->din1(sum_0_reg_68);
    cnn_fdiv_32ns_32nbck_U340->ce(ap_var_for_const0);
    cnn_fdiv_32ns_32nbck_U340->dout(grp_fu_107_p2);
    cnn_fexp_32ns_32nbdk_U341 = new cnn_fexp_32ns_32nbdk<1,5,32,32,32>("cnn_fexp_32ns_32nbdk_U341");
    cnn_fexp_32ns_32nbdk_U341->clk(ap_clk);
    cnn_fexp_32ns_32nbdk_U341->reset(ap_rst);
    cnn_fexp_32ns_32nbdk_U341->din0(ap_var_for_const1);
    cnn_fexp_32ns_32nbdk_U341->din1(dense_array_q0);
    cnn_fexp_32ns_32nbdk_U341->ce(ap_var_for_const0);
    cnn_fexp_32ns_32nbdk_U341->dout(grp_fu_112_p2);
...
soft_max::~soft_max() {
    ...
    delete cnn_fadd_32ns_32nbkb_U339;
    delete cnn_fdiv_32ns_32nbck_U340;
    delete cnn_fexp_32ns_32nbdk_U341;
}
