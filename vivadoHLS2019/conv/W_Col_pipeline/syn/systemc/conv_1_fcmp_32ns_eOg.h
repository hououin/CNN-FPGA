...
// ==============================================================
#ifndef __conv_1_fcmp_32ns_eOg__HH__
#define __conv_1_fcmp_32ns_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_1_fcmp_32ns_eOg) {
    ...
    SC_CTOR(conv_1_fcmp_32ns_eOg):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
