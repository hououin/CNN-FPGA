...
// ==============================================================
#ifndef __conv_fcmp_32ns_325jm__HH__
#define __conv_fcmp_32ns_325jm__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_fcmp_32ns_325jm) {
    ...
    SC_CTOR(conv_fcmp_32ns_325jm):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
