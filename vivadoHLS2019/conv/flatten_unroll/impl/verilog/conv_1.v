...
wire   [4:0] zext_ln21_1_fu_650_p1;
...
wire   [4:0] zext_ln21_2_fu_707_p1;
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln21_fu_597_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln21_1_fu_654_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state11) & (icmp_ln21_2_fu_711_p2 == 1'd1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln21_fu_597_p2 == 1'd1))) begin
        ...
        ap_ST_fsm_state7 : begin
            if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln21_1_fu_654_p2 == 1'd1))) begin
...
assign add_ln21_1_fu_660_p2 = (wc_0_1_reg_281 + 2'd1);

assign add_ln21_2_fu_717_p2 = (wc_0_2_reg_303 + 2'd1);

assign add_ln21_fu_603_p2 = (wc_0_0_reg_259 + 2'd1);

assign add_ln26_10_fu_754_p2 = (zext_ln26_17_fu_750_p1 + sub_ln26_2_reg_870);

assign add_ln26_1_fu_631_p2 = (select_ln35_5_reg_880 + zext_ln21_fu_593_p1);

assign add_ln26_3_fu_745_p2 = (select_ln35_5_reg_880 + zext_ln21_2_fu_707_p1);
...
assign add_ln26_fu_688_p2 = (select_ln35_5_reg_880 + zext_ln21_1_fu_650_p1);
...
assign icmp_ln21_1_fu_654_p2 = ((wc_0_1_reg_281 == 2'd3) ? 1'b1 : 1'b0);

assign icmp_ln21_2_fu_711_p2 = ((wc_0_2_reg_303 == 2'd3) ? 1'b1 : 1'b0);

assign icmp_ln21_fu_597_p2 = ((wc_0_0_reg_259 == 2'd3) ? 1'b1 : 1'b0);
...
assign zext_ln21_1_fu_650_p1 = wc_0_1_reg_281;

assign zext_ln21_2_fu_707_p1 = wc_0_2_reg_303;

assign zext_ln21_fu_593_p1 = wc_0_0_reg_259;
