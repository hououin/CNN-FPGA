...
// ==============================================================
#ifndef __conv_fcmp_32ns_32jbC__HH__
#define __conv_fcmp_32ns_32jbC__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_fcmp_32ns_32jbC) {
    ...
    SC_CTOR(conv_fcmp_32ns_32jbC):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
