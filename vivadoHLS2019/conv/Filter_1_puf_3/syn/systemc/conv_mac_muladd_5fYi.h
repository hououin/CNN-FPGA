...
// ==============================================================
#ifndef __conv_mac_muladd_5fYi__HH__
#define __conv_mac_muladd_5fYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mac_muladd_5fYi) {
    ...
    SC_CTOR(conv_mac_muladd_5fYi):  simcore_mac_1_U ("simcore_mac_1_U") {
