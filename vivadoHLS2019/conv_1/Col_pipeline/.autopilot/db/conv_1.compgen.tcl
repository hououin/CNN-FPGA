...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename conv_out \
    op interface \
    ports { conv_out_address0 { O 15 vector } conv_out_ce0 { O 1 bit } conv_out_we0 { O 1 bit } conv_out_d0 { O 32 vector } conv_out_address1 { O 15 vector } conv_out_ce1 { O 1 bit } conv_out_we1 { O 1 bit } conv_out_d1 { O 32 vector } } \
} "
} else {
