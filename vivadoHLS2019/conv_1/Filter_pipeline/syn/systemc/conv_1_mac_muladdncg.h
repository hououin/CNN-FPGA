...
// ==============================================================
#ifndef __conv_1_mac_muladdncg__HH__
#define __conv_1_mac_muladdncg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_1_mac_muladdncg) {
    ...
    SC_CTOR(conv_1_mac_muladdncg):  simcore_mac_0_U ("simcore_mac_0_U") {
