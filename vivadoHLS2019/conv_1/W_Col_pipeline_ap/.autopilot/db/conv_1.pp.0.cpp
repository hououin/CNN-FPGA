...
# 9 "<command line>" 2
# 1 "<built-in>" 2
# 1 "conv_1/conv_1.cpp" 2
# 1 "conv_1/conv_1.h" 1

# 1 "conv_1/parameters.h" 1
# 3 "conv_1/conv_1.h" 2
...
# 2 "conv_1/conv_1.cpp" 2

# 1 "conv_1/conv_1_weights.h" 1



float conv_1_weights[3][3][3][32]
= {
 {
  {
...
# 4 "conv_1/conv_1.cpp" 2

void conv_1(float conv_input[28][28][3], float conv_out[26][26][32]) {_ssdm_SpecArrayDimSize(conv_input, 28);_ssdm_SpecArrayDimSize(conv_out, 26);
#pragma HLS ARRAY_PARTITION variable=&conv_input complete dim=3
# 5 "conv_1/conv_1.cpp"
