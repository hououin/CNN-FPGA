...
// ==============================================================
#ifndef __dense_1_mac_muladg8j__HH__
#define __dense_1_mac_muladg8j__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(dense_1_mac_muladg8j) {
    ...
    SC_CTOR(dense_1_mac_muladg8j):  simcore_mac_0_U ("simcore_mac_0_U") {
