...
set C_modelArgList {
	...
	{ dense_1_out float 32 regular {array 50 { 0 0 } 0 1 }  }
}
...
set portList { 
	...
	{ dense_1_out_we1 sc_out sc_logic 1 signal 1 } 
	{ dense_1_out_d1 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dense_1_out_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "dense_1_out", "role": "we1" }} , 
 	{ "name": "dense_1_out_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dense_1_out", "role": "d1" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "8"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "40201", "EstimateLatencyMax" : "40201",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dense_1_fmul_32nseOg_U3", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dense_1_fmul_32nseOg_U4", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dense_1_fcmp_32nsfYi_U5", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dense_1_fcmp_32nsfYi_U6", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	dense_1 {
		flat_array {Type I LastRead 1598 FirstWrite -1}
		dense_1_out {Type O LastRead -1 FirstWrite 1608}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "40201", "Max" : "40201"}
	, {"Name" : "Interval", "Min" : "40202", "Max" : "40202"}
]}
...
set Spec2ImplPortList { 
	...
	dense_1_out { ap_memory {  { dense_1_out_address0 mem_address 1 6 }  { dense_1_out_ce0 mem_ce 1 1 }  { dense_1_out_we0 mem_we 1 1 }  { dense_1_out_d0 mem_din 1 32 }  { dense_1_out_address1 MemPortADDR2 1 6 }  { dense_1_out_ce1 MemPortCE2 1 1 }  { dense_1_out_we1 MemPortWE2 1 1 }  { dense_1_out_d1 MemPortDIN2 1 32 } } }
}
