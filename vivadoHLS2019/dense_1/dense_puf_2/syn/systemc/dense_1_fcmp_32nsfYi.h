...
// ==============================================================
#ifndef __dense_1_fcmp_32nsfYi__HH__
#define __dense_1_fcmp_32nsfYi__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dense_1_fcmp_32nsfYi) {
    ...
    SC_CTOR(dense_1_fcmp_32nsfYi):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
