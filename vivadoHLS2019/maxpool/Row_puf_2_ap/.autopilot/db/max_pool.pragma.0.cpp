...
#pragma HLS ARRAY_PARTITION variable=&conv_out complete dim=2
# 7 "maxpool/max_pool.cpp"

#pragma HLS ARRAY_PARTITION variable=&conv_out cyclic factor=4 dim=1
# 7 "maxpool/max_pool.cpp"

#pragma HLS ARRAY_PARTITION variable=&max_pool_out complete dim=2
# 7 "maxpool/max_pool.cpp"

#pragma HLS ARRAY_PARTITION variable=&max_pool_out cyclic factor=4 dim=1
# 7 "maxpool/max_pool.cpp"
