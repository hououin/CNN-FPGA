...
_ssdm_SpecArrayPartition( conv_out, 2, "COMPLETE", 0, "");
# 7 "maxpool/max_pool.cpp"

_ssdm_SpecArrayPartition( conv_out, 1, "CYCLIC", 4, "");
# 7 "maxpool/max_pool.cpp"

_ssdm_SpecArrayPartition( max_pool_out, 2, "COMPLETE", 0, "");
# 7 "maxpool/max_pool.cpp"

_ssdm_SpecArrayPartition( max_pool_out, 1, "CYCLIC", 4, "");
# 7 "maxpool/max_pool.cpp"
