...
set portList { 
	...
	{ max_pool_out_address1 sc_out sc_lv 10 signal 1 } 
	{ max_pool_out_ce1 sc_out sc_logic 1 signal 1 } 
	{ max_pool_out_we1 sc_out sc_logic 1 signal 1 } 
	{ max_pool_out_d1 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "2293", "EstimateLatencyMax" : "2293",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set ArgLastReadFirstWriteLatency {
	max_pool {
		conv_out {Type I LastRead 80 FirstWrite -1}
		max_pool_out {Type O LastRead -1 FirstWrite 63}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2293", "Max" : "2293"}
	, {"Name" : "Interval", "Min" : "2294", "Max" : "2294"}
]}
