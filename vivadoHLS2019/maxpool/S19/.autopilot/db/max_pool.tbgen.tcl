...
set C_modelArgList {
	{ conv_out_0 float 32 regular {array 676 { 1 1 } 1 1 }  }
	{ conv_out_1 float 32 regular {array 676 { 1 1 } 1 1 }  }
	{ conv_out_2 float 32 regular {array 676 { 1 1 } 1 1 }  }
	{ conv_out_3 float 32 regular {array 676 { 1 1 } 1 1 }  }
	{ conv_out_4 float 32 regular {array 676 { 1 1 } 1 1 }  }
	{ conv_out_5 float 32 regular {array 676 { 1 1 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "conv_out_0", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 25,"step" : 1},{"low" : 0,"up" : 25,"step" : 1},{"low" : 0,"up" : 0,"step" : 2}]}]}]} , 
 	{ "Name" : "conv_out_1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 25,"step" : 1},{"low" : 0,"up" : 25,"step" : 1},{"low" : 1,"up" : 1,"step" : 2}]}]}]} , 
 	{ "Name" : "conv_out_2", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 25,"step" : 1},{"low" : 0,"up" : 25,"step" : 1},{"low" : 2,"up" : 2,"step" : 2}]}]}]} , 
 	{ "Name" : "conv_out_3", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 25,"step" : 1},{"low" : 0,"up" : 25,"step" : 1},{"low" : 3,"up" : 3,"step" : 2}]}]}]} , 
 	{ "Name" : "conv_out_4", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 25,"step" : 1},{"low" : 0,"up" : 25,"step" : 1},{"low" : 4,"up" : 4,"step" : 2}]}]}]} , 
 	{ "Name" : "conv_out_5", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 25,"step" : 1},{"low" : 0,"up" : 25,"step" : 1},{"low" : 5,"up" : 5,"step" : 2}]}]}]} , 
...
set portList { 
	...
	{ conv_out_0_address0 sc_out sc_lv 10 signal 0 } 
	{ conv_out_0_ce0 sc_out sc_logic 1 signal 0 } 
	{ conv_out_0_q0 sc_in sc_lv 32 signal 0 } 
	{ conv_out_0_address1 sc_out sc_lv 10 signal 0 } 
	{ conv_out_0_ce1 sc_out sc_logic 1 signal 0 } 
	{ conv_out_0_q1 sc_in sc_lv 32 signal 0 } 
	{ conv_out_1_address0 sc_out sc_lv 10 signal 1 } 
	{ conv_out_1_ce0 sc_out sc_logic 1 signal 1 } 
	{ conv_out_1_q0 sc_in sc_lv 32 signal 1 } 
	{ conv_out_1_address1 sc_out sc_lv 10 signal 1 } 
	{ conv_out_1_ce1 sc_out sc_logic 1 signal 1 } 
	{ conv_out_1_q1 sc_in sc_lv 32 signal 1 } 
	{ conv_out_2_address0 sc_out sc_lv 10 signal 2 } 
	{ conv_out_2_ce0 sc_out sc_logic 1 signal 2 } 
	{ conv_out_2_q0 sc_in sc_lv 32 signal 2 } 
	{ conv_out_2_address1 sc_out sc_lv 10 signal 2 } 
	{ conv_out_2_ce1 sc_out sc_logic 1 signal 2 } 
	{ conv_out_2_q1 sc_in sc_lv 32 signal 2 } 
	{ conv_out_3_address0 sc_out sc_lv 10 signal 3 } 
	{ conv_out_3_ce0 sc_out sc_logic 1 signal 3 } 
	{ conv_out_3_q0 sc_in sc_lv 32 signal 3 } 
	{ conv_out_3_address1 sc_out sc_lv 10 signal 3 } 
	{ conv_out_3_ce1 sc_out sc_logic 1 signal 3 } 
	{ conv_out_3_q1 sc_in sc_lv 32 signal 3 } 
	{ conv_out_4_address0 sc_out sc_lv 10 signal 4 } 
	{ conv_out_4_ce0 sc_out sc_logic 1 signal 4 } 
	{ conv_out_4_q0 sc_in sc_lv 32 signal 4 } 
	{ conv_out_4_address1 sc_out sc_lv 10 signal 4 } 
	{ conv_out_4_ce1 sc_out sc_logic 1 signal 4 } 
	{ conv_out_4_q1 sc_in sc_lv 32 signal 4 } 
	{ conv_out_5_address0 sc_out sc_lv 10 signal 5 } 
	{ conv_out_5_ce0 sc_out sc_logic 1 signal 5 } 
	{ conv_out_5_q0 sc_in sc_lv 32 signal 5 } 
	{ conv_out_5_address1 sc_out sc_lv 10 signal 5 } 
	{ conv_out_5_ce1 sc_out sc_logic 1 signal 5 } 
	{ conv_out_5_q1 sc_in sc_lv 32 signal 5 } 
	{ max_pool_out_0_address0 sc_out sc_lv 7 signal 6 } 
	{ max_pool_out_0_ce0 sc_out sc_logic 1 signal 6 } 
	{ max_pool_out_0_we0 sc_out sc_logic 1 signal 6 } 
	{ max_pool_out_0_d0 sc_out sc_lv 32 signal 6 } 
	{ max_pool_out_1_address0 sc_out sc_lv 7 signal 7 } 
	{ max_pool_out_1_ce0 sc_out sc_logic 1 signal 7 } 
	{ max_pool_out_1_we0 sc_out sc_logic 1 signal 7 } 
	{ max_pool_out_1_d0 sc_out sc_lv 32 signal 7 } 
	{ max_pool_out_2_address0 sc_out sc_lv 7 signal 8 } 
	{ max_pool_out_2_ce0 sc_out sc_logic 1 signal 8 } 
	{ max_pool_out_2_we0 sc_out sc_logic 1 signal 8 } 
	{ max_pool_out_2_d0 sc_out sc_lv 32 signal 8 } 
	{ max_pool_out_3_address0 sc_out sc_lv 7 signal 9 } 
	{ max_pool_out_3_ce0 sc_out sc_logic 1 signal 9 } 
	{ max_pool_out_3_we0 sc_out sc_logic 1 signal 9 } 
	{ max_pool_out_3_d0 sc_out sc_lv 32 signal 9 } 
	{ max_pool_out_4_address0 sc_out sc_lv 7 signal 10 } 
	{ max_pool_out_4_ce0 sc_out sc_logic 1 signal 10 } 
	{ max_pool_out_4_we0 sc_out sc_logic 1 signal 10 } 
	{ max_pool_out_4_d0 sc_out sc_lv 32 signal 10 } 
	{ max_pool_out_5_address0 sc_out sc_lv 7 signal 11 } 
	{ max_pool_out_5_ce0 sc_out sc_logic 1 signal 11 } 
	{ max_pool_out_5_we0 sc_out sc_logic 1 signal 11 } 
	{ max_pool_out_5_d0 sc_out sc_lv 32 signal 11 } 
	{ max_pool_out_6_address0 sc_out sc_lv 7 signal 12 } 
	{ max_pool_out_6_ce0 sc_out sc_logic 1 signal 12 } 
	{ max_pool_out_6_we0 sc_out sc_logic 1 signal 12 } 
	{ max_pool_out_6_d0 sc_out sc_lv 32 signal 12 } 
	{ max_pool_out_7_address0 sc_out sc_lv 7 signal 13 } 
	{ max_pool_out_7_ce0 sc_out sc_logic 1 signal 13 } 
	{ max_pool_out_7_we0 sc_out sc_logic 1 signal 13 } 
	{ max_pool_out_7_d0 sc_out sc_lv 32 signal 13 } 
	{ max_pool_out_8_address0 sc_out sc_lv 7 signal 14 } 
	{ max_pool_out_8_ce0 sc_out sc_logic 1 signal 14 } 
	{ max_pool_out_8_we0 sc_out sc_logic 1 signal 14 } 
	{ max_pool_out_8_d0 sc_out sc_lv 32 signal 14 } 
	{ max_pool_out_9_address0 sc_out sc_lv 7 signal 15 } 
	{ max_pool_out_9_ce0 sc_out sc_logic 1 signal 15 } 
	{ max_pool_out_9_we0 sc_out sc_logic 1 signal 15 } 
	{ max_pool_out_9_d0 sc_out sc_lv 32 signal 15 } 
	{ max_pool_out_10_address0 sc_out sc_lv 7 signal 16 } 
	{ max_pool_out_10_ce0 sc_out sc_logic 1 signal 16 } 
	{ max_pool_out_10_we0 sc_out sc_logic 1 signal 16 } 
	{ max_pool_out_10_d0 sc_out sc_lv 32 signal 16 } 
	{ max_pool_out_11_address0 sc_out sc_lv 7 signal 17 } 
	{ max_pool_out_11_ce0 sc_out sc_logic 1 signal 17 } 
	{ max_pool_out_11_we0 sc_out sc_logic 1 signal 17 } 
	{ max_pool_out_11_d0 sc_out sc_lv 32 signal 17 } 
	{ max_pool_out_12_address0 sc_out sc_lv 7 signal 18 } 
	{ max_pool_out_12_ce0 sc_out sc_logic 1 signal 18 } 
	{ max_pool_out_12_we0 sc_out sc_logic 1 signal 18 } 
	{ max_pool_out_12_d0 sc_out sc_lv 32 signal 18 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv_out_0_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "conv_out_0", "role": "address0" }} , 
 	...
 	{ "name": "conv_out_0_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "conv_out_0", "role": "address1" }} , 
 	...
 	{ "name": "conv_out_1_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "conv_out_1", "role": "address1" }} , 
 	...
 	{ "name": "conv_out_2_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "conv_out_2", "role": "address1" }} , 
 	...
 	{ "name": "conv_out_3_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "conv_out_3", "role": "address0" }} , 
 	...
 	{ "name": "conv_out_3_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "conv_out_3", "role": "address1" }} , 
 	...
 	{ "name": "conv_out_4_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "conv_out_4", "role": "address0" }} , 
 	...
 	{ "name": "conv_out_4_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "conv_out_4", "role": "address1" }} , 
 	...
 	{ "name": "conv_out_5_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "conv_out_5", "role": "address0" }} , 
 	...
 	{ "name": "conv_out_5_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "conv_out_5", "role": "address1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.max_pool_mux_63_3cud_U3", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.max_pool_mux_63_3cud_U4", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	max_pool {
		conv_out_0 {Type I LastRead 27 FirstWrite -1}
		conv_out_1 {Type I LastRead 27 FirstWrite -1}
		conv_out_2 {Type I LastRead 27 FirstWrite -1}
		conv_out_3 {Type I LastRead 27 FirstWrite -1}
		conv_out_4 {Type I LastRead 27 FirstWrite -1}
		conv_out_5 {Type I LastRead 27 FirstWrite -1}
		max_pool_out_0 {Type O LastRead -1 FirstWrite 22}
		max_pool_out_1 {Type O LastRead -1 FirstWrite 23}
		max_pool_out_2 {Type O LastRead -1 FirstWrite 23}
		max_pool_out_3 {Type O LastRead -1 FirstWrite 24}
		max_pool_out_4 {Type O LastRead -1 FirstWrite 24}
		max_pool_out_5 {Type O LastRead -1 FirstWrite 25}
		max_pool_out_6 {Type O LastRead -1 FirstWrite 25}
		max_pool_out_7 {Type O LastRead -1 FirstWrite 26}
		max_pool_out_8 {Type O LastRead -1 FirstWrite 26}
		max_pool_out_9 {Type O LastRead -1 FirstWrite 27}
		max_pool_out_10 {Type O LastRead -1 FirstWrite 27}
		max_pool_out_11 {Type O LastRead -1 FirstWrite 28}
		max_pool_out_12 {Type O LastRead -1 FirstWrite 28}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2031", "Max" : "2031"}
...
set Spec2ImplPortList { 
	conv_out_0 { ap_memory {  { conv_out_0_address0 mem_address 1 10 }  { conv_out_0_ce0 mem_ce 1 1 }  { conv_out_0_q0 mem_dout 0 32 }  { conv_out_0_address1 MemPortADDR2 1 10 }  { conv_out_0_ce1 MemPortCE2 1 1 }  { conv_out_0_q1 MemPortDOUT2 0 32 } } }
	conv_out_1 { ap_memory {  { conv_out_1_address0 mem_address 1 10 }  { conv_out_1_ce0 mem_ce 1 1 }  { conv_out_1_q0 mem_dout 0 32 }  { conv_out_1_address1 MemPortADDR2 1 10 }  { conv_out_1_ce1 MemPortCE2 1 1 }  { conv_out_1_q1 MemPortDOUT2 0 32 } } }
	conv_out_2 { ap_memory {  { conv_out_2_address0 mem_address 1 10 }  { conv_out_2_ce0 mem_ce 1 1 }  { conv_out_2_q0 mem_dout 0 32 }  { conv_out_2_address1 MemPortADDR2 1 10 }  { conv_out_2_ce1 MemPortCE2 1 1 }  { conv_out_2_q1 MemPortDOUT2 0 32 } } }
	conv_out_3 { ap_memory {  { conv_out_3_address0 mem_address 1 10 }  { conv_out_3_ce0 mem_ce 1 1 }  { conv_out_3_q0 mem_dout 0 32 }  { conv_out_3_address1 MemPortADDR2 1 10 }  { conv_out_3_ce1 MemPortCE2 1 1 }  { conv_out_3_q1 MemPortDOUT2 0 32 } } }
	conv_out_4 { ap_memory {  { conv_out_4_address0 mem_address 1 10 }  { conv_out_4_ce0 mem_ce 1 1 }  { conv_out_4_q0 mem_dout 0 32 }  { conv_out_4_address1 MemPortADDR2 1 10 }  { conv_out_4_ce1 MemPortCE2 1 1 }  { conv_out_4_q1 MemPortDOUT2 0 32 } } }
	conv_out_5 { ap_memory {  { conv_out_5_address0 mem_address 1 10 }  { conv_out_5_ce0 mem_ce 1 1 }  { conv_out_5_q0 mem_dout 0 32 }  { conv_out_5_address1 MemPortADDR2 1 10 }  { conv_out_5_ce1 MemPortCE2 1 1 }  { conv_out_5_q1 MemPortDOUT2 0 32 } } }
