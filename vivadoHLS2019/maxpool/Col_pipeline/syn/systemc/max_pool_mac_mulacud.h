...
// ==============================================================
#ifndef __max_pool_mac_mulacud__HH__
#define __max_pool_mac_mulacud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(max_pool_mac_mulacud) {
    ...
    SC_CTOR(max_pool_mac_mulacud):  simcore_mac_0_U ("simcore_mac_0_U") {
