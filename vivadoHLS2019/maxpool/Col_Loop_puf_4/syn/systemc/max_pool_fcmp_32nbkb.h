...
// ==============================================================
#ifndef __max_pool_fcmp_32nbkb__HH__
#define __max_pool_fcmp_32nbkb__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(max_pool_fcmp_32nbkb) {
    ...
    SC_CTOR(max_pool_fcmp_32nbkb):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
