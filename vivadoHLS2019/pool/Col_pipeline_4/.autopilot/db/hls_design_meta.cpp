...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("max_pool_1_out_address0", 13, hls_out, 2, "ap_memory", "mem_address", 1),
	Port_Property("max_pool_1_out_ce0", 1, hls_out, 2, "ap_memory", "mem_ce", 1),
	Port_Property("max_pool_1_out_we0", 1, hls_out, 2, "ap_memory", "mem_we", 1),
	Port_Property("max_pool_1_out_d0", 32, hls_out, 2, "ap_memory", "mem_din", 1),
};
