...
// ==============================================================
#ifndef __max_pool_1_mac_mudEe__HH__
#define __max_pool_1_mac_mudEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(max_pool_1_mac_mudEe) {
    ...
    SC_CTOR(max_pool_1_mac_mudEe):  simcore_mac_1_U ("simcore_mac_1_U") {
