...
// ==============================================================
#ifndef __max_pool_1_mac_mucud__HH__
#define __max_pool_1_mac_mucud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(max_pool_1_mac_mucud) {
    ...
    SC_CTOR(max_pool_1_mac_mucud):  simcore_mac_0_U ("simcore_mac_0_U") {
