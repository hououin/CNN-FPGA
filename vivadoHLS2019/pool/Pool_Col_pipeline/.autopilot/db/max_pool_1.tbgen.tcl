...
set C_modelArgList {
	{ conv_1_out float 32 regular {array 21632 { 1 3 } 1 1 }  }
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.max_pool_1_mac_mucud_U2", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "37857", "Max" : "37857"}
	, {"Name" : "Interval", "Min" : "37858", "Max" : "37858"}
]}
...
set Spec2ImplPortList { 
	conv_1_out { ap_memory {  { conv_1_out_address0 mem_address 1 15 }  { conv_1_out_ce0 mem_ce 1 1 }  { conv_1_out_q0 mem_dout 0 32 } } }
