...
# 9 "<command line>" 2
# 1 "<built-in>" 2
# 1 "pool/pooling.cpp" 2
# 1 "pool/pooling.h" 1

# 1 "pool/parameters.h" 1
# 3 "pool/pooling.h" 2
...
# 3 "pool/pooling.cpp" 2



void max_pool_1( float conv_1_out[26][26][32], float max_pool_1_out[(26 / 2)][(26 / 2)][32])
{_ssdm_SpecArrayDimSize(conv_1_out, 26);_ssdm_SpecArrayDimSize(max_pool_1_out, 13);
#pragma HLS ARRAY_PARTITION variable=&conv_1_out cyclic factor=3 dim=1
# 7 "pool/pooling.cpp"
