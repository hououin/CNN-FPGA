...
// ==============================================================
#ifndef __max_pool_1_fcmp_3bkb__HH__
#define __max_pool_1_fcmp_3bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(max_pool_1_fcmp_3bkb) {
    ...
    SC_CTOR(max_pool_1_fcmp_3bkb):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
