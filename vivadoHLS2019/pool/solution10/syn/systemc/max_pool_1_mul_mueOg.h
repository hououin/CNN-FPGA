...
// ==============================================================
#ifndef __max_pool_1_mul_mueOg__HH__
#define __max_pool_1_mul_mueOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(max_pool_1_mul_mueOg) {
    ...
    SC_CTOR(max_pool_1_mul_mueOg):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
