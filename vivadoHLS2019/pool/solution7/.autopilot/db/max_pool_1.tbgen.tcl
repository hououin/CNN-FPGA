...
set C_modelArgList {
	...
	{ max_pool_1_out_1 float 32 regular {array 2080 { 0 0 } 0 1 }  }
	{ max_pool_1_out_2 float 32 regular {array 1248 { 0 0 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "conv_1_out_0_0", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 8,"step" : 1},{"low" : 0,"up" : 24,"step" : 3},{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	{ "Name" : "conv_1_out_0_1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 8,"step" : 1},{"low" : 1,"up" : 25,"step" : 3},{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	{ "Name" : "conv_1_out_0_2", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 8,"step" : 1},{"low" : 2,"up" : 25,"step" : 3},{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	{ "Name" : "conv_1_out_1_0", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 9,"up" : 17,"step" : 1},{"low" : 0,"up" : 24,"step" : 3},{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	{ "Name" : "conv_1_out_1_1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 9,"up" : 17,"step" : 1},{"low" : 1,"up" : 25,"step" : 3},{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	{ "Name" : "conv_1_out_1_2", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 9,"up" : 17,"step" : 1},{"low" : 2,"up" : 25,"step" : 3},{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	{ "Name" : "conv_1_out_2_0", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 18,"up" : 25,"step" : 1},{"low" : 0,"up" : 24,"step" : 3},{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	{ "Name" : "conv_1_out_2_1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 18,"up" : 25,"step" : 1},{"low" : 1,"up" : 25,"step" : 3},{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	{ "Name" : "conv_1_out_2_2", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 18,"up" : 25,"step" : 1},{"low" : 2,"up" : 25,"step" : 3},{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	{ "Name" : "max_pool_1_out_0", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "max_pool_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 12,"step" : 1},{"low" : 0,"up" : 4,"step" : 1},{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	{ "Name" : "max_pool_1_out_1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "max_pool_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 12,"step" : 1},{"low" : 5,"up" : 9,"step" : 1},{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	{ "Name" : "max_pool_1_out_2", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "max_pool_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 12,"step" : 1},{"low" : 10,"up" : 12,"step" : 1},{"low" : 0,"up" : 31,"step" : 1}]}]}]} ]}
...
set portList { 
	...
	{ max_pool_1_out_0_address0 sc_out sc_lv 12 signal 9 } 
	...
	{ max_pool_1_out_0_address1 sc_out sc_lv 12 signal 9 } 
	{ max_pool_1_out_0_ce1 sc_out sc_logic 1 signal 9 } 
	{ max_pool_1_out_0_we1 sc_out sc_logic 1 signal 9 } 
	{ max_pool_1_out_0_d1 sc_out sc_lv 32 signal 9 } 
	{ max_pool_1_out_1_address0 sc_out sc_lv 12 signal 10 } 
	...
	{ max_pool_1_out_1_address1 sc_out sc_lv 12 signal 10 } 
	{ max_pool_1_out_1_ce1 sc_out sc_logic 1 signal 10 } 
	{ max_pool_1_out_1_we1 sc_out sc_logic 1 signal 10 } 
	{ max_pool_1_out_1_d1 sc_out sc_lv 32 signal 10 } 
	{ max_pool_1_out_2_address0 sc_out sc_lv 11 signal 11 } 
	...
	{ max_pool_1_out_2_address1 sc_out sc_lv 11 signal 11 } 
	{ max_pool_1_out_2_ce1 sc_out sc_logic 1 signal 11 } 
	{ max_pool_1_out_2_we1 sc_out sc_logic 1 signal 11 } 
	{ max_pool_1_out_2_d1 sc_out sc_lv 32 signal 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "max_pool_1_out_1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "max_pool_1_out_1", "role": "address0" }} , 
 	...
 	{ "name": "max_pool_1_out_1_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "max_pool_1_out_1", "role": "address1" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "8"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "3755", "EstimateLatencyMax" : "3755",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.max_pool_1_urem_5cud_U7", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.max_pool_1_urem_5cud_U8", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	max_pool_1 {
		conv_1_out_0_0 {Type I LastRead 18 FirstWrite -1}
		conv_1_out_0_1 {Type I LastRead 18 FirstWrite -1}
		conv_1_out_0_2 {Type I LastRead 17 FirstWrite -1}
		conv_1_out_1_0 {Type I LastRead 18 FirstWrite -1}
		conv_1_out_1_1 {Type I LastRead 18 FirstWrite -1}
		conv_1_out_1_2 {Type I LastRead 17 FirstWrite -1}
		conv_1_out_2_0 {Type I LastRead 18 FirstWrite -1}
		conv_1_out_2_1 {Type I LastRead 18 FirstWrite -1}
		conv_1_out_2_2 {Type I LastRead 17 FirstWrite -1}
		max_pool_1_out_0 {Type O LastRead -1 FirstWrite 12}
		max_pool_1_out_1 {Type O LastRead -1 FirstWrite 15}
		max_pool_1_out_2 {Type O LastRead -1 FirstWrite 18}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3755", "Max" : "3755"}
	, {"Name" : "Interval", "Min" : "3756", "Max" : "3756"}
]}
...
set Spec2ImplPortList { 
	...
	max_pool_1_out_1 { ap_memory {  { max_pool_1_out_1_address0 mem_address 1 12 }  { max_pool_1_out_1_ce0 mem_ce 1 1 }  { max_pool_1_out_1_we0 mem_we 1 1 }  { max_pool_1_out_1_d0 mem_din 1 32 }  { max_pool_1_out_1_address1 MemPortADDR2 1 12 }  { max_pool_1_out_1_ce1 MemPortCE2 1 1 }  { max_pool_1_out_1_we1 MemPortWE2 1 1 }  { max_pool_1_out_1_d1 MemPortDIN2 1 32 } } }
