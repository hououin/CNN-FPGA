...
set C_modelArgList {
	{ max_pool_out float 32 regular {array 1600 { 1 3 } 1 1 }  }
...
set Spec2ImplPortList { 
	max_pool_out { ap_memory {  { max_pool_out_address0 mem_address 1 11 }  { max_pool_out_ce0 mem_ce 1 1 }  { max_pool_out_q0 mem_dout 0 32 } } }
