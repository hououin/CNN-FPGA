...
# ==============================================================
set ::env(PATH) "$::env(PATH);C:/Xilinx2020/Vivado/2020.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx2020/Vivado/2020.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);C:/Xilinx2020/Vivado/2020.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx2020/Vivado/2020.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "max_pool_1.autotvin.dat"
	set constFileTvOut       "max_pool_1.autotvout.dat"
	set constFileHdlTvIn     "max_pool_1.autohdltvin.dat"
	set constFileHdlTvOut    "max_pool_1.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
