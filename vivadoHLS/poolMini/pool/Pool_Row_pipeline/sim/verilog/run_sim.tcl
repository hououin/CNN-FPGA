...
if {[file isfile max_pool_1.autotvin.dat]} {
	file delete -force max_pool_1.autotvin.dat
}

if {[file isfile max_pool_1.autotvout.dat]} {
	file delete -force max_pool_1.autotvout.dat
}
