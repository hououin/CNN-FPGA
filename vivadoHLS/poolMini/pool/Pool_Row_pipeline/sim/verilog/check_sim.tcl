...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.max_pool_1.autotvin_conv_1_out.dat"
         "c.max_pool_1.autotvin_max_pool_1_out.dat"
         "c.max_pool_1.autotvout_max_pool_1_out.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.max_pool_1.autotvout_max_pool_1_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
