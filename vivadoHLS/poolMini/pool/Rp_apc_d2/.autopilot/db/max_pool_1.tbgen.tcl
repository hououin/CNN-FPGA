...
set C_modelArgList {
	...
	{ max_pool_1_out_0 float 32 regular {array 4 { 0 3 } 0 1 }  }
	{ max_pool_1_out_1 float 32 regular {array 4 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "conv_1_out_0", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 3,"step" : 1},{"low" : 0,"up" : 0,"step" : 2},{"low" : 0,"up" : 1,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "max_pool_1_out_0", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "max_pool_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 1,"step" : 1},{"low" : 0,"up" : 0,"step" : 2},{"low" : 0,"up" : 1,"step" : 1}]}]}]} , 
 	{ "Name" : "max_pool_1_out_1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "max_pool_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 1,"step" : 1},{"low" : 1,"up" : 1,"step" : 2},{"low" : 0,"up" : 1,"step" : 1}]}]}]} ]}
...
set Spec2ImplPortList { 
	...
	max_pool_1_out_0 { ap_memory {  { max_pool_1_out_0_address0 mem_address 1 2 }  { max_pool_1_out_0_ce0 mem_ce 1 1 }  { max_pool_1_out_0_we0 mem_we 1 1 }  { max_pool_1_out_0_d0 mem_din 1 32 } } }
	max_pool_1_out_1 { ap_memory {  { max_pool_1_out_1_address0 mem_address 1 2 }  { max_pool_1_out_1_ce0 mem_ce 1 1 }  { max_pool_1_out_1_we0 mem_we 1 1 }  { max_pool_1_out_1_d0 mem_din 1 32 } } }
}
