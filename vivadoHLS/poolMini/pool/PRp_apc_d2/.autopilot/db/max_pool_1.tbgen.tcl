...
set C_modelArgList {
	{ conv_1_out_0 float 32 regular {array 8 { 1 3 } 1 1 }  }
	{ conv_1_out_1 float 32 regular {array 8 { 1 3 } 1 1 }  }
	{ conv_1_out_2 float 32 regular {array 8 { 1 3 } 1 1 }  }
	{ conv_1_out_3 float 32 regular {array 8 { 1 3 } 1 1 }  }
	{ max_pool_1_out float 32 regular {array 8 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "conv_1_out_0", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 3,"step" : 1},{"low" : 0,"up" : 0,"step" : 2},{"low" : 0,"up" : 1,"step" : 1}]}]}]} , 
 	{ "Name" : "conv_1_out_1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 3,"step" : 1},{"low" : 1,"up" : 1,"step" : 2},{"low" : 0,"up" : 1,"step" : 1}]}]}]} , 
 	{ "Name" : "conv_1_out_2", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 3,"step" : 1},{"low" : 2,"up" : 2,"step" : 2},{"low" : 0,"up" : 1,"step" : 1}]}]}]} , 
 	{ "Name" : "conv_1_out_3", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 3,"step" : 1},{"low" : 3,"up" : 3,"step" : 2},{"low" : 0,"up" : 1,"step" : 1}]}]}]} , 
 	{ "Name" : "max_pool_1_out", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "max_pool_1_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 1,"step" : 1},{"low" : 0,"up" : 1,"step" : 1},{"low" : 0,"up" : 1,"step" : 1}]}]}]} ]}
...
set portList { 
	...
	{ max_pool_1_out_address0 sc_out sc_lv 3 signal 4 } 
	{ max_pool_1_out_ce0 sc_out sc_logic 1 signal 4 } 
	{ max_pool_1_out_we0 sc_out sc_logic 1 signal 4 } 
	{ max_pool_1_out_d0 sc_out sc_lv 32 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "max_pool_1_out_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "max_pool_1_out", "role": "address0" }} , 
...
set ArgLastReadFirstWriteLatency {
	max_pool_1 {
		conv_1_out_0 {Type I LastRead 1 FirstWrite -1}
		conv_1_out_1 {Type I LastRead 2 FirstWrite -1}
		conv_1_out_2 {Type I LastRead 1 FirstWrite -1}
		conv_1_out_3 {Type I LastRead 2 FirstWrite -1}
		max_pool_1_out {Type O LastRead -1 FirstWrite 4}}}
...
set Spec2ImplPortList { 
	conv_1_out_0 { ap_memory {  { conv_1_out_0_address0 mem_address 1 3 }  { conv_1_out_0_ce0 mem_ce 1 1 }  { conv_1_out_0_q0 mem_dout 0 32 } } }
	conv_1_out_1 { ap_memory {  { conv_1_out_1_address0 mem_address 1 3 }  { conv_1_out_1_ce0 mem_ce 1 1 }  { conv_1_out_1_q0 mem_dout 0 32 } } }
	conv_1_out_2 { ap_memory {  { conv_1_out_2_address0 mem_address 1 3 }  { conv_1_out_2_ce0 mem_ce 1 1 }  { conv_1_out_2_q0 mem_dout 0 32 } } }
	conv_1_out_3 { ap_memory {  { conv_1_out_3_address0 mem_address 1 3 }  { conv_1_out_3_ce0 mem_ce 1 1 }  { conv_1_out_3_q0 mem_dout 0 32 } } }
	max_pool_1_out { ap_memory {  { max_pool_1_out_address0 mem_address 1 3 }  { max_pool_1_out_ce0 mem_ce 1 1 }  { max_pool_1_out_we0 mem_we 1 1 }  { max_pool_1_out_d0 mem_din 1 32 } } }
}
