...
// ==============================================================
#ifndef __conv_1_fcmp_32ns_fYi__HH__
#define __conv_1_fcmp_32ns_fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_1_fcmp_32ns_fYi) {
    ...
    SC_CTOR(conv_1_fcmp_32ns_fYi):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
