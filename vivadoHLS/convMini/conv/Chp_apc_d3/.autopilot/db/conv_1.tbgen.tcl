...
set C_modelArgList {
	...
	{ input_1 float 32 regular {array 16 { 1 3 } 1 1 }  }
	{ conv_out_0 float 32 regular {array 4 { 0 3 } 0 1 }  }
	{ conv_out_1 float 32 regular {array 4 { 0 3 } 0 1 }  }
	{ conv_out_2 float 32 regular {array 4 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_0", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "input","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 3,"step" : 1},{"low" : 0,"up" : 3,"step" : 1},{"low" : 0,"up" : 0,"step" : 2}]}]}]} , 
 	{ "Name" : "input_1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "input","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 3,"step" : 1},{"low" : 0,"up" : 3,"step" : 1},{"low" : 1,"up" : 1,"step" : 2}]}]}]} , 
 	{ "Name" : "conv_out_0", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 1,"step" : 1},{"low" : 0,"up" : 1,"step" : 1},{"low" : 0,"up" : 0,"step" : 2}]}]}]} , 
 	{ "Name" : "conv_out_1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 1,"step" : 1},{"low" : 0,"up" : 1,"step" : 1},{"low" : 1,"up" : 1,"step" : 2}]}]}]} , 
 	{ "Name" : "conv_out_2", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_out","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 1,"step" : 1},{"low" : 0,"up" : 1,"step" : 1},{"low" : 2,"up" : 2,"step" : 2}]}]}]} ]}
...
set portList { 
	...
	{ conv_out_0_address0 sc_out sc_lv 2 signal 2 } 
	{ conv_out_0_ce0 sc_out sc_logic 1 signal 2 } 
	{ conv_out_0_we0 sc_out sc_logic 1 signal 2 } 
	{ conv_out_0_d0 sc_out sc_lv 32 signal 2 } 
	{ conv_out_1_address0 sc_out sc_lv 2 signal 3 } 
	{ conv_out_1_ce0 sc_out sc_logic 1 signal 3 } 
	{ conv_out_1_we0 sc_out sc_logic 1 signal 3 } 
	{ conv_out_1_d0 sc_out sc_lv 32 signal 3 } 
	{ conv_out_2_address0 sc_out sc_lv 2 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv_out_0_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "conv_out_0", "role": "address0" }} , 
 	...
 	{ "name": "conv_out_1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "conv_out_1", "role": "address0" }} , 
 	...
 	{ "name": "conv_out_2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "conv_out_2", "role": "address0" }} , 
...
set ArgLastReadFirstWriteLatency {
	conv_1 {
		...
		conv_out_0 {Type O LastRead -1 FirstWrite 4}
		conv_out_1 {Type O LastRead -1 FirstWrite 4}
		conv_out_2 {Type O LastRead -1 FirstWrite 4}
...
set Spec2ImplPortList { 
	...
	input_1 { ap_memory {  { input_1_address0 mem_address 1 4 }  { input_1_ce0 mem_ce 1 1 }  { input_1_q0 mem_dout 0 32 } } }
	conv_out_0 { ap_memory {  { conv_out_0_address0 mem_address 1 2 }  { conv_out_0_ce0 mem_ce 1 1 }  { conv_out_0_we0 mem_we 1 1 }  { conv_out_0_d0 mem_din 1 32 } } }
	conv_out_1 { ap_memory {  { conv_out_1_address0 mem_address 1 2 }  { conv_out_1_ce0 mem_ce 1 1 }  { conv_out_1_we0 mem_we 1 1 }  { conv_out_1_d0 mem_din 1 32 } } }
	conv_out_2 { ap_memory {  { conv_out_2_address0 mem_address 1 2 }  { conv_out_2_ce0 mem_ce 1 1 }  { conv_out_2_we0 mem_we 1 1 }  { conv_out_2_d0 mem_din 1 32 } } }
}
