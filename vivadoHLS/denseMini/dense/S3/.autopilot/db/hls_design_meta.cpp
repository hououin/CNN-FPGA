...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("flat_array_address0", 3, hls_out, 0, "ap_memory", "mem_address", 1),
	Port_Property("flat_array_ce0", 1, hls_out, 0, "ap_memory", "mem_ce", 1),
	Port_Property("flat_array_q0", 32, hls_in, 0, "ap_memory", "mem_dout", 1),
	Port_Property("flat_array_address1", 3, hls_out, 0, "ap_memory", "MemPortADDR2", 1),
	...
	Port_Property("prediction_address0", 2, hls_out, 1, "ap_memory", "mem_address", 1),
